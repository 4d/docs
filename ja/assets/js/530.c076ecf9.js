...
var mermaid_2490e8f2 = __webpack_require__(338328);
...
/* harmony export */ });
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(338328);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(126312);
/* harmony import */ var _createText_4a4f35c9_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(513316);
...
let vertexCounter = 0;
let config = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)();
let vertices = {};
let edges = [];
let classes = {};
let subGraphs = [];
...
let version;
let funs = [];
const sanitizeText = (txt) => _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, config);
...
const addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const addSingleLink = function(_start, _end, type) {
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 Got edge...", edge);
  ...
  if (edges.length < (config.maxEdges ?? 500)) {
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 pushing edge...");
    edges.push(edge);
  } else {
    throw new Error(
...
const addLink = function(_start, _end, type) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.l.info("addLink (abc78)", _start, _end, type);
  let i, j;
...
const updateLink = function(positions, style) {
  positions.forEach(function(pos) {
    ...
    if (pos === "default") {
      ...
      if (_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.u.isSubstringInArray("fill", style) === -1) {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if ((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel !== "loose") {
    return;
  }
    ...
    funs.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.u.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
const setLink = function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const clear = function(ver = "gen-1") {
  ...
  version = ver;
  config = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.v)();
};
const setGen = (ver) => {
  version = ver || "gen-2";
};
...
const addSubGraph = function(_id, list, _title) {
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
...
const flowDb = {
  defaultConfig: () => _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.K.flowchart,
  setAccTitle: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.s,
  getAccTitle: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.g,
  getAccDescription: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.a,
  setAccDescription: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.b,
  addVertex,
  lookUpDomId,
  addLink,
  ...
  exists,
  makeUniq,
  setDiagramTitle: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.q,
  getDiagramTitle: _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.t
};
...
/* harmony export */ });
/* harmony import */ var _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(132966);
/* harmony import */ var _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(397552);
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(338328);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(126312);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(599418);
...
const diagram = {
  parser: _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_7__.p,
  db: _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_7__.f,
  renderer: _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_8__.f,
  styles: _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_8__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_9__.p)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
    _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_8__.f.setConf(cnf.flowchart);
    _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_7__.f.clear();
    _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_7__.f.setGen("gen-2");
  }
};
...
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(338328);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(300697);
/* harmony import */ var _createText_4a4f35c9_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(513316);
...
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(338328);
/* harmony import */ var _index_9620d214_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(780375);
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(598318);
...
const addVertices = async function(vert, g, svgId, root, doc, diagObj) {
  ...
  for (const id of keys) {
    ...
    const styles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.m)((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.htmlLabels)) {
        const node = {
          label: vertexText
        };
        ...
        const rows = vertexText.split(_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex);
        for (const row of rows) {
    ...
    const labelText = await (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.r)(vertexText, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.c)());
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.padding
    });
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText,
...
const addEdges = async function(edges, g, diagObj) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.k)(edges.defaultStyle);
  ...
  for (const edge of edges) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
    ...
    edgeData.label = await (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.r)(edge.text.replace(_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex, "\n"), (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.c)());
    if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Drawing flowchart");
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.c)();
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraph - ", subG);
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .selectAll */ .Ubm)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  await (0,_index_9620d214_js__WEBPACK_IMPORTED_MODULE_4__.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
