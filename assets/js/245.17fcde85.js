...
;// ./node_modules/mermaid/dist/sankeyDiagram-c599f8ec.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_2490e8f2.e.sanitizeText(ID, (0,mermaid_2490e8f2.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_2490e8f2.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_2490e8f2.c)();
  const defaultSankeyConfig = mermaid_2490e8f2.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_2490e8f2.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
