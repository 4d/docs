...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(472434);
...
/* harmony export */ });
/* harmony import */ var _styles_e2b9d258_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(527224);
...
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(338328);
/* harmony import */ var _index_9620d214_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(780375);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(599418);
...
const sanitizeText = (txt) => _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(txt, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
  keys.filter((id) => classes[id].parent == parent).forEach(function(id) {
    var _a, _b;
    const vertex = classes[id];
    const cssClassStr = vertex.cssClasses.join(" ");
    const styles2 = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.k)(vertex.styles);
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .lUB)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.n)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .lUB)
    };
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart ?? (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().class;
  const securityLevel = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  await (0,_index_9620d214_js__WEBPACK_IMPORTED_MODULE_8__.r)(
    element,
    g,
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_7__.o)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
const diagram = {
  parser: _styles_e2b9d258_js__WEBPACK_IMPORTED_MODULE_9__.p,
  db: _styles_e2b9d258_js__WEBPACK_IMPORTED_MODULE_9__.d,
  renderer,
  styles: _styles_e2b9d258_js__WEBPACK_IMPORTED_MODULE_9__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_e2b9d258_js__WEBPACK_IMPORTED_MODULE_9__.d.clear();
  }
};
...
class ClassMember {
  constructor(input, memberType) {
    ...
    this.visibility = "";
    this.classifier = "";
    const sanitizedInput = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.d)(input, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.x)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.x)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.x)(this.returnType);
      }
    }
...
let functions = [];
const sanitizeText = (txt) => _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
const splitClassNameAndType = function(_id) {
  const id = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(_id, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  let genericType = "";
  let className = id;
  if (id.indexOf("~") > 0) {
...
const addClass = function(_id) {
  ...
  const name = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(className, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  classes[name] = {
    id: name,
    type,
    label: name,
...
const addRelation = function(relation) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(relation.relationTitle1.trim(), (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  relation.relationTitle2 = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(relation.relationTitle2.trim(), (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
...
const setLink = function(ids, linkStr, target) {
  const config = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const setClickFunc = function(_domId, functionName, functionArgs) {
  const domId = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(_domId, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  const config = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const db = {
  ...
  getConfig: () => (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__.c)().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
