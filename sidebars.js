...
const subCategories = [
  { id: "4d-environment", titles: { en: "4D Environment", fr: "Environnement 4D", es: "Entorno 4D", ja: "4D環境", pt: "Ambiente 4D" } },
  { id: "arrays", titles: { en: "Arrays", fr: "Tableaux", es: "Arrays", ja: "配列", pt: "Arrays" } },
  { id: "backup", titles: { en: "Backup", fr: "Sauvegarde", es: "Copia de seguridad", ja: "バックアップ", pt: "Página de Backup" } },
  { id: "blob", titles: { en: "BLOB", fr: "BLOB", es: "BLOB", ja: "BLOB", pt: "BLOB" } },
  { id: "boolean", titles: { en: "Boolean", fr: "Boolean", es: "Boolean", ja: "Boolean", pt: "Parâmetros" } },
  { id: "cache-management", titles: { en: "Cache Management", fr: "Gestion du cache", es: "Gestión de caché", ja: "キャッシュ管理", pt: "Cache Management" } },
  { id: "collections", titles: { en: "Collections", fr: "Collections", es: "Colecciones", ja: "コレクション", pt: "Coleções" } },
  { id: "communications", titles: { en: "Communications", fr: "Communications", es: "Comunicaciones", ja: "通信", pt: "Communications" } },
  { id: "compiler", titles: { en: "Compiler", fr: "Compilateur", es: "Compilador", ja: "コンパイラー", pt: "Compiler" } },
  { id: "data-entry", titles: { en: "Data Entry", fr: "Saisie", es: "Entrada", ja: "データ入力", pt: "Entrada de dados" } },
  { id: "data-security", titles: { en: "Data Security", fr: "Sécurité des données", es: "Seguridad de los datos", ja: "データセキュリティ", pt: "Segurança dos dados" } },
  { id: "date-and-time", titles: { en: "Date and Time", fr: "Dates et heures", es: "Fechas y horas", ja: "日付と時間", pt: "Data e Horas" } },
  { id: "design-object-access", titles: { en: "Design Object Access", fr: "Accès objets développement", es: "Acceso objetos diseño", ja: "デザインオブジェクトアクセス", pt: "Design Object Access" } },
  { id: "drag-and-drop", titles: { en: "Drag and Drop", fr: "Glisser-Déposer", es: "Arrastrar y soltar", ja: "ドラッグ＆ドロップ", pt: "Arrastar e Soltar" } },
  { id: "entry-control", titles: { en: "Entry Control", fr: "Gestion de la saisie", es: "Control de entrada", ja: "入力制御", pt: "Controle de entrada" } },
  { id: "file-and-folder", titles: { en: "File and Folder", fr: "Fichier et dossier", es: "Archivo y carpeta", ja: "ファイルとフォルダ", pt: "File and Folder" } },
  { id: "form-events", titles: { en: "Form Events", fr: "Evénements formulaire", es: "Eventos formulario", ja: "フォームイベント", pt: "Eventos formulário" } },
  { id: "forms", titles: { en: "Forms", fr: "Formulaires", es: "Formularios", ja: "Forms", pt: "Formulários" } },
  { id: "formulas", titles: { en: "Formulas", fr: "Formules", es: "Fórmulas", ja: "フォーミュラ", pt: "Fórmulas" } },
  { id: "graphs", titles: { en: "Graphs", fr: "Graphes", es: "Gráficos", ja: "グラフ", pt: "Graphs" } },
  { id: "http", titles: { en: "HTTP", fr: "HTTP", es: "HTTP", ja: "HTTPクライアント", pt: "HTTP" } },
  { id: "hierarchical-lists", titles: { en: "Hierarchical Lists", fr: "Listes hiérarchiques", es: "Listas jerárquicas", ja: "階層リスト", pt: "Hierarchical Lists" } },
  { id: "import-and-export", titles: { en: "Import and Export", fr: "Import-Export", es: "Import-Export", ja: "インポート＆エクスポート", pt: "Import and Export" } },
  { id: "interruptions", titles: { en: "Interruptions", fr: "Interruptions", es: "Interrupciones", ja: "割り込み", pt: "Interruptions" } },
  { id: "json", titles: { en: "JSON", fr: "JSON", es: "JSON", ja: "JSON", pt: "JSON" } },
  { id: "ldap", titles: { en: "LDAP", fr: "LDAP", es: "LDAP", ja: "LDAP", pt: "LDAP" } },
  { id: "language", titles: { en: "Language", fr: "Langage", es: "Lenguaje", ja: "ランゲージ", pt: "Línguagem" } },
  { id: "licenses", titles: { en: "Licenses", fr: "Licences", es: "Licencias", ja: "ライセンスリスト", pt: "Licenças" } },
  { id: "list-box", titles: { en: "List Box", fr: "List Box", es: "List Box", ja: "リストボックス", pt: "List Box" } },
  { id: "mail", titles: { en: "Mail", fr: "Mail", es: "Mail", ja: "メール", pt: "Mail" } },
  { id: "math", titles: { en: "Math", fr: "Fonctions mathématiques", es: "Funciones matemáticas", ja: "算術関数", pt: "Funções matemáticas" } },
  { id: "menus", titles: { en: "Menus", fr: "Menus", es: "Menús", ja: "メニュー", pt: "Menus" } },
  { id: "messages", titles: { en: "Messages", fr: "Messages", es: "Messages", ja: "メッセージ", pt: "Messages" } },
  { id: "named-selections", titles: { en: "Named Selections", fr: "Sélections temporaires", es: "Selecciones temporales", ja: "命名セレクション", pt: "Seleções temporárias" } },
  { id: "objects-forms", titles: { en: "Objects (Forms)", fr: "Objets (Formulaires)", es: "Objetos (formularios)", ja: "オブジェクト (フォーム)", pt: "Objects (Forms)" } },
  { id: "objects-language", titles: { en: "Objects (Language)", fr: "Objets (Langage)", es: "Objetos (Lenguaje)", ja: "オブジェクト (ランゲージ)", pt: "Objects (Language)" } },
  { id: "on-a-series", titles: { en: "On a Series", fr: "Fonctions statistiques", es: "Funciones estadísticas", ja: "統計関数", pt: "On a Series" } },
  { id: "pasteboard", titles: { en: "Pasteboard", fr: "Conteneur de données", es: "Portapapeles", ja: "ペーストボード", pt: "Pasteboard" } },
  { id: "pictures", titles: { en: "Pictures", fr: "Images", es: "Imágenes", ja: "ピクチャー", pt: "Imagens" } },
  { id: "printing", titles: { en: "Printing", fr: "Impressions", es: "Impresiones", ja: "印刷", pt: "Printing" } },
  { id: "process-communications", titles: { en: "Process (Communications)", fr: "Process (Communications)", es: "Process (Communications)", ja: "プロセス (通信)", pt: "Processo (Comunicações)" } },
  { id: "process-user-interface", titles: { en: "Process (User Interface)", fr: "Process (Interface utilisateur)", es: "Proceso (interfaz de usuario)", ja: "プロセス (ユーザーインターフェース)", pt: "Processo (Interface do Usuário)" } },
  { id: "processes", titles: { en: "Processes", fr: "Process", es: "Procesos", ja: "プロセス", pt: "Processos" } },
  { id: "queries", titles: { en: "Queries", fr: "Recherches et tris", es: "Búsquedas", ja: "クエリ", pt: "Queries" } },
  { id: "quick-report", titles: { en: "Quick Report", fr: "Etats rapides", es: "Informes rápidos", ja: "クイックレポート", pt: "Quick Report" } },
  { id: "record-locking", titles: { en: "Record Locking", fr: "Enregistrements (verrouillage)", es: "Bloqueo de registros", ja: "レコードロック", pt: "Record Locking" } },
  { id: "records", titles: { en: "Records", fr: "Enregistrements", es: "Registros", ja: "レコード", pt: "Records" } },
  { id: "relations", titles: { en: "Relations", fr: "Liens", es: "Relaciones", ja: "リレーション", pt: "Relações" } },
  { id: "resources", titles: { en: "Resources", fr: "Resources", es: "Resources", ja: "Resources", pt: "Resources" } },
  { id: "sql", titles: { en: "SQL", fr: "SQL", es: "SQL", ja: "SQL", pt: "SQL" } },
  { id: "svg", titles: { en: "SVG", fr: "SVG", es: "SVG", ja: "SVG", pt: "SVG" } },
  { id: "secured-protocol", titles: { en: "Secured Protocol", fr: "Protocole sécurisé", es: "Protocolo seguro", ja: "暗号化プロトコル", pt: "Protocolo seguro" } },
  { id: "selection", titles: { en: "Selection", fr: "Sélections", es: "Selección", ja: "セレクション", pt: "Seleção" } },
  { id: "sets", titles: { en: "Sets", fr: "Ensembles", es: "Conjuntos", ja: "セット", pt: "Conjuntos" } },
  { id: "spell-checker", titles: { en: "Spell Checker", fr: "Correcteur orthographique", es: "Corrector ortográfico", ja: "スペルチェッカー", pt: "Spell Checker" } },
  { id: "string", titles: { en: "String", fr: "String", es: "String", ja: "文字列", pt: "String" } },
  { id: "structure-access", titles: { en: "Structure Access", fr: "Définition structure", es: "Definición estructura", ja: "ストラクチャーアクセス", pt: "Structure Access" } },
  { id: "styled-text", titles: { en: "Styled Text", fr: "Texte multistyle", es: "Texto multiestilo", ja: "スタイル付きテキスト", pt: "Styled Text" } },
  { id: "subrecords", titles: { en: "Subrecords", fr: "Sous-enregistrements", es: "Subregistros", ja: "サブレコード", pt: "Sub-registros" } },
  { id: "system-documents", titles: { en: "System Documents", fr: "Documents système", es: "Documentos sistema", ja: "システムドキュメント", pt: "System Documents" } },
  { id: "system-environment", titles: { en: "System Environment", fr: "Environnement système", es: "Entorno sistema", ja: "システム環境", pt: "System Environment" } },
  { id: "table", titles: { en: "Table", fr: "Table", es: "Tabla", ja: "Table", pt: "Tabela" } },
  { id: "tools", titles: { en: "Tools", fr: "Outils", es: "Herramientas", ja: "ツール", pt: "Tools" } },
  { id: "transactions", titles: { en: "Transactions", fr: "Transactions", es: "Transacciones", ja: "トランザクション", pt: "Transactions" } },
  { id: "triggers", titles: { en: "Triggers", fr: "Triggers", es: "Triggers", ja: "Triggers", pt: "Triggers" } },
  { id: "user-interface", titles: { en: "User Interface", fr: "Interface utilisateur", es: "Interfaz de usuario", ja: "ユーザーインターフェース", pt: "Interface do usuário" } },
  { id: "users-and-groups", titles: { en: "Users and Groups", fr: "Utilisateurs et groupes", es: "Usuarios y grupos", ja: "ユーザー＆グループ", pt: "Usuários e grupos" } },
  { id: "variables", titles: { en: "Variables", fr: "Variables", es: "Variables", ja: "変数", pt: "Variáveis." } },
  { id: "web-area", titles: { en: "Web Area", fr: "Zones Web", es: "Área Web", ja: "Webエリア", pt: "Área Web" } },
  { id: "web-server", titles: { en: "Web Server", fr: "Serveur Web", es: "Servidor Web", ja: "Web サーバー", pt: "Servidor Web" } },
  { id: "web-services-client", titles: { en: "Web Services (Client)", fr: "Web Services (Client)", es: "Web Services (Client)", ja: "Webサービス (クライアント)", pt: "Web Services (Client)" } },
  { id: "web-services-server", titles: { en: "Web Services (Server)", fr: "Web Services (Serveur)", es: "Web Services (Servidor)", ja: "Webサービス (サーバー)", pt: "Web Services (Server)" } },
  { id: "windows", titles: { en: "Windows", fr: "Windows", es: "Windows", ja: "Windows", pt: "Windows" } },
  { id: "xml-dom", titles: { en: "XML DOM", fr: "XML DOM", es: "XML DOM", ja: "XML DOM", pt: "XML DOM" } },
  { id: "xml-sax", titles: { en: "XML SAX", fr: "XML SAX", es: "XML SAX", ja: "XML SAX", pt: "XML SAX" } },
  { id: "xml", titles: { en: "XML", fr: "XML", es: "XML", ja: "XML", pt: "XML" } }
];
...
subCategories.sort((a, b) => a.titles[locale].localeCompare(b.titles[locale]));
