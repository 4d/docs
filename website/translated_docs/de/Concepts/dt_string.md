...
```
> **Hinweise:** - 4D verwendet die ICU library zum Vergleichen von Strings (mit den Operatoren <>=#) und Suchen von Schlüsselwörtern. Weitere Informationen zu den Regeln bei Schlüsselwörtern finden Sie unter: http://www.unicode.org/reports/tr29/#Word_Boundaries. - In der japanischen Version verwendet 4D zum Suchen von Schlüsselwörtern anstatt ICU standardmäßig Mecab.
