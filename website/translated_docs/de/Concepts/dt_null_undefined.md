...
Null is a special data type with only one possible value: **null**. Dieser Wert wird von einem Ausdruck zurückgegeben, der gar keinen Wert enthält.
