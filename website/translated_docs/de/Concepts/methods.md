...
| **Trigger** (auch bekannt als *Tabellenmethode*) | Automatic, each time that you manipulate the records of a table (Add, Delete and Modify)                    | Nein                 | Property of a table. Triggers are methods that can prevent “illegal” operations with the records of your database.                                                                                               |
