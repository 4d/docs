...
| options    | Objekt | -> | Options for the named formula     |
<!-- END REF -->  
...
| vpAreaName | Text     | -> | 4D View Pro area form object name      |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Range object of all cells              |
<!-- END REF -->  
...
| sheet       | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis    | Objekt   | <- | Range object of cells                  |
<!-- END REF -->  
...
| Ergebnis      | Objekt | <- | Object containing a combined range |
...
| rangeObj  | Objekt | -> | Range object                                      |
| Ergebnis  | Objekt | <- | SVG picture of the area                           |
...
| Ergebnis  | Objekt | <- | Object returned. Contains the copied data |
<!-- END REF -->  
#### Beschreibung
...
| paramObj   | Objekt | -> | Export options                    |
<!-- END REF -->  
...
| pdfOptions           | object  | PDF only (optional) - Options for pdf export <p><table><tr><th>Property</th><th>Typ</yh><th>Beschreibung</th></tr><tr><td>creator</td><td>Text</td><td>name of the application that created the original document from which it was converted.</td></tr><tr><td>title</td><td>Text</td><td>title of the document.</td></tr><tr><td>author</td><td>Text</td><td>name of the person who created that document.</td></tr><tr><td>keywords</td><td>Text</td><td>keywords associated with the document.</td></tr><tr><td>subject</td><td>Text</td><td>subject of the document.</td></tr></table></p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| target      | Ganzzahl | <table><tr><td>`vk find target formula`</td><td>The search is performed in the cell formula</td></tr><tr><td>`vk find target tag`</td><td>The search is performed in the cell tag</td></tr><tr><td>`vk find target text`</td><td>The search is performed in the cell text (default)</td></tr></table><p>These flags can be combined. Beispiel:<p> <code>$search.target:=vk find target formula+vk find target text</code></p>                                                                                                |
...
| vpAreaName | Text     | -> | 4D View Pro area form object name      |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Range object of single cell            |
<!-- END REF -->  
...
| --------- | ------ | -- | --------------------------------------- |
| rangeObj  | Objekt | -> | Range object                            |
| Ergebnis  | Text   | <- | Name of the attribute bound to the cell |
...
| --------- | ---------- | -- | ------------------------------- |
| rangeObj  | Objekt     | -> | Range object                    |
| Ergebnis  | Collection | <- | Collection of column properties |
<!-- END REF -->  
...
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Ganzzahl | <- | Total number of columns                |
<!-- END REF -->  
...
| --------------- | -------- | -- | --------------------------------- |
| vpAreaName      | Text     | -> | 4D View Pro area form object name |
| Function result | Ganzzahl | <- | Index of the current sheet        |
<!-- END REF -->
...
| Ergebnis   | Object &#124; Collection | <- | Data context                                    |
...
| Ergebnis   | Text | <- | Named formula or named range definition |
<!-- END REF -->  
...
| --------- | ---------- | -- | ---------------------------- |
| rangeObj  | Objekt     | -> | Range object                 |
| Ergebnis  | Collection | <- | Collection of formula values |
<!-- END REF -->  
...
| vpAreaName | Text     | -> | 4D View Pro area form object name                   |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted)              |
| Ergebnis   | Objekt   | <- | Object containing frozen column and row information |
<!-- END REF -->  
...
| vpAreaName | Text       | -> | 4D View Pro area form object name     |
| scope      | Zahl       | -> | Target scope (default= current sheet) |
| Ergebnis   | Collection | <- | Existing names in the defined scope   |
<!-- END REF -->  
...
| vpAreaName | Text     | -> | 4D View Pro area form object name      |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Object of printing information         |
<!-- END REF -->  
...
| --------- | ---------- | -- | ---------------------------- |
| rangeObj  | Objekt     | -> | Range object                 |
| Ergebnis  | Collection | <- | Collection of row properties |
<!-- END REF -->  
...
| vpAreaName | Text     | -> | 4D View Pro area from object name      |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Ganzzahl | <- | Total number of rows                   |
<!-- END REF -->  
...
| --------------- | -------- | -- | --------------------------------- |
| vpAreaName      | Text     | -> | 4D View Pro area form object name |
| Function result | Ganzzahl | <- | Number of sheets                  |
<!-- END REF -->
...
| vpAreaName      | Text     | -> | 4D View Pro area form object name |
| name            | Text     | -> | Sheet name                        |
| Function result | Ganzzahl | <- | Sheet index                       |
<!-- END REF -->
...
| vpAreaName | Text     | -> | 4D View Pro area from object name      |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Sheet options object                   |
<!-- END REF -->  
...
| --------- | ------ | -- | ----------------------------------------- |
| rangeObj  | Objekt | -> | Range object                              |
| Ergebnis  | Objekt | <- | Object of cell spans in the defined range |
<!-- END REF -->  
...
| styleName  | Text     | -> | Name of style                          |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Style sheet object                     |
<!-- END REF -->  
...
| Ergebnis   | Collection | <- | Collection of style sheet objects      |
<!-- END REF -->  
...
| --------- | ------ | -- | ------------------------------ |
| rangeObj  | Objekt | -> | Range object                   |
| Ergebnis  | Objekt | <- | Object containing a cell value |
<!-- END REF -->  
...
| --------- | ---------- | -- | -------------------- |
| rangeObj  | Objekt     | -> | Range object         |
| Ergebnis  | Collection | <- | Collection of values |
<!-- END REF -->  
...
* Each subcollection contains cell values for the row. Values can be Integer, Real, Boolean, Text, Null. If a value is a date or time, it is returned in an object with the following properties:
 ...
 | Property | Typ   | Beschreibung                                                |
 | -------- | ----- | ----------------------------------------------------------- |
 | value    | Datum | Value in the cell (except- time)                            |
 | time     | Zahl  | Time value (in seconds) if the value is of the js date type |
...
| ---------- | ------ | -- | -------------------------------------- |
| vpAreaName | Text   | -> | 4D View Pro area form object name      |
| Ergebnis   | Objekt | <- | Object containing the workbook options |
<!-- END REF -->  
...
| vpAreaName | Text   | -> | 4D View Pro area form object name |
| filePath   | Text   | -> | Pathname of the document          |
| paramObj   | Objekt | -> | Import options                    |
...
| ---------- | ------ | -- | --------------------------------- |
| vpAreaName | Text   | -> | 4D View Pro area form object name |
| viewPro    | Objekt | -> | 4D View Pro object                |
...
| Ergebnis   | Objekt   | <- | Range object of name                      |
...
| options    | Lange Ganzzahl | -> | Specifies what is pasted                |
...
| scope      | Ganzzahl | -> | Target scope (default=current sheet)               |
...
| ---------- | -------- | -- | --------------------------------- |
| vpAreaName | Text     | -> | 4D View Pro area form object name |
| index      | Ganzzahl | -> | Index of the sheet to remove      |
<!-- END REF -->
...
| rowCount   | Ganzzahl | -> | Number of rows                         |
| sheet      | Ganzzahl | -> | Sheet index (current sheet if omitted) |
| Ergebnis   | Objekt   | <- | Range object of row(s)                 |
...
| Ergebnis   | Mixed  | <- | `.result` property of the `.onEvent` object, or Null if does not return a value |
...
| Parameter | Typ    |    | Beschreibung                             |
| --------- | ------ | -- | ---------------------------------------- |
| methodObj | Objekt | -> | Allowed methods in the 4D View Pro areas |
...
| borderPosObj   | Objekt | -> | Object containing border placement  |
...
| ----------- | ------ | -- | ----------------------------------- |
| rangeObj    | Objekt | -> | Range object                        |
| propertyObj | Objekt | -> | Object containing column properties |
...
| ---------- | -------- | -- | --------------------------------- |
| vpAreaName | Text     | -> | 4D View Pro area form object name |
| sheet      | Ganzzahl | <- | Index of the new current sheet    |
<!-- END REF -->
...
| vpAreaName | Text     | -> | 4D View Pro area form object name     |
| styleObj   | Objekt   | -> | Style object                          |
| sheet      | Ganzzahl | -> | Sheet index (default = current sheet) |
...
| ------------- | ------ | -- | --------------------------------------- |
| rangeObj      | Objekt | -> | Range object                            |
| field         | Zeiger | -> | Reference to field in virtual structure |
...
| propertyObj | Objekt | -> | Object containing row properties |
...
| Parameter | Typ    |    | Beschreibung          |
| --------- | ------ | -- | --------------------- |
| rangeObj  | Objekt | -> | Range object of cells |
...
| ---------- | -------- | -- | --------------------------------- |
| vpAreaName | Text     | -> | 4D View Pro area form object name |
| number     | Ganzzahl | -> | Number of sheets                  |
...
| sheet      | Ganzzahl | -> | Index of the sheet to be renamed  |
...
| sheet        | Objekt | -> | Sheet index (current sheet if omitted) |
...
| --------- | ------ | -- | ------------------------------ |
| rangeObj  | Objekt | -> | Range object                   |
| valueObj  | Objekt | -> | Cell values and format options |
...
| ---------- | ------ | -- | ------------------------------------------------ |
| vpAreaName | Text   | -> | 4D View Pro area form object name                |
| optionObj  | Objekt | -> | Object containing the workbook options to be set |
<!-- END REF -->  
...
| referenceStyle                        | number                  | Style for cell and range references in cell formulas. Available values: <table><tr><th>Constant</th><th>Wert</th><th>Beschreibung</th></tr><tr><td> vk reference style A1 </td><td>0</td><td> Use A1 style.</td></tr><tr><td> vk reference style R1C1 </td><td>1</td><td> Use R1C1 style</td></tr></table>                                                                                                                                                      |
...
| hPos      | Ganzzahl | -> | Horizontal view position of cell or row |
