...
| Ergebnis  | 4D.SMTPTransporter | <- | [SMTP transporter object](#smtp-transporter-object) |
<!-- END REF -->
...
| .**accessTokenOAuth2**: Text<p>Text string representing OAuth 2 authorization credentials. Used only with OAUTH2 `authenticationMode`. If `accessTokenOAuth2` is used but `authenticationMode` is omitted, the OAuth 2 protocol is used (if allowed by the server). Text string or token object representing OAuth2 authorization credentials. | none                                                                |
...
| [<!-- INCLUDE #SMTPTransporterClass.keepAlive.Syntax -->](#keepalive)<p>&nbsp;&nbsp;&nbsp;&nbsp;<!-- INCLUDE #SMTPTransporterClass.keepAlive.Summary -->| Wahr                                                                |
| [<!-- INCLUDE #transporter.logFile.Syntax -->](#logfile)<p>&nbsp;&nbsp;&nbsp;&nbsp;<!-- INCLUDE #transporter.logFile.Summary -->| none                                                                |
| **password** : Text<p>User password for authentication on the server. Text string or token object representing OAuth2 authorization credentials.                                                                                                                                                                                               | none                                                                |
...
| Parameter | Typ    |    | Beschreibung                                      |
| --------- | ------ |:--:| ------------------------------------------------- |
| mail      | Objekt | -> | [Email](EmailObjectClass.md#email-object) to send |
| Ergebnis  | Objekt | <- | SMTP status                                       |
<!-- END REF -->
