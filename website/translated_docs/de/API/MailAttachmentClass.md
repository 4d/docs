...
## .disposition**.disposition** : Text#### Beschreibung
...
| Parameter | Typ     |    | Beschreibung              |
| --------- | ------- |:--:| ------------------------- |
| Ergebnis  | 4D.Blob | <- | Content of the attachment |#### Beschreibung
...
| ------- | ------- |
| v19     | Added   |
</details>**.platformPath** : Text#### Beschreibung
