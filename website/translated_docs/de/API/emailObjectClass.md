...
| Ergebnis  | Text   | <- | Email object converted to MIME    |
<!-- END REF -->
...
| Parameter   | Typ        |    | Beschreibung                                                                          |
| ----------- | ---------- |:--:| ------------------------------------------------------------------------------------- |
| value       | Objekt     | -> | Path of the attachment file (text), or<br>Blob containing the attachment (BLOB) |
...
| Ergebnis    | Objekt     | <- | Attachment object                                                                     |
<!-- END REF -->
...
| Parameter | Typ  |    | Beschreibung              |
| --------- | ---- |:--:| ------------------------- |
| Ergebnis  | Blob | <- | Content of the attachment |
<!-- END REF -->
