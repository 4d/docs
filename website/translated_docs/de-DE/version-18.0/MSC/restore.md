...
Der linke Bereich enthält die vorhandenen Backups der Datenbank. Sie können auch unter dem linken Bereich auf die Schaltfläche Wählen klicken,... um ein Archiv an anderer Stelle zu öffnen. Es wird dann zur Liste der Archive hinzugefügt.
