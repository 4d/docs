...
| 列            | Used in other components to organize information on a page                                                    |
...
| ボタン          | Triggers actions on a web page. Serves as call to action (CTA) and links to pages, forms, assets, and more    |
...
| プロパティ     | タイプ    | 説明                                                                                                            |
| --------- | ------ | ------------------------------------------------------------------------------------------------------------- |
| caller    | テキスト   | Server-side reference of the component triggering the event                                                   |
