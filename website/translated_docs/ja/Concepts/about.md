...
従来の言語では、あらかじめオブジェクトを正式な記述法で宣言・定義しなければなりません。 In 4D, you simply create an object, such as a button, and use it. 4D automatically manages the object for you. たとえば、ボタンを使用するためには、ボタンをフォーム上に作成して名前を指定します。 ユーザーがボタンをクリックした時点で、ランゲージが自動的にメソッドに通知します。
