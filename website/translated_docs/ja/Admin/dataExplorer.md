...
- On the **left side**, you can select the dataclasses and attributes to display. You can filter the list of dataclass names and attribute names using the respective search areas. ![alt-text](assets/en/Admin/dataExplorer3.png)
