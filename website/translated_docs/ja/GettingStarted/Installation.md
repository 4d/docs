...
Once you have installed your application, you can start 4D. To do so, double-click on the 4D application icon.
...
Deploy the **Launching applications** area and select what you want to do:

- **Connect to 4D Server** - use 4D as a remote client and connect to an application that is already loaded by 4D Server.
- **Open a local application** - load an existing application stored on your disk.
- **Create a new application** - create a new, empty application project on your disk. 

Enjoy your 4D experience!

> Join the 4D developer community on line: <https://discuss.4d.com>.