...
- in the **Resources** folder of the project. Appropriate when you want to share static pictures between several forms in the project. この場合、パス名は "/RESOURCES/\<picture path\>" となります。
...
|   名   | データタイプ | とりうる値                           |
|:-----:|:------:| ------------------------------- |
| ピクチャー |  text  | POSIX シンタックスの相対パス、またはファイルシステムパス |
