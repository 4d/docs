...
> On 4D Server, opening a REST session requires that a free 4D client licence is available.<br> On 4D single-user, you can open up to three REST sessions for testing purposes.
