...
- **Limites**, **Règles**, etc. : cochez les éléments qui doivent être affichés par défaut dans chaque nouvelle fenêtre de l'éditeur de formulaire. Il est possible de modifier séparément l’affichage de chaque fenêtre à l’aide du menu hiérarchique **Afficher** de l’éditeur de formulaires.
