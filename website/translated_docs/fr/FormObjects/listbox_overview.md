...
Les list box sont des objets actifs complexes permettant d’afficher et de saisir des données sous forme de tableaux. They can be bound to database contents such as entity selections and record sections, or to any language contents such as collections and arrays. They include advanced features regarding data entry, column sorting, event managemet, customized appearance, moving of columns, etc.
...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Sur après modification        | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                            |                                                                                                      |
| Sue après frappe clavier      | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                            |                                                                                                      |
| Sur après tri                 | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[nomEn-tête](#propriétés-supplémentaires)</li>                                                                                            | *Les formules composées ne peuvent pas être triées. <br>(ex : This.firstName + This.lastName)*       |
| Sur clic alternatif           | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                          | *Arrays list boxes only*                                                                             |
| Sur avant saisie              | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sue avant frappe clavier      | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur début survol              | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur clic                      | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur fermeture corps           | <li>[ligne](#propriétés-supplémentaires)</li>                                                                                                                                             | *Current Selection & Named Selection list boxes only*                                                |
| Sur contracter                | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *Hierarchical list box only*                                                                         |
| Sur déplacement colonne       | <li>[nomColonne](#propriétés-supplémentaires)</li><li>[nouvellePosition](#propriétés-supplémentaires)</li><li>[anciennePosition](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur redimensionnement colonne | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[nouvelleTaille](#propriétés-supplémentaires)</li><li>[ancienneTaille](#propriétés-supplémentaires)</li>                                                               |                                                                                                      |
| Sur données modifiées         | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur action suppression        | <li>[ligne](#propriétés-supplémentaires)</li>                                                                                                                                             |                                                                                                      |
| Sur affichage corps           | <li>[isRowSelected](#additional-properties)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                                                   |                                                                                                      |
| Sur double clic               | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur glisser                   | <li>[zone](#propriétés-supplémentaires)</li><li>[nomZone](#propriétés-supplémentaires)</li><li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                     |                                                                                                      |
| Sur déposer                   | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur déployer                  | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *List box hiérarchiques uniquement*                                                                  |
| Sur clic pied                 | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[nomPied](#propriétés-supplémentaires)</li>                                                                                         | *Arrays, Current Selection & Named Selection list boxes only*                                        |
| On Getting Focus              | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *Propriétés supplémentaires retournées uniquement lors de la modification d'une cellule*             |
| Sur clic entête               | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[nomEn-tête](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| On Load                       |                                                                                                                                                                        |                                                                                                      |
| On Losing Focus               | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *Propriétés supplémentaires retournées uniquement lorsque la modification d'une cellule est achevée* |
| Sur début survol              | <li>[zone](#propriétés-supplémentaires)</li><li>[nomZone](#propriétés-supplémentaires)</li><li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                     |                                                                                                      |
| Sur fin survol                |                                                                                                                                                                        |                                                                                                      |
| Sur survol                    | <li>[zone](#propriétés-supplémentaires)</li><li>[nomZone](#propriétés-supplémentaires)</li><li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                     |                                                                                                      |
| Sur ouverture corps           | <li>[ligne](#propriétés-supplémentaires)</li>                                                                                                                                             | *Current Selection & Named Selection list boxes only*                                                |
...
| Sur défilement                | <li>[horizontalScroll](#additional-properties)</li><li>[verticalScroll](#additional-properties)</li>                                                                                                                   |                                                                                                      |
| On Unload                     |                                                                                                                                                                        |                                                                                                      |
...
| Evénement formulaire          | Propriétés supplémentaires retournées (voir [Evénement formulaire](https://doc.4d.com/4Dv18/4D/18/FORM-Evenement.301-4522191.fr.html) pour les propriétés principales) | Commentaires                                                                                         |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Sur après modification        | <li>[colonne](#propriétés-supplémentaires)</li><li>[columnName](#propriétés-supplémentaires)</li><li>[row](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sue après frappe clavier      | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
| Sur après tri                 | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[nomEn-tête](#propriétés-supplémentaires)</li>                                                                                         | *Les formules composées ne peuvent pas être triées. <br>(ex : This.firstName + This.lastName)*       |
| Sur clic alternatif           | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *Arrays list boxes only*                                                                             |
| Sur avant saisie              | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         |                                                                                                      |
...
| On Load                       |                                                                                                                                                                        |                                                                                                      |
| On Losing Focus               | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                      | *Propriétés supplémentaires retournées uniquement lorsque la modification d'une cellule est achevée* |
| Sur déplacement ligne         | <li>[nouvellePosition](#propriétés-supplémentaires)</li><li>[anciennePosition](#propriétés-supplémentaires)</li>                                                                                                                 | *Arrays list boxes only*                                                                             |
| Sur défilement                | <li>[horizontalScroll](#additional-properties)</li><li>[verticalScroll](#additional-properties)</li>                                                                                                                 |                                                                                                      |
| On Unload                     |                                                                                                                                                                        |                                                                                                      |
...
| ------------------------------------------------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A cell switches to edit mode (user action or a call to the `EDIT ITEM` command) | All                         | Sur avant saisie                                                                                                                                                                                               |
|                                                                                 | All                         | On Getting Focus                                                                                                                                                                                               |
| Its value is modified                                                           | All                         | Sue avant frappe clavier                                                                                                                                                                                       |
|                                                                                 | All                         | Sue après frappe clavier                                                                                                                                                                                       |
|                                                                                 | All                         | Sur après modification                                                                                                                                                                                         |
...
- If the variable is set to 0, the column is not sorted and the sort arrow is not displayed; ![](assets/en/FormObjects/sorticon0.png)
