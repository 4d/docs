...
| 4D Server           | Interpreted ([debugger attached](../Debugging/debugging-remote.md)) | Interpreted (debugger detached) | Compilé       |
| ------------------- | ------------------------------------------------------------------- | ------------------------------- | ------------- |
| Serveur REST        | cooperative                                                         | preemptive                      | preemptive    |
| Serveur Web         | cooperative                                                         | *web setting*                   | *web setting* |
| Web Services Server | cooperative                                                         | *web setting*                   | *web setting* |

| 4D remote/single-user | Interprété  | Compilé       |
| --------------------- | ----------- | ------------- |
| Serveur REST          | cooperative | preemptive    |
| Serveur Web           | cooperative | *web setting* |
