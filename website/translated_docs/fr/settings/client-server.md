...
-   **Demander** : Lorsque la notification est envoyée par le serveur, une boîte de dialogue est affichée sur les postes clients, indiquant la modification. L’utilisateur peut alors accepter ou refuser la synchronisation du dossier **Resources** local.\
