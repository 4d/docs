---
id: version-18.0-tabControl
title: Tab Controls
original_id: tabControl
---
...
Lorsque vous associez l’[](properties_Action.md#standard-action)action standard `gotoPage` à un objet de type Onglet, 4D affiche automatiquement la page du formulaire correspondant au numéro de l’onglet sélectionné.</p> 
