...
| minLength     | Nombre  | Cette propriété renvoie la valeur saisie pour la propriété **MinLength**, si elle a été saisie.                                                                                  |
| maxLength     | Nombre  | Cette propriété renvoie la valeur saisie pour la propriété **MaxLength**, si elle a été saisie.                                                                                  |
