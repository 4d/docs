...
| ---------- | ---- |:--:| ------------------------- |
| Résultat   | Blob | <- | Content of the attachment |<!-- END REF -->#### Description

La fonction `.getContent()`<!-- REF #MailAttachmentClass.getContent().Summary -->retourne le contenu de l'objet pièce jointe dans un BLOB<!-- END REF -->
...
## .name<!-- REF #MailAttachmentClass.name.Syntax -->**.name** : Text<!-- END REF -->#### Description
...
## .path<!-- REF #MailAttachmentClass.path.Syntax -->**.path** : Text<!-- END REF -->#### Description
