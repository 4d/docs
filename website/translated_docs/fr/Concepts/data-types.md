...
| [Heure](Concepts/dt_time.md)               | Yes                 | Yes                  | `C_TIME`, `ARRAY TIME`       |
| [Booléen](Concepts/dt_boolean.md)          | Yes                 | Yes                  | `C_BOOLEAN`, `ARRAY BOOLEAN` |
...
| [Pointeur](Concepts/dt_pointer.md)         | -                   | Yes                  | `C_POINTER`, `ARRAY POINTER` |
| [Image](Concepts/dt_picture.md)            | Yes                 | Yes                  | `C_PICTURE`, `ARRAY PICTURE` |
| [BLOB](Concepts/dt_blob.md)                | Yes                 | Yes                  | `C_BLOB`, `ARRAY BLOB`       |
| [Objet](Concepts/dt_object.md)             | Yes                 | Yes                  | `C_OBJECT`, `ARRAY OBJECT`   |
