...
Immediately following the function name, [parameters](#class-function-parameters) for the function can be declared with an assigned name and data type. Par exemple:
