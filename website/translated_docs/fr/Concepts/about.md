...
Grâce à son langage 4D intégré, qui comprend plus de 1300 commandes, 4D est un outil de développement puissant. You can use the 4D language for many different tasks—from performing simple calculations to creating complex custom user interfaces. For example, you can:
