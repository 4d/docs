...
Les attributs d'objet formulaire peuvent être déclarés avec leur [nom JSON](FormObjets/properties_Reference.md) en tant qu'attributs CSS (à l'exclusion des types d'objet, méthodes, événements et listes).
