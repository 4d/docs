...
| isEncrypted             | true                                                    | Vrai si le fichier de données est chiffré                                                                         |
| isCompiled              | true                                                    | True si l'application est compilée                                                                                |
| isEngined               | true                                                    | True si l'application est fusionnée avec 4D Volume Desktop                                                        |
| isProjectMode           | true                                                    | True si l'application est un projet                                                                               |
