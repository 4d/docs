...
| Sur déployer                  | <li>[colonne](#propriétés-supplémentaires)</li><li>[nomColonne](#propriétés-supplémentaires)</li><li>[ligne](#propriétés-supplémentaires)</li>                                                                                         | *Hierarchical list box only*                                                                         |
