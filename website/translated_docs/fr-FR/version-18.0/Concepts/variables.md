...
**Note:** Parameters $1, $2... passés à des méthodes sont des variables locales. Pour plus d'informations, veuillez consulter le thème [Paramètres](Concepts/parameters.md).
