...
| Parámetros | Tipo    |    | Descripción               |
| ---------- | ------- |:--:| ------------------------- |
| Resultado  | 4D.Blob | <- | Content of the attachment |#### Descripción
...
| ------- | -------------- |
| v19     | Añadidos       |
</details>**.platformPath** : Text#### Descripción
