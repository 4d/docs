...
| **password** : Text<p>Contraseña del usuario para la autenticación en el servidor. Cadena de texto u objeto token que representan las credenciales de autorización OAuth 2.                                                                                                                                                                                                                                                                   | ninguno                                                                  |
