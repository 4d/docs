...
*   **Editor de formularios:** arrastre un objeto de la barra de herramientas del editor de formularios al formulario. Then use the Property List to specify the object's properties.   
...
*   **JSON code in dynamic forms:** Define the properties using JSON. Use the [type](properties_Object.md#type) property to define the object type, then set its available properties.  Consulte la página [Formularios dinámicos](https://doc.4d.com/4Dv17R5/4D/17-R5/Dynamic-Forms.300-4163740.en.html#3692292) para obtener información.  
