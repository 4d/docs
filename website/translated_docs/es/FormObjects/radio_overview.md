...
Selecting one radio button in a group sets that button to 1 and all of the others in the group to 0. Sólo se puede seleccionar un botón de radio a la vez.
