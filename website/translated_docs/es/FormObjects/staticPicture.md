...
- en la carpeta **Resources** del proyecto. Appropriate when you want to share static pictures between several forms in the project. En este caso, la ruta de acceso está en "/RESOURCES/\<picture path\>".
