...
La interfaz del editor de formularios muestra cada formulario JSON en su propia ventana, que tiene una barra de herramientas y otra de objetos. Puede tener varios formularios abiertos al mismo tiempo. Las reglas laterales e inferiores le ayudan a posicionar los objetos en el formulario. Puede cambiar las unidades de medida para que muestre pulgadas, centímetros o píxeles.

### Mostrar/ocultar elementos del formulario

Puede mostrar u ocultar la mayoría de los elementos de la interfaz en el editor de formularios. Esta funcionalidad le permite mostrar sólo los elementos que necesita crear o ver en un formulario, o sólo las herramientas que desea utilizar. Esta opción se aplica siempre a la ventana actual del editor de formularios. Por ejemplo, es útil mostrar las líneas de control de salida cuando se trabaja en un formulario de salida.

Para mostrar u ocultar un elemento en el editor de formularios:

1.  Elija **Mostrar** en el menú Formulario. O Utilice el comando **Display** del menú contextual que aparece en la ventana del editor de formularios (haga clic derecho en la ventana sin hacer clic en un objeto). Aparece un submenú jerárquico con todos los elementos que puede mostrar u ocultar:<p>![](assets/en/FormEditor/showHideElements.png)<p>Una marca de verificación colocada junto al elemento indica que se mostrará. Para ocultar un elemento, selecciónelo para que desaparezca la marca de verificación.

2.  Seleccione el elemento que desea mostrar u ocultar.<p>A continuación se describen los comandos de este menú:
    *   **Formulario heredado**: muestra u oculta los objetos del formulario heredado (si lo hay) en la página actual del formulario. Para más información, consulte Uso de los formularios heredados.
    *   **Página 0**: muestra u oculta los objetos de la página 0 en la página actual del formulario. Esta opción permite distinguir entre los objetos de la página actual del formulario y los de la página 0. Para más información sobre las páginas de los formularios, consulte la sección Crear un formulario multipáginas.
    *   **Papel**: muestra u oculta los bordes de la página de impresión, que se muestran como líneas grises. Esta opción puede no tener ningún efecto aparente cuando se selecciona la opción Límites (ver más abajo). Si el tamaño del formulario es menor que el de la página de impresión, los bordes de la página se muestran fuera del área de visualización del formulario y, por tanto, no aparecen. Consulte la sección Imprimir un formulario.
    *   **Reglas**: muestra u oculta las reglas en la ventana del editor de formularios.
    *   **Marcadores**: muestra u oculta las líneas de control de salida y los marcadores asociados que muestran los límites de las diferentes áreas del formulario.
    *   **Etiquetas de los marcadores**: muestra u oculta las etiquetas de los marcadores, disponibles sólo cuando se muestran las líneas de control de salida. Para más información, consulte el párrafo Mover las líneas de control de salida.
    *   **Límites**: Muestra u oculta los límites del formulario. Cuando se selecciona esta opción, el formulario se muestra en el editor de formularios tal y como aparece en el modo Aplicación. De esta manera puede ajustar su formulario sin tener que cambiar al modo Aplicación para ver el resultado.
> Las opciones **Tamaño basado en**, **Margen hor** y **Margen vertical** de las propiedades modifican los límites del formulario. Cuando se utilizan estos parámetros, los límites se basan en los objetos del formulario. Cuando se modifica el tamaño de un objeto que se encuentra junto al límite del formulario, el rectángulo de delimitación se modifica para reflejar ese cambio. Para más información sobre las propiedades de los formularios, consulte la sección [Propiedades de los formularios](jsonReference.html).
...
| ![](assets/en/FormEditor/rectangle.png) | [Rectángulo](../FormObjects/shapesOverview.html#rectangle) / [Línea](../FormObjects/shapesOverview.html#line) / [Óvalo](../FormObjects/shapesOverview.html#oval)                                                                                                                   |   S   |
| ![](assets/en/FormEditor/splitter.png)  | [Splitter](../en/FormObjects/splitters.md) / [Control de pestañas](../FormObjects/tabControl.md)                                                                                                                                                                                   |   D   |
