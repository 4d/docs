...
*   **Type** ([Longint](Concepts/number.md) por defecto): define el tipo por defecto de los campos llave primaria. Puede elegir el tipo de UUID. En este caso, los campos de llave primaria creados por defecto son de [tipo Alfa](Concepts/string.md) y tienen marcadas las propiedades de los campos **Formato UUID** y **Auto UUID**.

## Editor de estructura

Este grupo de opciones configura la visualización del editor de estructuras de 4D.
