...
*   Personaliza el contenido de la carpeta *Resources*. > En macOS, 4D Volume Desktop se proporciona en forma de paquete de software. Para modificarlo, primero hay que desplegar su contenido (**Control+clic** en el icono).
...
>     
>     * **Windows** - Cuando se crea una aplicación con doble clic, 4D se encarga de personalizar su icono. Para ello, debe crear un archivo ícono (extensión *.ico*), antes de crear el archivo de la aplicación, y colocarlo junto a la carpeta del proyecto.</p></p> ```Su archivo de iconos debe tener el mismo nombre que el archivo del proyecto e incluir la extensión *.ico*. 4D tiene en cuenta automáticamente este archivo a la hora de construir la aplicación ejecutable. ``` 
...
>         
>         ![ mark=](assets/es/Project/DefaultData.png)
>         
