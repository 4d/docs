...
### 4D View Pro
The current selection of rows or columns is modified. En este contexto, el [objeto evento](overview.md#event-object) devuelto por el comando `FORM Event` contiene:
