...
- **Destino del archivo de copia de seguridad**: muestra información sobre la ubicación del archivo de copia de seguridad de la base. It also indicates the free/used space on the backup disk.
