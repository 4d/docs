...
When the repair procedure is finished, the "Repair" page of the MSC is displayed. A message indicates if the repair was successful. Si es así, puede abrir la base inmediatamente. ![](assets/en/MSC/MSC_RepairOK.png)
...
Una vez finalizada la reparación, 4D genera un archivo de registro en la carpeta Logs de la base. This file allows you to view all the operations carried out. Se crea en formato XML y se denomina: *DatabaseName**_Repair_Log_yyyy-mm-dd hh-mm-ss.xml*" donde:
