...
- **Encriptado**: si se marca, los registros de la tabla se cifran en el archivo de datos. ***Nota:** toda incoherencia entre las opciones Cifrable y Cifrado requiere que se compruebe el estado de cifrado del archivo de datos en la **página Cifrar** de la base. *
