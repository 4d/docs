...
- Puntos (".") Puntos (".") Puntos (".") y corchetes ("[ ]") no están permitidos en los nombres de tablas, campos, métodos o variables.
...
- Puntos (".") Puntos (".") Puntos (".") y los corchetes ("[ ]") no están permitidos.
