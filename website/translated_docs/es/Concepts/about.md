...
Los comandos del lenguaje 4D permiten acceder a los editores estándar de gestión de registros. Por ejemplo, cuando se utiliza el comando Query, se presenta el Editor de consultas (al que se puede acceder en el modo Diseño utilizando el comando Query del menú Registros. Por ejemplo, cuando se utiliza el comando `QUERY`, se presenta el Editor de búsquedas (al que se puede acceder en el modo Diseño utilizando el comando Query del menú Registros. Por ejemplo, Query([People];[People]Apellido="Smith") encontrará todas las personas de apellido Smith en su base.
