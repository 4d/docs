...
El lenguaje 4D es estricto con los tipos de datos, aunque se permite cierta flexibilidad en muchos casos. Se crea una variable digitada utilizando un comando `C_XXX`. Por ejemplo, para crear una variable de tipo fecha, puede escribir:
