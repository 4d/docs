...
- **Verificación del código**: su aplicación de base de datos se analiza para comprobar la coherencia del código. Se detectan tanto los conflictos lógicos como los sintácticos.
