...
- **Destino do arquivo de cópia de segurança**: mostra informação sobre a localização do arquivo de cópia de segurança do banco de dados. It also indicates the free/used space on the backup disk.
- **Informação da última copia de segurança**: oferece a data e a hora da última cópia de segurança (automática ou manual) realizada no banco de dados.
