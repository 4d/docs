...
- **Encrypted**: If checked, the records of the table are encrypted in the data file. ***Nota:** toda incoerência entre as opciones Criptografável e Criptografado requer que se comprove o estado de cifrado do arquivo de dados na **página Criptografar** do banco de dados. *
