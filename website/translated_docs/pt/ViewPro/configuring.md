...
| U         | Sublinhado                       | printInfo.headerLeft:="&UThis is text."                               | <ins>This is text.</ins>                         |
...
| firstPageNumber | inteiro longo | The page number to print on the first page.<p>Default value = 1                                                                                                             |
...
| fitPagesTall   | inteiro longo | The number of vertical pages (portrait orientation) to check when optimizing printing.<p> Default value = -1    |
| fitPagesWide   | inteiro longo | The number of horizontal pages (landscape orientation) to check when optimizing printing. <p>Default value = -1 |
...
|                 | visibility | inteiro longo | Specifies the visibility of the cell label. Optional property.                                                                                                                                                                                                                                                                                                       | `vk label visibility auto`, `vk label visibility hidden`, `vk label visibility visible`                                                                                                                                                     |
