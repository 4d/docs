...
| entitySet      | Coleção | A collection in which each object contains information about each entity selection. |
| ProgressInfo   | Coleção | A collection containing information about progress indicator information.           |
| sessionInfo    | Coleção | A collection in which each object contains information about each user session.     |
