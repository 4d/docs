...
The parameters allow you to manipulate data in dataclasses in your 4D project. Além de recuperar dados usando métodos HTTP`GET`, também pode adicionar, atualizar e apagar entidades em uma dataclass usando os métodos HTTP `POST`.
