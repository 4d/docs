...
describe('Preprocessor', function() {
    describe('References', function() {
      ...
      it('List of references', function() {
        ...
        ref = map.get("ref2.New collection.summary")
        assert.equal(ref.content.trim(), "new Collection")
      });
    });
    ...
    describe('Syntax', function() {
        ...
        var p = new preproc.Preprocessing(folderPath, "")
        p.collect()
        it('Check syntax', function() {
            let c = p.getSyntaxObject()
            assert.equal(c["commands"]["Collection"]["entries()"], "new Collection")
            assert.equal(c["ref2"], undefined)
        });
