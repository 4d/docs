...
2. Select **New > Database Project...** from the **File** menu: ![](../assets/img/Project/project-create1.png) OR
	Select **Database Project...** from the **New** toolbar button: ![](../assets/img/Project/projectCreate2.png)   
