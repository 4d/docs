...
```
![](../assets/img/Concepts/concatHor.en.png)
![](../assets/img/Concepts/concatHor2.en.png)
...
```
![](../assets/img/Concepts/concatVer.en.png)
![](../assets/img/Concepts/concatVer2.en.png)

Exclusive superimposition
```4d
Pict3:=Pict1 & Pict2 // Superimposes Pict2 on top of  Pict1
```
![](../assets/img/Concepts/superimpoExc.fr.png)

Inclusive superimposition
```4d
Pict3:=Pict1|Pict2 // Recovers resulting mask from superimposing two pictures of the same size
```
![](../assets/img/Concepts/superimpoInc.fr.png)
...
```
![](../assets/img/Concepts/hormove.en.png)
...
```
![](../assets/img/Concepts/vertmove.en.png)![](../assets/img/Concepts/vertmove2.en.png)
...
```
![](../assets/img/Concepts/resize.en.png)![](../assets/img/Concepts/resisze2.en.png)
...
![](../assets/img/Concepts/Horscaling.en.png)![](../assets/img/Concepts/Horscaling2.en.png)
...
![](../assets/img/Concepts/vertscaling.en.png)![](../assets/img/Concepts/veticalscaling2.en.png)
