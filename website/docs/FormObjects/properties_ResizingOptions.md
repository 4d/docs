...
![](../assets/img/FormObjects/property_columnAutoResizing.png)
...
![](../assets/img/FormObjects/splitter_pusher1.png)  

![](../assets/img/FormObjects/splitter_pusher3.png)

When this property is not applied to the splitter, the result is as follows:

![](../assets/img/FormObjects/splitter_pusher2.png)
