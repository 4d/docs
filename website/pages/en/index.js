    ...
    {[
 {
	   ...
	   image: imgUrl('manuals.png'),
		imageAlign: 'left',
	     ...
	     content: '[Project databases](Project/overview.html)<br>[Forms](FormEditor/objectLibrary)<br>[Menus](Menus/overview.html)<br>[4D for iOS](https://developer.4d.com/4d-for-ios/)',
