...
- New [FileHandle](docs/API/FileHandleClass) class and new [`.open()`](docs/API/FileClass#open) function in the `File` class. 
- 4D View Pro: new table commands [VP Get tables](docs/ViewPro/method-list#vp-get-tables), [VP INSERT TABLE COLUMNS](docs/ViewPro/method-list#vp-insert-table-columns), [VP INSERT TABLE ROWS](docs/ViewPro/method-list#vp-insert-table-rows), [VP REMOVE TABLE COLUMNS](docs/ViewPro/method-list#vp-remove-table-columns), [VP REMOVE TABLE ROWS](docs/ViewPro/method-list#vp-remove-table-rows), [VP RESIZE TABLE](docs/ViewPro/method-list#vp-resize-table).
