...
|[**.find**( *methodName* : Text { ; *...param* : any } ) -> value or undefined<br>**.find**( *startFrom* : Integer ; *methodName* : Text { ; *...param* : any } ) -> value or undefined](#find)<p>&nbsp;&nbsp;&nbsp;&nbsp;returns the first value in the collection for which *methodName*, applied on each element, returns **true**|
...
|[**.max**( { *propertyPath* : Text } ) : Mixed ](#max)<p>&nbsp;&nbsp;&nbsp;&nbsp;returns the element with the highest value in the collection|
|[**.min**( { *propertyPath* : Text } ) : Mixed ](#min)<p>&nbsp;&nbsp;&nbsp;&nbsp;returns the element with the smallest value in the collection|
...
**.find**( *methodName* : Text { ; *...param* : any } ) -> value or undefined<br>**.find**( *startFrom* : Integer ; *methodName* : Text { ; *...param* : any } ) -> value or undefined
