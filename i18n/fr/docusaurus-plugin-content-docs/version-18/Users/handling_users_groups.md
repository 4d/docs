...
Par défaut, le Super_Utilisateur et l'Administrateur se trouvent dans toutes les bases. In the [user management dialog box](#users-editor), the icons of the Designer and Administrator are displayed in red and green respectively:
