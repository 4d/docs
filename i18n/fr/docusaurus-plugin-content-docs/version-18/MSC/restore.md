...
- **Emplacement des fichiers restitués** : dossier dans lequel seront placés les fichiers restitués. **Destination folder of the restored files**: Folder where the restored files will be placed. Pour modifier cet emplacement, cliquez sur le bouton **[...]** et désignez le dossier dans lequel vous souhaitez effectuer la restitution.
