...
* Vous pouvez représenter un champ de liste ou une variable directement dans un formulaire à l'aide d'objets [Pop-up menus/Listes déroulantes](dropdownList_Overview.md) et [Combo box](comboBox_overview.md).
