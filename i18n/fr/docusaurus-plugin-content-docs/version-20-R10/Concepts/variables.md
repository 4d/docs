...
| `Error`, `Error method`, `Error line`, `Error formula` | Text, Longint | See [Handling errors within the method](../Concepts/error-handling.md#handling-errors-within-the-method). Used in an error-catching method installed by the [`ON ERR CALL`](../commands-legacy/on-err-call.md) command.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
