...
| `vk position nearest` | Alignement vers la limite la plus proche (haut, bas, gauche, droite, centre). Alignement vers la limite la plus proche (haut, bas, gauche, droite, centre).                           | X                      | X                      |
