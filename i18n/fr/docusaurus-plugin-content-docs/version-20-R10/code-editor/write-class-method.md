...
| **Informations sur la méthode**         | ![method-information-icon](../assets/en/code-editor/method-information.png)       | Affiche la boîte de dialogue [Propriétés de la méthode](../Project/code-overview.md#project-method-properties) (méthodes de projet uniquement).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `<method_path/>`       | Balise remplacée par la syntaxe du chemin (tel que retourné par [`METHOD Get path`](../commands-legacy/method-get-path.md)) de la méthode courante.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
