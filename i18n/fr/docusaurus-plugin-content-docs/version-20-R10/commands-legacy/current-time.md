...
L'heure courante est toujours comprise entre *00:00:00* et *23:59:59*. Vous pouvez utiliser les fonctions [String](string.md) ou [Time string](../commands/time-string) pour convertir en chaîne alphanumérique l'expression de type heure retournée par **Current time**.
