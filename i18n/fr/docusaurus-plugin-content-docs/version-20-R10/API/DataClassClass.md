...
- si l'objet `Formula` est **null**, l'erreur 1626 ("Expecting a text or formula") est générée, que vous pouvez intercepter en utilisant une méthode installée avec `ON ERR CALL`.
