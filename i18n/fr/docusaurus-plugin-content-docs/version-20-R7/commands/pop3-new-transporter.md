...
| **password** : Text<br/>Mot de passe utilisateur pour l'authentification sur le serveur. Not returned in *[POP3 transporter](../API/POP3TransporterClass.md#pop3-transporter-object)* object.                                                                                                                                                                                                                                                                                                                                                         | aucun                                                                            |
