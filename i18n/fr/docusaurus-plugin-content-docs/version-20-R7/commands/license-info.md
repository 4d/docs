...
| attributes          | collection de chaînes | Type(s) de licence, le cas échéant (facultatif)                                                                                                                                                                                    | \["application","OEM"\]     |
...
| expirationDate      | object                | Date d'expiration (facultatif)                                                                                                                                                                                                                        | {"day":2, "month":6, "year":2018} |
