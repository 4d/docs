...
- in the **Resources** folder of the project. Convient lorsque vous souhaitez partager des images statiques entre plusieurs formulaires du projet. In this case, the Pathname is in the "/RESOURCES/\<picture path\>".
