...
| encoding         | Text    | "UTF-8"    | Seulement si `dataType="text"`. Encodage du contenu du corps de la réponse. For the list of available values, see the [`CONVERT FROM TEXT`](../commands-legacy/convert-from-text.md) command description                                                                                                                                                                                                                           |
