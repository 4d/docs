...
Pour **rejeter** le glisser, la méthode de l'objet de destination doit retourner -1. Si aucun résultat n'est retourné, 4D suppose que le glissement est accepté.
