...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *ptrTable* : Pointer ; *numChamp* : Integer ) : Boolean<br/>**Is field number valid** ( *numTable* : Integer ; *numChamp* : Integer ) : Boolean<!-- END REF-->
