...
<!--REF #_command_.WA SET PAGE CONTENT.Syntax-->**WA SET PAGE CONTENT** ( * ; *objet* : Text ; *contenu* : Text ; *baseURL* : Text )<br/>**WA SET PAGE CONTENT** ( *objet* : Variable, Field ; *contenu* : Text ; *baseURL* : Text )<!-- END REF-->
