...
<!--REF #_command_.LISTBOX SET ARRAY.Syntax-->**LISTBOX SET ARRAY** ( * ; *objet* : Text ; *typeTab* : Integer ; *ptrTab* : Pointer )<br/>**LISTBOX SET ARRAY** ( *objet* : Variable ; *typeTab* : Integer ; *ptrTab* : Pointer )<!-- END REF-->
