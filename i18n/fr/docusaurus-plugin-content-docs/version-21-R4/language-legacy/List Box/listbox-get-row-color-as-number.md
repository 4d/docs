...
<!--REF #_command_.LISTBOX Get row color as number.Syntax-->**LISTBOX Get row color as number** ( * ; *objet* : Text ; *ligne* : Integer {; *typeCouleur* : Integer} )  : Integer<br/>**LISTBOX Get row color as number** ( *objet* : Variable ; *ligne* : Integer {; *typeCouleur* : Integer} )  : Integer<!-- END REF-->
