...
<!--REF #_command_.LISTBOX MOVE COLUMN.Syntax-->**LISTBOX MOVE COLUMN** ( * ; *objet* : Text ; *positionCol* : Integer )<br/>**LISTBOX MOVE COLUMN** ( *objet* : Variable ; *positionCol* : Integer )<!-- END REF-->
...
| objet | Text, Variable | &#8594;  | Nom d'objet (si * est spécifié) ou Variable (si * est omis) de la colonne à déplacer |
