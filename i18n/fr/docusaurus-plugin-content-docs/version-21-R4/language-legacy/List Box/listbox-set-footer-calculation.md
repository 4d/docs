...
<!--REF #_command_.LISTBOX SET FOOTER CALCULATION.Syntax-->**LISTBOX SET FOOTER CALCULATION** ( * ; *objet* : Text ; *calcul* : Integer )<br/>**LISTBOX SET FOOTER CALCULATION** ( *objet* : Variable ; *calcul* : Integer )<!-- END REF-->
