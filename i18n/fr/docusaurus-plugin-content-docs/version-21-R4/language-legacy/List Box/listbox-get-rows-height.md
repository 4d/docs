...
<!--REF #_command_.LISTBOX Get rows height.Syntax-->**LISTBOX Get rows height** ( * ; *objet* : Text {; *unité* : Integer} ) : Integer<br/>**LISTBOX Get rows height** ( *objet* : Variable {; *unité* : Integer} ) : Integer<!-- END REF-->
