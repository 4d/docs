...
<!--REF #_command_.LISTBOX SET FOOTERS HEIGHT.Syntax-->**LISTBOX SET FOOTERS HEIGHT** ( * ; *objet* : Text ; *hauteur* : Integer {; *unité* : Integer} )<br/>**LISTBOX SET FOOTERS HEIGHT** ( *objet* : Variable ; *hauteur* : Integer {; *unité* : Integer} )<!-- END REF-->
