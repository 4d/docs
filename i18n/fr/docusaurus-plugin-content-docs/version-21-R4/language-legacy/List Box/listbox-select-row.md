...
<!--REF #_command_.LISTBOX SELECT ROW.Syntax-->**LISTBOX SELECT ROW** ( * ; *objet* : Text ; *positionLigne* : Integer {; *action* : Integer} )<br/>**LISTBOX SELECT ROW** ( *objet* : Variable ; *positionLigne* : Integer {; *action* : Integer} )<!-- END REF-->
