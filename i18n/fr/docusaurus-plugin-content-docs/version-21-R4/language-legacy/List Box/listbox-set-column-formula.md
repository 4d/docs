...
<!--REF #_command_.LISTBOX SET COLUMN FORMULA.Syntax-->**LISTBOX SET COLUMN FORMULA** ( * ; *objet* : Text ; *formule* : Text ; *typeDonnées* : Integer )<br/>**LISTBOX SET COLUMN FORMULA** ( *objet* : Variable ; *formule* : Text ; *typeDonnées* : Integer )<!-- END REF-->
...
**Note :** Vous pouvez utiliser la commande [OBJECT SET DATA SOURCE](../commands/object-set-data-source) pour définir la source de données d'une list box de type tableau. 
