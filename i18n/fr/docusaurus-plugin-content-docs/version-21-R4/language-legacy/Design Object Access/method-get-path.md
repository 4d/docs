...
<!--REF #_command_.METHOD Get path.Syntax-->**METHOD Get path** ( *typeMéthode* : Integer {; *laTable* : Table}{; *nomObjet* : Text{; *nomObjetForm* : Text}}{; *} ) : Text<!-- END REF-->
...
| Path volatile method | Entier long | 128    | Retourne : [Volatile] methodName                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
