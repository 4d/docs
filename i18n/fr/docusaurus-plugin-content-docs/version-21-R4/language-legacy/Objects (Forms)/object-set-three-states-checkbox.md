...
<!--REF #_command_.OBJECT SET THREE STATES CHECKBOX.Syntax-->**OBJECT SET THREE STATES CHECKBOX** ( * ; *objet* : Text ; *troisEtats* : Boolean )<br/>**OBJECT SET THREE STATES CHECKBOX** ( *objet* : Variable, Field ; *troisEtats* : Boolean )<!-- END REF-->
