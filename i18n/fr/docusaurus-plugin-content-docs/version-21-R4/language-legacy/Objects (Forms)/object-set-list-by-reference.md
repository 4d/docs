...
<!--REF #_command_.OBJECT SET LIST BY REFERENCE.Syntax-->**OBJECT SET LIST BY REFERENCE** ( * ; *objet* : Text {; *typeListe* : Integer}; *liste* : Integer )<br/>**OBJECT SET LIST BY REFERENCE** ( *objet* : Variable, Field {; *typeListe* : Integer}; *liste* : Integer )<!-- END REF-->
