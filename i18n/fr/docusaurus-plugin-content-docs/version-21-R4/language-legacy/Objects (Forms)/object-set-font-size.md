...
<!--REF #_command_.OBJECT SET FONT SIZE.Syntax-->**OBJECT SET FONT SIZE** ( * ; *objet* : Text ; *taille* : Integer )<br/>**OBJECT SET FONT SIZE** ( *objet* : Variable, Field ; *taille* : Integer )<!-- END REF-->
