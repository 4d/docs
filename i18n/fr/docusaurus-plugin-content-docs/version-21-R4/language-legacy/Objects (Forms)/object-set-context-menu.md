...
<!--REF #_command_.OBJECT SET CONTEXT MENU.Syntax-->**OBJECT SET CONTEXT MENU** ( * ; *objet* : Text ; *menuContext* : Boolean )<br/>**OBJECT SET CONTEXT MENU** ( *objet* : Variable, Field ; *menuContext* : Boolean )<!-- END REF-->
