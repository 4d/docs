...
<!--REF #_command_.OBJECT SET STYLE SHEET.Syntax-->**OBJECT SET STYLE SHEET** ( * ; *objet* : Text ; *nomFeuilleStyle* : Text )<br/>**OBJECT SET STYLE SHEET** ( *objet* : Variable, Field ; *nomFeuilleStyle* : Text )<!-- END REF-->
