...
<!--REF #_command_.OBJECT SET VERTICAL ALIGNMENT.Syntax-->**OBJECT SET VERTICAL ALIGNMENT** ( * ; *objet* : Text ; *alignement* : Integer )<br/>**OBJECT SET VERTICAL ALIGNMENT** ( *objet* : Variable, Field ; *alignement* : Integer )<!-- END REF-->
