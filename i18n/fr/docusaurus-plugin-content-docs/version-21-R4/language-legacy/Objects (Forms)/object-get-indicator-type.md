...
Le type d’indicateur peut être défini via la Liste des propriétés en mode Développement ou via la commande [OBJECT SET INDICATOR TYPE](../commands/object-set-indicator-type).
