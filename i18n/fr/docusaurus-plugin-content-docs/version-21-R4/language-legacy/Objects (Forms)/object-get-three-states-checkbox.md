...
<!--REF #_command_.OBJECT Get three states checkbox.Syntax-->**OBJECT Get three states checkbox** ( * ; *objet* : Text ) : Boolean<br/>**OBJECT Get three states checkbox** ( *objet* : Variable, Field ) : Boolean<!-- END REF-->
