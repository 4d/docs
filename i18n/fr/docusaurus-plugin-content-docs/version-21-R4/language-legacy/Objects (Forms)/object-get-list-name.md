...
<!--REF #_command_.OBJECT Get list name.Syntax-->**OBJECT Get list name** ( * ; *objet* : Text {; *typeListe* : Integer} ) : Text<br/>**OBJECT Get list name** ( *objet* : Variable, Field {; *typeListe* : Integer} ) : Text<!-- END REF-->
