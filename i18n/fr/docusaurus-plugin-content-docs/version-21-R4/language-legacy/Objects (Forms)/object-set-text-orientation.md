...
<!--REF #_command_.OBJECT SET TEXT ORIENTATION.Syntax-->**OBJECT SET TEXT ORIENTATION** ( * ; *objet* : Text ; *orientation* : Integer )<br/>**OBJECT SET TEXT ORIENTATION** ( *objet* : Variable, Field ; *orientation* : Integer )<!-- END REF-->
