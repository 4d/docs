...
<!--REF #_command_.OBJECT SET PLACEHOLDER.Syntax-->**OBJECT SET PLACEHOLDER** ( * ; *objet* : Text ; *texteExemple* : Text )<br/>**OBJECT SET PLACEHOLDER** ( *objet* : Variable, Field ; *texteExemple* : Text )<!-- END REF-->
