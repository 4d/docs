...
<!--REF #_command_.OBJECT SET FORMAT.Syntax-->**OBJECT SET FORMAT** ( * ; *objet* : Text ; *formatAffich* : Text )<br/>**OBJECT SET FORMAT** ( *objet* : Variable, Field ; *formatAffich* : Text )<!-- END REF-->
