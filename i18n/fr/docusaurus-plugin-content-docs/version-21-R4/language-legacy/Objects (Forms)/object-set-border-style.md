...
<!--REF #_command_.OBJECT SET BORDER STYLE.Syntax-->**OBJECT SET BORDER STYLE** ( * ; *objet* : Text ; *styleBordure* : Integer )<br/>**OBJECT SET BORDER STYLE** ( *objet* : Variable, Field ; *styleBordure* : Integer )<!-- END REF-->
