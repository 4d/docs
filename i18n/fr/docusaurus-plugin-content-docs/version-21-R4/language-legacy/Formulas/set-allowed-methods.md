...
- Les formules insérées dans des zones de texte stylées ou dans des documents 4D Write Pro par la commande [ST INSERT EXPRESSION](../../commands-legacy/st-insert-expression) - les méthodes non autorisées sont automatiquement rejetées.
...
[EDIT FORMULA](../../commands-legacy/edit-formula)\
[GET ALLOWED METHODS](../../commands-legacy/get-allowed-methods)
