...
La commande **WEB SERVICE SET OPTION** permet de définir différentes options qui seront utilisées lors de la prochaine requête SOAP déclenchée par la commande [WEB SERVICE CALL](../commands/web-service-call).   
