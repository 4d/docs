...
<!--REF #_command_.MULTI SORT ARRAY.Syntax-->**MULTI SORT ARRAY** ( ...(*tableau* : Array {; *sensDuTri* : >, <}) )<br/>**MULTI SORT ARRAY** ( *tabPointeurs* : Pointer array ; *tabTris* : Integer array )<!-- END REF-->
