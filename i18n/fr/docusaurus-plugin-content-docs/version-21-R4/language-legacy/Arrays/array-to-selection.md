...
<!--REF #_command_.ARRAY TO SELECTION.Syntax-->**ARRAY TO SELECTION** ({ *tableau* : Array ; *leChamp* : Field {; ...(*tableau* : Array; *leChamp* : Field)}{; *} })<!-- END REF-->
...
| leChamp | Field | &#8592; | Champ recevant les valeurs du tableau |
