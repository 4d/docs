...
<!--REF #_command_.DOM Parse XML source.Syntax-->**DOM Parse XML source** ( *nomFichier* : Text {; *validation* : Boolean {; *dtd* : Text }} ) : Text<br/>**DOM Parse XML source** ( *nomFichier* : Text {; *validation* : Boolean {; *schéma* : Text }} ) : Text<!-- END REF-->
