...
<!--REF #_command_.DOM Create XML element arrays.Syntax-->**DOM Create XML element arrays** ( *refElément* : Text ; *xChemin* : Text {; ...(*tabNomsAttributs* : Text array ; *tabValeursAttributs* : Text array)} ) : Text<!-- END REF-->
