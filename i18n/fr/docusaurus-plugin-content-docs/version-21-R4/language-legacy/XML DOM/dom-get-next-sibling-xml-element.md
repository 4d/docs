...
<!--REF #_command_.DOM Get next sibling XML element.Syntax-->**DOM Get next sibling XML element** ( *refElément* : Text {; *nomElémentFrère* : Text {; *valeurElémentFrère* : any}} ) : Text<!-- END REF-->
