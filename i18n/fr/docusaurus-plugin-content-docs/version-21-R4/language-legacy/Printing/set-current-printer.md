...
Passez dans le paramètre *nomImpr* le nom de l’imprimante à sélectionner. Pour obtenir la liste des imprimantes disponibles, utilisez au préalable la commande [PRINTERS LIST](../commands/printers-list).  
...
Le nom du pilote est "Microsoft Print to PDF" (cf. exemple présenté dans la section [SET PRINTABLE MARGIN](../commands/set-printable-margin)).
