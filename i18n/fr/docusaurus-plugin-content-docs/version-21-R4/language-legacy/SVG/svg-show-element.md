...
<!--REF #_command_.SVG SHOW ELEMENT.Syntax-->**SVG SHOW ELEMENT** ( * ; *objetImage* : Text ; *id* : Text {; *marge* : Integer} )<br/>**SVG SHOW ELEMENT** ( *objetImage* : Variable, Field ; *id* : Text {; *marge* : Integer} )<!-- END REF-->
