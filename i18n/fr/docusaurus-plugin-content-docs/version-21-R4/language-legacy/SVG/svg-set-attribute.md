...
<!--REF #_command_.SVG SET ATTRIBUTE.Syntax-->**SVG SET ATTRIBUTE** ( * ; *objetImage* : Text ; *id_Element* : Text ; ...(*nomAttribut* : Text ; *valeurAttribut* : Text, Integer, Boolean) {; *})<br/>**SVG SET ATTRIBUTE** (  *nomAttribut2* : Variable, Field; *valeurAttribut2* : Text ;...(*nomAttributN* : Text ; *valeurAttributN* : Text, Integer, Boolean) {; *})<!-- END REF-->
