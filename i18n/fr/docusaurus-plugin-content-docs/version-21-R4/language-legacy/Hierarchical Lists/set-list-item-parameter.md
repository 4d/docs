...
<!--REF #_command_.SET LIST ITEM PARAMETER.Syntax-->**SET LIST ITEM PARAMETER** ( * ; *liste* : Text ; *refElément* : Integer, Operator ; *sélecteur* : Text ; *valeur* : Text, Boolean, Real )<br/>**SET LIST ITEM PARAMETER** ( *liste* : Integer ; *refElément* : Integer, Operator ; *sélecteur* : Text ; *valeur* : Text, Boolean, Real )<!-- END REF-->
...
| valeur | Text, Boolean, Real | &#8594;  | Valeur du paramètre |
</div>
<!-- END REF-->
