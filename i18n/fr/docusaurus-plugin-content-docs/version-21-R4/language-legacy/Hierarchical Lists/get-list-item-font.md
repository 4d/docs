...
<!--REF #_command_.Get list item font.Syntax-->**Get list item font** ( * ; *liste* : Text ; *refElément* : Integer, Operator ) : Text<br/>**Get list item font** ( *liste* : Integer ; *refElément* : Integer, Operator ) : Text<!-- END REF-->
