...
<!--REF #_command_.SET LIST ITEM ICON.Syntax-->**SET LIST ITEM ICON** ( * ; *liste* : Text ; *réfElément* : Integer, Operator ; *icône* : Picture, Pointer )<br/>**SET LIST ITEM ICON** (*liste* : Integer ; *réfElément* : Integer, Operator ; *icône* : Picture, Pointer )<!-- END REF-->
...
| réfElément | Integer, Operator | &#8594;  | Numéro de référence d’élément ou 0 pour le dernier élément ajouté à la liste ou * pour l’élément courant de la liste |
| icône | Picture, Pointer | &#8594;  | Icône à associer à l'élément |
</div>
<!-- END REF-->
