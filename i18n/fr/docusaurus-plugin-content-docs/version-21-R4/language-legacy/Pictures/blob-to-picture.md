...
**Note :** Un BLOB créé par la commande [VARIABLE TO BLOB](../commands/variable-to-blob) est géré automatiquement, il n’est pas nécessaire de passer le codec pour l’encapsuler, le BLOB étant "signé". Pour l’opération inverse dans ce cas, vous devez passer ".4DVarBlob" comme identifiant de codec à la commande [PICTURE TO BLOB](../commands/picture-to-blob).  
