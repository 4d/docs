...
<!--REF #_command_.ST SET TEXT.Syntax-->**ST SET TEXT** ( * ; *objet* : Text ; *nouvText* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )<br/>**ST SET TEXT** ( *objet* : Variable, Field ; *nouvText* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )<!-- END REF-->
...
| objet | Text, Variable, Field | &#8594;  | Nom d'objet (si * est spécifié) ou <br/>Variable ou champ Texte (si * est omis) |
