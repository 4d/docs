...
<!--REF #_command_.ST GET OPTIONS.Syntax-->**ST GET OPTIONS** ( * ; *objet* : Text ; *option* : Integer ; *valeur* : Integer {; ...(*option* : Integer ; *valeur* : Integer)} )<br/>**ST GET OPTIONS** ( *objet* : Variable, Field ; *option* : Integer ; *valeur* : Integer {; ...(*option* : Integer ; *valeur* : Integer)} )<!-- END REF-->
