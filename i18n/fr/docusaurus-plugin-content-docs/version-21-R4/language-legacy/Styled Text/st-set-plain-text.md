...
<!--REF #_command_.ST SET PLAIN TEXT.Syntax-->**ST SET PLAIN TEXT** ( * ; *objet* : Text ; *nouvText* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )<br/>**ST SET PLAIN TEXT** ( *objet* : Variable, Field ; *nouvText* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )<!-- END REF-->
