...
<!--REF #_command_.ST Get expression.Syntax-->**ST Get expression** ( * ; *objet* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )  : Text<br/>**ST Get expression** ( *objet* : Variable, Field {; *débutSél* : Integer {; *finSél* : Integer}} )  : Text<!-- END REF-->
