...
<!--REF #_command_.ST COMPUTE EXPRESSIONS.Syntax-->**ST COMPUTE EXPRESSIONS** ( * ; *objet* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )<br/>**ST COMPUTE EXPRESSIONS** ( *objet* : Variable, Field {; *débutSél* : Integer {; *finSél* : Integer}} )<!-- END REF-->
