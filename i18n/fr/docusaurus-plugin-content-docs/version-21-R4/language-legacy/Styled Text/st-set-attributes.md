...
<!--REF #_command_.ST SET ATTRIBUTES.Syntax-->**ST SET ATTRIBUTES** ( * ; *objet* : Text ; *débutSél* : Integer ; *finSél* : Integer ; *nomAttribut* : Integer ; *valeurAttribut* : Text, Integer {; ...(*nomAttribut* : Integer ; *valeurAttribut* : Text, Integer)} )<br/>**ST SET ATTRIBUTES** ( *objet* : Variable, Field ; *débutSél* : Integer ; *finSél* : Integer ; *nomAttribut* : Integer ; *valeurAttribut* : Text, Integer {; ...(*nomAttribut* : Integer ; *valeurAttribut* : Text, Integer)} )<!-- END REF-->
