...
<!--REF #_command_.WEB GET HTTP HEADER.Syntax-->**WEB GET HTTP HEADER** ( *entête* : Text )<br/>**WEB GET HTTP HEADER** ( *tabChamps* : Text array ; *tabValeurs* : Text array )<!-- END REF-->
...
Cette commande peut être appelée depuis toute méthode (*Méthode base Sur authentification Web*, [On Web Connection](../commands/on-web-connection-database-method), méthode appelée par "*/4DACTION*"...) exécutée dans un process Web.
...
* Vous pouvez également envoyer des pages différentes en fonction de la langue du navigateur (par exemple dans la [On Web Connection](../commands/on-web-connection-database-method)) :
...
* Exemple de gestion des hôtes virtuels (par exemple dans la [On Web Connection](../commands/on-web-connection-database-method)). Les trois noms “home\_site.com”, “home\_site1.com” et “home\_site2.com” pointent vers la même adresse IP, par exemple 192.1.2.3.
