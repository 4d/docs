...
Cette commande peut être appelée depuis la *Méthode base Sur authentification Web*, la [On Web Connection](../commands/on-web-connection-database-method) ou toute méthode Web. 
