...
Cette commande peut être appelée, selon les besoins, dans la [On Web Connection](../commands/on-web-connection-database-method) ou toute autre méthode 4D qui résulte de la soumission d’un formulaire.
