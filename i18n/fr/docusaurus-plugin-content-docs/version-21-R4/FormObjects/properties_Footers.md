...
> Cette propriété peut être également définie dynamiquement à l'aide de la commande [LISTBOX SET FOOTERS HEIGHT](../commands/listbox-set-footers-height).
...
[En-têtes](properties_Headers.md) - [Pieds List box](listbox-header-footer.md#footers)
