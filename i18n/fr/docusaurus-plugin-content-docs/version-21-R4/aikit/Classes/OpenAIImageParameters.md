...
| ----------------- | ------- | ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `model`           | Text    | "dall-e-2"        | Spécifie le modèle à utiliser pour la génération d'images. Le [modèle à utiliser](https://developers.openai.com/api/docs/guides/embeddings#embedding-models). |
