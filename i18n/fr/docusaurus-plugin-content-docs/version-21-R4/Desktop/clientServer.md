...
| [Trigger](../Develop/triggers)                                                                                                                                                                                                                                                                                              | server               | n/a                                                                                                                                                                                                                                                                                                      |
...
| Méthode projet appelée à partir d'une procédure stockée sur le serveur                                                                                                                                                                                                                                                      | server               | Appeler la commande [`EXECUTE ON CLIENT`](../commands/execute-on-client). Le client concerné doit avoir été [inscrit](../commands/register-client)                                                                                                                                       |
