...
Un fichier .4dz est essentiellement une version compressée du dossier du projet. Sa taille compacte et optimisée facilite le déploiement des packages de projet. Les fichiers .4dz peuvent être utilisés par 4D Server, 4D Volume Desktop (applications fusionnées) et 4D.
