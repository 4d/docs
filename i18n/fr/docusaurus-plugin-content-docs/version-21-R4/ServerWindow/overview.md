...
> L'accès à la fenêtre d'administration de 4D Server s'effectue par un 4D distant. Pour plus d'informations sur ce point, veuillez vous référer à la page [Administration des machines à distance](remote-admin.md) .
