...
| Types d'éléments de collection | string                                 | number                                       | number                                 | number                                       | boolean                                      | object ou null                             | picture                                      | string or date according to the [Dates inside objects](../commands/set-database-parameter#dates-inside-objects-85) parameter | nombre de secondes                     | 4D.Blob                |   |