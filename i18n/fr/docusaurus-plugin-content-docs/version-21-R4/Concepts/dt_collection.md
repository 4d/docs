...
| Types d'éléments de collection | string                                 | number                                       | number                                 | number                                       | boolean                                      | object ou null                             | picture                                      | chaîne ou date en fonction du paramètre [Dates inside objects](../commands/set-database-parameter#dates-inside-objects-85) | nombre de secondes                     | 4D.Blob                |   |