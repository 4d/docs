...
| AIProviders.json                             | [Fichier de configuration *propriétés structure* du fournisseur d'IA](../settings/ai.md#aiprovidersjson). Peut être écrasé par un fichier AIProviders.json ajouté dans les [*propriétés utilisateur*](#settings-user) ou [*propriétés utilisateur pour les données*](#settings-user-data) (voir aussi [Priorité des paramètres](../settings/overview.md#priority-of-settings)).                                                                                                                                                                                                                                                                                                                                                                             | JSON   |
...
| AIProviders.json    | [Fichier de configuration de fournisseur IA](../settings/ai.md#aiprovidersjson) pour ce fichier de données                                                                                                                                                                                                                     | JSON   |
...
| AIProviders.json    | [Fichier de configuration de fournisseur IA](../settings/ai.md#aiprovidersjson) pour ce projet (tous fichiers de données)                                                                                                                                                                                                                                                                                                                                                       | JSON   |
