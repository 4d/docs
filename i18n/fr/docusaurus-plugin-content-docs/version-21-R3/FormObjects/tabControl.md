...
> Vous pouvez également stocker les noms des pages dans une liste hiérarchique et utiliser la commande [LIST TO ARRAY](../commands/list-to-array) pour charger les valeurs dans le tableau.

## Fonctionnalités de Goto page

### Commande FORM GOTO PAGE

Vous pouvez utiliser la commande [`FORM GOTO PAGE`](../commands/form-goto-page) dans la méthode de l'onglet :
