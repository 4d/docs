...
Ce fichier texte peut également contenir des clés de configuration, en particulier [`"tokenizedText" : false`](../Preferences/general.md#excluding-tokens-in-existing-projects).
...
| Contenu                                                 | Description                                                                                                                                                              | Format |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ |
| assets/                                                 | [Fichiers partagés](https://developer.4d.com/qodly/4DQodlyPro/pageLoaders/events/bindingActionToEvents#shared-folder) tels que les images utilisées dans les pages Qodly | variés |
| CustomComponents/                                       | Fichiers [Custom components](https://developer.4d.com/qodly/Integrations/customComponent/overview) utilisés dans les pages Qodly                                         | json   |
| *other_files*.json | Eléments partagés tels que css ou datasources utilisés dans les pages Qodly                                                                                              | json   |
...
| Contenu                                                      | Description                                                                                                                      | Format |
| ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- | ------ |
| *QodlyFormName*.WebForm                      | Représentations json des pages Qodly                                                                                             | JSON   |
| crafted_components.json | Description des [crafted components](https://developer.4d.com/qodly/4DQodlyPro/pageLoaders/craftedComponents) des pages de Qodly | JSON   |
...
Dossier contenant les composants intégrés au projet (doit être stocké au même niveau que le dossier Project). Ces composants sont prioritaires par rapport à tout autre emplacement.

:::info

Vous pouvez également utiliser les fichiers [**dependencies.json** et (optionnellement) **environment4d.json**](components.md) pour déclarer des composants.
