...
- lorsque le serveur web reçoit une URL d'accès à la racine et qu'aucune page d'accueil n'a été définie dans les Propriétés ou au moyen de la commande [`WEB SET HOME PAGE`](../commands/web-set-home-page)
