...
* Si vous souhaitez contrôler les retours à la ligne, insérez vos propres retours chariot dans votre texte, à l'aide de [Char](../commands/char)(13).
* Vous pouvez appeler la commande [GOTO XY](../commands/goto-xy) pour afficher le texte à un emplacement particulier dans la fenêtre.
* Vous pouvez appeler la commande [ERASE WINDOW](../commands/erase-window) pour effacer le contenu de la fenêtre.
...
A l'aide de la commande [GOTO XY](../commands/goto-xy) et de l'écriture de quelques lignes supplémentaires, la présentation s'améliore nettement : 
