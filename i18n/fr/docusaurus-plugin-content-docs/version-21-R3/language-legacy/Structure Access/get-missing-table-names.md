...
Une fois que vous avez identifié les tables manquantes de la base, vous pouvez les réactiver via la commande [REGENERATE MISSING TABLE](../commands/regenerate-missing-table).
