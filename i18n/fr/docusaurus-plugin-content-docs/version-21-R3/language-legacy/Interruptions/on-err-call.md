...
Vous pouvez utiliser la commande [Last errors](../commands/last-errors) pour obtenir la séquence d'erreurs (c'est-à-dire la "pile" d'erreurs) à l'origine de l'interruption.
