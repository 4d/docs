...
| storeCertificateName   | Text    | undefined                                                                                                                                                | Nom d'un certificat stocké dans le Certificate Store (Windows) ou dans le *keychain* (macOS) à utiliser à la place d'un certificat enregistré dans le dossier des certificats. Si le certificat n'est pas trouvé dans le store, une erreur est renvoyée. Pour plus d'informations, voir [ce blog post pour Windows](https://blog.4d.com/https-requests-now-support-windows-certificate-store) et [ce blog post pour macOS](https://blog.4d.com/https-requests-macos-keychain-support-is-here). |
