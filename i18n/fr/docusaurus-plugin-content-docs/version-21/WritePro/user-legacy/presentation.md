...
Cependant, vous devez disposer d'une [licence 4D Write Pro installée dans votre application](../../Users/handling_users_groups.md#assigning-a-license-to-a-group) afin d'activer cette fonctionnalité.
