...
* l'objet feuille de style (créé à l'aide de [WP New style sheet](../WritePro/commands/wp-new-style-sheet) ou retourné par la commande [WP Get style sheet](../WritePro/commands/wp-get-style-sheet)) à retirer dans le paramètre *typeFeuilleStyle*, ou
