...
You can insert special expressions related to document attributes in any document area (body, header, footer) using the [WP Insert formula](commands/wp-insert-formula.md) command. Within a formula, a formula context object is automatically exposed. Vous pouvez utiliser les propriétés de cet objet par l'intermédiaire de [**This**](../commands/this.md) :
