...
Le paramètre \* vous permet d'annuler une impression lancée avec la commande [Print form](./commands/print-form). L'exécution de cette instruction stoppe immédiatement l'impression en cours. 
