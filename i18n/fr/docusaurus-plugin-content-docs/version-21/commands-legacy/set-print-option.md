...
Une fois fixée à l’aide de cette commande, une option d’impression sera conservée durant toute la session pour l’application 4D entière. Elle sera utilisée par les commandes [PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form), [QR REPORT](qr-report.md) et par toutes les impressions de 4D, y compris en mode Développement.
