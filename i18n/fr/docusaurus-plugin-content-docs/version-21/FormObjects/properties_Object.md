...
> Le calcul des pieds de page peut également être défini en utilisant la commande 4D [`LISTBOX SET FOOTER CALCULATION`](./commands/listbox-set-footer-calculation).
