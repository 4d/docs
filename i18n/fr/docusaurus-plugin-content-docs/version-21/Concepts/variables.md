...
| `cs.<namespace>`cs.<namespace> | Object de la classe className du composant `<namespace>` |
...
| `Error`, `Error line`           | Integer | Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands-legacy/on-err-call.md). Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `Error method`, `Error formula` | Text    | Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands-legacy/on-err-call.md). Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
