...
|              | openMode                  | integer                     | <li>0 (normal) : mode d'ouverture standard, ni différé ni incrémental. Lors de l'ouverture d'un fichier, l'interface utilisateur et l'événement d'interface utilisateur peuvent être actualisés et réactifs à des moments précis.</li><li>1 (lazy) : mode d'ouverture lazy. Lors de l'ouverture du fichier, seule la feuille active sera chargée directement. Les autres feuilles ne seront chargées que lorsqu'elles seront utilisées.</li><li>2 (incrémental): mode d'ouverture incrémental. Lors de l'ouverture du fichier, l'interface utilisateur et les événements UI peuvent être actualisés et sont réactifs directement.</li> |
...
|              | frozenColumnsAsRowHeaders | boolean                     | Indique s'il faut traiter les colonnes figées comme des en-têtes de lignes ; valeur par défaut : false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|              | frozenRowsAsColumnHeaders | boolean                     | Indique s'il faut traiter les lignes figées comme des en-têtes de colonnes ; valeur par défaut : false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|              | fullRecalc                | boolean                     | Indique si le calcul doit être effectué après le chargement des données json, la valeur par défaut est faux.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|              | dynamicReferences         | boolean                     | Indique si les fonctions doivent être calculées avec une référence dynamique, par défaut = true.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|              | calcOnDemand              | boolean                     | Indique si les formules doivent être calculées uniquement lorsqu'elles sont demandées, valeur par défaut = false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|              | includeUnusedStyles       | boolean                     | Indique s'il faut inclure le style de nom inutilisé lors de la conversion du fichier xml Excel au format json ; valeur par défaut : true.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|              | password                  | text                        | Le mot de passe permettant d'ouvrir le classeur.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|              | openMode                  | text                        | Mode d'ouverture : normal, différé ou incrémental. Par défaut, normal.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- L'utilisation de l'objet *excelOptions* est recommandée pour l'importation du format ".xlsx". Veillez à ne pas mélanger cet objet avec la propriété héritée de premier niveau *password* afin d'éviter d'éventuels problèmes.
