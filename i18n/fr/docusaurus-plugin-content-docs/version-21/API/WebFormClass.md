...
La classe `WebForm` contient des fonctions et des propriétés permettant de gérer vos composants de pages Qodly. Les objets retournés sont de la classe [`4D.WebFormItem`](WebFormItemClass.md).
