...
The `On Double Clicked` event is generated when the user double-clicks on an object. La durée maximale séparant un double-clic est définie dans les préférences système.
