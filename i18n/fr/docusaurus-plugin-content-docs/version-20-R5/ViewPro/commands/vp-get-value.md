...
Dans _rangeObj_, passez une plage dont vous souhaitez récupérer la valeur.
...
| --------- | ------------------------------------------ | ------------------------------------------------------------------------- |
| value     | Integer, Real, Boolean, Text, Date, Object | Valeur de _rangeObj_ (exceptée - time)                 |
...
Si _rangeObj_ contient plusieurs cellules ou plusieurs plages, la valeur de la première cellule est retournée. La commande retourne un objet null si la cellule est vide.
