...
In _rangeObj_, pass a range of the cell (created with [VP Cell](vp-cell.md)) whose formula you want to specify. Si _rangeObj_ comprend plusieurs plages, seule la première plage est utilisée.
