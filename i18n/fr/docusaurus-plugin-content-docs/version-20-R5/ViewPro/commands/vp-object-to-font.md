...
La commande `VP Object to font` <!-- REF #_method_.VP Object to font.Summary -->retourne une chaîne de raccourci de police de _fontObj_<!-- END REF -->.

Dans _fontObj_, passez un objet contenant les propriétés de police. Les propriétés suivantes sont prises en charge :
