...
La commande `VP Get sheet options` <!-- REF #_method_.VP Obtenir les options de la feuille. ummary -->retourne un objet contenant les options de la feuille courante de la zone _vpAreaName_ <!-- END REF -->.
