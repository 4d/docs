...
Variant can be used to declare method parameters ($0, $1,...) that can be of various types. Dans ce cas, vous pouvez générer votre code en testant le type de valeur du paramètre, par exemple :
