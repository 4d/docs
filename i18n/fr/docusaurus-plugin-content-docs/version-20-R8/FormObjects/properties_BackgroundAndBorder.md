...
Vous pouvez également définir cette propriété en utilisant la commande [`LISTBOX SET PROPERTY`](../commands-legacy/listbox-set-property.md) avec la constante `lk background color expression`.
