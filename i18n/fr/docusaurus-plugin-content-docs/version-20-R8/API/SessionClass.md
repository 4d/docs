...
- [**Session des procédures stockées**](https://doc.4d.com/4Dv20/4D/20/Stored-Procedures.300-6330553.en.html) : Toutes les procédures stockées exécutées sur le serveur partagent la même session utilisateur virtuelle.
