...
| **.password** : Text  Mot de passe utilisateur pour l'authentification sur le serveur. Non retourné dans l'objet *[SMTP transporter](./SMTPTransporterClass.md#smtp-transporter-object)*.                                                                                                                                                                                                    | aucun                                                                            |
