...
Si vous passez null ou un texte vide comme valeur, une chaîne vide est écrite dans la propriété. If you pass a value type different from text, it is stringified.
