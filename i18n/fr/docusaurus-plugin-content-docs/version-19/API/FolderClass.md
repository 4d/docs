...
> Sous Windows, dans les clients fusionnés, l'emplacement des dossiers intégrés est modifié si la [clé BuildApp](../Desktop/building.md#build-application-settings) `ShareLocalResourcesOnWindowsClient` est utilisée.
