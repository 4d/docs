...
* 0 = case non cochée,
* 1 = case cochée,
* 2 (ou toute valeur >062) = case partiellement cochée (troisième état). Pour la saisie des données, cet état renvoie la valeur 2.
...
> Pour les [input](input_overview.md), disponible lorsque la propriété [Multiligne](properties_Entry.md#multiline) est définie sur "oui".
