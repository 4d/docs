...
Vous pouvez aussi déclarer le paramètre de retour en indiquant uniquement `: type`, auquel cas il pourra être disponible via `$0` (voir [syntaxe séquentielle](#valeur-retournée-1)).
