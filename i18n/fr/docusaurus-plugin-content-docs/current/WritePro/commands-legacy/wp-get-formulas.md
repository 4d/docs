...
| \[ \].name       | Texte    | Nom de la formule, si un nom a été défini ( non retourné dans le cas contraire). Les noms peuvent être définis à l'aide de [WP INSERT FORMULA](../commands/wp-insert-formula).                                                                             |
