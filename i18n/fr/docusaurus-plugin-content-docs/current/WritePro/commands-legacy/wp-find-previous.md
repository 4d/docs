...
<!--REF #_command_.WP Find previous.Syntax-->**WP Find previous** ( *objCible* : Object ; *rechercherAprès* : Object ; *rechercherValeur* : Text ; *conditionRecherche* : Integer {; *remplacerValeur* : Text} ) -> Résultat<!-- END REF-->
