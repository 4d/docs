...
Dans *wpSection*, passez la section à partir de laquelle vous voulez supprimer les éléments de la sous-section. La section peut être obtenue en utilisant les commandes [WP Get sections](../commands/wp-get-sections) ou [WP Get section](../commands/wp-get-section).
