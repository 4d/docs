...
**Compatibility Note**: *Handling expressions using the [**ST INSERT EXPRESSION**](../commands-legacy/st-insert-expression), [**ST Get expression**](../commands-legacy/st-get-expression), [**ST COMPUTE EXPRESSIONS**](../commands-legacy/st-compute-expressions), and [**ST FREEZE EXPRESSIONS**](../commands-legacy/st-freeze-expressions) commands is deprecated, however, it is still supported in 4D Write Pro for compatibility*.
...
| ------------------------------------------------------------------------------ | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [This](../commands/this).title                              | Text   | Titre défini dans l'attribut wk title                                                                                                                                                                                                                                                                                                                             |
| [This](../commands/this).author                             | Text   | Auteur défini dans l'attribut wk author                                                                                                                                                                                                                                                                                                                           |
...
| [This](../commands/this).document                           | Object | Document 4D Write Pro                                                                                                                                                                                                                                                                                                                                             |
| [This](../commands/this).data                               | Object | Contexte des données du document 4D Write Pro défini par [**WP SET DATA CONTEXT**](commands-legacy/wp-set-data-context.md)                                                                                                                                                                                                                                        |
...
| [This](../commands/this).sectionName                        | String | Le nom que l'utilisateur donne à la section                                                                                                                                                                                                                                                                                                                       |
...
| When a datasource has been defined for the table                                                                       | [This](../commands/this).table.dataSource | Objet (formula)                          | Datasource as a formula                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                        | [This](../commands/this).tableData                        | Collection or Entity selection (usually) | Evaluated table.dataSource                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| In each data row when a table datasource returns a collection or an entity selection                                   | [This](../commands/this).item.xxx         | Tous                                                        | Mapped to each item of the table datasource collection or entity selection, for example **This.item.firstName** if the associated entity has the *firstName* attribute                                                                                                                                                                                                                                                                                                                                |
...
When the [**Current date**](../commands-legacy/current-date) command, a date variable, or a method returning a date is inserted in a formula, it will automatically be transformed into text using the system date short format.

**Time**

When the [**Current time**](../commands-legacy/current-time) command, a time variable, or a method returning a time is inserted in a formula, it must be enclosed within a [**String**](../commands/string) command because time type is not supported in JSON. Examinez les exemples de formules suivants :
...
Table and field expressions inserted in 4D Write Pro documents support the virtual structure definition of the database. The virtual structure exposed to formulas is defined through [**SET FIELD TITLES**](../commands-legacy/set-field-titles)(...;\*) and [**SET TABLE TITLES**](../commands-legacy/set-table-titles)(...;\*) commands.
