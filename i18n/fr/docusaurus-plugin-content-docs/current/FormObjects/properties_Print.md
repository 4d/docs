...
> Les commandes [`Print object`](../commands-legacy/print-object) et [`Print form`](../commands/print-form) ne prennent pas en charge cette propriété.
...
> Cette propriété peut être définie par programmation en utilisant la commande [`OBJECT SET PRINT VARIABLE FRAME`](../commands-legacy/object-set-print-variable-frame).
