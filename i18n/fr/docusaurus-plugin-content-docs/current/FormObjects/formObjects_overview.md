...
- **Langage 4D** : Les commandes du thème `Objets (Formulaires)` telles que [`OBJECT DUPLICATE`](../commands-legacy/object-duplicate) ou [`OBJECT SET FONT STYLE`](../commands-legacy/object-set-font-style) permettent de créer et de définir des objets de formulaire.
