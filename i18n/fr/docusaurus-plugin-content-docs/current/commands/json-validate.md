...
The **JSON Validate** returns an object that provides the status of the validation. Cet objet peut avoir les propriétés suivantes :
...
| 9        | motif                | The string "{s1}" does not match the pattern in the schema:{s2}.                                                              |
...
| 29       | contient             | Array does not contain any items matching the 'contains' schema.                                                                              |
| 30       | contient             | Array must contain at least {s1} items matching the 'contains' schema, but only {s2} were found.                                              |
| 31       | contient             | Array must contain at most {s1} items matching the 'contains' schema, but {s2} were found.                                                    |
| 32       | obligatoire          | The property "{s1}" requires the property "{s2}" to be present.                                                                               |
