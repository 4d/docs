...
| remoteDebuggerSessionID                                                          | text       | ID de session de l'application distante à laquelle le débogueur de serveur est attaché. Cet identifiant est également renvoyé par [Process activity](./commands/process-activity).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | "A838A40BJN3NJKH..."                                                                                                                                                  |
...
(\*) Sous Windows, ce compteur doit être préalablement initialisé, par exemple par un appel à la commande **Application info** dans la méthode base [On Startup](./commands/on-startup-database-method).
