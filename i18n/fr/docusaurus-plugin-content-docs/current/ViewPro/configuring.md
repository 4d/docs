...
* If you set the paper size using the `kind` property, you can use either:
  ...
  * one of the formats returned by the [`PRINT OPTION VALUES`](https://doc.4d.com/4dv19/help/command/en/page785.html) command. In that case, [`VP Get print info`](./commands/vp-get-print-info.md) returns the corresponding format with the height and width.
...
| formatter       |            | text        | Modèle pour la propriété value/time.                                                                                                                                                                                                                                                                                                                                 | Number/text/date/time formats, special characters. See [Cell Format](#cell-format.md).                                                                                                                      |
