...
La commande `VP IMPORT FROM BLOB` <!-- REF #_method_.VP IMPORT FROM BLOB.Summary -->designates the 4D formulas that can be called directly from 4D View Pro formulas .<!-- END REF -->.
