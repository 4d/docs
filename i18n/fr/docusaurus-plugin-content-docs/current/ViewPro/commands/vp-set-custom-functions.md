...
|                    |            | \[ ].type | Number              | Type de paramètre. Type de paramètre. Type de paramètre. If *type* is `Is object`, the object is sent in a `.value` property. See [Parameters](../formulas.md#parameters) section. |
