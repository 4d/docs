...
|              | openMode                  | integer                     | <li>0 (normal) : mode d'ouverture standard, ni différé ni incrémental. Lors de l'ouverture du fichier, l'interface utilisateur et les événements UI peuvent être actualisés et sont réactifs à des moments précis.</li><li>1 (lazy) : mode d'ouverture différé. Lors de l'ouverture du fichier, seule la feuille active sera chargée directement. Les autres feuilles ne seront chargées que lorsqu'elles seront utilisées.</li><li>2 (incremental) : mode d'ouverture incrémental. Lors de l'ouverture du fichier, l'interface utilisateur et les événements UI peuvent être actualisés et sont réactifs directement.</li> |
