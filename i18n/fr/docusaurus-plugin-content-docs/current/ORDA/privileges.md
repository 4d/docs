...
- Une action de permission définie au niveau du datastore est automatiquement assignée à toutes les dataclass. The *execute* permission action defined at the datastore level applies to all functions of the project, including all [singleton](../REST/$singleton.md) functions.
...
| **execute** | Execute any function on the project (datastore, dataclass, entity selection, entity, singleton) | Exécuter n'importe quelle fonction de dataclass. Les fonctions de dataclass, d'entité et d'entity selection sont considérées comme des fonctions de dataclass | n/a                                                                                                                                                                   | Exécuter cette fonction                                                                                                                                                                                                                                                                                                            |
