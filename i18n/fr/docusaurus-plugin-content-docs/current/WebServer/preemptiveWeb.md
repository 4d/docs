...
- En principe, tout code traité par la commande [`PROCESS 4D TAGS`](../commands-legacy/process-4d-tags) dans le contexte du web, par exemple par le biais de pages .shtml
