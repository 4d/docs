...
Cette commande doit être appelée à partir d'une méthode d'appel sur erreur installée par la commande [ON ERR CALL](../../commands-legacy/on-err-call) ou dans un contexte [Try ou Try/Catch](../../Concepts/error-handling.md#tryexpression).
...
[ON ERR CALL](../../commands-legacy/on-err-call)
[throw](../../commands-legacy/throw)\
