...
**Conseil :** Si vous voulez récupérer plusieurs informations de l'utilisateur, construisez un formulaire approprié et appelez-le avec la commande [DIALOG](../commands/dialog), plutôt que d'afficher une succession de boîtes de dialogue du type **Request**.
