...
<!--REF #_command_.QUERY BY ATTRIBUTE.Syntax-->**QUERY BY ATTRIBUTE** ( {*laTable* : Table ;}{*opConj* : &, \|, # ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRech* : Text, >, <, >=, <=, #, =, \|, % ; *valeur* : Text, Real, Date, Time {; *} )<!-- END REF-->
