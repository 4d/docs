...
Si la constante Description in XML format est passée à la commande [Last query path](../commands/last-query-path), *$vResultPath* contient la description de la recherche exprimée en XML :
