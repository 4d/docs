...
<!--REF #_command_.DOM Get last child XML element.Syntax-->**DOM Get last child XML element** ( *refElément* : Text {; *nomElémentEnf* : Text {; *valeurElémentEnf* : any}} ) : Text<!-- END REF-->
