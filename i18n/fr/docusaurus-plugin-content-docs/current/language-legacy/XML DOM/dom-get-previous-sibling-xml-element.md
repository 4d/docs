...
<!--REF #_command_.DOM Get previous sibling XML element.Syntax-->**DOM Get previous sibling XML element** ( *refElément* : Text {; *nomElémentFrère* : Text {; *valeurElémentFrère* : any}} ) : Text<!-- END REF-->
