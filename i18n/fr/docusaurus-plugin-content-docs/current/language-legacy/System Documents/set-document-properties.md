...
<!--REF #_command_.SET DOCUMENT PROPERTIES.Syntax-->**SET DOCUMENT PROPERTIES** ( *nomFichier* : Text ; *verrouillé* : Boolean ; *invisible* : Boolean ; *créé le* : Date ; *créé à* : Time ; *modifié le* : Date ; *modifié à* : Time )<!-- END REF-->
