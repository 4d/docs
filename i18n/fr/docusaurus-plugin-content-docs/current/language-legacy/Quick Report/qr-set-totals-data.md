...
<!--REF #_command_.QR SET TOTALS DATA.Syntax-->**QR SET TOTALS DATA** ( *zone* : Integer ; *numColonne* : Integer ; *numRupture* : Integer ; *opérateur* : Integer )<br/>**QR SET TOTALS DATA** ( *zone* : Integer ; *numColonne* : Integer ; *numRupture* : Integer ; *valeur* : Text )<!-- END REF-->
