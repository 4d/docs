...
**\** Les noms de la structure virtuelle sont définis à l'aide de commandes [SET TABLE TITLES](../commands/set-table-titles) et [SET FIELD TITLES](../commands/set-field-titles) (utilisées avec le paramètre \*).* 
