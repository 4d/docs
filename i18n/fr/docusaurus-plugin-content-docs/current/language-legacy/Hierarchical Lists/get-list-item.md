...
<!--REF #_command_.GET LIST ITEM.Syntax-->**GET LIST ITEM** ( * ; *liste* : Text ; *positionElém* : Integer, Operator ; *réfElément* : Integer ; *libelléElément* : Text {; *sous_Liste* : Integer } {; *déployée* : Boolean} )<br/>**GET LIST ITEM** ( *liste* : Integer ; *positionElém* : Integer, Operator ; *réfElément* : Integer ; *libelléElément* : Text {; *sous_Liste* : Integer } {; *déployée* : Boolean} )<!-- END REF-->
...
| positionElém | Integer, Operator | &#8594;  | Position de l'élément dans la ou les liste(s) déployée(s)/contractée(s) ou * pour l‘élément courant de la liste |
