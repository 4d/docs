...
<!--REF #_command_.OBJECT SET FONT STYLE.Syntax-->**OBJECT SET FONT STYLE** ( * ; *objet* : Text ; *style* : Integer )<br/>**OBJECT SET FONT STYLE** ( *objet* : Variable, Field ; *style* : Integer )<!-- END REF-->
