...
<!--REF #_command_.OBJECT SET MULTILINE.Syntax-->**OBJECT SET MULTILINE** ( * ; *objet* : Text ; *multiLigne* : Integer )<br/>**OBJECT SET MULTILINE** ( *objet* : Variable, Field ; *multiLigne* : Integer )<!-- END REF-->
