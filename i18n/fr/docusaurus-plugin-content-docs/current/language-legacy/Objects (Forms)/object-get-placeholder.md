...
<!--REF #_command_.OBJECT Get placeholder.Syntax-->**OBJECT Get placeholder** ( * ; *objet* : Text ) : Text<br/>**OBJECT Get placeholder** ( *objet* : Variable, Field ) : Text<!-- END REF-->
...
Un texte d’exemple peut avoir été défini soit via la Liste des propriétés, soit via la commande [OBJECT SET PLACEHOLDER](../commands/object-set-placeholder). 
