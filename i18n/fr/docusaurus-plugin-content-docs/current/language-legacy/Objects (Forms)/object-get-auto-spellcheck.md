...
<!--REF #_command_.OBJECT Get auto spellcheck.Syntax-->**OBJECT Get auto spellcheck** ( * ; *objet* : Text ) : Boolean<br/>**OBJECT Get auto spellcheck** ( *objet* : Variable, Field ) : Boolean<!-- END REF-->
