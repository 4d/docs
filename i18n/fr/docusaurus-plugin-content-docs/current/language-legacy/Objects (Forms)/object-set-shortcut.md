...
<!--REF #_command_.OBJECT SET SHORTCUT.Syntax-->**OBJECT SET SHORTCUT** ( * ; *objet* : Text ; *touche* : Text {; *modifiers* : Integer} )<br/>**OBJECT SET SHORTCUT** ( *objet* : Variable, Field ; *touche* : Text {; *modifiers* : Integer} )<!-- END REF-->
