...
<!--REF #_command_.OBJECT GET MINIMUM VALUE.Syntax-->**OBJECT GET MINIMUM VALUE** ( * ; *objet* : Text ; *valeurMini* : Date, Time, Real )<br/>**OBJECT GET MINIMUM VALUE** ( *objet* : Variable, Field ; *valeurMini* : Date, Time, Real )<!-- END REF-->
