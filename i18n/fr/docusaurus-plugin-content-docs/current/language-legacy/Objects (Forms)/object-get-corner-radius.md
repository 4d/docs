...
<!--REF #_command_.OBJECT Get corner radius.Syntax-->**OBJECT Get corner radius** ( * ; *objet* : Text ) : Integer<br/>**OBJECT Get corner radius** ( *objet* : Variable, Field ) : Integer<!-- END REF-->
