...
<!--REF #_command_.OBJECT GET SHORTCUT.Syntax-->**OBJECT GET SHORTCUT** ( * ; *objet* : Text ; *touche* : Text ; *modifiers* : Integer )<br/>**OBJECT GET SHORTCUT** ( *objet* : Variable, Field ; *touche* : Text ; *modifiers* : Integer )<!-- END REF-->
