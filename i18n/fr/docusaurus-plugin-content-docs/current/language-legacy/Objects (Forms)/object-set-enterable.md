...
<!--REF #_command_.OBJECT SET ENTERABLE.Syntax-->**OBJECT SET ENTERABLE** ( * ; *objet* : Text ; *saisissable* : Boolean, Integer )<br/>**OBJECT SET ENTERABLE** ( *objet* : Variable, Field, Table ; *saisissable* : Boolean, Integer )<!-- END REF-->
...
| objet | Text, Variable, Field | &#8594;  | Nom d'objet (si * spécifié) ou Table ou Champ ou Variable (si * omis) |
