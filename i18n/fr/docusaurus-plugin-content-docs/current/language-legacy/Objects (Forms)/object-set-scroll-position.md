...
<!--REF #_command_.OBJECT SET SCROLL POSITION.Syntax-->**OBJECT SET SCROLL POSITION** ( * ; *objet* : Text {; *positionLigne* : Integer {; *positionH* : Integer}}{; *} )<br/>**OBJECT SET SCROLL POSITION** ( *objet* : Variable, Field, Table {; *positionLigne* : Integer {; *positionH* : Integer}}{; *} )<br/><!-- END REF-->
...
| objet | Text, Variable, Field | &#8594;  | Nom d’objet (si * est spécifié) ou Table, champ ou variable (si * est omis) |
