...
<!--REF #_command_.OBJECT Get vertical alignment.Syntax-->**OBJECT Get vertical alignment** ( * ; *objet* : Text ) : Integer<br/>**OBJECT Get vertical alignment** ( *objet* : Variable, Field ) : Integer<!-- END REF-->
