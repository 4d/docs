...
<!--REF #_command_.OBJECT SET INDICATOR TYPE.Syntax-->**OBJECT SET INDICATOR TYPE** ( * ; *objet* : Text ; *indicateur* : Integer )<br/>**OBJECT SET INDICATOR TYPE** ( *objet* : Variable, Field ; *indicateur* : Integer )<!-- END REF-->
