...
<!--REF #_command_.OBJECT Get indicator type.Syntax-->**OBJECT Get indicator type** ( * ; *objet* : Text ) : Integer<br/>**OBJECT Get indicator type** ( *objet* : Variable, Field ) : Integer<!-- END REF-->
