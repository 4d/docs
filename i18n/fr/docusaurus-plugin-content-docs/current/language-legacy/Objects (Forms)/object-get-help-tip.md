...
<!--REF #_command_.OBJECT Get help tip.Syntax-->**OBJECT Get help tip** ( * ; *objet* : Text ) : Text<br/>**OBJECT Get help tip** ( *objet* : Variable, Field ) : Text<!-- END REF-->
