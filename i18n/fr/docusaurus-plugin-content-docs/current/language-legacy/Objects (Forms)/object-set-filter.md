...
<!--REF #_command_.OBJECT SET FILTER.Syntax-->**OBJECT SET FILTER** ( * ; *objet* : Text ; *filtreSaisie* : Text )<br/>**OBJECT SET FILTER** ( *objet* : Variable, Field ; *filtreSaisie* : Text )<!-- END REF-->
