...
<!--REF #_command_.DISTINCT VALUES.Syntax-->**DISTINCT VALUES** ( *leChamp* : Field ; *tableau* : Array {; *tabNbVal* : Integer array} )<!-- END REF-->
