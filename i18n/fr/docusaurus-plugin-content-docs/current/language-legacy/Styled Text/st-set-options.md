...
<!--REF #_command_.ST SET OPTIONS.Syntax-->**ST SET OPTIONS** ( * ; *objet* : Text ; *option* : Integer ; *valeur* : Integer {; ...(*option* : Integer ; *valeur* : Integer)} )<br/>**ST SET OPTIONS** ( *objet* : Variable, Field ; *option* : Integer ; *valeur* : Integer {; ...(*option* : Integer ; *valeur* : Integer)} )<!-- END REF-->
