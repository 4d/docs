...
<!--REF #_command_.ST Get text.Syntax-->**ST Get text** ( * ; *objet* : Text {; *débutSél* : Integer {; *finSél* : Integer}} )  : Text<br/>**ST Get text** ( *objet* : Variable, Field {; *débutSél* : Integer {; *finSél* : Integer}} )  : Text<!-- END REF-->
