...
Si la commande [SET FIELD TITLES](../commands/set-field-titles) a été appelée au cours de la session, **GET FIELD TITLES** retourne uniquement les noms “modifiés” et les numéros des champs ayant été définis via cette commande.  
