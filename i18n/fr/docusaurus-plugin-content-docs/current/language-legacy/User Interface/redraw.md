...
<!--REF #_command_.REDRAW.Syntax-->**REDRAW** ( *laTable* : Table )<br/>**REDRAW** ( *objet* : Field, Variable ))<!-- END REF-->
<!--REF #_command_.REDRAW.Params-->
<div class="no-index">

| Paramètre | Type |  | Description |
| --- | --- | --- | --- |
| laTable | Table | &#8594;  | Table de laquelle redessiner le sous-formulaire |
| objet | Field, Variable | &#8594;  | Champ duquel redessiner la zone ou Variable de laquelle redessiner la zone ou List box à mettre à jour |
</div>
<!-- END REF-->
