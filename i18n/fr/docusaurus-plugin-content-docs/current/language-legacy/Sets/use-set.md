...
L'exemple suivant utilise [LOAD SET](../commands/load-set) pour charger un ensemble des sites de la société Dubois à Paris. **USE SET** est ensuite appelée pour faire de l'ensemble la sélection courante :
