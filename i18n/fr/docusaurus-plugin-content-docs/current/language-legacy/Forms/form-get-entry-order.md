...
<!--REF #_command_.FORM GET ENTRY ORDER.Syntax-->**FORM GET ENTRY ORDER** ( *nomsObjets* : Text array {; *numPage* : Integer } )<br/>**FORM GET ENTRY ORDER** ( *nomsObjets* : Text array {; *} )<!-- END REF-->
