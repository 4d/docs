...
<!--REF #_command_.FORM GET OBJECTS.Syntax-->**FORM GET OBJECTS** ( *tabObjets* : Text array {; *tabVariables* : Pointer array {; *tabPages* : Integer array}} {; *optionPage* : Integer } )<!-- END REF-->
...
| optionPage | Entier long | &#8594;  | 1=Page courante du formulaire, 2=Toutes les pages, 4=Pages héritées |
</div>
<!-- END REF-->
