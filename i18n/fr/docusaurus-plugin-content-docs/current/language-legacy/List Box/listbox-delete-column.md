...
<!--REF #_command_.LISTBOX DELETE COLUMN.Syntax-->**LISTBOX DELETE COLUMN** ( * ; *objet* : Text ; *positionCol* : Integer {; *nombre* : Integer} )<br/>**LISTBOX DELETE COLUMN** ( *objet* : Variable ; *positionCol* : Integer {; *nombre* : Integer} )<!-- END REF-->
