...
<!--REF #_command_.LISTBOX SET ROW FONT STYLE.Syntax-->**LISTBOX SET ROW FONT STYLE** ( * ; *objet* : Text ; *ligne* : Integer ; *style* : Integer )<br/>**LISTBOX SET ROW FONT STYLE** ( *objet* : Variable ; *ligne* : Integer ; *style* : Integer )<!-- END REF-->
