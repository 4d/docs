...
<!--REF #_command_.LISTBOX Get footer calculation.Syntax-->**LISTBOX Get footer calculation** ( * ; *objet* : Text ) : Integer<br/>**LISTBOX Get footer calculation** ( *objet* : Variable ) : Integer<!-- END REF-->
