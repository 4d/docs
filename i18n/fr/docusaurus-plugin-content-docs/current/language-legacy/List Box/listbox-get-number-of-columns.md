...
<!--REF #_command_.LISTBOX Get number of columns.Syntax-->**LISTBOX Get number of columns** ( * ; *objet* : Text ) : Integer<br/>**LISTBOX Get number of columns** ( *objet* : Variable ) : Integer<!-- END REF-->
