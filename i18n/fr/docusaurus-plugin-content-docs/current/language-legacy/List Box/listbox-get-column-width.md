...
<!--REF #_command_.LISTBOX Get column width.Syntax-->**LISTBOX Get column width** ( * ; *objet* : Text {; *largeurMini* : Integer {; *largeurMaxi* : Integer}} ) : Integer<br/>**LISTBOX Get column width** ( *objet* : Variable {; *largeurMini* : Integer {; *largeurMaxi* : Integer}} ) : Integer<!-- END REF-->
