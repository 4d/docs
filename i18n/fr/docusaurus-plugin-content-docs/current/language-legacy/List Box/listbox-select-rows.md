...
<!--REF #_command_.LISTBOX SELECT ROWS.Syntax-->**LISTBOX SELECT ROWS** ( * ; *objet* : Text ; *sélection* : Object, Collection {; *action* : Integer} )<br/>**LISTBOX SELECT ROWS** ( *objet* : Variable ; *sélection* : Object, Collection {; *action* : Integer} )<!-- END REF-->
...
| objet | Text, Variable | &#8594;  | Nom de l'objet (si * est spécifié) ou Variable (si * est spécifié) |
