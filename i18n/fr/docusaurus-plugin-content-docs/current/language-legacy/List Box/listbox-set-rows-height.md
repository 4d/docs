...
<!--REF #_command_.LISTBOX SET ROWS HEIGHT.Syntax-->**LISTBOX SET ROWS HEIGHT** ( * ; *objet* : Text ; *hauteur* : Integer {; *unité* : Integer} )<br/>**LISTBOX SET ROWS HEIGHT** ( *objet* : Variable ; *hauteur* : Integer {; *unité* : Integer} )<!-- END REF-->
