...
<!--REF #_command_.LISTBOX SET ROW COLOR.Syntax-->**LISTBOX SET ROW COLOR** ( * ; *objet* : Text ; *ligne* : Integer ; *couleur* : Text, Integer {; *typeCouleur* : Integer} )<br/>**LISTBOX SET ROW COLOR** ( *objet* : Variable ; *ligne* : Integer ; *couleur* : Text, Integer {; *typeCouleur* : Integer} )<!-- END REF-->
