...
<!--REF #_command_.LISTBOX Get array.Syntax-->**LISTBOX Get array** ( * ; *objet* : Text ; *typeTab* : Integer ) : Pointer<br/>**LISTBOX Get array** ( *objet* : Variable ; *typeTab* : Integer ) : Pointer<!-- END REF-->
