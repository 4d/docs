...
<!--REF #_command_.LISTBOX GET GRID COLORS.Syntax-->**LISTBOX GET GRID COLORS** ( * ; *objet* : Text ; *couleurH* : Text, Integer ; *couleurV* : Text, Integer )<br/>**LISTBOX GET GRID COLORS** ( *objet* : Variable ; *couleurH* : Text, Integer ; *couleurV* : Text, Integer )<!-- END REF-->
