...
<!--REF #_command_.LISTBOX Get row font style.Syntax-->**LISTBOX Get row font style** ( * ; *objet* : Text ; *ligne* : Integer ) : Integer<br/>**LISTBOX Get row font style** ( *objet* : Variable ; *ligne* : Integer ) : Integer<!-- END REF-->
