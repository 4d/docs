...
<!--REF #_command_.LISTBOX SET AUTO ROW HEIGHT.Syntax-->**LISTBOX SET AUTO ROW HEIGHT** ( * ; *objet* : Text ; *sélecteur* : Integer ; *valeur* : Integer ; *unité* : Integer )<br/>**LISTBOX SET AUTO ROW HEIGHT** ( *objet* : Variable ; *sélecteur* : Integer ; *valeur* : Integer ; *unité* : Integer )<!-- END REF-->
