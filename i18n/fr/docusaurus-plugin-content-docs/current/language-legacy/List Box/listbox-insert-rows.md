...
<!--REF #_command_.LISTBOX INSERT ROWS.Syntax-->**LISTBOX INSERT ROWS** ( * ; *objet* : Text ; *positionLigne* : Integer {; *nbLignes* : Integer} )<br/>**LISTBOX INSERT ROWS** ( *objet* : Variable ; *positionLigne* : Integer {; *nbLignes* : Integer} )<!-- END REF-->
