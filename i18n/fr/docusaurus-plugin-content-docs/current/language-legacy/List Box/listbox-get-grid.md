...
<!--REF #_command_.LISTBOX GET GRID.Syntax-->**LISTBOX GET GRID** ( * ; *objet* : Text ; *horizontal* : Boolean ; *vertical* : Boolean )<br/>**LISTBOX GET GRID** ( *objet* : Variable ; *horizontal* : Boolean ; *vertical* : Boolean )<!-- END REF-->
