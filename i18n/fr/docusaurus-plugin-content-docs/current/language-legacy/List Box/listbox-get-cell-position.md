...
<!--REF #_command_.LISTBOX GET CELL POSITION.Syntax-->**LISTBOX GET CELL POSITION** ( * ; *objet* : Text {; *x* : Real ; *y* : Real }; *colonne* : Integer ; *ligne* : Integer {; *varCol* : Pointer} )<br/>**LISTBOX GET CELL POSITION** ( *objet* : Variable {; *x* : Real ; *y* : Real }; *colonne* : Integer ; *ligne* : Integer {; *varCol* : Pointer} )<!-- END REF-->
