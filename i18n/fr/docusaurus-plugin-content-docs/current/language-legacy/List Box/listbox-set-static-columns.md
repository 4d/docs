...
<!--REF #_command_.LISTBOX SET STATIC COLUMNS.Syntax-->**LISTBOX SET STATIC COLUMNS** ( * ; *objet* : Text ; *nbColonnes* : Integer )<br/>**LISTBOX SET STATIC COLUMNS** ( *objet* : Variable ; *nbColonnes* : Integer )<!-- END REF-->
