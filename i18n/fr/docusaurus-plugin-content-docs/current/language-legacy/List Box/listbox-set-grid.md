...
<!--REF #_command_.LISTBOX SET GRID.Syntax-->**LISTBOX SET GRID** ( * ; *objet* : Text ; *horizontal* : Boolean ; *vertical* : Boolean )<br/>**LISTBOX SET GRID** ( *objet* : Variable ; *horizontal* : Boolean ; *vertical* : Boolean )<!-- END REF-->
