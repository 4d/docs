...
<!--REF #_command_.LISTBOX SET HIERARCHY.Syntax-->**LISTBOX SET HIERARCHY** ( * ; *objet* : Text ; *hiérarchique* : Boolean {; *hiérarchie* : Pointer array} )<br/>**LISTBOX SET HIERARCHY** ( *objet* : Variable ; *hiérarchique* : Boolean {; *hiérarchie* : Pointer array} )<!-- END REF-->
