...
<!--REF #_command_.LISTBOX SET HEADERS HEIGHT.Syntax-->**LISTBOX SET HEADERS HEIGHT** ( * ; *objet* : Text ; *hauteur* : Integer {; *unité* : Integer} )<br/>**LISTBOX SET HEADERS HEIGHT** ( *objet* : Variable ; *hauteur* : Integer {; *unité* : Integer} )<!-- END REF-->
