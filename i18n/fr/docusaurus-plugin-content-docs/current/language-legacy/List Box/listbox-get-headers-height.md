...
<!--REF #_command_.LISTBOX Get headers height.Syntax-->**LISTBOX Get headers height** ( * ; *objet* : Text {; *unité* : Integer} ) : Integer<br/>**LISTBOX Get headers height** ( *objet* : Variable {; *unité* : Integer} ) : Integer<!-- END REF-->
