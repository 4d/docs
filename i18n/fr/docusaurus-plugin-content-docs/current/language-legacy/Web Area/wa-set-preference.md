...
<!--REF #_command_.WA SET PREFERENCE.Syntax-->**WA SET PREFERENCE** ( * ; *objet* : Text ; *sélecteur* : Integer ; *valeur* : Boolean )<br/>**WA SET PREFERENCE** ( *objet* : Variable, Field ; *sélecteur* : Integer ; *valeur* : Boolean )<!-- END REF-->
