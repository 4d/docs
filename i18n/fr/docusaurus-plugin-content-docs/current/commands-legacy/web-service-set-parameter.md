...
| --- | --- | --- | --- |
| nom | Text | &srarr; | Nom du paramètre à inclure dans la requête SOAP |
| valeur | Variable | &srarr; | Variable 4D contenant la valeur du paramètre |
| typeSOAP | Text | &srarr; | Type SOAP du paramètre |
