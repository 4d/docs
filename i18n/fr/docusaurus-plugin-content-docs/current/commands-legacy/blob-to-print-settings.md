...
| --- | --- | --- | --- |
| paramImpression | Blob | &srarr; | BLOB contenant les paramètres d’impression |
| param | Integer | &srarr; | 0=Utilise les valeurs sauvegardées pour le nombre de copies et la plage d'impression, 1=Réinitialise aux valeurs par défaut |
| Résultat | Integer | &larr; | Code d'état : 1=Opération réussie, 0=Pas d'imprimante courante, -1=Paramètres incorrects, 2=L'imprimante a changé |
