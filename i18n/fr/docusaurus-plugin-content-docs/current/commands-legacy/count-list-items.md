...
<!--REF #_command_.Count list items.Syntax-->**Count list items** ( {* ;} *liste* {; *} ) -> Résultat<!-- END REF-->
...
| * | Opérateur | &srarr; | Si omis (défaut) : Retourner les éléments visibles (déployés) dans la ou les liste(s) Si spécifié : Retourner tous les éléments |
