...
| --- | --- | --- | --- |
| nomUtilisateur | Text | &srarr; | Nom de l'utilisateur (compte) |
| groupe | Text | &srarr; | Nom du groupe |
| Résultat | Boolean | &larr; | Vrai = utilisateur est dans groupe Faux = utilisateur n'est pas dans groupe |
