...
| --- | --- | --- | --- |
| cléPrivée | Blob | &harr; | BLOB devant recevoir la clé privée |
| cléPublique | Blob | &harr; | BLOB devant recevoir la clé publique |
| longueur | Integer | &srarr; | Longueur des clés en bits [512...2048] Par défaut = 512 |
