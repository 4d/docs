...
| --- | --- | --- | --- |
| langID | Integer array | &larr; | ID uniques des langues |
| langFichiers | Text array | &larr; | Noms des fichiers de langue installés |
| langNoms | Text array | &larr; | Noms locaux des langues |
