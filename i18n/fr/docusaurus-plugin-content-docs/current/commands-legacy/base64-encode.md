...
| --- | --- | --- | --- |
| àEncoder | Blob, Text | &rarr; | Valeur à encoder |
| &larr; | Valeur encodée (si le paramètre encodé est omis) |
| encodé | Blob, Text | &larr; | Valeur encodée |
| * | Opérateur | &rarr; | Encoder au format Base64URL |
