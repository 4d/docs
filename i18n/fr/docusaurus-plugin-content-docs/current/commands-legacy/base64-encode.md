...
| --- | --- | --- | --- |
| àEncoder | Blob, Text | &srarr; | Valeur à encoder |
| &harr; | Valeur encodée (si le paramètre encodé est omis) |
| encodé | Blob, Text | &harr; | Valeur encodée |
| * | Opérateur | &srarr; | Encoder au format Base64URL |
