...
<!--REF #_command_.WA SET EXTERNAL LINKS FILTERS.Syntax-->**WA SET EXTERNAL LINKS FILTERS** ( * ; *objet* : Text ; *tabFiltres* : Text array ; *tabAutorisRefus* : Boolean array )<br/>**WA SET EXTERNAL LINKS FILTERS** ( *objet* : Field, Variable ; *tabFiltres* : Text array ; *tabAutorisRefus* : Boolean array )<!-- END REF-->
