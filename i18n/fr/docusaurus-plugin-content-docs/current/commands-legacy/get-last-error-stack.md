...
| --- | --- | --- | --- |
| tabCodes | Integer array | &larr; | Tableau de numéros d'erreurs |
| tabCompInternes | Text array | &larr; | Tableau de codes de composants internes |
| tabLibellés | Text array | &larr; | Tableau de libellés d'erreurs |
