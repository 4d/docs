...
| --- | --- | --- | --- |
| cheminAccès | Text | &srarr; | Chemin d'accès de volume ou de dossier |
| documents | Text array | &harr; | Nom des documents situés à cet endroit |
| options | Integer | &srarr; | Options de construction de la liste |
