...
| --- | --- | --- | --- |
| blob | Blob | &rarr; | BLOB contenant la liste hiérarchique |
| offset | Integer | &rarr; | Offset (en octets) dans le BLOB |
| &larr; | Nouvel offset après la lecture |
| Résultat | Integer | &larr; | Référence de la liste nouvellement créée |
