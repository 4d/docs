...
| --- | --- | --- | --- |
| valeurXML | Text | &srarr; | Valeur de type texte provenant d’une structure XML |
| var4D | Field, Variable | &harr; | Variable ou champ 4D devant recevoir la valeur XML convertie |
