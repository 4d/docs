...
| --- | --- | --- | --- |
| tabBooléen | Tableau booléen | &#x1F858; | Tableau d'appartenance des enregistrements à l’ensemble |
| ensemble | Chaîne | &#x1F852; | Nom de l’ensemble ou Ensemble UserSet si ce paramètre est omis |
