...
| id_Element | Text | &srarr; | ID de l'élément dont vous souhaitez connaître une valeur d'attribut |
| nomAttribut | Text | &srarr; | Nom d’attribut |
| valeurAttribut | Text, Integer | &harr; | Valeur courante de l'attribut |
