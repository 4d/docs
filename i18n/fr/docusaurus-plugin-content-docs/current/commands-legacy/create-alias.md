...
| --- | --- | --- | --- |
| cheminCible | Text | &srarr; | Nom ou chemin d’accès de la cible de l’alias/du raccourci |
| cheminAlias | Text | &srarr; | Nom ou chemin d’accès complet de l’alias/du raccourci à créer |
