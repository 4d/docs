...
Si une fenêtre barre d'outils a été créée par la commande [Open form window](../commands/open-form-window.md) avec l'option Toolbar form window, la commande masque la fenêtre. Si la fenêtre barre d'outils était déjà masquée ou si aucune fenêtre de ce type n'a été créée, la commande ne fait rien
