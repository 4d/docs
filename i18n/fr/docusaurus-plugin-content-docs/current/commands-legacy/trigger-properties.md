...
| --- | --- | --- | --- |
| niveauTrigger | Integer | &rarr; | Niveau d'exécution du trigger |
| evenementBase | Integer | &larr; | Evénement de base de données |
| numTable | Integer | &larr; | Numéro de la table |
| numEnreg | Integer | &larr; | Numéro de l'enregistrement |
