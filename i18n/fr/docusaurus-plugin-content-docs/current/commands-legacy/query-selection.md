...
| --- | --- | --- | --- |
| laTable | Table | &srarr; | Table dans laquelle effectuer la recherche ou ou Table par défaut si ce paramètre est omis |
| critère | Expression | &srarr; | Lignes de recherche |
