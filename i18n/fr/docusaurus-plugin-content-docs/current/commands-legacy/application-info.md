...
| remoteDebuggerSessionID     | texte      | ID de la session de l'application distante à laquelle est associé le débogueur du serveur. Cet ID est également retourné par [Get process activity](get-process-activity.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | "A838A40BJN3NJKH..."                            |
