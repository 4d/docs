...
| --- | --- | --- | --- |
| * | Opérateur | &srarr; | Numéro du process de la première fenêtre non-flottante |
| Résultat | Integer | &larr; | Numéro du process dont la ou les fenêtre(s) est (sont) au premier plan |
