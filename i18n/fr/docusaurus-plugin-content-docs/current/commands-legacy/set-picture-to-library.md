...
| --- | --- | --- | --- |
| image | Picture | &rarr; | Nouvelle image |
| refImage | Integer | &rarr; | Numéro de référence de l'image dans la bibliothèque d'images |
| nomImage | Text | &rarr; | Nouveau nom de l’image |
