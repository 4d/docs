...
| --- | --- | --- | --- |
| code | Integer | &srarr; | Code d'un caractère ou code de touche de fonction |
| modifiers | Integer | &srarr; | Etat des touches Modifier |
| process | Integer | &srarr; | Numéro de référence du process de destination ou File d'attente des événements de l'application si paramètre omis ou égal à 0 |
