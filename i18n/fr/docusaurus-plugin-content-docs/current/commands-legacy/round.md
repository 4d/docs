...
| --- | --- | --- | --- |
| arrondi | Real | &srarr; | Nombre à arrondir |
| nbDécimales | Integer | &srarr; | Nombre de décimales de l'arrondi |
| Résultat | Real | &larr; | Valeur de nombre arrondie avec une précision égale à nbDécimales |
