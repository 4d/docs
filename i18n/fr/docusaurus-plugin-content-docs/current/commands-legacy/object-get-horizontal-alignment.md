...
<!--REF #_command_.OBJECT Get horizontal alignment.Syntax-->**OBJECT Get horizontal alignment** ( * ; *objet* : Text ) : Integer<br/>**OBJECT Get horizontal alignment** ( *objet* : Field, Variable ) : Integer<!-- END REF-->
