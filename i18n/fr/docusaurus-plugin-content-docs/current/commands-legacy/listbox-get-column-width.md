...
| largeurMini | Integer | &harr; | Largeur minimale de la colonne (en pixels) |
| largeurMaxi | Integer | &harr; | Largeur maximale de la colonne (en pixels) |
| Résultat | Integer | &larr; | Largeur de colonne en pixels |
