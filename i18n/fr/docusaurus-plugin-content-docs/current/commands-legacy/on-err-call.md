...
| --- | --- | --- | --- |
| méthodErreur | Text | &rarr; | Méthode de gestion d'erreur à appeler ou Chaîne vide pour désinstaller la méthode |
...
Vous pouvez utiliser la commande [Last errors](last-errors.md) ou [GET LAST ERROR STACK](get-last-error-stack.md) pour obtenir la séquence d'erreurs (c'est-à-dire la "pile" d'erreurs) à l'origine de l'interruption.
