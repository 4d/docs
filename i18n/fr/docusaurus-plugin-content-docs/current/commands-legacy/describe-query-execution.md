...
| --- | --- | --- | --- |
| statut | Boolean | &srarr; | Vrai=Enregistrer la description des requêtes, Faux=Stopper l'enregistrement |
...
Si la constante Description in XML format est passée à la commande [Get last query path](get-last-query-path.md), *$vResultPath* contient la description de la recherche exprimée en XML :
