...
| --- | --- | --- | --- |
| laText | Text | &srarr; | Chaîne à convertir en majuscules |
| * | Opérateur | &srarr; | Si passé : conserver les accents Si omis : supprimer les accents |
| Résultat | Text | &larr; | chaîne en majuscules |
