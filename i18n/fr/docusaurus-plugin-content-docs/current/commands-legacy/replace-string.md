...
| obsolète | Text | &rarr; | Caractère(s) à remplacer |
| nouveau | Text | &rarr; | Chaîne de remplacement (si chaîne vide, toutes les occurrences sont effacées) |
| combien | Integer | &rarr; | Nombre de remplacements à effectuer |
