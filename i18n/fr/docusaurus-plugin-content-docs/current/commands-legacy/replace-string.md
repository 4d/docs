...
| obsolète | Text | &srarr; | Caractère(s) à remplacer |
| nouveau | Text | &srarr; | Chaîne de remplacement (si chaîne vide, toutes les occurrences sont effacées) |
| combien | Integer | &srarr; | Nombre de remplacements à effectuer |
