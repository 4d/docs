...
<!--REF #_command_.OBJECT Is styled text.Syntax-->**OBJECT Is styled text** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| Résultat | Boolean | &larr; | Vrai si l’objet est un texte en multistyle, Faux sinon |
