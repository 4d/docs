...
| --- | --- | --- | --- |
| laTable | Table | &rarr; | Table du formulaire |
| nomFormulaire | Text | &rarr; | Nom du formulaire |
| imageForm | Picture | &larr; | Image du formulaire en exécution si premier(s) paramètre(s) omis, ou <br/>Image du formulaire dans l'éditeur de formulaires si un nom de formulaire est passé |
| pageNum | Integer | &rarr; | Numéro de page du formulaire |
