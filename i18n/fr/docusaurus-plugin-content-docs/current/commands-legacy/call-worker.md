...
| --- | --- | --- | --- |
| process | Text, Integer | &srarr; | Nom ou numéro du process worker |
| formule | Object, Text | &srarr; | Objet Formula ou Nom de la méthode projet |
| param | Expression | &srarr; | Paramètre(s) passé(s) à la méthode |
