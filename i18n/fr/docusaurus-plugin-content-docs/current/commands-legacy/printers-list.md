...
| --- | --- | --- | --- |
| tabNoms | Text array | &larr; | Noms des imprimantes |
| tabNomsAlt | Text array | &larr; | Windows : Emplacements des imprimantes, macOS : Noms personnalisés des imprimantes |
| tabModèles | Text array | &larr; | Modèles des imprimantes |
