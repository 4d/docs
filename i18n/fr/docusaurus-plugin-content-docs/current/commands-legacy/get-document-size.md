...
| --- | --- | --- | --- |
| document | Text, Time | &rarr; | Numéro de référence de document ou Nom de document |
| * | Opérateur | &rarr; | (Mac OS uniquement) Si omis : taille de la data fork, si passé : taille de la resource fork |
