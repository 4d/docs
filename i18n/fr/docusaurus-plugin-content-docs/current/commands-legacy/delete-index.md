...
| --- | --- | --- | --- |
| ptrChp &#124; nomIndex | Pointeur, Chaîne | &rarr; | Pointeur vers le champ duquel supprimer les index ou Nom de l’index à supprimer |
| * | Opérateur | &rarr; | Si passé = opération asynchrone |
