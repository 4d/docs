...
| --- | --- | --- | --- |
| pages | Text array | &larr; | Noms des pages les plus consultées |
| hits | Integer array | &larr; | Nombre de hits pour chaque page |
| usage | Integer | &larr; | Pourcentages du cache utilisé |
