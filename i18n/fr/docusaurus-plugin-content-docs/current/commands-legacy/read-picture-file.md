...
| --- | --- | --- | --- |
| nomFichier | Text | &rarr; | Nom ou chemin d’accès complet du fichier à lire, ou chaîne vide |
| image | Picture | &larr; | Champ ou variable recevant l’image |
| * | Opérateur | &rarr; | Si passé = accepter tout type de fichier |
