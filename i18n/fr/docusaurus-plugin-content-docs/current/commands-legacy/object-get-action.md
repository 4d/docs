...
<!--REF #_command_.OBJECT Get action.Syntax-->**OBJECT Get action** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| objet | any | &srarr; | Nom de l'objet (si * est spécifié) ou <br/>Champ ou variable (si * est omis) |
| Résultat | Text | &larr; | Nom de l'action standard associée et (s'il existe) son paramètre chaîne. |
