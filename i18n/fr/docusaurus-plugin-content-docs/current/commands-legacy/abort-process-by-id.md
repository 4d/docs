...
Dans le paramètre *uniqueID*, passez l'ID unique du process que vous souhaitez stopper sur le serveur. Vous pouvez récupérer l'ID du process à l'aide des commandes [Process activity](./commands/process-activity) ou [Process info](./commands/process-info).
