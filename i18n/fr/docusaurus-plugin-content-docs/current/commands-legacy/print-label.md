...
| nomFichier | Text | &srarr; | Nom de fichier d'étiquettes sur disque |
| * &#124; > | &srarr; | * pour supprimer les boîtes de dialogue d'impression ou > pour ne pas réinitialiser les paramètres d'impression |
