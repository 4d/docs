...
| saisissable | Boolean | &srarr; | Vrai = Saisissable, Faux = Non-saisissable |
| style | Integer | &srarr; | Style de police pour l'élément |
| icône | Text, Integer | &srarr; | Nom ou numéro d'image ("" ou 0 pour ne pas associer d'icône) |
| couleur | Integer | &srarr; | Valeur de couleur RVB ou -1 = rétablir couleur originale |
