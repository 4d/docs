...
| --- | --- | --- | --- |
| option | Integer | &rarr; | Numéro d’option à définir |
| valeur | Boolean | &rarr; | Nouvelle valeur de l’option |
| * | Opérateur | &rarr; | Si passé : la modification ne s’applique qu’à l’appel suivant |
