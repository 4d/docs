...
| --- | --- | --- | --- |
| racine | Text | &rarr; | Nom de l’élément racine |
| nameSpace | Text | &rarr; | Valeur de l’espace de nommage (Namespace) |
| nSNom | Text | &rarr; | Nom d’espace de nommage |
| nSValeur | Text | &rarr; | Valeur d’espace de nommage |
