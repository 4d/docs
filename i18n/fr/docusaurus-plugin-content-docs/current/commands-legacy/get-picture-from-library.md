...
| --- | --- | --- | --- |
| refImage &#124; nomImage | Entier long, Chaîne | &rarr; | Numéro de référence ou Nom d'une image de la bibliothèque d’images |
| image | Picture | &larr; | Image de la bibliothèque d'images |
