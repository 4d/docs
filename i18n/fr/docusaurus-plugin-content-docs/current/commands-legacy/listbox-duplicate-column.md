...
| objet | any | &rarr; | Nom d'objet (si * est spécifié) ou Variable (si * est omis) de la colonne à dupliquer |
| positionCol | Integer | &rarr; | Emplacement de la nouvelle colonne dupliquée |
| nomCol | Text | &rarr; | Nom de la nouvelle colonne |
...
| varEntête | Integer, Pointer | &rarr; | Variable d’en-tête de la colonne |
