...
| réfElément | Integer | &rarr; | Numéro de référence d'élément ou 0 pour le dernier élément ajouté à la liste |
| tabRéfs | Integer array | &rarr; | Tableau de numéros de référence d’éléments |
