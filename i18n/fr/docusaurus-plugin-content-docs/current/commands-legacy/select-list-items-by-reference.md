...
| réfElément | Integer | &srarr; | Numéro de référence d'élément ou 0 pour le dernier élément ajouté à la liste |
| tabRéfs | Integer array | &srarr; | Tableau de numéros de référence d’éléments |
