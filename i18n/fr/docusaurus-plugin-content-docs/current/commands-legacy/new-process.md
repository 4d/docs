...
| --- | --- | --- | --- |
| méthode | Text | &srarr; | Méthode à exécuter dans le process |
...
| Résultat | Integer | &larr; | Numéro du process nouvellement créé ou du process déjà en cours d'exécution |
