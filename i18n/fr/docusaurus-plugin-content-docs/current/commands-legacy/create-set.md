...
| --- | --- | --- | --- |
| laTable | Table | &rarr; | Table pour laquelle vous voulez créer un ensemble à partir de la sélection courante ou Table par défaut si ce paramètre est omis |
| ensemble | Text | &rarr; | Nom du nouvel ensemble |
