...
| objet | any | &rarr; | Nom d'objet (si * spécifié) ou Table ou Champ ou Variable (si * omis) |
| saisissable | Boolean, Integer | &rarr; | Booléen : Vrai=saisissable, Faux=non saisissable<br/>Entier long : 0=non saisissable, 1=saisissable, 2=non saisissable non focusable |
