...
| --- | --- | --- | --- |
| valeur | Object, any | &srarr; | Données à convertir en chaîne JSON |
| * | Opérateur | &srarr; | Améliorer la présentation |
| Résultat | Text | &larr; | Chaîne contenant le texte JSON sérialisé |
