...
| --- | --- | --- | --- |
| laTable | Table | &srarr; | Table de l'enregistrement de destination ou Table par défaut si ce paramètre est omis |
| enregistrement | Integer | &srarr; | Numéro renvoyé par Numero enregistrement |
