...
<!--REF #_command_.OBJECT Get context menu.Syntax-->**OBJECT Get context menu** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| Résultat | Boolean | &larr; | Vrai = menu contextuel activé, <br/>Faux = menu contextuel désactivé |
