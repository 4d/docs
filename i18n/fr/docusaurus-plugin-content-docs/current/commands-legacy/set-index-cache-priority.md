...
| --- | --- | --- | --- |
| leField | Field | &rarr; | Champ dont vous voulez modifier la priorité des index pour toute la session |
| priorité | Integer | &rarr; | Priorité du ou des index du champ dans le cache |
