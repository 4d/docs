...
| --- | --- | --- | --- |
| typeSortie | Integer | &rarr; | Type de sortie du message |
| message | Text | &rarr; | Contenu du message |
| importance | Integer | &rarr; | Niveau d’importance du message (Windows uniquement) |
