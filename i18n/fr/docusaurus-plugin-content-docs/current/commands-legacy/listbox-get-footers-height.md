...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( {* ;} *objet* {; *unité*} ) -> Résultat<!-- END REF-->
...
| unité | Integer | &rarr; | Unité de la valeur de hauteur : <br/>0 ou omis = pixels, 1 = lignes |
