...
<!--REF #_command_.LISTBOX Get row height.Syntax-->**LISTBOX Get row height** ( {* ;} *objet* ; *ligne* ) -> Résultat<!-- END REF-->
...
| ligne | Integer | &rarr; | Ligne de la List box dont on veut récupérer la hauteur |
