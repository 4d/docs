...
| --- | --- | --- | --- |
| source | Text | &rarr; | Chaîne dans laquelle effectuer l'insertion |
| insertion | Text | &rarr; | Chaîne à insérer dans source |
| positionDépart | Integer | &rarr; | Position de l'insertion |
