...
| données | Text, Variable | &srarr; | Texte ou variable à insérer dans le document |
| * | Opérateur | &srarr; | Si passé = Encoder les caractères spéciaux en mode 'XML Données brutes' |
