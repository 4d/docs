...
<!--REF #_command_.Get list item font.Syntax-->**Get list item font** ( {* ;} *liste* : Integer, Text ; *refElément* : Entier long, Opérateur ) : Text<br/>**Get list item font** ( * ; *liste* : Integer, Text ; * ) : Text<!-- END REF-->
