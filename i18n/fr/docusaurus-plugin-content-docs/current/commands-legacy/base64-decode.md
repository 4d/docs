...
| --- | --- | --- | --- |
| àDécoder | Text, Blob | &srarr; | Valeur encodée à décoder |
| &harr; | Valeur décodée (si le paramètre décodé est omis) |
| décodé | Text, Blob | &harr; | Valeur décodée |
| * | Opérateur | &srarr; | Décoder au format Base64URL |
