...
| --- | --- | --- | --- |
| nomArray | Array | &rarr; | Nom du tableau |
| taille | Integer | &rarr; | Nombre d'éléments du tableau ou Nombre de tableaux si taille2 est spécifié |
| taille2 | Integer | &rarr; | Nombre d'éléments des tableaux à deux dimensions |
