...
| largeur | Integer | &rarr; | Largeur de colonne (en pixels) |
| largeurMini | Integer | &rarr; | Largeur minimale de colonne (en pixels) |
| largeurMaxi | Integer | &rarr; | Largeur maximale de colonne (en pixels) |
