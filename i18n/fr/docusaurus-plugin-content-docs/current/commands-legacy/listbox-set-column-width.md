...
| largeur | Integer | &srarr; | Largeur de colonne (en pixels) |
| largeurMini | Integer | &srarr; | Largeur minimale de colonne (en pixels) |
| largeurMaxi | Integer | &srarr; | Largeur maximale de colonne (en pixels) |
