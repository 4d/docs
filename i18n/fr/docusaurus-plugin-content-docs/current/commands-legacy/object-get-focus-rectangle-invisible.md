...
<!--REF #_command_.OBJECT Get focus rectangle invisible.Syntax-->**OBJECT Get focus rectangle invisible** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| Résultat | Boolean | &larr; | Vrai = rectangle focus caché, Faux = rectangle focus visible |
