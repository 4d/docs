...
| xPath | Text | &rarr; | Chemin XPath de l’élément XML |
| valeurElément | Text, Variable | &rarr; | Nouvelle valeur de l’élément |
| * | Opérateur | &rarr; | Si passé : définir la valeur en CDATA |
