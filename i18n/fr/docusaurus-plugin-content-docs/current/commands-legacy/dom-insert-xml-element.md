...
| refElémentSource | Text | &srarr; | Référence de l’élément XML à insérer |
| indexEnfant | Integer | &srarr; | Index de l’enfant de l’élément cible avant lequel le nouvel élément doit être inséré |
