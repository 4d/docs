...
| --- | --- | --- | --- |
| laTable | Table | &srarr; | Table dans laquelle aller à l'enregistrement spécifié ou Table par défaut si ce paramètre est omis |
| enregistrement | Integer | &srarr; | Position de l'enregistrement dans la sélection |
