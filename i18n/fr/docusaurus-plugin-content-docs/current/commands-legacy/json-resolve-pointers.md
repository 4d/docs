...
| --- | --- | --- | --- |
| objet | Object | &rarr; | Objet contenant des pointeurs JSON à résoudre |
| &larr; | Objet avec pointeurs JSON résolus (uniquement si Résultat est un objet) |
| options | Object | &rarr; | Options pour la résolution des pointeurs |
