...
| --- | --- | --- | --- |
| laTable | Table | &srarr; | Table de laquelle réduire la sélection ou Table par défaut si ce paramètre est omis |
| nombre | Integer | &srarr; | Nombre d'enregistrements à conserver |
