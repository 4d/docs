...
<!--REF #_command_.SELECT LIST ITEMS BY POSITION.Syntax-->**SELECT LIST ITEMS BY POSITION** ( {* ;} *liste* : Integer, Text ; *positionElém* : Integer {; *tabPositions* : Integer array} )<!-- END REF-->
