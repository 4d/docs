...
| --- | --- | --- | --- |
| leChamp | Texte, BLOB, Image | &#x1F852; | Champ pour lequel définir le lieu de stockage |
| chemin | Texte, Entier long | &#x1F852; | Chemin d’accès et nom du fichier de stockage externe ou<br/>0 = utiliser la définition en structure<br/>1 = utiliser le dossier par défaut |
