...
| --- | --- | --- | --- |
| leChamp | Text, Blob, Picture | &rarr; | Champ pour lequel définir le lieu de stockage |
| chemin | Text, Integer | &rarr; | Chemin d’accès et nom du fichier de stockage externe ou<br/>0 = utiliser la définition en structure<br/>1 = utiliser le dossier par défaut |
