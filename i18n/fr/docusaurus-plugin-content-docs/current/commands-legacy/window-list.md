...
| --- | --- | --- | --- |
| fenêtres | Array | &larr; | Tableau des numéros de référence des fenêtres |
| * | Opérateur | &rarr; | Si omis, ignorer fenêtres flottantes Si spécifié, tenir compte des fenêtres flottantes |
