...
| --- | --- | --- | --- |
| fenêtres | Array | &harr; | Tableau des numéros de référence des fenêtres |
| * | Opérateur | &srarr; | Si omis, ignorer fenêtres flottantes Si spécifié, tenir compte des fenêtres flottantes |
