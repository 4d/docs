...
| --- | --- | --- | --- |
| cheminAccès | Text | &srarr; | Nom ou chemin d’accès du fichier d’historique à intégrer |
| numOpération | Real | &srarr; | Numéro de la dernière opération intégrée ou -2 pour tout intégrer |
| &harr; | Nouveau numéro de la dernière opération intégrée |
| mode | Integer | &srarr; | 0=mode strict (mode par défaut), 1=mode réparation auto |
| objErreur | Object | &harr; | Opération(s) manquante(s) |
