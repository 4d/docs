...
| --- | --- | --- | --- |
| laTable | Table | &rarr; | Table à utiliser ou Table par défaut si ce paramètre est omis |
| nomFichier | Text | &rarr; | Document d'état rapide à charger |
| nomMéthode | Text | &rarr; | Nom de la méthode à appeler |
| * | Opérateur | &rarr; | Suppression des boîtes de dialogue d'impression |
