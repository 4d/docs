...
<!--REF #_command_.OBJECT Get data source.Syntax-->**OBJECT Get data source** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| Résultat | Pointer | &larr; | Pointeur vers la source de données courante de l’objet |
