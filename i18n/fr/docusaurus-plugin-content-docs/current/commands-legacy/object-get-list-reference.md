...
<!--REF #_command_.OBJECT Get list reference.Syntax-->**OBJECT Get list reference** ( {* ;} *objet* {; *typeListe*} ) -> Résultat<!-- END REF-->
...
| Résultat | Integer | &larr; | Numéro de référence de la liste |
