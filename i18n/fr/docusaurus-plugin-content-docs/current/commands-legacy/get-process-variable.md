...
<!--REF #_command_.GET PROCESS VARIABLE.Syntax-->**GET PROCESS VARIABLE** ( *process* : Integer ; *varSource* : Variable ; *varDestination* : Variable {; ...(*varSource* : Variable, *varDestination* : Variable)} )<!-- END REF-->
