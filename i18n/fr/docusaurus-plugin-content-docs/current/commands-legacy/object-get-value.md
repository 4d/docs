...
<!--REF #_command_.OBJECT Get value.Syntax-->**OBJECT Get value** ( *nomObjet* ) -> Résultat<!-- END REF-->
<!--REF #_command_.OBJECT Get value.Params-->
| Paramètre | Type |  | Description |
| --- | --- | --- | --- |
| nomObjet | Text | &rarr; | Nom de l'objet |
| Résultat | any | &larr; | Valeur courante des sources de données de l'objet de formulaire |
