...
| position | Integer | &srarr; | Nouvelle position du taquet |
| * | Opérateur | &srarr; | Si passé = déplacer les marqueurs suivants Si omis = ne pas déplacer les marqueurs suivants |
