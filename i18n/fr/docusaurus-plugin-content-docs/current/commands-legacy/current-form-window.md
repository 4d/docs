...
La fenêtre du formulaire courant peut avoir été générée automatiquement par une commande telle que [ADD RECORD](add-record.md), à la suite d’une action utilisateur ou via les commandes [Open window](./commands/open-window) ou [Open form window](./commands/open-form-window). 
