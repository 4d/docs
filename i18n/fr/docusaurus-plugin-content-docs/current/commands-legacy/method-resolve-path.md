...
| --- | --- | --- | --- |
| chemin | Text | &rarr; | Chemin à résoudre |
| typeMéthode | Integer | &larr; | Sélecteur de type d’objet |
| ptrTable | Pointer | &larr; | Référence de table |
| nomObjet | Text | &larr; | Nom de formulaire ou de méthode base |
