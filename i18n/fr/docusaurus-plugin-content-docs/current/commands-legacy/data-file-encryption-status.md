...
| --- | --- | --- | --- |
| cheminStructure | Text | &srarr; | Chemin d'accès du fichier de structure à vérifier |
| cheminDonnées | Text | &srarr; | Chemin d'accès du fichier de données 4D à vérifier |
