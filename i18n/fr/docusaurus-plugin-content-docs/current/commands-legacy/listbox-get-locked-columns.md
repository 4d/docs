...
<!--REF #_command_.LISTBOX Get locked columns.Syntax-->**LISTBOX Get locked columns** ( {* ;} *objet* ) -> Résultat<!-- END REF-->
...
| Résultat | Integer | &larr; | Nombre de colonnes verrouillées |
