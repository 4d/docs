...
| --------------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `onData`<br>(ou `formula`) | 4D.Function | Une fonction à appeler de manière asynchrone lors de la réception d'un bloc de données.<br>*S'assurer que le process courant ne se termine pas.* |
