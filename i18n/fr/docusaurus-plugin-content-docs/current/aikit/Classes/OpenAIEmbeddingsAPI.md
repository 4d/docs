...
| *model*      | Text                                                        | Le [modèle à utiliser](https://developers.openai.com/api/docs/guides/embeddings#embedding-models). Prend en charge [provider:model aliases](../provider-model-aliases.md). |
