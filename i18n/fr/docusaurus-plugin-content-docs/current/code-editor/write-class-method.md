...
- Dans le dossier 4D actif de la machine. Les macros sont alors partagées pour toutes les bases.
  **Note :** L’emplacement du dossier 4D actif varie en fonction du système d’exploitation. Pour plus d’informations, reportez-vous à la description de la commande [Get 4D folder](../commands-legacy/get-4d-folder) dans le *manuel Langage de 4D*.
...
| `<method_path/>`       | Balise remplacée par la syntaxe du chemin (tel que retourné par [`METHOD Get path`](../commands-legacy/method-get-path)) de la méthode courante.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
