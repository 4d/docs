...
| `Error`, `Error line`           | Integer | Voir [Gestion des erreurs dans la méthode](../Concepts/error-handling.md#handling-errors-within-the-method). Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `Error method`, `Error formula` | Text    | Voir [Gestion des erreurs dans la méthode](../Concepts/error-handling.md#handling-errors-within-the-method). Utilisées dans une méthode d'interception d'erreurs installée par la commande [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
