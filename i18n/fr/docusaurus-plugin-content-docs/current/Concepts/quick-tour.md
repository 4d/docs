...
Ce code affichera une boîte de dialogue d'alerte standard contenant le message "Hello, World!" et un bouton OK. To execute the code, you just need to click on the execution button in the Code Editor:
