...
- les caractères `{ }` (accolades) indiquent des paramètres facultatifs. For example, `.delete({ option : Integer })` means that the *option* parameter may be omitted when calling the function.
