...
| Release | Modifications                                |
| ------- | -------------------------------------------- |
| 21 R2   | prise en charge de removeFluentUI            |
| 20 R9   | Lecture des UUIDs dans les exécutables macOS |
...
| ProductName      | Text    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ProductVersion   | Text    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| removeFluentUI   | Boolean | Ne peut être utilisé qu'avec une application 4D fusionnée (fichier .exe). Passez True pour remplacer le *manifest* faisant référence au Windows App SDK intégré (requis pour le [rendu Fluent UI](../FormEditor/forms.md#fluent-ui-rendering)) et le fichier *.pri* par des versions permettant l'utilisation d'un Windows App SDK installé dans le système d'exploitation. L'utilisation d'un SDK local permet de réduire la taille de l'application générée (vous devez également supprimer les fichiers intégrés par défaut). Le fait de passer False ou d'omettre la propriété n'a aucun effet. |
