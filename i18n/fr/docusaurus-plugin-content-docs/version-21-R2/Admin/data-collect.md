...
| numberOfFields                                              | Number                                   | Nombre de champs                                                                                                                     |
| numberOfKeepRecordSyncInfo                                  | Number                                   | Nombre de tables dont l'option "Activer la réplication" est cochée                                                                   |
| numberOfRecordsMax                                          | Number                                   | Nombre total d'enregistrements                                                                                                       |
| numberOfTables                                              | Number                                   | Nombre de tables                                                                                                                     |
...
| SQLServer                                                   | Number                                   | Nombre de requêtes SQL via le réseau                                                                                                 |
