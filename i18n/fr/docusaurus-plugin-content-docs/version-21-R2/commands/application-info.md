...
| IPAddressesToListen                                                              | collection | Serveur 4D uniquement. Serveur 4D uniquement. Pour plus d'informations, voir [Configuration IP](../settings/client-server.md#ip-configuration-page).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | \["192.168.18.12","192.168.18.10"\]                             |
