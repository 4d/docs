...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Déposer ou Coller                                                                                                                                                                    | Si l'image a :<ul><li>**72dpi ou 96dpi** - L'image est formatée en "[Center](FormObjects/properties_Picture.md#center--truncated-non-centered)" et l'objet contenant l'image a le même nombre de pixels.</li><li>**Autre dpi** - L'image est formatée en "[Scaled to fit](FormObjects/properties_Picture.md#scaled-to-fit)" et l'objet contenant l'image est égal au (nombre de pixels de l'image \* dpi) / (dpi) de l'image</li> <li>**Pas de dpi** - L'image est formatée en "[Scaled to fit](FormObjects/properties_Picture.md#scaled-to-fit)".</li></ul> |
| [Taille automatique](https://doc.4d.com/4Dv20/4D/20.2/Setting-object-display-properties.300-6750143.en.html#148057) (menu contextuel de l'éditeur de formulaires) | Si le format d'affichage de l'image est :<ul><li>**[Scaled](FormObjects/properties_Picture.md#scaled-to-fit)** - L'objet contenant l'image est redimensionné en fonction du (nombre de pixels de l'image \* dpi écran) / (dpi image </li> <li>) **Not scaled** - L'objet contenant l'image a le même nombre de pixels que l'image.</li></ul>                                                                                                                                                                                                                                 |
