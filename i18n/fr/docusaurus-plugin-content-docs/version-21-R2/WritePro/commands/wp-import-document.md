...
- Dans le paramètre *filePath*, indiquez le chemin d'accès d'un document stocké sur le disque. Vous devez passer un chemin d'accès complet, sauf si le document est situé au même niveau que le dossier Project, auquel cas vous pouvez simplement passer son nom.
...
- anciens documents 4D Write (.4w7 ou .4wt). Documents au format 4D Write Pro (.4wp).
- Documents au format 4D Write Pro (.4wp). anciens documents 4D Write (.4w7 ou .4wt).
- Documents au format .docx. Pour plus d'informations, voir *Importer et exporter au format .docx*.

**Note :** Si vous souhaitez importer un document stocké dans un champ BLOB 4D, vous pouvez également utiliser la commande [WP New](../commands-legacy/wp-new.md).
...
| sections                | Text     | Pour les documents MS Word (.docx) uniquement. Pour les documents MS Word (.docx) uniquement. Valeurs disponibles :<br/><br/> **all** (par défaut) - Toutes les sections sont importées. Les sections continues, paires ou impaires sont converties en sections standard. **ignore** \- Les sections sont converties en sections par défaut de 4D Write Pro (format A4 portrait sans en-tête ni pied de page). **Note** : Les sauts de section de tout type sauf continus sont convertis en sauts de section avec saut de page. Les sauts de section continus sont importés en tant que sauts de section continus.                                                                                                                                                       |
