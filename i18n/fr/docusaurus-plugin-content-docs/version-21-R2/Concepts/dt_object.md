...
- en utilisant la commande [`New object`](./commands/new-object),
- en utilisant l'opérateur `{}`.

:::info

Plusieurs commandes et fonctions 4D renvoient des objets, par exemple [`Database measures`](./commands/database-measures) ou [`File`](./commands/file). Dans ce cas, il n'est pas nécessaire d'instancier explicitement l'objet, le langage 4D le fait pour vous.

:::

### Commande `New object`

La commande [`New object`](./commands/new-object) crée un nouvel objet vide ou pré-rempli et renvoie sa référence.
