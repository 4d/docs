...
<!--REF #_command_.DOM Get previous sibling XML element.Syntax-->**DOM Get previous sibling XML element** ( *refElément* : Text {; *nomElémentFrère* : Text {; *valeurElémentFrère* : Text}} ) : Text<!-- END REF-->
