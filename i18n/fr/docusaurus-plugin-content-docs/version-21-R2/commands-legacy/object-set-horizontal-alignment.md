...
<!--REF #_command_.OBJECT SET HORIZONTAL ALIGNMENT.Syntax-->**OBJECT SET HORIZONTAL ALIGNMENT** ( * ; *objet* : Text ; *alignement* : Integer )<br/>**OBJECT SET HORIZONTAL ALIGNMENT** ( *objet* : Field, Variable ; *alignement* : Integer )<!-- END REF-->
