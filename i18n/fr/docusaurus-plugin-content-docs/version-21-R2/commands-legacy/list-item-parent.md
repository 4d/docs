...
<!--REF #_command_.List item parent.Syntax-->**List item parent** ( {* ;} *liste* : Integer, Text ; *refElément* : Opérateur, Entier long ) : Integer<br/>**List item parent** ( * ; *liste* : Integer, Text ; * ) : Integer<!-- END REF-->
