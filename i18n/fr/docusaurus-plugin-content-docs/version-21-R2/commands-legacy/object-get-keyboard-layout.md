...
<!--REF #_command_.OBJECT Get keyboard layout.Syntax-->**OBJECT Get keyboard layout** ( * ; *objet* : Text ) : Text<br/>**OBJECT Get keyboard layout** ( *objet* : Field, Variable ) : Text<!-- END REF-->
