...
Avant d’appeler la commande **Print object**, vous devez désigner le formulaire table ou projet contenant les objets à imprimer, à l’aide de la commande [FORM LOAD](./commands/form-load). 
