...
<!--REF #_command_.LISTBOX Get number of rows.Syntax-->**LISTBOX Get number of rows** ( * ; *objet* : Text ) : Integer<br/>**LISTBOX Get number of rows** ( *objet* : Field, Variable ) : Integer<!-- END REF-->
