...
Le nom du formulaire est défini par le nom du dossier qui contient le fichier form.4Dform. Voir la page [Architecture d'un projet](Project/architecture#sources) pour plus d'informations.
