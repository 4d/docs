...
-   4D : cliquez sur le bouton **Vider le cache**dans la page[Web/Options (I)](../settings/web.md) de la boîte de dialogue Propriétés.
-   4D Server : cliquez sur le bouton **Vider le cache** dans la page HTTP de la fenêtre d'administration de 4D Server.
