...
- ***paramètre web*** signifie que le mode préemptif dépend d'un paramétrage :
    - lorsque l'option [**Sessions évolutives**](sessions.md#enabling-sessions) est sélectionnée, le mode préemptif est automatiquement utilisé pour les process web.
