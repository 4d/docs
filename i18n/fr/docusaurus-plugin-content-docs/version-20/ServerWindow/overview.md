...
> La fenêtre d'administration de 4D Server est accessible depuis un 4D distant. Pour plus d'informations sur ce point, veuillez vous référer à la page [Administration depuis des machines distantes](remote-admin.md).
