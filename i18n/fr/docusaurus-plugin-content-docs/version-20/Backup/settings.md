...
> Les propriétés définies dans cette boîte de dialogue sont écrites dans le fichier *Backup.4DSettings*, stocké dans le dossier [Settings](Project/architecture.md#settings-user).
