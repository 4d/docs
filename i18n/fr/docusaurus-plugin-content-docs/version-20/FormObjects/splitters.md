...
Une fois inséré, un séparateur se présente sous la forme d’un trait. Vous pouvez modifier son [style de bordure](properties_BackgroundAndBorder.md#border-line-style) pour obtenir une ligne plus fine ou [changer sa couleur](properties_BackgroundAndBorder.md#line-color).
