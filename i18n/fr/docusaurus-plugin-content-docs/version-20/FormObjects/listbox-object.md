...
| On Close Detail      | <li>[row](#additional-properties)</li>                                                                                                                                                                         | *List box Sélection courante et Sélection temporaire uniquement*                                                                                                                   |
...
| On Footer Click      | <li>[column](#additional-properties)</li><li>[columnName](#additional-properties)</li><li>[footerName](#additional-properties)</li>                                                                            | *Listbox tableau, sélection courante et sélection temporaire uniquement*                                                                                                           |
...
| On Open Detail       | <li>[row](#additional-properties)</li>                                                                                                                                                                         | *List box Sélection courante et Sélection temporaire uniquement*                                                                                                                   |
