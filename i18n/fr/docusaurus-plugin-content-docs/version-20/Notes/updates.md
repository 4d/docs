...
À partir de la "nightly build" **101734**, la boîte de dialogue Build application comporte une nouvelle option permettant de construire des applications d'évaluation. Voir sa [description dans la documentation 4D Rx](../../../docs/Desktop/building#build-an-evaluation-application).
