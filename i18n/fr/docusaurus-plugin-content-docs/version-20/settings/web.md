...
- **Autoriser requêtes Web Services** : Cette option permet d’initialiser la publication de Web Services. Lorsque cette option est cochée, 4D crée le fichier WSDL. Lorsque cette option est cochée, 4D crée le fichier WSDL.
