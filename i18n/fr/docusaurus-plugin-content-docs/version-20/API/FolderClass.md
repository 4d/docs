...
Dans le paramètre *path*, passez un chemin de dossier. Vous pouvez utiliser une chaîne personnalisée ou un [filesystem](../Concepts/paths.md#filesystem-pathnames) (par exemple, "/DATA").
