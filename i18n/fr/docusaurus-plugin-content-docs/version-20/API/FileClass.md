...
La fonction `.rename()` <!-- REF #FileClass.rename().Summary -->La fonction `.rename()`<!-- END REF -->.
...
|Paramètre|Type||Description|
|---|---|---|---|---|
|info|Object|->|Propriétés à écrire dans le fichier de ressource de version .exe/.dll ou .plist|
</div>
<!-- END REF -->
