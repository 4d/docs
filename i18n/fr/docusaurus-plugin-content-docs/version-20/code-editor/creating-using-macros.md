...
| `<method_path/>`           | Tag remplacé par le chemin (tel que retourné par [`METHOD Get path`](https://doc.4d.com/4dv19R/help/command/en/page1164.html)) de la méthode courante.                                                                                                                                                                                                                                                                                                                                                                                                                               |
