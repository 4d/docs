...
Objetos que se hacen invisibles utilizando el comando [`OBJECT SET VISIBLE`](../commands/object-set-visible) o la propiedad [Visibilidad](FormObjects/properties_Display.md#visibility) no generan este evento.
