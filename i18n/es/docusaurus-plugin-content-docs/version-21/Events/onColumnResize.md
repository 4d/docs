...
Este evento se genera cuando el ancho de una columna en el list box es modificado por un usuario. Este evento se genera cuando el ancho de una columna en el list box es modificado por un usuario. El evento se activa "en directo", *es decir*, se envía continuamente durante el evento, mientras se redimensiona el list box o la columna en cuestión.
