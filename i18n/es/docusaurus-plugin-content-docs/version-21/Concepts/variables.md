...
| `Error`, `Error line`             | Integer | Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands-legacy/on-err-call.md). Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `Error method`, `Error formula`   | Text    | Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands-legacy/on-err-call.md). Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
