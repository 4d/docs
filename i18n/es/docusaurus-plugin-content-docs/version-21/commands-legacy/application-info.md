...
| remoteDebuggerSessionID     | texto     | El ID de la sesión de la aplicación remota a la que está conectado el depurador del servidor. Este ID también es devuelto por [Process activity](./commands/process-activity).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | "A838A40BJN3NJKH..."                            |
| SDIMode                     | booleano  | True si la aplicación se ejecuta en modo SDI en Windows (inútil en macOS). Valores posibles: true, false. Para más información, consulte [modo SDI](../Menus/sdi.md) en *developer.4d.com*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | true                                            |
