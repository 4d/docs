...
* <!--REF #_command_.Get indexed string.Summary-->Una de las cadenas guardadas en el recurso lista de cadenas (“STR#”) cuyo número de identificación se pasa en *resNum*.<!-- END REF-->
