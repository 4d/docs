...
Si pasa [True](../commands/true) en $result, debe llamar exitosamente al comando [CHANGE CURRENT USER](change-current-user.md) en el Método base On SQL Authentication para que la petición sea aceptada y para que 4D abra una sesión SQL para el usuario. 
