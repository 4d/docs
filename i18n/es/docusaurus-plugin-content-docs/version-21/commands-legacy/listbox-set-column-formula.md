...
**Nota**: utilice el comando [Command name](./commands/command-name) para definir las fórmulas independientes del lenguaje de la aplicación (cuando se llaman los comandos 4D).  
