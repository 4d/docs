...
| ---------------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Paper option                 | 1     | Si sólo utiliza *valor1*, que contiene el nombre del papel. Si se utilizan los dos parámetros, *valor1* contiene el ancho del papel y *valor2* contiene el alto del papel. La anchura y la altura se expresan en puntos. Utilice el comando [PRINT OPTION VALUES](print-option-values.md) para obtener el nombre, el alto y el ancho de todos los formatos de papel que ofrece la impresora.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Una vez fijado utilizando este comando, una opción de impresión se conservará durante toda la sesión para toda la aplicación 4D. Será utilizada por los comandos [PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form) y [QR REPORT](qr-report.md) y [WP PRINT](../WritePro/commands-legacy/wp-print.md), así como también para todas las impresiones 4D, incluyendo en modo Diseño.
