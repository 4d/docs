...
| networked  | boolean | <li>True: el almacén de datos se alcanza a través de una conexión de red.</li><li>False: the datastore is not reached through a network connection (local database)</li>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
