...
| storeCertificateName   | Text    | indefinido                                                                                                                                            | (Sólo para Windows) Nombre de la tienda de certificados del SO (p.ej. "LocalMachine") desde donde usar certificados en lugar de los que se encuentran en la carpeta de certificados para las solicitudes que utilizan el agente. Si no se encuentra el almacén de certificados, se devuelve un error. Para más información, consulte [esta entrada de blog](https://blog.4d.com/https-requests-now-support-windows-certificate-store). |
