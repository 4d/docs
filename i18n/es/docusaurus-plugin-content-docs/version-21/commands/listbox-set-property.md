...
| lk meta expression             | 34    | Propiedad **[Meta Info Expression](../FormObjects/properties_Text.md#meta-info-expression)** para los list box de tipo selección colección o entity selection<br/>Se aplica a: List box                                                                                                                                                                                                                                                                                                                                                                |
