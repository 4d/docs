...
Si desea "forzar" la liberación de un objeto en cualquier momento, utilice `.shutdown()` o la función `terminate()`; esto desencadena el evento `onTerminate` y libera el objeto.
