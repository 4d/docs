...
| ------------------------------------------------------------------------------ | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [This](./commands/this).title                              | Text   | Título definido en el atributo wk title                                                                                                                                                                                                                                                                                                                                                                     |
| [This](./commands/this).author                             | Text   | Autor definido en el atributo wk author                                                                                                                                                                                                                                                                                                                                                                     |
| [This](./commands/this).subject                            | Text   | Asunto definido en el atributo wk subject                                                                                                                                                                                                                                                                                                                                                                   |
| [This](./commands/this).company                            | Text   | Empresa definida en el atributo wk company                                                                                                                                                                                                                                                                                                                                                                  |
| [This](./commands/this).notes                              | Text   | Notas definidas en el atributo wk notes                                                                                                                                                                                                                                                                                                                                                                     |
| [This](./commands/this).dateCreation                       | Fecha  | Fecha de creación definida en el atributo wk date creation                                                                                                                                                                                                                                                                                                                                                  |
| [This](./commands/this).dateModified                       | Fecha  | Fecha de modificación definida en el atributo wk date modified                                                                                                                                                                                                                                                                                                                                              |
| [This](./commands/this).pageNumber (\*) | Number | Número de página tal y como está definido<li>:- Desde el inicio del documento (por defecto) o </li><li>- Desde el inicio de página de sección si está definido por inicio de página de sección.</li> Esta fórmula siempre es dinámica; no se ve afectada por el comando [**FORMULAS WP FREEZE**](commands-legacy/wp-freeze-formulas.md). |
| [This](./commands/this).pageCount (\*)  | Number | Número de páginas: número total de páginas.<br/> Esta fórmula siempre es dinámica; no se ve afectada por el comando [**FORMULAS WP FREEZE**](commands-legacy/wp-freeze-formulas.md).                                                                                                                                                                        |
| [This](./commands/this).document                           | Object | Documento 4D Write Pro                                                                                                                                                                                                                                                                                                                                                                                      |
| [This](./commands/this).data                               | Object | Contexto de datos del documento 4D Write Pro definido por [**WP SET DATA CONTEXT**](commands-legacy/wp-set-data-context.md)                                                                                                                                                                                                                                                                                 |
| [This](./commands/this).sectionIndex                       | Number | El índice de la sección en el documento 4D Write Pro a partir de 1                                                                                                                                                                                                                                                                                                                                          |
| [This](./commands/this).pageIndex                          | Number | El número de página real en el documento 4D Write Pro a partir de 1 (independientemente de los números de página de la sección)                                                                                                                                                                                                                                                          |
| [This](./commands/this).sectionName                        | String | El nombre que el usuario da a la sección                                                                                                                                                                                                                                                                                                                                                                    |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| En cualquier sitio                                                                                                                                               | [This](./commands/this).table                            | Object                                                            | Tabla actual                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                  | [This](./commands/this).row                              | Object                                                            | Current table row element                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                                                                                                                                                  | [This](./commands/this).rowIndex                         | Number                                                            | Índice de la línea actual, a partir de 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Cuando se ha definido una fuente de datos para la tabla                                                                                                          | [This](./commands/this).table.dataSource | Objet (fórmula)                                | Fuente de datos como fórmula                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                  | [This](./commands/this).tableData                        | Collection o Entity selection (por lo general) | table.dataSource evaluada                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| En cada fila de datos cuando una fuente de datos tabla devuelve una colección o una selección de entidades                                                       | [This](./commands/this).item.xxx         | Cualquiera                                                        | Asignado a cada elemento de la colección de fuentes de datos de la tabla o selección de entidades, por ejemplo **This.item.firstName** si la entidad asociada tiene el atributo *firstName*                                                                                                                                                                                                                                                                                                       |
|                                                                                                                                                                  | [This](./commands/this).itemIndex                        | Number                                                            | Índice del elemento actual en la colección o selección de entidades, a partir de 0                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| En cualquier línea (excepto en las líneas de encabezado) cuando una fuente de datos tabla devuelve una colección o una selección de entidades | [This](./commands/this).previousItems                    | Collection o entity selection                                     | Items displayed on the pages before the bottom carry over row (if any) or before the row of the expression, including the page where is displayed the row containing the expression. <br/>Esta expresión devuelve el mismo tipo de valor que la expresión **This.tableData**.                                                                                                                                                                                  |
| In a break row                                                                                                                                                   | [This](./commands/this).breakItems                       | Collection o entity selection                                     | Items of the collection or entity selection displayed in the rows between:<br/><ul><li>the current break row and the previous break row of the same level (or the start of the table) if the break row(s) are displayed after the data row.</li><li>la línea de ruptura actual y la siguiente del mismo nivel (o el final de la tabla) si la línea o líneas de ruptura se muestran antes de la línea de datos.</li></ul> |
