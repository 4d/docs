...
Pase un nombre para la hoja de estilo en el parámetro *nomHojaEstilo*. El nombre de la hoja de estilo se almacena con el documento y facilita reutilizar o modificar el estilo. También se puede utilizar con los comandos [WP Get style sheet](../WritePro/commands/wp-get-style-sheet) y [WP DELETE STYLE SHEET](../WritePro/commands/wp-delete-style-sheet). El nombre de la hoja de estilo debe cumplir las siguientes reglas:
