...
* el objeto hoja de estilo (creado con [WP New style sheet](../WritePro/commands/wp-new-style-sheet) o devuelto por el comando [WP Get style sheet](../WritePro/commands/wp-get-style-sheet)) para eliminar en el parámetro *tipoHojaEstilo*, o
