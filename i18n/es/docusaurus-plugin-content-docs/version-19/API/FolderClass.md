...
> En Windows, en los clientes fusionados, la ubicación de las carpetas integradas se modifica si se utiliza la [llave BuildApp](../Desktop/building.md#build-application-settings) `ShareLocalResourcesOnWindowsClient`.
