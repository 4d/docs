...
| .**accessTokenOAuth2**: cadena Text que representa las credenciales de autorización OAuth 2. Sólo se utiliza con OAUTH2 `authenticationMode`. Si se utiliza `accessTokenOAuth2` pero se omite `authenticationMode`, se utiliza el protocolo OAuth 2 (si el servidor lo permite). Sólo se utiliza con OAUTH2 `authenticationMode`. | ninguno                                                                  |
| [<!-- INCLUDE #transporter.authenticationMode.Syntax -->](#authenticationmode)&nbsp;&nbsp;&nbsp;&nbsp;<!-- INCLUDE #transporter.authenticationMode.Summary -->| el modo de autenticación más seguro se utiliza soportado por el servidor |
...
| **password**: contraseña Text usuario para la autenticación en el servidor. Sólo se utiliza con OAUTH2 `authenticationMode`.                                                                                                                                                                                                      | ninguno                                                                  |
