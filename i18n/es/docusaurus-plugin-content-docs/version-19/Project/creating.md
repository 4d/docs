...
2. Seleccione el archivo `.4dproject` del proyecto y haga clic en **Abrir**. By default, the project is opened with its current data file. Other file types are suggested:
