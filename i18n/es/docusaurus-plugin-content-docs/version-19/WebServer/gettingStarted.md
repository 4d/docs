...
1. Utilizaremos el servidor REST para acceder a los datos: vaya a la caja de diálogo "Configuración", seleccione la página "Recurso Web/Rest" y marque la opción **Exponer como servidor REST**.
