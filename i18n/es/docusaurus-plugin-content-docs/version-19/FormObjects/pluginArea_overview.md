...
Al abrir una aplicación, 4D crea una lista interna de los plug-ins [instalados en su aplicación](../Concepts/plug-ins.md#how-to-install-a-plug-in). Una vez que haya insertado un área de plug-in en un formulario, puede asignar un plug-in al área directamente en la lista **Tipo** en la lista de propiedades:
