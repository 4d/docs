...
| ------------- | --------------------------- | :--------------------------: | ------------------------------------------------------------------------------------------------- |
| formulaString | Text                        | &#x1F852 | Fórmula texto a devolver como objeto                                                              |
| context       | Number                      | &#x1F852 | `sk execute in current database` (por defecto) o `sk execute in host database` |
| Result        | 4D.Function | &#x1F850 | Objeto nativo que encapsula la fórmula                                                            |
