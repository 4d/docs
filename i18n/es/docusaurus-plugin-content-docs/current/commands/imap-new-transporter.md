...
| ---------- | ---------------------------------- | :--------------------------: | --------------------------------------------------------------------------------- |
| server     | Object                             | &#x1F852 | Información del servidor de correo                                                |
| Result     | 4D.IMAPTransporter | &#x1F850 | [IMAP transporter object](../API/IMAPTransporterClass.md#imap-transporter-object) |
...
The function returns an [**IMAP transporter object**](../API/IMAPTransporterClass.md#imap-transporter-object). Todas las propiedades devueltas son de sólo lectura\*\*.
