...
| ---------- | ------- | -------------------------- | -------------------------------------------------------------------------------------- |
| sessionID  | Text    | &#8594 | Session ID                                                                             |
| options    | Integer | &#8594 | Return options                                                                         |
| Resultado  | Object  | &#8592 | Snapshot of running processes and/or (4D Server only) user sessions |
