...
| ---------- | ---------------------------------- | ---------------------------- | ----------------------------------------------------------------------------------------------- |
| dsTable    | Tabla                              | &#x1F852 | Tabla de la base 4D cuya selección actual se utilizará para construir la selección de entidades |
| settings   | Object                             | &#x1F852 | Opciones de construcción: context                                               |
| Resultado  | 4D.EntitySelection | &#x1F850 | Selección de entidades que coinciden con la clase de datos relacionada con la tabla dada        |
