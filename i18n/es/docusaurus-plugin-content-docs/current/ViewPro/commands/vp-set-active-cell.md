...
In *rangeObj*, pass a range containing a single cell as an object (see [VP Cell](vp-cell.md)). Si *rangeObj* no es un rango de celdas o contiene varios rangos, se utiliza la primera celda del primer rango.
