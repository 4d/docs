...
> La página de monitoreo en tiempo real utiliza el comando [`ACTIVITY SNAPSHOT`](https://doc.4d.com/4dv19/help/command/en/page1277.html) internamente. Puede encontrar más información en la descripción de este comando.
