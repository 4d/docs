...
- con 4D en modo remoto, en la carpeta de la base cliente en la máquina remota (para más información sobre la ubicación de esta carpeta, ver el comando [`Get 4D folder`](../commands-legacy/get-4d-folder)). Debe copiar estos archivos manualmente en la máquina remota.
