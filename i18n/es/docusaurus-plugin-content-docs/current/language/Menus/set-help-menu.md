...
| method                      | Text \| [4D.Function](../API/FunctionClass.md#about-4dfunction-objects) | Nombre del método proyecto u objeto fórmula 4D a ejecutar cuando se selecciona el elemento de menú. Cuando se utiliza esta propiedad, no se debe pasar la propiedad "action" (de lo contrario se ignora "method").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
