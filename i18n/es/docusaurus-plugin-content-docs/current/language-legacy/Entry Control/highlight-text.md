...
<!--REF #_command_.HIGHLIGHT TEXT.Syntax-->**HIGHLIGHT TEXT** ( * ; *objeto* : Text ; *inicioSel* : Integer ; *finSel* : Integer )<br/>**HIGHLIGHT TEXT** ( *objeto* : Variable, Field ; *inicioSel* : Integer ; *finSel* : Integer )<!-- END REF-->
