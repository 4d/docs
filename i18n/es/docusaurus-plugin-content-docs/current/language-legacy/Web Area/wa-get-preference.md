...
<!--REF #_command_.WA GET PREFERENCE.Syntax-->**WA GET PREFERENCE** ( * ; *objeto* : Text ; *selector* : Integer ; *valor* : Variable )<br/>**WA GET PREFERENCE** ( *objeto* : Variable, Field ; *selector* : Integer ; *valor* : Variable )<!-- END REF-->
