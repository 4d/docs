...
<!--REF #_command_.DOM Get first child XML element.Syntax-->**DOM Get first child XML element** ( *elementRef* : Text {; *nomElementHijo* : Text {; *valorElementHijo* : any}} ) : Text<!-- END REF-->
