...
<!--REF #_command_.DOM Get last child XML element.Syntax-->**DOM Get last child XML element** ( *elementRef* : Text {; *nomElementHijo* : Text {; *valorElementHijo* : any}} ) : Text<!-- END REF-->
