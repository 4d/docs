...
<!--REF #_command_.SET DOCUMENT PROPERTIES.Syntax-->**SET DOCUMENT PROPERTIES** ( *doc* : Text ; *bloqueado* : Boolean ; *invisible* : Boolean ; *creado el* : Date ; *creado a las* : Time ; *modificado el* : Date ; *modificado a las* : Time )<!-- END REF-->
