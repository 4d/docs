...
* *lengID* recibe los números de ID generados automáticamente y utilizados con el comando [SPELL SET CURRENT DICTIONARY](../commands/spell-set-current-dictionary).  
