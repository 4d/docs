...
<!--REF #_command_.DISTINCT VALUES.Syntax-->**DISTINCT VALUES** ( *unCampo* : Field ; *array* : Array {; *contArray* : Integer array} )<!-- END REF-->
