...
<!--REF #_command_.FORM SCREENSHOT.Syntax-->**FORM SCREENSHOT** ( {{*tabla* : Table ;} *nomForm* : Text ;} *imagForm* : Picture {; *pagNum* : Integer} )<!-- END REF-->
