...
Llamar este comando es necesario cuando se utiliza el comando [FORM LOAD](../commands/form-load) fuera del contexto de impresión (en el caso de la impresión, el formulario actual se cierra de nuevo automáticamente cuando se llama el comando [CLOSE PRINTING JOB](close-printing-job.md)).
