...
Los parámetros asociados a los elementos permiten almacenar información adicional sobre cada elemento. Se definen con la ayuda del comando [SET LIST ITEM PARAMETER](../commands/set-list-item-parameter).
