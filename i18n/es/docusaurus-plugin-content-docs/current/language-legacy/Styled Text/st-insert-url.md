...
<!--REF #_command_.ST INSERT URL.Syntax-->**ST INSERT URL** ( * ; *objeto* : Text ; *textoURL* : Text ; *direccionURL* : Text {; *inicioSel* : Integer {; *finSel* : Integer}} )<br/>**ST INSERT URL** ( *objeto* : Variable, Field ; *textoURL* : Text ; *direccionURL* : Text {; *inicioSel* : Integer {; *finSel* : Integer}} )<!-- END REF-->
