...
<!--REF #_command_.ST SET PLAIN TEXT.Syntax-->**ST SET PLAIN TEXT** ( * ; *objeto* : Text ; *nuevTexto* : Text {; *inicioSel* : Integer {; *finSel* : Integer}} )<br/>**ST SET PLAIN TEXT** ( *objeto* : Variable, Field ; *nuevTexto* : Text {; *inicioSel* : Integer {; *finSel* : Integer}} )<!-- END REF-->
