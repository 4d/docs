...
| folderToZip     | [4D.Folder](../API/FolderClass.md)  | &#8594; | Objeto archivo o carpeta a comprimir                                 |
...
Una vez creado un archivo, puede utilizar el comando [ZIP Read archive](../commands/zip-read-archive) para acceder a él.
