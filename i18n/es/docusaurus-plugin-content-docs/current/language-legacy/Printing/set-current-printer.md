...
Este comando puede utilizarse con los comandos [PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form) y [QR REPORT](qr-report.md), y se aplica a todas las impresiones de 4D, incluyendo en el modo Diseño.  
