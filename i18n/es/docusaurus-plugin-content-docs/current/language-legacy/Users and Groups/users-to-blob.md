...
El BLOB generado se encripta automáticamente y sólo puede ser leído utilizando el comando [BLOB TO USERS](../commands/blob-to-users). Puede almacenar este BLOB en un archivo en su disco duro o en un campo.
