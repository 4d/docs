...
<!--REF #_command_.LISTBOX Get static columns.Syntax-->**LISTBOX Get static columns** ( * ; *objeto* : Text ) : Integer<br/>**LISTBOX Get static columns** ( *objeto* : Variable ) : Integer<!-- END REF-->
...
Las columnas estáticas pueden definirse vía la Lista de propiedades o con la ayuda del comando [LISTBOX SET STATIC COLUMNS](../commands/listbox-set-static-columns).  
