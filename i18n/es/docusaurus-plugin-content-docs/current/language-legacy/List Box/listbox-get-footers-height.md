...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( * ; *objeto* : Text {; *unidad* : Integer} ) : Integer<br/>**LISTBOX Get footers height** ( *objeto* : Variable {; *unidad* : Integer} ) : Integer<!-- END REF-->
