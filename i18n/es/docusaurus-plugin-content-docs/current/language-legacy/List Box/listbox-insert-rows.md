...
<!--REF #_command_.LISTBOX INSERT ROWS.Syntax-->**LISTBOX INSERT ROWS** ( * ; *objeto* : Text ; *posicionL* : Integer {; *numLineas* : Integer} )<br/>**LISTBOX INSERT ROWS** ( *objeto* : Variable ; *posicionL* : Integer {; *numLineas* : Integer} )<!-- END REF-->
