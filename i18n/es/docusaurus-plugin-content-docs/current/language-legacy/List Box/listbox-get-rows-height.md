...
<!--REF #_command_.LISTBOX Get rows height.Syntax-->**LISTBOX Get rows height** ( * ; *objeto* : Text {; *unidad* : Integer} ) : Integer<br/>**LISTBOX Get rows height** ( *objeto* : Variable {; *unidad* : Integer} ) : Integer<!-- END REF-->
