...
<!--REF #_command_.LISTBOX SET STATIC COLUMNS.Syntax-->**LISTBOX SET STATIC COLUMNS** ( * ; *objeto* : Text ; *numColumnas* : Integer )<br/>**LISTBOX SET STATIC COLUMNS** ( *objeto* : Variable ; *numColumnas* : Integer )<!-- END REF-->
