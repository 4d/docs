...
<!--REF #_command_.OBJECT SET TEXT ORIENTATION.Syntax-->**OBJECT SET TEXT ORIENTATION** ( * ; *objeto* : Text ; *orientacion* : Integer )<br/>**OBJECT SET TEXT ORIENTATION** ( *objeto* : Variable, Field ; *orientacion* : Integer )<!-- END REF-->
