...
Puede definir el estilo de línea del borde para un objeto en modo de diseño utilizando la lista de propiedades, o utilizando el comando [OBJECT SET BORDER STYLE](../commands/object-set-border-style).
