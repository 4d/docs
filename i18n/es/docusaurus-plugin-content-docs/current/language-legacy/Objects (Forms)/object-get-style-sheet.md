...
La hoja de estilo puede haber sido asignada en modo Diseño utilizando la lista de propiedades o para el proceso actual usando el comando [OBJECT SET STYLE SHEET](../commands/object-set-style-sheet).  
