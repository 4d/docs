...
<!--REF #_command_.OBJECT SET HELP TIP.Syntax-->**OBJECT SET HELP TIP** ( * ; *objeto* : Text ; *mensajeAyuda* : Text )<br/>**OBJECT SET HELP TIP** ( *objeto* : Variable, Field ; *mensajeAyuda* : Text )<!-- END REF-->
