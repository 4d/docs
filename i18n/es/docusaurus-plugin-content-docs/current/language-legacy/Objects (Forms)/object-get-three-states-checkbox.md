...
La propiedad "Tres estados" se puede definir ya sea usando la lista de propiedades, o utilizando el comando [OBJECT SET THREE STATES CHECKBOX](../commands/object-set-three-states-checkbox) si se llama en el proceso actual.
