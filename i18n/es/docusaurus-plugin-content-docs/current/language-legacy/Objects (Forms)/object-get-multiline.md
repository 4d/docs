...
Puede definir la opción "Multilínea" de un objeto utilizando la lista de propiedades o utilizando el comando [OBJECT SET MULTILINE](../commands/object-set-multiline).  
