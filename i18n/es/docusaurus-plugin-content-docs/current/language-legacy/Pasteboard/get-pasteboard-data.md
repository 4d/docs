...
**Nota:** no puede leer datos de tipo archivo con este comando; para hacer esto, debe utilizar el comando [Get file from pasteboard](../commands/get-file-from-pasteboard).
