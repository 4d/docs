...
<!--REF #_command_.HTTP Get.Syntax-->**HTTP Get** ( *url* : Text ; *respuesta* : Text, Blob, Picture, Object, Collection {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<!-- END REF-->
