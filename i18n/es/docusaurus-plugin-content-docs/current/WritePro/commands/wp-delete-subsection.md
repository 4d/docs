...
| -------------- | ------- | -------------------------- | ---------------------------------------------------------------------------------- |
| wpSection      | Object  | &#8594 | 4D Write Pro section                                                               |
| subSectionType | Longint | &#8594 | Subsection type (wk first page, wk left page, or wk right page) |
| subSection     | Object  | &#8594 | 4D Write Pro subsection                                                            |
