...
<!--REF #_command_.WP Find next.Syntax-->**WP Find next** ( *objTarget* : Object ; *buscarDespues* : Object ; *buscarValor* : Text ; *condicionBusq* : Integer {; *valorReempl* : Text} ) -> Resultado<!-- END REF-->
