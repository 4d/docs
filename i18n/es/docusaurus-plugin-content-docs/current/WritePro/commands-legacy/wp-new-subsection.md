...
| --- | --- | --- | --- |
| wpSection | Object | &rarr; | Sección 4D Write Pro |
| subSectionType | Integer | &rarr; | Tipo de subsección (wk first page, wk left page, o wk right page) |
| Resultado | Object | &larr; | Nueva subsección |
