...
| numCol | Entero largo | &#x1F852; | Número de columna |
| numColumns | Entero largo | &#x1F852; | Número de columnas a insertar (valor predeterminado = 1) |
| Resultado | Objeto | &#x1F850; | Rango de columnas de la tabla |
