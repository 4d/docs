...
4D soporta modos de ejecución **sincrónicas** y **asíncronas**, permitiendo a los desarrolladores elegir el mejor enfoque basado en el rendimiento, la respuesta y la distribución de la carga de trabajo.
