...
Además la recuperación de una sola entidad en una clase de datos utilizando [{dataClass}({key})]({dataClass}.md#key.md), también puede escribir una [función de clase](ClassFunctions.md#function-calls) que devuelva una entity selection (o una colección).
