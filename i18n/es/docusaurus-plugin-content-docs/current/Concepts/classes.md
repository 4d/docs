...
| **Modo remoto 4D**  | Proceso (_nota_: los singletons no están sincronizados en el proceso gemelo) | Máquina remota 4D                | Máquina remota 4D o sesión Web/REST                                            |
