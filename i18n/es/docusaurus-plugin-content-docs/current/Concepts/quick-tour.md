...
| Tipo                                                                            | Definición                                                                                                  | Examples of a 4D command using it                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Fecha                                                                           | A calendar date value.                                                                      | $vDate:=Current date                                                                                                                                                                                                                                                             |
...
| Puntero                                                                         | A reference to another variable, field, or object.                                          | If(Is nil pointer($ptr))                                                                                                                                                                                                                                   |
...
| Array de texto                                                                  | An array containing text values.                                                            | ARRAY TEXT($names;10)                                                                                                                                                                                                                                                         |
