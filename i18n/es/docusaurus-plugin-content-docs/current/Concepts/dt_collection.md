...
| Tipos de elementos de la colección | string                                 | number                                       | number                                 | number                                       | boolean                                      | object o null                              | picture                                      | cadena o fecha según el parámetro [Fechas dentro de objetos](../commands/set-database-parameter#dates-inside-objects-85) | número de segundos                     | 4D.Blob                |   |