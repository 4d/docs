...
- el comando [`WEB GET HTTP HEADER`](../commands/web-get-http-header) devuelve los encabezados de la solicitud. Es útil para manejar cookies personalizadas, por ejemplo (junto con el comando `WEB SET HTTP HEADER`).
