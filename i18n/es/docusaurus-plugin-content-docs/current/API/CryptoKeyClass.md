...
verifica la firma base64 contra la representación utf8 del *mensaje*
<!-- END REF -->
...
La función `.verify()` <!-- REF #CryptoKey.verify().Summary -->verifica la firma base64 contra la representación utf8 del *message*<!-- END REF --> utilizando las llaves del objeto `CryptoKey` y las *opciones* suministradas.
