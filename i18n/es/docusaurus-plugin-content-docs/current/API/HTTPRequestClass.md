...
| certificatesFolder     | [Folder](FolderClass.md)                          | Define la carpeta de certificados de cliente activa. Can be overriden by "storeCertificateName" (see below).                                                                                                                                                                                                                                                                                            | indefinido           |
