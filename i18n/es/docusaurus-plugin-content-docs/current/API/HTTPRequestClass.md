...
| ---------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| agent                  | [4D.HTTPAgent](HTTPAgentClass.md) | HTTPAgent a utilizar para la HTTPRequest. Agent options will be merged with request options (request options take precedence). Si no se define un agente específico, se utiliza un agente global con valores predeterminados.                                                               | Global agent object |
