...
| withBoxInfo       | Boolean    | Default value is false. Si true, agrega los atributos `mailCount`, `mailRecent` e `id` al objeto resultado.                                                                         |
...
| [].mailRecent    | Number  | Number of messages marked "recent" (indicating new messages). Devuelto si withBoxInfo=true                                                                                                                                                                                                                                                          |
| [].mailUnseen    | Number  | Number of messages marked "unseen". Devuelto si withBoxInfo=true                                                                                                                                                                                                                                                                                                       |
