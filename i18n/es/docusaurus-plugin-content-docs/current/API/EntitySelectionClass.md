...
La función `.add()` <!-- REF #EntitySelectionClass.add().Summary -->añade la *entidad* especificada a la selección de entidades y devuelve la selección de entidades modificada<!-- END REF -->.
