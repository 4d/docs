...
| --- | --- | --- | --- |
| Blob | Blob | &rarr; | BLOB que contiene un texto expresado en un juego de caracteres específico |
| juegoCaracteres | Text, Integer | &rarr; | Nombre o número de juego de caracteres de blob |
