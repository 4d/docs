...
| --- | --- | --- | --- |
| Blob | Blob | &srarr; | BLOB que contiene un texto expresado en un juego de caracteres específico |
| juegoCaracteres | Text, Integer | &srarr; | Nombre o número de juego de caracteres de blob |
| Resultado | Text | &larr; | Contenido del BLOB expresado en el juego de caracteres 4D |
