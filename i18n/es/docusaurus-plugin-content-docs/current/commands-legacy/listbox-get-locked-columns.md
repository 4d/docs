...
<!--REF #_command_.LISTBOX Get locked columns.Syntax-->**LISTBOX Get locked columns** ( {* ;} *objeto* ) -> resultado<!-- END REF-->
...
| resultado | Integer | &larr; | Número de columnas bloqueadas |
