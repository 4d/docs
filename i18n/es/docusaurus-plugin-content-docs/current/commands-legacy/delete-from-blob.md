...
| --- | --- | --- | --- |
| Blob | Blob | &srarr; | BLOB del cual borrar los bytes |
| offset | Integer | &srarr; | Offset a partir del cual borrar los bytes |
| numero | Integer | &srarr; | Número de bytes a borrar |
