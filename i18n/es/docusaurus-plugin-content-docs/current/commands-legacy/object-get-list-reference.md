...
| tipoLista | Integer | &srarr; | Tipo de lista: lista de Selección, lista obligatoria o la lista de excluidos |
| Resultado | Integer | &larr; | Número de referencia de lista |
