...
| contenido | Blob, Text | &harr; | Contenido de la parte |
| nombre | Text | &harr; | Nombre de la variable "input" |
| tipoMime | Text | &harr; | Tipo mime del archivo |
| nomArchivo | Text | &harr; | Nombre del archivo enviado |
