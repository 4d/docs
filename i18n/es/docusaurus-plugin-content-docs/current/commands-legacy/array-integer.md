...
| tamaño | Integer | &srarr; | Nombre de los elementos en el array o Número de filas si se especifica el tamaño 2 |
| tamaño2 | Integer | &srarr; | Número de columnas en un array de dos dimensiones |
