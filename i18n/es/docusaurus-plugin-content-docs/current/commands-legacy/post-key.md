...
| --- | --- | --- | --- |
| codigo | Integer | &rarr; | Código de un caracter o código de tecla de función |
| modificadores | Integer | &rarr; | Estado de teclas Modificador |
| proceso | Integer | &rarr; | Número de referencia del proceso de destino o Fila de atención de eventos de la aplicación, si se omite o si es igual a 0 |
