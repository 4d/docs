...
| --- | --- | --- | --- |
| codigo | Integer | &srarr; | Código de un caracter o código de tecla de función |
| modificadores | Integer | &srarr; | Estado de teclas Modificador |
| proceso | Integer | &srarr; | Número de referencia del proceso de destino o Fila de atención de eventos de la aplicación, si se omite o si es igual a 0 |
