...
| --- | --- | --- | --- |
| rutaObjetivo | Text | &rarr; | Nombre o ruta de acceso al objetivo del alias/atajo |
| rutaAlias | Text | &rarr; | Nombre o ruta de acceso completa del alias/del atajo a crear |
