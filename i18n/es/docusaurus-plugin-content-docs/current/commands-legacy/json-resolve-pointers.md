...
| --- | --- | --- | --- |
| objeto | Object | &rarr; | Objeto que contiene punteros JSON para resolver |
| &larr; | Objeto con punteros JSON resueltos (sólo si resultado es un objeto) |
| opciones | Object | &rarr; | Opciones para la resolución de punteros |
