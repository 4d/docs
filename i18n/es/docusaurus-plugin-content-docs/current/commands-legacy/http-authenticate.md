...
| --- | --- | --- | --- |
| nombre | Text | &srarr; | Nombre de usuario |
| clave | Text | &srarr; | Clave de usuario |
| metodoAut | Integer | &srarr; | Método de autenticación: 0 o se omite = no definido, 1 = BASIC, 2 = DIGEST |
