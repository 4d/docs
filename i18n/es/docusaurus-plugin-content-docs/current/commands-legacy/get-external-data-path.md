...
| --- | --- | --- | --- |
| elCampo | Text, Blob, Picture | &srarr; | Campo del cual obtener el lugar de almacenamiento |
| resultado | Text | &larr; | Ruta de acceso completa del archivo de almacenamiento externo |
