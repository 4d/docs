...
| --- | --- | --- | --- |
| fuente | Text | &rarr; | Cadena de la cual borrar caracteres |
| posicion | Integer | &rarr; | Primer caracter a borrar |
| numCaracteres | Integer | &rarr; | Número de caracteres a borrar |
