...
| objeto | any | &srarr; | Nombre del objeto (si se especifica *) o<br/>Variable (si se omite *) de la columna a mover |
| posicionCol | Integer | &srarr; | Nueva ubicación de la columna |
