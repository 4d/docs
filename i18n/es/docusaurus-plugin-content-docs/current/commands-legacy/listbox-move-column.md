...
| objeto | any | &rarr; | Nombre del objeto (si se especifica *) o<br/>Variable (si se omite *) de la columna a mover |
| posicionCol | Integer | &rarr; | Nueva ubicación de la columna |
