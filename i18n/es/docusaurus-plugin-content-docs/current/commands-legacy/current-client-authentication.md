...
| --- | --- | --- | --- |
| dominio | Text | &harr; | Nombre del dominio |
| protocolo | Text | &harr; | "Kerberos", "NTLM", o cadena vacía |
| Resultado | Text | &larr; | Nombre de usuario de sesión devuelto por Windows |
