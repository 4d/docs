...
| --- | --- | --- | --- |
| campo | Field | &srarr; | Campo cuyo valor de prioridad de índice(s) debe ajustarse |
| prioridad | Integer | &srarr; | Valor de prioridad de la caché para los índices de campo |
