...
| --- | --- | --- | --- |
| campo | Field | &rarr; | Campo cuyo valor de prioridad de índice(s) debe ajustarse |
| prioridad | Integer | &rarr; | Valor de prioridad de la caché para los índices de campo |
