...
| --- | --- | --- | --- |
| ruta | Text, Text array | &rarr; | Texto o array texto que contiene una o más rutas de acceso |
| fechaMod | Date, Date array | &larr; | Fecha(s) de modificación de métodos(s) |
| horaMod | Time, Integer array | &larr; | Hora(s) de modificación de métodos(s) |
