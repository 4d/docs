...
| refElem | Integer | &rarr; | Número de referencia del elemento o 0 para el último elemento  añadido a la lista |
| refArray | Integer array | &rarr; | Array de números de referencia de elementos |
