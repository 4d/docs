...
| refElem | Integer | &srarr; | Número de referencia del elemento o 0 para el último elemento  añadido a la lista |
| refArray | Integer array | &srarr; | Array de números de referencia de elementos |
