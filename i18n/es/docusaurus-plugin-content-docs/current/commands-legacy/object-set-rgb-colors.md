...
| colorPrimerPlano | Text, Integer | &rarr; | Valor del color RGB del primer plano |
| colorFondo | Text, Integer | &rarr; | Valor del color RGB del fondo |
| colorFondoAlt | Text, Integer | &rarr; | Valor del color RGB del fondo alterno |
