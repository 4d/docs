...
| --- | --- | --- | --- |
| nomArchivo | Text | &rarr; | Nombre o ruta de acceso completo del archivo a escribir, o cadena vacía |
| imagen | Picture | &rarr; | Campo o variable imagen a escribir |
| codec | Text | &rarr; | Identificación de codec de imagen |
