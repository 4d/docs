...
| --- | --- | --- | --- |
| nomObjeto | Text | &rarr; | Nombre de archivo de sonido o sonido sistemaCadena vacía para detener un sonido asincrónico |
| canal | Integer | &rarr; | Si se pasa, canal de salida y ejecución asincrónico Si se omite, ejecución sincrónica |
