...
| --- | --- | --- | --- |
| array | Array | &rarr; | Nombre del array |
| posicion | Integer | &rarr; | Donde insertar los elementos |
| reemplazos | Integer | &rarr; | Número de elementos a insertar, o 1 elemento si se omite |
