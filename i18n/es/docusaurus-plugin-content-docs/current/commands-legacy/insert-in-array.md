...
| --- | --- | --- | --- |
| array | Array | &srarr; | Nombre del array |
| posicion | Integer | &srarr; | Donde insertar los elementos |
| reemplazos | Integer | &srarr; | Número de elementos a insertar, o 1 elemento si se omite |
