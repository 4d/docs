...
| --- | --- | --- | --- |
| valor XML | Texto | &rarr; | Valor de tipo texto proveniente de una estructura XML |
| objeto4D | Field, Variable | &larr; | Variable o campo 4D que recibe el valor XML convertido |
