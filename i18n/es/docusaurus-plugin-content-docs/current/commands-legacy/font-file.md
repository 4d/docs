...
| --- | --- | --- | --- |
| familiaFuente | Text | &srarr; | Nombre de la familia de fuente |
| estiloFuente | Integer | &srarr; | Estilo de fuente: 0=normal (por defecto), 1=negrita, 2=itálica |
| Resultado | Null, Object | &larr; | Objeto archivo fuente |
