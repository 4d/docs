...
| --- | --- | --- | --- |
| objeto | Object, Object | &rarr; | Objeto estructurado |
| propiedad | Text | &rarr; | Nombre de la propiedad a definir |
| array | Array, Variable | &rarr; | Array a almacenar en propiedad |
