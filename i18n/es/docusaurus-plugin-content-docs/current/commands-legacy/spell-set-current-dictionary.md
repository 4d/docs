...
| --- | --- | --- | --- |
| diccionario | Integer, Text | &rarr; | ID, Nombre o Código de lenguaje del diccionario a utilizar para la corrección ortográficaSi se omite = restablecer el diccionario por defecto |
