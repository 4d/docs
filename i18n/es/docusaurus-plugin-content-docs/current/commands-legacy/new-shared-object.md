...
| --- | --- | --- | --- |
| propiedad | Text | &srarr; | Nombre de la propiedad a crear |
| valor | Text, Date, Boolean, Pointer, Number, Object | &srarr; | Valor de la propiedad |
| Resultado | Object | &larr; | Nuevo objeto compartido |
