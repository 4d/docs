...
| --- | --- | --- | --- |
| unField | Field | &rarr; | Campo del cual crear o borrar el índice |
| index | Boolean, Integer | &rarr; | • True=Crear el índice, False=Borrar el índice, o • Crear un índice de tipo: -1=palabras claves, 0=por defecto, 1=B-Tree estándar, 3=B-Tree cluster |
| * | Operator |  &rarr; | Si se pasa * indexación asincrónica |
