...
| --- | --- | --- | --- |
| volumen | Text | &rarr; | Nombre del volumen |
| tamaño | Real | &larr; | Tamaño del volumen expresado en bytes |
| utilizado | Real | &larr; | Espacio utilizado expresado en bytes |
| libre | Real | &larr; | Espacio libre expresado en bytes |
