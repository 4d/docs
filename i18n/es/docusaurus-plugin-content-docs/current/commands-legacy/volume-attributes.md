...
| --- | --- | --- | --- |
| volumen | Text | &srarr; | Nombre del volumen |
| tamaño | Real | &harr; | Tamaño del volumen expresado en bytes |
| utilizado | Real | &harr; | Espacio utilizado expresado en bytes |
| libre | Real | &harr; | Espacio libre expresado en bytes |
