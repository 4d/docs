...
| arrayNoms | Text array | &larr; | Nombres de los valores |
| info1Array | Integer array | &larr; | Valores (1) de la opción |
| info2Array | Integer array | &larr; | Valores (2) de la opción |
