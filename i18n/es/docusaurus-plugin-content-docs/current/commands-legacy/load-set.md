...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla a la cual pertenece el conjunto o Tabla por defecto si se omite |
| conjunto | Text | &srarr; | Nombre del conjunto a crear en memoria |
| doc | Text | &srarr; | Documento que contiene el conjunto |
