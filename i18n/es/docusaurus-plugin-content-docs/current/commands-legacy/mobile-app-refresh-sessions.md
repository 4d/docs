...
El comando puede devolver uno de los siguientes errores, que se puede manejar a través de los comandos [ON ERR CALL](on-err-call.md) y [GET LAST ERROR STACK](get-last-error-stack.md):
