...
| nombre | Text | &larr; | Nombre del elemento |
| prefijo | Text | &larr; | Espacio de nombre |
| nomsAtributos | Text array | &larr; | Nombres de los atributos |
| valoresAtributos | Text array | &larr; | Valores de los atributos |
