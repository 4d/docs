...
| datos | Text, Variable | &srarr; | Texto o variable a insertar en el documento |
| * | Operador | &srarr; | Si se pasa: codificar los caracteres especiales Si se omite: no codificación |
