...
| datos | Text, Variable | &rarr; | Texto o variable a insertar en el documento |
| * | Operador | &rarr; | Si se pasa: codificar los caracteres especiales Si se omite: no codificación |
