...
| --- | --- | --- | --- |
| arrayCodigos | Integer array | &harr; | Números de errores |
| arrayCompInternos | Text array | &harr; | Códigos de componentes internos |
| arrayTextos | Text array | &harr; | Texto de errores |
