...
| remoteDebuggerSessionID     | texto     | El ID de la sesión de la aplicación remota a la que está conectado el depurador del servidor. Este ID también es devuelto por [Get process activity](get-process-activity.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | "A838A40BJN3NJKH..."                            |
