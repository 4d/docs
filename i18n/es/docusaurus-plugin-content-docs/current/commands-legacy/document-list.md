...
| --- | --- | --- | --- |
| nombreRuta | Text | &rarr; | Ruta de acceso al volumen o a la carpeta |
| documentos | Text array | &larr; | Nombres de los documentos presentes en esta ubicación |
| opciones | Integer | &rarr; | Opciones para crear la lista |
