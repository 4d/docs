...
| --- | --- | --- | --- |
| nombreRuta | Text | &srarr; | Ruta de acceso al volumen o a la carpeta |
| documentos | Text array | &harr; | Nombres de los documentos presentes en esta ubicación |
| opciones | Integer | &srarr; | Opciones para crear la lista |
