...
| --- | --- | --- | --- |
| imagen | Picture | &rarr; | Imagen para la cual obtener la información |
| largo | Real | &larr; | Largo de la imagen expresado en píxeles |
| altura | Real | &larr; | Alto de la imagen expresado en píxeles |
| hDesp | Integer | &larr; | Offset horizontal cuando la imagen se muestra en segundo plano |
| vDesp | Integer | &larr; | Offset  vertical cuando la imagen se muestra en segundo plano |
| modo | Integer | &larr; | Modo de transferencia cuando la imagen se muestra en segundo plano |
