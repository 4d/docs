...
| --- | --- | --- | --- |
| expresionBool | Boolean | &srarr; | Expresión booleana |
| textoMensaje | Text | &srarr; | Texto del mensaje de error |
| Resultado | Boolean | &larr; | Resultado de la evaluación de expresionBool |
