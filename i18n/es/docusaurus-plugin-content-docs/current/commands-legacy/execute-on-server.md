...
<!--REF #_command_.Execute on server.Syntax-->**Execute on server** ( *proced* ; *pila* {; *nombre* {; *param* {; *param2* ; ... ; *paramN*}}}{; *} ) -> Resultado<!-- END REF-->
...
| param | Expresión | &#x1F852; | Paramétro(s) del procedimiento |
