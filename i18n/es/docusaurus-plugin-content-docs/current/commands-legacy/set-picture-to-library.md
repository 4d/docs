...
| --- | --- | --- | --- |
| imagen | Picture | &srarr; | Nueva imagen |
| refImag | Integer | &srarr; | Número de referencia de la imagen en la librería de imágenes |
| nomImag | Text | &srarr; | Nuevo nombre de la imagen |
