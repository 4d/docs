...
Más particularmente, los comandos relacionados son: [ALERT](alert.md), [DIALOG](../commands/dialog.md), [CONFIRM](confirm.md), [Request](request.md), [ADD RECORD](add-record.md), [MODIFY RECORD](modify-record.md), [DISPLAY SELECTION](display-selection.md) y [MODIFY SELECTION](modify-selection.md).
