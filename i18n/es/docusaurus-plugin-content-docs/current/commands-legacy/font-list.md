...
| --- | --- | --- | --- |
| fuentes | Text array | &harr; | Array de nombres de fuentes disponibles |
| tipoLista | Integer, * | &srarr; | Tipo de lista de fuente a devolver o * para devolver los nombres de fuente en OS X |
