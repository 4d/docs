...
| --- | --- | --- | --- |
| aCodificar | Blob, Text | &rarr; | Valor a codificar |
| &larr; | Valor codificado (si el parámetro codificado se omite) |
| codificado | Blob, Text | &larr; | Varlor codificado |
| * | Operador | &rarr; | Codificado en formato Base64URL |
