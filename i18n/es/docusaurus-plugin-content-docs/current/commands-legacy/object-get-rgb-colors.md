...
| --- | --- | --- | --- |
| * | Operador | &srarr; | Si se especifica, objeto es un nombre (cadena). Si se omite, objeto es una variable o un campo |
| objeto | any | &srarr; | Nombre del objeto (si se especifica *) o variable o campo (si se omite *) |
| colorPrimerPlano | Text, Integer | &harr; | Valor del color RGB del primer plano |
| colorFondo | Text, Integer | &harr; | Valor del color RGB del fondo |
| colorFondoAlt | Text, Integer | &harr; | Valor del color RGB del fondo alterno |
