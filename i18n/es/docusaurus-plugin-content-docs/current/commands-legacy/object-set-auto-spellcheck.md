...
<!--REF #_command_.OBJECT SET AUTO SPELLCHECK.Syntax-->**OBJECT SET AUTO SPELLCHECK** ( * ; *objeto* : Text ; *correcionAuto* : Boolean )<br/>**OBJECT SET AUTO SPELLCHECK** ( *objeto* : Field, Variable ; *correcionAuto* : Boolean )<!-- END REF-->
