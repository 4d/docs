...
| objeto | any | &srarr; | Nombre del objeto (si se especifica *) o variables (si * se omite) |
| jerarquico | Boolean | &harr; | True = list box jerárquico, False = list box no jerárquico |
| jerarquia | Pointer array | &harr; | Array de punteros |
