...
| objeto | any | &rarr; | Nombre del objeto (si se especifica *) o variables (si * se omite) |
| jerarquico | Boolean | &larr; | True = list box jerárquico, False = list box no jerárquico |
| jerarquia | Pointer array | &larr; | Array de punteros |
