...
<!--REF #_command_.Open resource file.Syntax-->**Open resource file** ( *resNomArchivo* {; *tipo*} ) -> Resultado<!-- END REF-->
<!--REF #_command_.Open resource file.Params-->
| Parámetro | Tipo |  | Descripción |
| --- | --- | --- | --- |
| resNomArchivo | Text | &rarr; | Nombre o ruta de acceso completa del archivo de recursos o Cadena vacía para mostrar la caja de diálogo estándar de apertura de archivos |
| tipo | Text | &rarr; | Tipo de archivo Mac OS (cadena de 4 caracteres) o extensión del archivo Windows (cadena de 1 a 3 caracteres) o archivo de recursos ("res " / .RES) si se omite |
