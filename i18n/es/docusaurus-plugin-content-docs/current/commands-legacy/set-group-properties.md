...
| --- | --- | --- | --- |
| refGrupo | Integer | &rarr; | Número de referencia único del grupo activo o -1 para añadir un grupo de Diseñador o -2 para añadir un grupo de Administrador |
| &larr; | Número de identificación único del grupo agregado (si lo hay) |
| nombre | Text | &rarr; | Nuevo nombre de grupo |
| propietario | Integer | &rarr; | Número de referencia único del usuario o del propietario del nuevo grupo |
| miembros | Integer array | &rarr; | Nuevos miembros del grupo |
