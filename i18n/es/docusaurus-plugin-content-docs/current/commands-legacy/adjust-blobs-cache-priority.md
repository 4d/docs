...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla cuyo valor de prioridad de datos "blobs" tiene que ser ajustado |
| prioridad | Integer | &srarr; | Valor de prioridad de la caché para los BLOBs en la tabla |
