...
| --- | --- | --- | --- |
| unField | Field | &rarr; | Campo indexado con el cual escanear los registros |
| Numero | Integer | &rarr; | Número de registros a devolver |
| > o < | Operador | &rarr; | > a partir del inicio del índice < a partir del final del índice |
