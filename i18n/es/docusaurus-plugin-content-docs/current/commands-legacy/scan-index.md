...
| --- | --- | --- | --- |
| unField | Field | &srarr; | Campo indexado con el cual escanear los registros |
| Numero | Integer | &srarr; | Número de registros a devolver |
| > o < | Operador | &srarr; | > a partir del inicio del índice < a partir del final del índice |
