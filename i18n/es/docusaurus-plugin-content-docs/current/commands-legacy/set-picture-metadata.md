...
| --- | --- | --- | --- |
| imagen | Picture | &rarr; | Imagen cuyos metadatos quiere escribir |
| nomMeta | Text | &rarr; | Nombre o ruta del bloque a escribir |
| ContenidoMeta | Variable | &rarr; | Contenido del metadato |
