...
| --- | --- | --- | --- |
| nomArray | Array | &rarr; | Nombre de array |
| tam | Integer | &rarr; | Número de elementos en el array o Número de filas si se especifica tamaño2 |
| tam2 | Integer | &rarr; | Número de columnas en un array de dos dimensiones |
