...
| --- | --- | --- | --- |
| nomArchivo | Text | &rarr; | Nombre o ruta de acceso completa del archivo a leer, o cadena vacía |
| imagen | Picture | &larr; | Campo o variable que recibe la imagen |
| * | Operador | &rarr; | Si se pasa = acepta todo tipo de archivo |
