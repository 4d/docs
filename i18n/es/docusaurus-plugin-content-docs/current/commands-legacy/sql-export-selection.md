...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla de la cual exportar la selección |
...
| tamLimiteArchivos | Integer | &srarr; | Tamaño máximo del archivo Export.sql (en KB) |
| tamLimiteCampos | Integer | &srarr; | Límite de tamaño debajo del cual el contenido de un campo Texto, BLOB o imagen se integrará al archivo principal (en bytes) |
