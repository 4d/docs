...
| --- | --- | --- | --- |
| tabla | Table | &rarr; | Tabla de la cual exportar la selección |
...
| tamLimiteArchivos | Integer | &rarr; | Tamaño máximo del archivo Export.sql (en KB) |
| tamLimiteCampos | Integer | &rarr; | Límite de tamaño debajo del cual el contenido de un campo Texto, BLOB o imagen se integrará al archivo principal (en bytes) |
