...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla de la cual debe devolverse una selección de  registros , o Tabla por defecto, si se omite |
| * | Operador | &srarr; | Si se pasa, no se muestra la barra de desplazamiento |
