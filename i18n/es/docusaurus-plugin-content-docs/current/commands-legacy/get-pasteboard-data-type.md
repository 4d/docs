...
| --- | --- | --- | --- |
| firmas4D | Text array | &larr; | Firmas 4D de tipos de datos |
| tiposNativos | Text array | &larr; | Tipos de datos nativos |
| nombresFormatos | Text array | &larr; | Nombres de los formatos (Windows únicamente), cadenas vacías bajo Mac OS |
