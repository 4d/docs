...
| --- | --- | --- | --- |
| tablasN &#124; CampoN | Tabla, Campo | &rarr; | Tabla de inicio de las relaciones o Campo de inicio de la relación |
| uno | Integer | &rarr; | Estado de la relación Muchos a Uno a partir del campo o de las relaciones Muchos a Uno de la tabla |
| muchos | Integer | &rarr; | Estado de la relación Uno a Muchos a partir del campo o de las relaciones Uno a Muchos de la tabla |
