...
| --- | --- | --- | --- |
| proceso | Text, Integer | &rarr; | Nombre o número del proceso worker |
| metodo | Object, Text | &rarr; | Nombre del método proyecto a llamar |
| param | Expression | &rarr; | Parámetros pasados al método |
