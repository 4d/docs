...
| --- | --- | --- | --- |
| proceso | Text, Integer | &srarr; | Nombre o número del proceso worker |
| metodo | Object, Text | &srarr; | Nombre del método proyecto a llamar |
| param | Expression | &srarr; | Parámetros pasados al método |
