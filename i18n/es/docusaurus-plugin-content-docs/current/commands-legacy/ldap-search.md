...
<!--REF #_command_.LDAP Search.Syntax-->**LDAP Search** ( *dnRootEntry* : Text ; *filtro* : Text {; *alcance* : Text {; *atributos* : Text array {; *atributosEnArray* : Boolean array}}} ) : Object<!-- END REF-->
