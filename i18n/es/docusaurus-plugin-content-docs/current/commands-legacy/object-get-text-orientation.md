...
<!--REF #_command_.OBJECT Get text orientation.Syntax-->**OBJECT Get text orientation** ( {* ;} *objeto* ) -> Resultado<!-- END REF-->
...
| Resultado | Integer | &larr; | Ángulo de rotación de texto |
