...
| objeto | any | &rarr; | Nombre de objeto (si * se especifica) o <br/>Variable (si * se omite) |
| fila | Integer | &rarr; | Número de fila |
| tipoColor | Integer | &rarr; | Listbox color de fuente (por defecto) o Listbox color de fondo |
