...
| Last backup information | Entero largo | 5     | *info1* devuelve la duración de la última copia de seguridad en milisegundos (entero largo) e *info2* la última estampa de tiempo de inicio de la copia de seguridad (cadena, ver los detalles de formato en el comando [Timestamp](../commands/timestamp)). |
