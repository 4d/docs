...
| subtotal | Integer | &srarr; | Número del subtotal |
| valor | Integer | &srarr; | 0=sin espacio, 32000=inserta un salto de página, >0=espacio añadido en la parte superior del nivel de ruptura, <0=aumento proporcional |
