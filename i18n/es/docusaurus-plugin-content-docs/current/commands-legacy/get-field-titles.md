...
| --- | --- | --- | --- |
| tabla | Table | &rarr; | Tabla de la cual quiere conocer los nombres de los campos |
| titulosCampos | Text array | &larr; | Nombres actuales de los campos |
| numCampos | Integer array | &larr; | Números de los campos |
