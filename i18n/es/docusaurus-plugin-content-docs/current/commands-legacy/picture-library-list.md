...
| --- | --- | --- | --- |
| refsImag | Integer array | &larr; | Números de referencia de las imágenes de la librería de imágenes |
| nomsImag | Text array | &larr; | Nombres de las imágenes de la librería de imágenes |
