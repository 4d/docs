...
| --- | --- | --- | --- |
| * | Operador | &srarr; | Windows: altura de la ventana de la aplicación o altura de la pantalla si se especifica * Macintosh: altura de la pantalla principal |
| Resultado | Integer | &larr; | Altura expresada en píxeles |
