...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( {* ;} *objeto* {; *unidad*} ) -> resultado<!-- END REF-->
...
| unidad | Integer | &srarr; | Unidad de valor de altura: 0 o si se omite = píxeles, 1 = líneas |
