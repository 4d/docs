...
| --- | --- | --- | --- |
| imagen | Picture | &srarr; | Imagen de la cual obtener los metadatos |
| nomMeta | Text | &srarr; | Nombre o ruta de acceso del bloque a leer |
| ContenidoMeta | Variable | &harr; | Contenido del metadato |
