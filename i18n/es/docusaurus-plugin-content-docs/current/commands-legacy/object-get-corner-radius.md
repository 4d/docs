...
<!--REF #_command_.OBJECT Get corner radius.Syntax-->**OBJECT Get corner radius** ( {* ;} *objeto* ) -> Resultado<!-- END REF-->
...
| Resultado | Integer | &larr; | Radio de esquinas redondeadas (en píxeles) |
