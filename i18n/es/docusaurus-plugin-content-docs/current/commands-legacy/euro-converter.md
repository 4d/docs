...
| --- | --- | --- | --- |
| valor | Real | &srarr; | Valor a convertir |
| deMoneda | Text | &srarr; | Código de la moneda en que está expresado el valor |
| aMoneda | Text | &srarr; | Código de la moneda a la que debe convertirse el valor |
