...
| comentarios | Text, Text array | &rarr; | Comentarios de los métodos designados |
| * | * | &rarr; | Si se pasa = el comando se aplica a la base local cuando se ejecuta desde un componente (parámetro ignorado fuera de este contexto) |
