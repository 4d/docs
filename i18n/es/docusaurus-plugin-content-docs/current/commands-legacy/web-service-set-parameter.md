...
| --- | --- | --- | --- |
| nombre | Text | &rarr; | Nombre del parámetro a incluir en la petición SOAP |
| valor | Variable | &rarr; | Variable 4D que contiene el valor del parámetro |
| tipoSOAP | Text | &rarr; | Tipo SOAP del parámetro |
