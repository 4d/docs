...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla cuyo valor de prioridad de datos "blobs" tiene que definirse para la sesión |
| prioridad | Integer | &srarr; | Valor de prioridad de la caché para BLOBs en la tabla |
