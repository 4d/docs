...
| --- | --- | --- | --- |
| tabla | Table | &rarr; | Tabla para la cual imprimir la selección, o Tabla por defecto, si se omite |
| * &#124; > | Operador | &rarr; | * para eliminar las cajas de diálogo de impresión, o > para no reiniciar los parámetros de impresión |
