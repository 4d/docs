...
| --- | --- | --- | --- |
| series | Field, Array | &rarr; | Datos para los cuales se devuelve el valor  máximo |
| rutaAtributo | Text | &rarr; | Ruta de atributo para el cual calcular el valor máximo |
