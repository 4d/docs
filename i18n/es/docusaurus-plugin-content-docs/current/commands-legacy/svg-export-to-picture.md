...
| varImag | Picture | &srarr; | Variable imagen a recibir del árbol XML (imagen SVG) |
| tipoExport | Integer | &srarr; | 0 = No guardar la fuente de datos, 1 = Copiar la fuente de datos, 2 (por defecto) = Fuente de datos propia |
