...
| --- | --- | --- | --- |
| titulosTablas | Text array | &rarr; | Nombres de las tablas tal como deben aparecer |
| numTablas | Integer array | &rarr; | Números de las tablas |
| * | Operador | &rarr; | Utilizar los nombres personalizados en el editor de fórmulas |
