...
| --- | --- | --- | --- |
| unField | Field | &rarr; | Campo o subcampo indexable a utilizar para datos |
| array | Array | &larr; | Array a recibir los datos del campo |
| contArray | Integer array, Real array | &larr; | Array a recibir el número de ocurrencias de cada valor |
