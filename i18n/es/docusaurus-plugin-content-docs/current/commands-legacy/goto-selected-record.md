...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla en la cual ir al registro seleccionado o Tabla por defecto, si se omite |
| registro | Integer | &srarr; | Posición del registro en la selección |
