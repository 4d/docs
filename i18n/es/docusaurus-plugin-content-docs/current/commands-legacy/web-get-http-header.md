...
| --- | --- | --- | --- |
| encab&#124;arrayCamp | Texto, Array texto | &larr; | Encabezado HTTP de la petición o Campos del encabezado HTTP |
| arrayValores | Text array | &larr; | Contenido de los campos del encabezado HTTP |
