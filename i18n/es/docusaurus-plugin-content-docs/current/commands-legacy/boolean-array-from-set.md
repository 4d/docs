...
| --- | --- | --- | --- |
| arrBool | Boolean array | &larr; | Array para indicar si un registro está en un conjunto o no |
| conjunto | Text | &rarr; | Nombre del conjunto o UserSet si se omite este parámetro |
