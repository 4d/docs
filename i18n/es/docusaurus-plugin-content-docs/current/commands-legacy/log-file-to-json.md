...
| --- | --- | --- | --- |
| rutaCarpetaDest | Text | &rarr; | Ruta de acceso de la carpeta de destino del archivo guardado |
| tamMax | Integer | &rarr; | Tamaño máximo del archivo JSON a crear (bytes) |
| rutaHist | Text | &rarr; | Ruta de acceso del archivo de historial a exportar; utilizar el historial actual si se omite |
| atribCampo | Integer | &rarr; | Atributo de descripción del campo: 1 = utilizar número(por defecto), 2 = utilizar nombre |
