...
<!--REF #_command_.LISTBOX Get headers height.Syntax-->**LISTBOX Get headers height** ( * ; *objeto* : Text {; *unidad* : Integer} ) : Integer<br/>**LISTBOX Get headers height** ( *objeto* : Field, Variable {; *unidad* : Integer} ) : Integer<!-- END REF-->
