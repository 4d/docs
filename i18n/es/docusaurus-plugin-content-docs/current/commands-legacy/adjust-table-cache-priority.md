...
| --- | --- | --- | --- |
| tabla | Table | &rarr; | Tabla cuyo valor de prioridad de datos escalar tiene que ser ajustado |
| prioridad | Integer | &rarr; | Valor de prioridad de la caché para la tabla |
