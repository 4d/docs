...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla cuyo valor de prioridad de datos escalar tiene que ser ajustado |
| prioridad | Integer | &srarr; | Valor de prioridad de la caché para la tabla |
