...
| --- | --- | --- | --- |
| tabla | Table | &rarr; | Referencia de tabla |
| arrayNoms | Text array | &larr; | Array de nombres de formulario |
| filtro | Text | &rarr; | Filtro de nombres |
| marcador | Real | &rarr; | Marcador para versión mínima a devolver |
| &larr; | Nuevo valor |
