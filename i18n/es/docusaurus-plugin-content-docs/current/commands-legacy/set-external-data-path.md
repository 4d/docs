...
| --- | --- | --- | --- |
| aCampo | Text, Blob, Picture | &rarr; | Campo para el cual definir el lugar de almacenamiento |
| ruta | Text, Integer | &rarr; | Ruta de acceso y nombre del archivo de almacenamiento externo o0 = utilizar la definición en estructura 1 = utilizar la carpeta por defecto |
