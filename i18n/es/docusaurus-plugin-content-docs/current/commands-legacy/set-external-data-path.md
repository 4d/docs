...
| --- | --- | --- | --- |
| aCampo | Texto, BLOB, Imagen | &#x1F852; | Campo para el cual definir el lugar de almacenamiento |
| ruta | Texto, Entero largo | &#x1F852; | Ruta de acceso y nombre del archivo de almacenamiento externo o0 = utilizar la definición en estructura 1 = utilizar la carpeta por defecto |
