...
| --- | --- | --- | --- |
| inicio | Integer | &srarr; | Número de registro seleccionado a partir del cual comenzar la recuperación de datos |
| fin | Integer | &srarr; | Número de registro seleccionado donde termina la recuperación de datos |
| campo | Field, Table | &srarr; | Campo a utilizar para recuperar los datos o Tabla a utilizar para recuperar los números de registros |
| array | Array | &harr; | Array para recibir los datos o números de registros de los campos |
