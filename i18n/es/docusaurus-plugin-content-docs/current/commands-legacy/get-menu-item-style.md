...
<!--REF #_command_.Get menu item style.Syntax-->**Get menu item style** ( *menu* ; *lineamenu* {; *proceso*} ) -> Resultado<!-- END REF-->
...
| proceso | Integer | &srarr; | Process reference number |
| Resultado | Integer | &larr; | Estilo del comando de menú |
