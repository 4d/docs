...
| columna | Integer | &rarr; | Número de columna |
| linea | Integer | &rarr; | Número de línea |
| borde | Integer | &rarr; | Valor del borde compuesto |
| grueso | Integer | &rarr; | Ancho de la línea |
| color | Integer | &rarr; | Color del borde |
