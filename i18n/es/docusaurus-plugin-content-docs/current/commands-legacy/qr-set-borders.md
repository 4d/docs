...
| columna | Integer | &srarr; | Número de columna |
| linea | Integer | &srarr; | Número de línea |
| borde | Integer | &srarr; | Valor del borde compuesto |
| grueso | Integer | &srarr; | Ancho de la línea |
| color | Integer | &srarr; | Color del borde |
