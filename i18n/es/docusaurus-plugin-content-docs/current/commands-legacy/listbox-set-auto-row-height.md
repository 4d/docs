...
| selector | Integer | &rarr; | Valor de la altura a definir: lk row min height o lk row max height |
| valor | Integer | &rarr; | Valor mínimo o máximo de la altura de la fila |
