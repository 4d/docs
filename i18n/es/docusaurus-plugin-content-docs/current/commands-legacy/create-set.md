...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla para la cual crear un conjunto a partir de la selección actual o Tabla por defecto si se omite |
| conjunto | Text | &srarr; | Nombre del nuevo conjunto |
