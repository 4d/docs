...
| --- | --- | --- | --- |
| nomGrupos | Text array | &harr; | Nombres de los grupos tal como aparecen en el editor de contraseñas |
| numGrupos | Integer array | &harr; | Números de referencia únicos para cada grupo |
