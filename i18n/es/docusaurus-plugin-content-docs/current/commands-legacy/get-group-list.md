...
| --- | --- | --- | --- |
| nomGrupos | Text array | &larr; | Nombres de los grupos tal como aparecen en el editor de contraseñas |
| numGrupos | Integer array | &larr; | Números de referencia únicos para cada grupo |
