...
| --- | --- | --- | --- |
| siglo | Integer | &rarr; | Siglo por defecto (menos uno) para la entrada de años con dos dígitos |
| añoPivote | Integer | &rarr; | Año pivote para la entrada de años con dos dígitos |
