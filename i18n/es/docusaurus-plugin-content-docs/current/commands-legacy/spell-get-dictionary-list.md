...
| --- | --- | --- | --- |
| lengID | Integer array | &larr; | IDs únicos de los lenguajes |
| lengArchivos | Text array | &larr; | Nombres de los archivos de lenguaje instalados |
| lengNoms | Text array | &larr; | Nombres locales de los lenguajes |
