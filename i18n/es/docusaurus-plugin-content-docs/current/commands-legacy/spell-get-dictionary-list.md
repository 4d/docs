...
| --- | --- | --- | --- |
| lengID | Integer array | &harr; | IDs únicos de los lenguajes |
| lengArchivos | Text array | &harr; | Nombres de los archivos de lenguaje instalados |
| lengNoms | Text array | &harr; | Nombres locales de los lenguajes |
