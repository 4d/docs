...
| --- | --- | --- | --- |
| formula | Text | &srarr; | Fórmula de texto sin formato |
| opciones | Integer | &srarr; | Instrucciones para entrada/salida |
| mensajeError | Text | &harr; | Mensaje de error (cadena vacía si no hay error) |
