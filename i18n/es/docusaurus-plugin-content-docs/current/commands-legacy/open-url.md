...
| --- | --- | --- | --- |
| ruta | Text | &rarr; | Ruta del documento o URL a abrir |
| nomAp | Text | &rarr; | Nombre de la aplicación a utilizar |
| * | Operador | &rarr; | Si se especifica = la URL no está traducida, Si se omite = la URL está traducida |
