...
<!--REF #_command_.Get 4D folder.Syntax-->**Get 4D folder** {( *carpeta* {; *opciones*} {; *})} -> Resultado<!-- END REF-->
<!--REF #_command_.Get 4D folder.Params-->
| Parámetro | Tipo |  | Descripción |
| --- | --- | --- | --- |
| carpeta | Entero largo | &#x1F852; | Tipo de carpeta (si se omite = carpeta activa 4D) |
| opciones | Objeto | &#x1F852; | Configuración de la ruta de la carpeta de la base 4D Client |
