...
| numTabla &#124; tempo | Entero largo, Cadena | &rarr; | Número de la tabla de la cual utilizarla selección actual o nombre de la selección temporal a utilizar |
| nomSel | Text | &rarr; | Nombre del conjunto seleccionado |
