...
| numTabla &#124; tempo | Entero largo, Cadena | &srarr; | Número de la tabla de la cual utilizarla selección actual o nombre de la selección temporal a utilizar |
| nomSel | Text | &srarr; | Nombre del conjunto seleccionado |
