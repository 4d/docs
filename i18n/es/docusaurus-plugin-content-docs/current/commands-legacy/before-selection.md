...
| --- | --- | --- | --- |
| tabla | Table | &srarr; | Tabla para la cual probar si el puntero se encuentra antes del primer registro seleccionado o Tabla por defecto, si se omite |
| Resultado | Boolean | &larr; | Sí (TRUE) o No (FALSE) |
