...
| --- | --- | --- | --- |
| textoHTML | Text | &rarr; | Campo o variable de tipo texto con formato HTML a enviar al navegador web |
| tipo | Text | &rarr; | True = Ir al modo contextual False o si se omite = Permanecer en el modo actual |
