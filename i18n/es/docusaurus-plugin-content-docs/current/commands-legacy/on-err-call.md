...
| --- | --- | --- | --- |
| metodoError | Text | &srarr; | Método de gestión de errores a llamar o cadena vacía para desinstalar el método |
| alcance | Integer | &srarr; | Alcance del método de gestión de errores |
