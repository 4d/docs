...
| --- | --- | --- | --- |
| metodoError | Text | &rarr; | Método de gestión de errores a llamar o cadena vacía para desinstalar el método |
| alcance | Integer | &rarr; | Alcance del método de gestión de errores |
