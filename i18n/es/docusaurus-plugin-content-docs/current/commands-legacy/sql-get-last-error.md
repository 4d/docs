...
| --- | --- | --- | --- |
| errCode | Integer | &harr; | Código del error |
| errText | Text | &harr; | Texto del error |
| errODBC | Text | &harr; | Código del error ODBC |
| errSQLServer | Integer | &harr; | Código del error nativo servidor SQL |
