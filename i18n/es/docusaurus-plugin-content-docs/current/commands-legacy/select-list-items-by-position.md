...
| posicionElem | Integer | &rarr; | Posición del elemento en la(s) lista(s) desplegada(s) /contraída(s) |
| posicionArray | Integer array | &rarr; | Array de posiciones en la(s) lista(s) desplegada(s) /contraída(s) |
