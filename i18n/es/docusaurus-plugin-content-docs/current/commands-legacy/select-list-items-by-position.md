...
| posicionElem | Integer | &srarr; | Posición del elemento en la(s) lista(s) desplegada(s) /contraída(s) |
| posicionArray | Integer array | &srarr; | Array de posiciones en la(s) lista(s) desplegada(s) /contraída(s) |
