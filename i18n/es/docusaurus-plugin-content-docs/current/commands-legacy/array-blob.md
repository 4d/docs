...
| --- | --- | --- | --- |
| nomArray | Array | &rarr; | Nombre del array |
| tam | Integer | &rarr; | Número de elementos del array o número de arrays si se especifica tam2 |
| tam2 | Integer | &rarr; | Número de los elementos de los array 2D |
