...
| *model*      | Text                                                        | El [modelo a utilizar] (https://developers.openai.com/api/docs/guides/embeddings#embedding-models). Soporta [provider:model aliases](../provider-model-aliases.md). |
