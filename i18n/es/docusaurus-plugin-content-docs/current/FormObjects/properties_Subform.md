...
- Añadir registro: crea un nuevo registro en el subformulario y cambia al modo edición. The record will be created directly in the list if the [Enterable in List](#enterable-in-list) property is enabled. En caso contrario, se creará en modo página, en el [formulario detallado](#detail-form) asociado al subformulario.
