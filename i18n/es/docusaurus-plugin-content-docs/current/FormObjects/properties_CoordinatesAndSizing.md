...
You can also set this property using the [OBJECT Get corner radius](../commands-legacy/object-get-corner-radius) and [OBJECT SET CORNER RADIUS](../commands-legacy/object-set-corner-radius) commands.
