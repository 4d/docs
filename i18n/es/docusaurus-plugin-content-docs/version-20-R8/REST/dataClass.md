...
Cuando llame a este parámetro en su petición REST, se devolverán las 100 primeras entidades a menos que haya especificado un valor utilizando [`$top/$limit`]($top_$limit.md).
