...
| IDE de código                                                                    | 4D IDE code editor *or* VS Code with [4D-Analyzer extension](https://github.com/4d/4D-Analyzer-VSCode)<br/>*4D Server únicamente*: Qodly Studio code editor (see (2)) | Editor de código Qodly Studio                                                 |
