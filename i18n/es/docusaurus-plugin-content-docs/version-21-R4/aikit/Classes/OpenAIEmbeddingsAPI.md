...
| *model*      | Text                                                        | Soporta [provider:model aliases](../provider-model-aliases.md). El [modelo a utilizar] (https://developers.openai.com/api/docs/guides/embeddings#embedding-models). |
