...
También se puede definir esta propiedad utilizando los comandos [OBJECT Get corner radius](../commands/object-get-corner-radius) y [OBJECT SET CORNER RADIUS](../commands/object-set-corner-radius).
