...
| Nombre | Tipos de datos | Valores posibles                                                                                                                                                           |
| ------ | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| action | string         | El nombre de una [acción estándar](/Desktop/standard-actions) o de una [acción estándar 4D Write Pro](../WritePro/user-legacy/standard-actions.md) válida. |
