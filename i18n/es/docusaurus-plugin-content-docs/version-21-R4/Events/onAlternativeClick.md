...
- Si el menú emergente está **separado**, el evento sólo se genera cuando se hace clic en la parte del botón con la flecha. Note that the [standard action](/Desktop/standard-actions) assigned to the button (if any) is not executed in this case.
