...
- Si el menú emergente está **separado**, el evento sólo se genera cuando se hace clic en la parte del botón con la flecha. Tenga en cuenta que la [acción estándar](/Desktop/standard-actions) asignada al botón (si existe) no se ejecuta en este caso.
