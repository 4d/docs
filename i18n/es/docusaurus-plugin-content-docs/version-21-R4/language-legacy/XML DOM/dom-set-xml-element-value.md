...
**Nota:** si el elemento designado por *refElement* es de tipo BLOB procesado por este comando, lo codifica automáticamente en base64\. Sin embargo, el comando [DOM GET XML ELEMENT VALUE](../commands/dom-get-xml-element-value) realiza automáticamente la operación inversa.
