...
<!--REF #_command_.LISTBOX SET ROW HEIGHT.Syntax-->**LISTBOX SET ROW HEIGHT** ( * ; *objeto* : Text ; *linea* : Integer ; *altura* : Integer )<br/>**LISTBOX SET ROW HEIGHT** ( *objeto* : Variable ; *linea* : Integer ; *altura* : Integer )<!-- END REF-->
...
La unidad utilizada para la *altura* especificada corresponde a la definida globalmente para las filas del list box, ya sea en la lista de propiedades o por una llamada anterior al comando [LISTBOX SET ROWS HEIGHT](../commands/listbox-set-rows-height).
...
... Entonces las filas 1, 5 y 11 se ponen a la altura global de fila predeterminada establecida por [LISTBOX SET ROWS HEIGHT](../commands/listbox-set-rows-height) (es decir, 2 líneas) ya que la unidad ha cambiado de píxeles a líneas. Puesto que no hay conversión automática aplicada, el cambio de unidades siempre resulta en altos de fila reinicializados en el nuevo valor por defecto definido.
