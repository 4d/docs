...
<!--REF #_command_.LISTBOX SET ARRAY.Syntax-->**LISTBOX SET ARRAY** ( * ; *objeto* : Text ; *tipoArray* : Integer ; *ptrArray* : Pointer )<br/>**LISTBOX SET ARRAY** ( *objeto* : Variable ; *tipoArray* : Integer ; *ptrArray* : Pointer )<!-- END REF-->
