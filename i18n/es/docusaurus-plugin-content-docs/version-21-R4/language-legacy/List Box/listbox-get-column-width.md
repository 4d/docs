...
<!--REF #_command_.LISTBOX Get column width.Syntax-->**LISTBOX Get column width** ( * ; *objeto* : Text {; *anchoMin* : Integer {; *anchoMax* : Integer}} )  : Integer<br/>**LISTBOX Get column width** ( *objeto* : Variable {; *anchoMin* : Integer {; *anchoMax* : Integer}} )  : Integer<!-- END REF-->
