...
<!--REF #_command_.LISTBOX SET HEADERS HEIGHT.Syntax-->**LISTBOX SET HEADERS HEIGHT** ( * ; *objeto* : Text ; *altura* : Integer {; *unidad* : Integer} )<br/>**LISTBOX SET HEADERS HEIGHT** ( *objeto* : Variable ; *altura* : Integer {; *unidad* : Integer} )<!-- END REF-->
