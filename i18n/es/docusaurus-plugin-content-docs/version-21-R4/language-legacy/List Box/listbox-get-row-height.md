...
<!--REF #_command_.LISTBOX Get row height.Syntax-->**LISTBOX Get row height** ( * ; *objeto* : Text ; *linea* : Integer ) : Integer<br/>**LISTBOX Get row height** ( *objeto* : Variable ; *linea* : Integer ) : Integer<!-- END REF-->
