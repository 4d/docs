...
<!--REF #_command_.LISTBOX GET PRINT INFORMATION.Syntax-->**LISTBOX GET PRINT INFORMATION** ( * ; *objeto* : Text ; *selector* : Integer ; *info* : Integer, Boolean )<br/>**LISTBOX GET PRINT INFORMATION** ( *objeto* : Variable ; *selector* : Integer ; *info* : Integer, Boolean )<!-- END REF-->
...
Este comando debe llamarse en el contexto de la impresión de un list box mediante el comando [Print object](../commands/print-object). Fuera de este contexto, no devuelve valores significativos.
...
| -------------------------- | ------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| lk last printed row number | Entero largo | 0     | Devuelve en *info* el número de la última línea impresa. Permite conocer el número de la próxima línea a imprimir. <br/>El número devuelto puede ser mayor al número de líneas efectivamente impresas si el list box contiene las líneas invisibles o si se llama al comando [OBJECT SET SCROLL POSITION ](../commands/object-set-scroll-position). Por ejemplo, si se han impreso las líneas 1, 18 y 20, *info* es 20\. |
