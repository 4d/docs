...
<!--REF #_command_.QUERY SELECTION BY ATTRIBUTE.Syntax-->**QUERY SELECTION BY ATTRIBUTE** ( {*tabla* : Table ;}{*opConj* : &, \|, # ;} *campoObjeto* : Field ; *rutaAtributo* : Text ; *opBusq* :  Text, >, <, >=, <=, #, =, \|, % ; *valor* : Text, Real, Date, Time {; *} )<!-- END REF-->
