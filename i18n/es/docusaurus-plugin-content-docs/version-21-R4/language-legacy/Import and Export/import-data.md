...
* Guarde el proyecto en el disco, luego cárguelo, utilizando por ejemplo el comando [DOM Parse XML source](../commands/dom-parse-xml-source), y pase su referencia en el parámetro *proyecto*.
