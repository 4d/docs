...
<!--REF #_command_.SELECT LIST ITEMS BY POSITION.Syntax-->**SELECT LIST ITEMS BY POSITION** ( * ; *lista* : Text ; *posicionElem* : Integer {; *posicionArray* : Integer array} )<br/>**SELECT LIST ITEMS BY POSITION** ( *lista* : Integer ; *posicionElem* : Integer {; *posicionArray* : Integer array} )<!-- END REF-->
