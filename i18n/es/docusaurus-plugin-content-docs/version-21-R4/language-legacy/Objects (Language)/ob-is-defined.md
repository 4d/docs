...
<!--REF #_command_.OB Is defined.Syntax-->**OB Is defined** ( *objeto* : Object {; *propiedad* : Text} ) : Boolean<!-- END REF-->
...
<!--REF #_command_.OB Is defined.Summary-->El comando **OB Is defined** devuelve **True** si *objeto* o *propiedad* se definen y **False** en caso contrario.<!-- END REF-->debe haber sido creado con el comando *C\_OBJECT* o designar un campo objeto 4D.  
...
**Nota**: un objeto puede estar definido, pero vacío. Para saber si un objeto no está definido o está vacío, utilice el comando [OB Is empty](../commands/ob-is-empty).  
