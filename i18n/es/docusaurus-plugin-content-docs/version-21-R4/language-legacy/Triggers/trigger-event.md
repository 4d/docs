...
<!--REF #_command_.Trigger event.Summary-->El comando **[Trigger event](../commands/trigger-event)** se llama en un trigger y devuelve un valor numérico que indica el tipo del evento de la base, en otras palabras, la razón por la cual se invoca el trigger.<!-- END REF--> 
