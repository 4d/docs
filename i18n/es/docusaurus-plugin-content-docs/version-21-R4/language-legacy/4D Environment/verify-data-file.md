...
*dataPath* designa un archivo de datos 4D (.4DD). Debe corresponder al fichero de estructura definido por el parámetro *structurePath*. Para verificar el archivo de datos abierto actualmente, utilice el comando [VERIFY CURRENT DATA FILE](../commands/verify-current-data-file).
