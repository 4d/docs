...
<!--REF #_command_.SVG Find element IDs by rect.Syntax-->**SVG Find element IDs by rect** ( * ; *objetoPicture* : Text ; *x* : Integer ; *y* : Integer ; *ancho* : Integer ; *alto* : Integer ; *arrIDs* : Text array ) : Boolean<br/>**SVG Find element IDs by rect** ( *objetoPicture* : Variable, Field ; *x* : Integer ; *y* : Integer ; *ancho* : Integer ; *alto* : Integer ; *arrIDs* : Text array ) : Boolean<!-- END REF-->
