...
<!--REF #_command_.OBJECT SET AUTO SPELLCHECK.Syntax-->**OBJECT SET AUTO SPELLCHECK** ( * ; *objeto* : Text ; *correcionAuto* : Boolean )<br/>**OBJECT SET AUTO SPELLCHECK** ( *objeto* : Variable, Field ; *correcionAuto* : Boolean )<!-- END REF-->
