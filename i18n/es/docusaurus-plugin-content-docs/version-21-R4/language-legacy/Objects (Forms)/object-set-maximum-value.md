...
<!--REF #_command_.OBJECT SET MAXIMUM VALUE.Syntax-->**OBJECT SET MAXIMUM VALUE** ( * ; *objeto* : Text ; *valorMax* : Date, Time, Real )<br/>**OBJECT SET MAXIMUM VALUE** ( *objeto* : Variable, Field ; *valorMax* : Date, Time, Real )<!-- END REF-->
