...
<!--REF #_command_.OBJECT SET SHORTCUT.Syntax-->**OBJECT SET SHORTCUT** ( * ; *objeto* : Text ; *tecla* : Text {; *modificadores* : Integer} )<br/>**OBJECT SET SHORTCUT** ( *objeto* : Variable, Field ; *tecla* : Text {; *modificadores* : Integer} )<!-- END REF-->
