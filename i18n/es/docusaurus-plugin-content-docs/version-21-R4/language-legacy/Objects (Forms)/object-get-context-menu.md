...
Puede configurar la opción "Menú contextual" en modo Diseño utilizando la lista de propiedades o utilizando el comando [OBJECT SET CONTEXT MENU](../commands/object-set-context-menu).  
