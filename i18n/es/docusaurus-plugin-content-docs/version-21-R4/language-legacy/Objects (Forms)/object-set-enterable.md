...
<!--REF #_command_.OBJECT SET ENTERABLE.Syntax-->**OBJECT SET ENTERABLE** ( * ; *objeto* : Text ; *editable* : Boolean, Integer )<br/>**OBJECT SET ENTERABLE** ( *objeto* : Variable, Field, Table ; *editable* : Boolean, Integer )<!-- END REF-->
