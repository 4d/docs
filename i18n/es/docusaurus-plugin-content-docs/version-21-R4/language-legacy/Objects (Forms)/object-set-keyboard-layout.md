...
<!--REF #_command_.OBJECT SET KEYBOARD LAYOUT.Syntax-->**OBJECT SET KEYBOARD LAYOUT** ( * ; *objeto* : Text ; *codigoLeng* : Text )<br/>**OBJECT SET KEYBOARD LAYOUT** ( *objeto* : Variable, Field ; *codigoLeng* : Text )<!-- END REF-->
