...
<!--REF #_command_.ST GET OPTIONS.Syntax-->**ST GET OPTIONS** ( * ; *objeto* : Text ; *opcion* : Integer ; *valor* : Integer {; ...(*opcion* : Integer ; *valor* : Integer)} )<br/>**ST GET OPTIONS** ( *objeto* : Variable, Field ; *opcion* : Integer ; *valor* : Integer {; ...(*opcion* : Integer ; *valor* : Integer)} )<!-- END REF-->
