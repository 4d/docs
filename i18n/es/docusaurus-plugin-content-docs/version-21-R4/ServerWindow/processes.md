...
- **Observar sesión**: permite visualizar, en la [página Sesiones](sessions.md), todos los procesos de la(s) sesión(es) seleccionada(s). Este botón se activa cuando se selecciona al menos un proceso de usuario.
