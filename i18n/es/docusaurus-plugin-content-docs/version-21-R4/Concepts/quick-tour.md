...
| ?2:03:04? + ?1:02:03? ?2:03:04? + ?1:02:03? ?2:03:04? + ?1:02:03? ?2:03:04? + ?1:02:03? ?2:03:04? + ?1:02:03? + ?1:02:03? | Time                   | Esta expresión suma dos horas y devuelve la hora 3:05:07.                                                                                                                                            |
...
- **grupo variable de parámetros**: la notación `{; ...(param1 : Tipo ; param2 : Tipo)}` indica de 1 a un número ilimitado de grupos de parámetros. Por ejemplo, `COLLECTION TO ARRAY( collection : Collection ; array : Array {; propertyName : Text}{; ...(array : Array ; propertyName : Text) })` significa que se puede pasar al comando un número ilimitado de pares de valores de tipo array/texto.

### Descripción del tipo de parámetro

En la documentación del lenguaje 4D se pueden utilizar los siguientes tipos de parámetros.

| Tipo                                                                                | Definición                                                                                                          | Ejemplos de un comando 4D que lo usa                                                                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| > , <, >=, <=, #, =, \| , %       | Comparación, operadores lógicos o símbolos usados en las condiciones o expresiones de una petición. | ORDER BY([Products];[Products]Type;<)<br/>PRINT RECORD([Employees];>) |
...
| Nombre de la clase (ej: 4D.File) | Una referencia a un tipo de clase que se utiliza para crear o manipular instancias de clase.        | $file:=File("/RESOURCES/NovelCover1.jpg")                                                                                                                                                                                                     |
...
| Expression                                                                          | Puede ser cualquier cosa                                                                                            | SET PROCESS VARIABLE($vlProcess;vtCurStatus;"")                                                                                                                                                                                                                               |
