...
| --------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [type](#type)   | text    | Define el tipo de llave a crear: <li>"RSA": genera un par de llaves RSA, utilizando [.size](#size) como tamaño.</li><li>"ECDSA": genera un par de llaves Elliptic Curve Digital Signature Algorithm, utilizando [.curve](#curve) como curva. Tenga en cuenta que las llaves ECDSA no pueden utilizarse para el cifrado, sino solo para la firma.</li><li>"PEM": carga una definición de par de llaves en formato PEM, utilizando [.pem](#pem).</li> |
...
La <!-- REF #CryptoKey.pem.Summary -->definición PEM de una clave de cifrado a cargar. Si la llave es una llave privada, se deducirá de ella la llave pública RSA o ECDSA. <!-- END REF -->
...
| encoding          | text    | Representation of provided signature. Puede ser "Base64", o "Base64URL". Por defecto es "Base64".                                                                                                                                                      |
