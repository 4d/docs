...
- antiguos documentos 4D Write (.4w7 o .4wt). Para una lista detallada de las funcionalidades 4D Write que actualmente están soportadas en objetos 4D Write Pro, consulte la sección [Importación de documentos 4D Write](../user-legacy/importing-4d-write-documents.md).
