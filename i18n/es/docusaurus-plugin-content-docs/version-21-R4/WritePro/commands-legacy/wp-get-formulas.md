...
| \[ \].name       | Texto    | Nombre de la fórmula, si se ha definido un nombre (no se devuelve en caso contrario). Los nombres pueden definirse utilizando [WP INSERT FORMULA](../commands/wp-insert-formula).                                                                               |
