...
1. Haga una de las siguientes cosas:
    ...
    * Seleccione **Abrir/Proyecto local...** desde el menú **Archivo** o del botón**Abrir** de la barra de herramientas. Aparece la caja de diálogo estándar de apertura de archivos.
