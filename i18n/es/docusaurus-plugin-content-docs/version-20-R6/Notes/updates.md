...
- The plug-ins *4D Internet Commands* and *4D for OCI* are no longer included in 4D installers. Para obtener estos plug-ins, necesita conectarse al [**portal de descarga de productos 4D**](https://product-download.4d.com/).
