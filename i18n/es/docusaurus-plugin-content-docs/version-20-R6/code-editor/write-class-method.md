...
- **[warnings](../Project/compiler.md#warnings)** ![warning](../assets/en/code-editor/incorrec-expression-icon.png): los warnings están destinados a llamar su atención sobre declaraciones que podrían llevar a errores de ejecución. No impiden la compilación.
