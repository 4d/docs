...
- `result`: Execution result of the 4D method, returned in the "$0" expression. Este resultado puede ser de cualquier tipo soportado por JavaScript (cadena, número, array, objeto). You can use the `C_OBJECT` command to return the objects.
