...
- **Activo**: dependencias que están cargadas y pueden ser utilizadas en el proyecto. It includes *overloading* dependencies, which are actually loaded. Las dependencias *Overloaded* se enumeran en el panel **Conflicts** junto con todas las dependencias en conflicto.
