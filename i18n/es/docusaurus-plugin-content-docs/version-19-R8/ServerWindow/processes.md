...
| ![](../assets/en/Admin/server-icon-7.png)  | Procedimiento almacenado (proceso lanzado por un 4D conectado y ejecutado en el servidor)                                                                             |
...
| ![](../assets/en/Admin/server-icon-13.png) | Proceso 4D client (proceso que se ejecuta en el 4D conectado)                                                                                                         |
| ![](../assets/en/Admin/server-icon-14.png) | Método web (lanzado por 4DACTION por ejemplo)                                                                                                                         |
| ![](../assets/en/Admin/server-icon-15.png) | Método web (lanzado por 4DACTION por ejemplo)                                                                                                                         |
| ![](../assets/en/Admin/server-icon-16.png) | Método SOAP (apropiativo)                                                                                                                                             |
| ![](../assets/en/Admin/server-icon-17.png) | Método SOAP (lanzado por un Web Service)                                                                                                                              |
| ![](../assets/en/Admin/server-icon-18.png) | Logger (registrador)                                                                                                                                                  |
| ![](../assets/en/Admin/server-icon-19.png) | Gestor de sesiones TCP                                                                                                                                                |
| ![](../assets/en/Admin/server-icon-20.png) | Listener conexión TCP                                                                                                                                                 |
...
| ![](../assets/en/Admin/server-icon-24.png) | Proceso worker (apropiativo)                                                                                                                                          |
| ![](../assets/en/Admin/server-icon-25.png) | Procedimiento almacenado (proceso apropiativo)                                                                                                                        |
