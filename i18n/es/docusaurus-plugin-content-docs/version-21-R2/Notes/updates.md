...
- Las funcionalidades [**Buscar en diseño**](../Project/search-replace.md#search-in-components) y [**Reemplazar en contenido**](../Project/search-replace.md#replace-in-contents) ahora admiten componentes editables.
