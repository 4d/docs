...
Si está acostumbrado a codificar con **VS Code**, también puede utilizar este editor con 4D code después de instalar la extensión [4D-Analyzer](https://github.com/4d/4D-Analyzer-VSCode).
...
| **Información del método**           | ![method-information-icon](../assets/en/code-editor/method-information.png)       | Muestra el diálogo [Propiedades del método](../Project/project-method-properties.md) (sólo métodos proyecto).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
Una función de renombrado global se puede utilizar con **variables** y **métodos proyecto**, que permite renombrarlos de forma segura en todo el proyecto. Para ello, resalte la variable o el nombre del método del proyecto en el editor y seleccione **Renombrar...** en el menú **Método** o en el menú contextual. A continuación, se muestra un cuadro de diálogo, lo que le permite escribir el nuevo nombre. Para más información, consulte la sección [Renombrar los métodos proyecto y las variables](../Project/search-replace.md#renaming-project-methods-and-variables).
...
| `<method_path/>`           | Etiqueta reemplazada por sintaxis de ruta (como se devuelve por [`METHOD Get path`](../commands-legacy/method-get-path.md) del método actual.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
El atributo *in_menu* de la etiqueta `<macro>` se utiliza para definir si la macro aparece o no en este menú.
...
Por defecto, todos los macros son accesibles utilizando la función de autocompletar (también conocida como escritura anticipada) (ver [Escribir un método](./write-class-method.md)). El atributo *type_ahead* de la etiqueta `<macro>` se puede utilizar para excluir una macro de este tipo de operación.
...
Se recomienda gestionar las selecciones de texto utilizando los comandos [GET MACRO PARAMETER](../commands-legacy/get-macro-parameter.md) y [SET MACRO PARAMETER](../commands-legacy/set-macro-parameter.md). Estos comandos pueden utilizarse para superar la partición de los espacios de ejecución del proyecto local/componente y permitir así la creación de componentes dedicados a la gestión de macros. Para activar este modo para una macro, debe declarar el atributo Version con el valor 2 en el elemento Macro. Estos comandos pueden utilizarse para superar la partición de los espacios de ejecución del proyecto local/componente y permitir así la creación de componentes dedicados a la gestión de macros. Este atributo debe declararse así:
