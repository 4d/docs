...
La ejecución síncrona se utiliza cuando:
...
Si desea "forzar" la liberación de un objeto en cualquier momento, utilice una función `.shutdown()` o `terminate()`; esto desencadena el evento `onTerminate` y libera el objeto.
