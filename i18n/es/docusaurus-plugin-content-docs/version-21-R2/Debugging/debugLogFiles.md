...
| 6         | operation_type                                                          | Tipo de operación histórico. Tipo de operación histórico. Tipo de operación histórico. Los valores de las columnas 6, 7 y 8 se repiten en la línea del nivel de pila de cierre. La columna 10 contiene los números de secuencia de apertura del nivel de pila, es decir, 122 para la tercera línea y 121 para la cuarta.                                                           |
