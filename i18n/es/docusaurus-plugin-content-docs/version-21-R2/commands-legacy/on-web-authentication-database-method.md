...
* No llame elementos de interfaz en el Método base On Web Authentication ([ALERT](alert.md), [DIALOG](./commands/dialog), etc.) porque de lo contrario su ejecución se interrumpirá y la conexión será rechazada. Lo mismo sucede si se presenta un error durante su proceso.
