...
<!--REF #_command_.WP Find previous.Syntax-->**WP Find previous**  ( *objTarget* : Object ; *buscarAntes* : Object ; *buscarValor* : Text ; *buscarCondicion* : Integer {; *remplazarValor* : Text} ) -> Resultado<!-- END REF-->
