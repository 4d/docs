...
| IPAddressesToListen                                                              | collection | Sólo 4D Server. Sólo 4D Server. Para más información, consulte [Configuración IP](../settings/client-server.md#ip-configuration-page).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | \["192.168.18.12","192.168.18.10"\]                             |
...
| remoteDebuggerSessionID                                                          | text       | ID de sesión de la aplicación remota a la que está conectado el depurador del servidor. Este ID también es devuelto por [Process activity](../commands/process-activity.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | "A838A40BJN3NJKH..."                                                                                                                                                  |
