...
El evento `On Double Clicked` no es compatible con [**steppers**](FormObjects/stepper.md) en Windows cuando el tema de renderizado [Fluent UI](../FormEditor/forms.md#fluent-ui-rendering) está activado.
