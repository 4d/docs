...
En el método de clase `myClass`, utilice la instrucción `Function <methodName>` para definir el método miembro de clase _methodName_. Un método miembro de clase puede recibir y devolver parámetros como cualquier método, y utilizar `This` como instancia del objeto.
