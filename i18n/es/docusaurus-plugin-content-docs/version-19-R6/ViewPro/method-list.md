...
In *dataContextAttribute*, pass the name of the attribute to bind to *cellRange*. Si *dataContextAttribute* es una cadena vacía, la función elimina el enlace actual.
