...
title: Página del monitor en tiempo real
---
...
> La página de observación en tiempo real utiliza internamente el comando [`GET ACTIVITY SNAPSHOT`](https://doc.4d.com/4dv19/help/command/en/page1277.html). Puede encontrar más información en la descripción de este comando.
...
Al pausar la página, aparece el mensaje "PAUSED" y la etiqueta del botón cambia a **Reanudar**. Puede reanudar el seguimiento de las operaciones realizando la misma acción que para la pausa.
