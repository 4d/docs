...
El editor de código 4D ofrece un control de base de errores de sintaxis. Cuando se ejecuta el código se realiza una comprobación adicional de errores. Para más información sobre cómo gestionar los errores, consulte [Depuración](../Debugging/basics.md).
...
| **temas**                                       | Puede seleccionar el tema Oscuro o Claro, o definir uno personalizado                                                                                                                                                                                                                                              | **Preferencias** > [**Métodos**](../Preferences/methods.md)                                                                                                                                                         |
...
Esta función es extremadamente útil para invertir un conjunto de asignaciones utilizadas para obtener o definir propiedades, o para corregir errores de entrada. Para utilizar esta función, seleccione la(s) línea(s) que desea modificar y, a continuación, elija **Método** > **Intercambiar expresión** o utilice el menú contextual del área. Dentro de la selección, sólo se modificarán las líneas que asignen un valor.
...
- Las macros se pueden llamar utilizando el menú contextual del Editor de Código o utilizando la función de autocompletado (ver la sección siguiente).
...
> El proceso de estructura permanece congelado hasta que se complete la ejecución del método llamado. Debe asegurarse de que la ejecución es rápida y de que no hay riesgo de que bloquee la aplicación. Si esto ocurre, utilice el comando **Ctrl+F8** (Windows) o **Comando+F8** (Mac OS) para "matar" el proceso.
