...
- **Componente**: proyecto matricial, compilado o [generado](Desktop/building.md#compilar-componente), copiado en la carpeta [`Components`](Project/architecture.md) de la aplicación local y cuyo contenido se utiliza en la aplicación local.

## Básicos

La creación e instalación de los componentes 4D se realiza directamente desde 4D:

- Para instalar un componente, simplemente necesita copiar los archivos del componente en la carpeta [`Components` del proyecto](Project/architecture.md). Puede utilizar alias o atajos.
