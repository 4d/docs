...
En _rangeObj_, pase un rango de la celda (creada con [VP Cell](vp-cell.md)) cuya fórmula desea especificar. Si _rangeObj_ incluye varios rangos, sólo se utiliza el primer rango.
