...
El comando `VP PASTE FROM OBJECT` <!-- REF #_method_.PASTE FROM OBJECT.Summary -->pega el contenido, estilo y fórmulas almacenadas en _dataObject_ al objeto _rangeObj_<!-- END REF -->.
