...
El comando `VP NEW DOCUMENT` <!-- REF #_method_.VP NEW DOCUMENT.Summary -->carga y muestra un documento nuevo y predeterminado en el objeto área de formulario de 4D View Pro _vpAreaName_<!-- END REF -->. El nuevo documento vacío sustituye a los datos ya insertados en el área.
