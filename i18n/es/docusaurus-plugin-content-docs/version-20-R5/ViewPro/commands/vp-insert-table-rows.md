...
El comando `VP INSERT TABLE ROWS` <!-- REF #_method_.VP INSERT TABLE ROWS.Summary -->inserta una o _count_ fila(s) vacía(s) en el _tableName_ especificado en el índice _row_ especificado<!-- END REF -->.
