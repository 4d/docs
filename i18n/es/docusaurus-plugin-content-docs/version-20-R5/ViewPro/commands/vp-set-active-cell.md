...
En _rangeObj_, pasa un rango que contenga una sola celda como un objeto (ver [VP Cell](vp-cell.md)). Si _rangeObj_ no es un rango de celdas o contiene varios rangos, se utiliza la primera celda del primer rango.
