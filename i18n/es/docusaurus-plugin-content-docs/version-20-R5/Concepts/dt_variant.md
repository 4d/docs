...
Variant se puede utilizar para declarar parámetros de métodos ($0, $1,...) que puede ser de varios tipos. En este caso, puede construir su código probando el tipo de valor del parámetro, por ejemplo:
