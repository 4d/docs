...
Los comandos [Formula](../commands/formula.md) y [Formula from string](../commands/formula-from-string.md) le permiten crear objetos`4D.Function` para ejecutar cualquier expresión 4D o código expresado como texto.
