...
| key                 | number                | ID of the installed product. A unique number is associated to a 4D application (such as 4D Server, 4D in local mode, 4D Desktop, etc.) instalado en una máquina. Este número está encriptado. | 12356789                                                                          |
