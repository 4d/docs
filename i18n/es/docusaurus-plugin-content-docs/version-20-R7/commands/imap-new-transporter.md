...
| .**password** : Text<br/>contraseña de usuario para la autenticación en el servidor. Not returned in *[IMAP transporter](\(../API/IMAPTransporterClass.md#imap-transporter-object\))* object.                                                                                                                                                                                                                                                                                                                                | ninguno                                                                  |
