...
| **.password** : Text<br/>contraseña de usuario para la autenticación en el servidor. Not returned in *[POP3 transporter](../API/POP3TransporterClass.md#pop3-transporter-object)* object.                                                                                                                                                                                                                                                                                                                               | ninguno                                                                  |
