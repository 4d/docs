...
| ------------------ | ------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Multiple selection | Entero largo | 2     | El usuario puede seleccionar varios registros al tiempo. Para seleccionar registros contiguos, haga clic en el primer registro a seleccionar, luego presione la tecla **Mayús** antes de hacer clic en el último registro a incluir en la selección. Para seleccionar registros no adyacentes, haga clic en cada registro por separado mientras presiona la tecla **Ctrl** (Windows) o **Comando** (macOS). |
