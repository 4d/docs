...
<!--REF #_command_.HTTP Parse message.Summary-->La documentación de este comando está disponible en [developer.<!-- END REF-->4d.com.](../API/HTTPRequestClass.md#http-parse-messege)
