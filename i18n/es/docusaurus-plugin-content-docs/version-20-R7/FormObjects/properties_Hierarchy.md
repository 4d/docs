...
Esta propiedad especifica que el list box debe mostrarse en forma jerárquica. En el formulario JSON, esta función se activa [cuando el valor de la propiedad _dataSource_ es un array](properties_Object.md#hierarchical-list-box), es decir, una colección.
