...
- También puede [adjuntar el depurador de Qodly Studio a una aplicación 4D Server](developer.4d.com/qodly/4DQodlyPro/debugging#using-qodly-debugger-on-4d-server) si necesita depurar páginas Qodly en un entorno desplegado.
