...
| write\_duration                                                                  | Tiempo tomado en microsegundos para enviar la:<li>Petición (cuando se ejecuta en el cliente). A to B in image below.</li><li>Respuesta (cuando se ejecuta en el servidor). E a F en la imagen de abajo.</li>                                                                                                                                                                                        |
