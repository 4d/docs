...
| AIProviders.json                             | *Estructura* [Archivo de configuración del proveedor de IA](../settings/ai.md#aiprovidersjson). Se puede anular mediante un archivo AIProviders.json añadido en *[configuración de usuario](#settings-user)* o *[configuración de datos del usuario](#settings-user-data)* (ver también [Prioridad de la configuración](../settings/overview.md#priority-of-settings).                                                                                                                                                                                                                                                                                                                               | JSON    |
...
| AIProviders.json    | [Archivo de configuración de proveedor de IA](../settings/ai.md#aiprovidersjson) para este proyecto (todos los archivos de datos)                                                                                                                                                                                                                                                                                                                                                            | JSON    |
