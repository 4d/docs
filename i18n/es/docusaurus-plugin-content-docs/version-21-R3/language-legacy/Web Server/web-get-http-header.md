...
Este comando puede llamarse desde cualquier método (*Método de base On Web Authentication*, [On Web Connection](../commands/on-web-connection-database-method), método llamado por "*/4DACTION"*...) ejecutado en un proceso web.
...
* Este es un ejemplo de hosts virtuales (por ejemplo en el [On Web Connection](../commands/on-web-connection-database-method)). Los siguiente nombres "home\_site.com", "home\_site1.com" y "home\_site2.com" apuntan a la misma dirección IP, por ejemplo 192.1.2.3.
