...
<!--REF #_command_.ST Get expression.Syntax-->**ST Get expression** ( * ; *objeto* : Text {; *inicioSel* : Integer {; *finSel* : Integer}} )  : Text<br/>**ST Get expression** ( *objeto* : Field, Variable {; *inicioSel* : Integer {; *finSel* : Integer}} )  : Text<!-- END REF-->
