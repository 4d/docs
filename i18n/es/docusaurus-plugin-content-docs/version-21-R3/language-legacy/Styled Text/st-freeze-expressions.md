...
Para más información acerca de expresiones 4D usadas en áreas de texto multiestilo o 4D Write Pro, consulte la descripción del comando [ST INSERT EXPRESSION](../commands/st-insert-expression).
