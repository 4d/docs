...
Puede comparar el valor devuelto con las constantes del tema *List box cálculo pie*  (ver el comando [LISTBOX SET FOOTER CALCULATION](../commands/listbox-set-footer-calculation)).
