...
Los comandos [`File`](../commands/file) y [`Folder`](../commands/folder) sólo aceptan **rutas absolutas**. Las rutas relativas no están soportadas y devolverán errores. For example, the following code is not allowed:
