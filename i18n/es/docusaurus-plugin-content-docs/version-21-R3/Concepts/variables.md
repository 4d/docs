...
| `cs.<namespace>`cs.<namespace> | Objeto del componente `<namespace>` nombre de la clase |
...
| `Error`, `Error line`             | Integer | Ver [Gestión de errores en el método](../Concepts/error-handling.md#handling-errors-within-the-method). Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `Error method`, `Error formula`   | Text    | Ver [Gestión de errores en el método](../Concepts/error-handling.md#handling-errors-within-the-method). Utilizado en un método de captura de errores instalado por el comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
