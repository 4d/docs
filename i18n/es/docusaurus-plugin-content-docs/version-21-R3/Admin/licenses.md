...
| *4D Desktop*                  | Licencia por equipo, que permite el uso de aplicaciones 4D autónomas                         | Diálogo [Primera activación](#first-activation) en la máquina usuario            |
| *4D Desktop Business Edition* | Licencia personalizada integrada para aplicaciones 4D independientes                         | Página [Licencias](../Desktop/building.md#licenses) del diálogo Crear aplicación |
