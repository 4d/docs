...
| `<method_path/>`           | Etiqueta reemplazada por sintaxis de ruta (como se devuelve por [`METHOD Get path`](../commands/method-get-path) del método actual.                                                                                                                                                                                                                                                                                                                                                                                                                       |
