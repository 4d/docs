...
|                                                                                                                                                                                                                                                                                                                 |                       | llamar al comando [`Execute on server`](../commands/execute-on-server). The code is executed in the [Stored procedures session](./sessions.md#stored-procedure-sessions)                                    |
