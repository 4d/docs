...
| Nombre     | Tipos de datos | Valores posibles          |
| ---------- | -------------- | ------------------------- |
| detailForm | string         | <ul><li>Nombre (cadena) de la tabla o formulario proyecto</li><li>Ruta POSIX (cadena) a un archivo .json que describe el formulario</li><li>Objeto que describe el formulario</li></ul> |
