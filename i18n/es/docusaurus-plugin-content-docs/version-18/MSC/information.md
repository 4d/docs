...
- **Encriptado**: si se marca, los registros de la tabla se cifran en el archivo de datos. **Encrypted**: If checked, the records of the table are encrypted in the data file.
