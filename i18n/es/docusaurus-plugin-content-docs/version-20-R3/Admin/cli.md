...
| `--user-param`                                                                                                                                                                                | Cadena usuario personalizada                         | Una cadena que estará disponible dentro de la aplicación a través del comando [`Get database parameter`](https://doc.4d.com/4dv19R/help/command/en/page643.html) (la cadena no debe comenzar con un caracter "-", que está reservado).                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
