...
| Contiene palabra clave    | Imagen % Cadena        | Boolean  | Returns true if the string is associated with the picture stored in the picture expression. Ver `GET PICTURE KEYWORDS`                                                                |
