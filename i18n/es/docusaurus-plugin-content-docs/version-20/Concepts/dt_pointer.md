...
```4d
  ...
  //$changeUp – Pointer to a string field or variable. Cambia la cadena a mayúsculas.
  //$changeLow – Pointer to a string field or variable. Cambia la cadena a minúsculas.
