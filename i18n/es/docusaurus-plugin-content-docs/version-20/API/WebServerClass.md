...
The <!-- REF #WebServerClass.perfectForwardSecrecy.Summary -->disponibilidad de PFS en el servidor<!-- END REF -->.
...
The <!-- REF #WebServerClass.rootFolder.Summary -->ruta de la carpeta raíz del servidor web<!-- END REF -->. La ruta se formatea en la ruta completa POSIX utilizando filesystems. Cuando se utiliza esta propiedad en el parámetro `settings`, puede ser un objeto `Folder`.
