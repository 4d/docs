...
| .**accessTokenOAuth2**: Text<br/>.**accessTokenOAuth2**: Object<br/>Cadena de texto u objeto token que representa las credenciales de autorización OAuth2. Sólo se utiliza con OAUTH2 `authenticationMode`. Si se utiliza `accessTokenOAuth2` pero se omite `authenticationMode`, se utiliza el protocolo OAuth 2 (si el servidor lo permite). Not returned in *[POP3 transporter](#pop3-transporter-object)* object. | ninguno                                                                  |
...
| **.password**: Text<br/>Contraseña de usuario para la autenticación en el servidor. Not returned in *[POP3 transporter](#pop3-transporter-object)* object.                                                                                                                                                                                                                                                                  | ninguno                                                                  |
