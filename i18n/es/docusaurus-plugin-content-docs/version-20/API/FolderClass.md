...
En el parámetro *path*, pase una ruta de carpeta. Puede utilizar una cadena personalizada o un [sistema de archivos](../Concepts/paths.md#filesystem-pathnames) (por ejemplo, "/DATA").
