...
2. Elija **Agrupar** en el menú Objetos. Ahora, al modificar el objeto agrupado, se modifican todos los objetos que componen el grupo. O Haga clic en el botón Agrupar en la barra de herramientas del editor de formularios:<br/>![](../assets/en/FormEditor/group.png) 4D marca el límite de los objetos recién agrupados con manijas. No hay marcas que delimiten ninguno de los objetos individuales del grupo.
