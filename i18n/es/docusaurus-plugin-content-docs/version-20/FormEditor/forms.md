...
- **Código JSON:** cree y diseñe sus formularios utilizando JSON y guarde los archivos de formulario en la [ubicación adecuada](Project/architecture#sources). Ejemplo:
