...
| On After Sort        | <li>[columna](./listbox-object#additional-properties)</li><li>[nombreColumna](./listbox-object#additional-properties)</li><li>[nombreEncabezado](./listbox-object#additional-properties)</li>                                                                                                          | *Las fórmulas compuestas no se pueden ordenar. <br/>(por ejemplo, This.firstName + This.lastName)* |
