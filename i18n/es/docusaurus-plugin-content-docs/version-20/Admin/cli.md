...
| `
          --webadmin-store-settings` |                                                      | | |</code> --webadmin-store-settings`|                                                      | Almacena la llave de acceso y los parámetros de inicio automático en el archivo de parámetros actual (es decir, el archivo [`WebAdmin.4DSettings`](webAdmin.md#webadmin-settings) por defecto o un archivo personalizado designado por el parámetro`--webadmin-settings-path`). Utilice el argumento`--webadmin-store-settings`para guardar estos parámetros si es necesario. No disponible con la herramienta <a href="#tool4d">4d</a>.</td>
</tr>
<tr>
  <td align="left"><code>--utility`                                                                                                                             |                  | | |</code>--utility`|                                                      | Sólo disponible con 4D Server. Inicia [4D Server en modo utilitario](#4d-server-in-utility-mode).</td>
</tr>
<tr>
  <td align="left"><code>--skip-onstartup`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |  | Lanza el proyecto sin ejecutar ningún método "automático", incluidos los métodos base `On Startup` y `On Exit` |
