...
| `--user-param`                         | Cadena usuario personalizada                         | Permite pasar una cadena personalizada recuperable mediante `database parameter` (la cadena no debe comenzar con un caracter "-", que está reservado). |
