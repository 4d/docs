...
| version                 | Number                  | Número de lanzamiento de la aplicación 4D                                                              |
...
Los datos recopilados se guardan en un archivo de texto (formato JSON) para cada base de datos cuando se producen determinados eventos, como al iniciar o cerrar 4D Server. El archivo se almacena dentro de la [carpeta 4D activa](https://doc.4d.com/4dv20/help/command/en/page485.html), es decir.:
