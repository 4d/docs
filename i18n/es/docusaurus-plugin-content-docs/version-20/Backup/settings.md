...
- **Datos**: archivo de datos de la aplicación. Cuando esta opción está marcada, los siguientes elementos se copian automáticamente al mismo tiempo que los datos:
    ...
    - la carpeta `Settings` ubicada [al lado del archivo de datos](Project/architecture.md#settings-user-data) (si existe), es decir, la configuración de usuario *para los datos*.
