...
Este evento también se activa cuando se ha realizado una operación de soltar en el área Web (con los [motores](../FormObjects/properties_WebArea.md#use-embedded-web-rendering-engine) sistema integrados y Windows) si la opción [Arrastrar y soltar](../FormObjects/webArea_overview.md#user-interface) también está activada para el área. Puede aceptar la acción de soltar llamando:
