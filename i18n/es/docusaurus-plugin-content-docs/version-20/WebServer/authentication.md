...
> * No llame a ningún elemento de interfaz en el método base `On Web Authentication` (`ALERT`, `DIALOG`, etc.), ya que de lo contrario su ejecución se interrumpirá y la conexión será rechazada. Lo mismo ocurrirá si se produce un error durante su procesamiento.
