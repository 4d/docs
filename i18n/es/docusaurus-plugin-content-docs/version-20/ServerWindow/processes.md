...
Al igual que la página Usuarios, esta página contiene un [área de búsqueda/filtrado](users.md#searchfiltering-area) dinámica que puede utilizarse para reducir el número de líneas mostradas en la lista a las que corresponden al texto introducido en el área de búsqueda. La búsqueda/filtrado se realiza en las columnas Sesión y Nombre del proceso.
...
> También puede abortar directamente los procesos seleccionados sin mostrar la caja de diálogo de confirmación, manteniendo presionada la tecla **Alt** mientras presiona este botón, o utilizando el comando [`ABORT PROCESS BY ID`](https://doc.4d.com/4dv19/help/command/en/page1634.html).
