...
A maioria desses atalhos pode ser personalizada na caixa de diálogo [Preferencies 4D](../Preferences/shortcuts.md).
...
Você pode mover a linha onde o cursor está diretamente, sem selecioná-la primeiro, usando os comandos **Mover Linhas para Cima** e **Mover Linhas para Baixo** no menu **Método**. Você também pode fazer isso usando **Alt/Option** + **Seta para cima** ou **Seta para baixo** [atalho de teclado](#shortcuts).
