...
| typeInference          | String                | "all": Digita todas as variáveis, "locals": Processo e interprocesso são digitadas, "none": Todas as variáveis são digitadas                                                                        |
...
| **Propriedade**                                        | **Tipo** | **Descrição**                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type                                                   | String   | "projectMethod", "formObjectMethod", "formmethod","databaseMethod", "triggerMethod", "executeOnServer" (when calling a project method with the *Executar no atributo servidor*.), "executeFormula" (when executing a formula via [PROCESS 4D TAGS](process-4d-tags.md) or the evaluation of a formula in a 4D Write Pro document.), "class", "classFunction"|
| path                                                   | String   | Rota método (mesmo formato que [METHOD OPEN PATH](method-open-path.md))                                                                                                                                                                                                                                                                                                                   |
