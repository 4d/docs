...
O comando OPEN PRINTING JOB pode ser utilizado com todos os comandos de impressão 4D, os comandos do editor de relatórios rápidos, e os comandos de impressão dos plug-ins 4D Write.
