...
Essa propriedade especifica que o list box deve ser exibido em forma hierárquica. No formulário JSON, esse recurso é acionado [quando o valor da propriedade *dataSource* é um array](properties_Object.md#hierarchical-list-box), ou seja, uma coleção.
