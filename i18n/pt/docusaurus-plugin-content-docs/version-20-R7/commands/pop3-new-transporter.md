...
| **.password** : Text<br/>Senha do usuário para autenticação no servidor. Not returned in *[POP3 transporter](../API/POP3TransporterClass.md#pop3-transporter-object)* object.                                                                                                                                                                                                                                                                                                                                               | nenhum                                                            |
