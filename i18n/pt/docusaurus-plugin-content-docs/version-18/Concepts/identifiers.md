...
- Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") e colchetes ("[ ]") não são permitidos em nomes de tabelas, campos, métodos ou variáveis.
...
- Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") Pontos (".") e parênteses ("[ ]") não são permitidos.
