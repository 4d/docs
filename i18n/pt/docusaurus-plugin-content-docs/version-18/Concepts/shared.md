...
- Several **Use... End use** structures can be nested in the 4D code. Nesse caso, todos os bloqueios são empilhados e as propriedades/elementos se libertarão só quando se execute a última chamada de End use.
