...
The 4D tags such as `4DEVAL`, `4DTEXT`, `4DHTML`... as well as the [`/4DACTION URL`](./httpRequests.md#4daction) allow you to trigger the execution of any project method of a 4D project published on the Web. Por exemplo, a solicitação *<http://www.server.com/4DACTION/login>* causa a execução do método projeto ***login***, se ele existir.
