...
- ***parâmetro web*** significa que o modo preventivo depende de um valor de configuração:
  - quando a opção [**Sessões escalonáveis**](sessions.md#enabling-sessions) estiver selecionada, o modo preemptivo será usado automaticamente para os processos Web.
