...
> No Windows, em clientes fusionados, a localização das pastas incorporadas é modificada se for utilizada a tecla `ShareLocalResourcesOnWindowsClient` [BuildApp key](../Desktop/building.md#build-application-settings).
