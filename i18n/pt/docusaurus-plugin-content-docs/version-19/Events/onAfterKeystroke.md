...
- no [lista colunas](FormObjects/listbox-column.md) método, exceto quando uma célula está sendo editada (entretanto, ela é gerada em quaisquer casos no método [lista caixa](FormObjects/listbox_overview.md)),
