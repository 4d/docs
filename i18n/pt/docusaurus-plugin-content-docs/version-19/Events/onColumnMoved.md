...
| ---- | ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| 32   | [Caixa de Listagem](FormObjects/listbox_overview.md) - [Coluna da caixa de listagem](FormObjects/listbox-column.md) | Uma coluna do list box é movida pelo utilizador através de arrastar e largar |
