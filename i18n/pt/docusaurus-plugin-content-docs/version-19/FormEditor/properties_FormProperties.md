...
O nome do formulário é definido pelo nome da pasta que contém o arquivo form.4Dform. Consulte a [arquitetura do projeto](Project/architecture.md#sources-folder) para obter mais informações.
