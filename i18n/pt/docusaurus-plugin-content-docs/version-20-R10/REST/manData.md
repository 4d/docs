...
Uma nova seleção de entidades é retornada; no entanto, você também pode criar uma entidade definida chamando [`$method=entityset`]($method.md#methodentityset) no final da solicitação REST.
