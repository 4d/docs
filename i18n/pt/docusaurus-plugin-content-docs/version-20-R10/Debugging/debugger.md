...
- Você também pode [anexar o depurador do Qodly Studio a um aplicativo do Servidor 4D](developer.4d.com/qodly/4DQodlyPro/debugging#using-qodly-debugger-on-4d-server) se você precisar depurar páginas Qodly em um ambiente implantado.
