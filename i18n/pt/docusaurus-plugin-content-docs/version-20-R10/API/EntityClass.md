...
| `dk status locked`                        | 3     | A entidade está trancada por um bloqueio pessimista.<br/> **Texto de status**: "Já bloqueado"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<!-- REF #EntityClass.getKey().Syntax -->**.getKey**( { *mode* : Integer } ) : qualquer<!-- END REF -->
