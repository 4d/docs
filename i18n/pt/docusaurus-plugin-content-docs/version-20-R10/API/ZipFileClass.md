...
As seguintes propriedades e funções da classe [File](FileClass.md) estão disponíveis para os objetos `ZIPFile`:

| APIs disponíveis de [File](FileClass.md) para ZIPFile                               | Comentário                             |
| ----------------------------------------------------------------------------------- | -------------------------------------- |
