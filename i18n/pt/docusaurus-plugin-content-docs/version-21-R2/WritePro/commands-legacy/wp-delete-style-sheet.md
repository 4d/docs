...
* o objeto folha de estilo (criado com [WP New style sheet](../WritePro/commands/wp-new-style-sheet) ou devolvido pelo comando [WP Get style sheet](../WritePro/commands/wp-get-style-sheet)) para eliminar no parâmetro *tipoFolhaEstilo*, ou
