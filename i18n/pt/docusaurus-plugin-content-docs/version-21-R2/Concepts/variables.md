...
| `Error`, `Error line`           | Integer | Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands-legacy/on-err-call.md). Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `Error method`, `Error formula` | Text    | Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands-legacy/on-err-call.md). Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands/on-err-call).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
