...
Este comando pode ser utilizado com os comandos[PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form), e [QR REPORT](qr-report.md) e se aplica a todas as impressões de 4D, incluso no ambiente Desenho.  
