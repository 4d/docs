...
<!--REF #_command_.Open window.Syntax-->**Open window** ( *esquerda* : Integer ; *superior* : Integer ; *direita* : Integer ; *inferior* : Integer {; *tipo* : Integer {; *titulo* : Text {; *caixaFechar* : Text}}} ) : Integer<!-- END REF-->
...
**Nota**: também pode administrar o fechamento da janela desde o método do formulário mostrado na janela quando ocorrer um evento On Close Box. Para maior informação, consulte o comando [Form event code](./commands/form-event-code)  
