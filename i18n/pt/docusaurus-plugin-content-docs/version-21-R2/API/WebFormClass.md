...
The `WebForm` class contains functions and properties allowing to handle your Qodly web page components. The returned objects are of the [`4D.WebFormItem`](WebFormItemClass.md) class.
