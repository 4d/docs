...
To return a new string with whitespace trimmed from both ends, use [`Trim`](./trim.md). To return a new string with whitespace trimmed from both ends, use [`Trim`](./trim.md).
