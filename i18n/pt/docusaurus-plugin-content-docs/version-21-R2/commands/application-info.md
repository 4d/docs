...
| IPAddressesToListen                                                              | collection | 4D Server only. 4D Server only. For more information, see [IP configuration](../settings/client-server.md#ip-configuration-page).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | \["192.168.18.12","192.168.18.10"\]                             |
