...
O comando `VP Get names` <!-- REF #_method_.VP Get names.Summary -->retorna uma coleção de todos os "nomes" definidos na folha atual ou no escopo designado pelo parâmetro *escopo*<!-- END REF -->.
