...
> Uma sessão remota de sono é automaticamente desligada pelo servidor após 48 horas de inatividade. Você pode modificar esse tempo limite padrão usando o comando [`SET DATABASE PARAMETER`](../commands-legacy/set-database-parameter.md) com o seletor `Remote connection sleep timeout`.
