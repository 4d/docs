...
In *rangeObj*, pass a range of the cell(s) (created for example with [`VP Cell`](vp-cell) or [`VP Column`](vp-column.md)) whose value you want to specify. Se *rangeObj* incluir várias células, o valor especificado será repetido em cada célula.
