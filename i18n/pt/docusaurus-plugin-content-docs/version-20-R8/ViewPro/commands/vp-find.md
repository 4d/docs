...
| afterRow    | Integer    | O número da linha imediatamente anterior à linha inicial da pesquisa. Se *rangeObj* for um intervalo combinado, o número da linha fornecido deverá ser do primeiro intervalo. Valor padrão: -1 (início do *rangeObj*)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
