...
Um loop `Repeat... Until` é similar a um loop [While... End while](flow-control.md#whileend-while), exceto que comprova a expressão booleana depois do loop  e não antes.
