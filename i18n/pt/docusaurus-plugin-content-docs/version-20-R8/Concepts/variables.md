...
Quando cria a sua base de dados 4D, especifica os nomes e tipos de campos que pretende utilizar. Variables are much the same—you also give them names and different types (see [Data types](data-types.md)).
