...
| **update**   | Atualizar atributos em qualquer classe de dados.                                     | Update attributes in this dataclass.                                                                                                            | Update this attribute content (ignored for alias attributes).                                                         | n/a                                                                                                                                                                                                                                                                      |
