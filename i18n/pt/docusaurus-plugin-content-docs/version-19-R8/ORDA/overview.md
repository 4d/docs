...
Basically, ORDA handles objects. No ORDA, todos os conceitos principais, incluindo o próprio datastore, estão disponíveis através de objectos. In 4D, the datastore is automatically [mapped upon the 4D structure](dsMapping.md).
