...
Tanto a sintaxe [named](#named-parameters) como [seqüencial](#sequential-parameters)  podem ser misturadas sem restrições para declarar parâmetros. Por exemplo:
...
```4d
  //Código do método DO_SOMETHING
  //Assume que todos os parâmetros são do tipo texto
 C_TEXT($1;$2;$3)
