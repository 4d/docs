...
Para comparar dois reais por igualdade, a linguagem 4D realmente compara o valor absoluto da diferença com *epsilon*. Consulte o comando [`SET REAL COMPARISON LEVEL`](./commands/set-real-comparison-level).
