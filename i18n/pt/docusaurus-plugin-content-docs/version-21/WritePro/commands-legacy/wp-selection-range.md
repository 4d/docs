...
<!--REF #_command_.WP Selection range.Summary-->O comando **WP Selection range** devolve um novo objeto faixa ou um objeto imagem baseado no conteúdo atualmente selecionado na área *wpArea* 4D Write Pro.<!-- END REF--> 
