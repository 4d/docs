...
*dataPath* designa um arquivo de dados 4D (.4DD). Deve corresponder ao arquivo de estrutura definido pelo parâmetro *structurePath*. Para verificar o arquivo de dados aberto no momento, use o comando [VERIFY CURRENT DATA FILE](verify-current-data-file.md).
