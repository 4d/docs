...
Se você marcar a opção [**Gerar o arquivo de símbolos**](#symbol-file) nas configurações do compilador, um arquivo de símbolo chamado \`ProjectName_symbols. It is divided into several parts:
