...
| ---- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 41   | [Caixa de Listagem](FormObjects/listbox_overview.md) - [Coluna da caixa de listagem](FormObjects/listbox-column.md) | Uma célula de um list box está prestes a mudar para o modo de edição |
