...
- Endereço de rede ****: O endereço IP da máquina onde o servidor 4D foi iniciado.
  - Se dois servidores forem executados simultaneamente na mesma máquina, o endereço IP deve ser seguido por um dobro e número da porta, por exemplo: `192. 68.92.104:19814`.
