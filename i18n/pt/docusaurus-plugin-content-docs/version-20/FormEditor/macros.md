...
Esse menu é construído com base no(s) [arquivo(s) de definição de macro](#location-of-macro-file) `formMacros.json`. Os itens de macro estão ordenados por ordem alfabética.
