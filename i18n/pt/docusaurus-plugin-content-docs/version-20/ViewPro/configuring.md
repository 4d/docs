...
Style sheets are created with the [VP ADD STYLESHEET](method-list.md#vp-add-stylesheet) command and applied with the the [VP SET DEFAULT STYLE](method-list.md#vp-set-default-style) or [VP SET CELL STYLE](method-list.md#vp-set-cell-style) commands. Você pode remover uma folha de estilo com o comando [VP REMOVE STYLESHEET](method-list.md#vp-remove-stylesheet).
