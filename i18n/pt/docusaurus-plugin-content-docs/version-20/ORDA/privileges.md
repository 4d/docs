...
| **describe** | Todas as classes de dados estão disponíveis na /rest/$catalog API                    | This dataclass is available in the /rest/$catalog API                                                                                                | Esse atributo está disponível na API /rest/$catalog.                                                                  | Esta função de classe de dados está disponível na API /rest/$catalog                                                                                                                                                                                                     |
