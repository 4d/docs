...
Uma vez inserido, o separador aparece como uma linha. Você pode modificar [o estilo da borda](properties_BackgroundAndBorder.md#border-line-style) para obter uma linha mais fina ou [alterar sua cor](properties_BackgroundAndBorder.md#line-color).
