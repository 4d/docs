...
| disabled            | boolean | Desactiva a linha correspondente. As áreas acessíveis deixam de ser acessíveis se esta opção estiver activada. O texto e os controlos (caixas de verificação, listas, etc.) aparecem esbatidos ou a cinzento. Esta definição é ignorada se o modo de seleção do list box é "Nenhum".                                                                                                                                                                             |
