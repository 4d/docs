...
| [4D NetKit](https://github.com/4d/4D-NetKit/tree/20.x)                        | Set of tools to connect to third-party APIs                                                                    | `OAuth2Provider` class, `New OAuth2 provider`, `OAuth2ProviderObject.getToken()`                             |
