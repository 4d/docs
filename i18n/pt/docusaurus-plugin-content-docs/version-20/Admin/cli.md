...
| `--webadmin-settings-file`  | Rota do arquivo                                    | Armazena a chave de acesso e inicia automaticamente os parâmetros nas configurações de arquivo utilizadas (ou seja, o arquivo padrão [`WebAdmin.4DSettings`](webAdmin.md#webadmin-settings) ou um arquivo personalizado designado pelo parâmetro `--webadmin-settings-path`). Use o argumento `--webadmin-store-settings` para salvar essas configurações se necessário Não disponível com [tool4d](#tool4d).                                                                                                                                                                                                                   |
| `--webadmin-access-key`     | Text                                               | Chave de acesso para o servidor web [WebAdmin](webAdmin.md) Não disponível com [tool4d](#tool4d). Use o argumento `--webadmin-store-settings` para salvar essas configurações se necessário Não disponível com [tool4d](#tool4d).                                                                                                                                                                                                                                                                                                                                                                                               |
| `--webadmin-auto-start`     | Parâmetros                                         | Estado do início automático para o servidor [WebAdmin](webAdmin.md) Não disponível com [tool4d](#tool4d). Use o argumento `--webadmin-store-settings` para salvar essas configurações se necessário Não disponível com [tool4d](#tool4d).                                                                                                                                                                                                                                                                                                                                                                                       |
| `--webadmin-store-settings` |                                                    | Rota do arquivo personalizado WebAdmin `.4DSettings` para o  [servidor WebAdmin](webAdmin.md) Não disponível com [tool4d](#tool4d). Use o argumento `--webadmin-store-settings` para salvar essas configurações se necessário Use o argumento `--webadmin-store-settings` para salvar essas configurações se necessário Não disponível com [tool4d](#tool4d).                                                                                                                                                                                                                                                                   |
