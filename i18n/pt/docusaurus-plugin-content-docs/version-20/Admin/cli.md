...
| `--webadmin-store-settings` |                                                    | Armazena a chave de acesso e os parâmetros de arranque automático no ficheiro de definições utilizado (ou seja, o ficheiro padrão [`WebAdmin.4DSettings`](webAdmin.md#webadmin-settings) ou um ficheiro personalizado designado pelo parâmetro `--webadmin-settings-path`). Não disponível com [tool4d](#tool4d).                                                                                                                                                                                                                                                                   |
