...
O comando `VP Object to font` <!-- REF #_method_.VP Object to font.Summary -->retorna uma string abreviada de fonte de _fontObj_<!-- END REF -->.

Em _fontObj_, passe um objeto que contém as propriedades da fonte. As propriedades abaixo são compatíveis:
