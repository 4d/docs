...
Em _rangeObj_, passe um intervalo cujas fórmulas você deseja recuperar. If _rangeObj_ designates multiple ranges, the formula of the first range is returned. If _rangeObj_ does not contain any formulas, the command returns an empty string.
