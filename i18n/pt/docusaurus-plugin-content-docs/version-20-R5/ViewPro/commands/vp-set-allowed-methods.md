...
|                  | parameters |                                                                                | Uma coleção de objetos | Coleção de parâmetros (na ordem em que são definidos no método). For more information, please refer to the [Parameters](../formulas.md#parameters) section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
