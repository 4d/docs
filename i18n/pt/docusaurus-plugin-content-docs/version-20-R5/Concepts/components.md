...
A instalação e o carregamento de componentes em seus projetos 4D são feitos por meio do [gerenciador de pacotes 4D] (../Project/components.md).
...
Se o componente for compilado, seu [namespace](../Extensions/develop-components.md#declaring-the-component-namespace) será escrito entre parênteses após seu nome. Use esse namespace para acessar as funções do componente.
