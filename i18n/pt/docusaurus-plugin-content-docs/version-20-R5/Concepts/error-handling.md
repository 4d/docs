...
Dentro de um método de erro personalizado, você tem acesso a várias informações que ajudarão você a identificar o erro:

- variáveis de sistema dedicadas:
