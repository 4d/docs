...
4D acepta varios `filesystem` que designan las carpetas 4D específicas con una ubicación variable en macOS y Windows. Os nomes de caminho do sistema de arquivos são úteis por duas razões principais:
