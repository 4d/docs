...
Para fechar a base atual no servidor, pode selecionar o comando de menu **Fechar a base...** no servidor. Também pode escolher o comando **Sair** ou chamar ao comando [QUIT 4D](../commands/quit-4d) dentro de um procedimento armazenado executado no servidor.
...
Se deseja que o código se execute automaticamente em uma máquina cliente quando um 4D remoto deixa de conectar-se ao servidor, utilize o [Semaphore](../commands/semaphore).
