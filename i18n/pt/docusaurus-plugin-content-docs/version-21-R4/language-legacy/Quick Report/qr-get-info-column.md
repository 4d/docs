...
<!--REF #_command_.QR GET INFO COLUMN.Syntax-->**QR GET INFO COLUMN** ( *area* : Integer ; *numColuna* : Integer ; *titulo* : Text ; *objeto* : Text ; *ocultar* : Integer ; *tamanho* : Integer ; *valoresRepetidos* : Integer ; *formato* : Text {; *resultVar* : Text} )<!-- END REF-->
...
**Nota:** o comando não leva em conta nenhuma estrutura virtual definida por meio dos comandos [SET TABLE TITLES](../commands/set-table-titles) e [SET FIELD TITLES](../commands/set-field-titles). O nome real do campo se devolve no parâmetro *objeto*.   
