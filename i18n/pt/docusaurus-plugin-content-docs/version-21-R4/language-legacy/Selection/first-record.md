...
Este comando é utilizado com frequência depois do comando [USE SET](../commands/use-set) para iniciar um loop na seleção de registros a partir do primeiro registro. Entretanto, também pode ser chamado desde uma sub-rotina se não estiver seguro de se o registro atual é realmente o primeiro.
