...
Estas propriedades podem ser definidas com a ajuda do comando [SET LIST PROPERTIES](../commands/set-list-properties) ou no editor de listas no ambiente Desenho, se a lista foi criada no editor ou guardada utilizando o comando [SAVE LIST](../commands/save-list).

Para uma completa descrição da aparência, ícones de knots, altura de linha mínima e administração de uma lista com duplo clique, consulte o comando [SET LIST PROPERTIES](../commands/set-list-properties).
