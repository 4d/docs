...
<!--REF #_command_.DOM Get first child XML element.Syntax-->**DOM Get first child XML element** ( *refElemento* : Text {; *nomElemFilho* : Text {; *valorElemFilho* : any}} ) : Text<!-- END REF-->
