...
<!--REF #_command_.DOM Get previous sibling XML element.Syntax-->**DOM Get previous sibling XML element** ( *refElemento* : Text {; *nomeElemIrmao* : Text {; *valorElemIrmao* : any}} ) : Text<!-- END REF-->
