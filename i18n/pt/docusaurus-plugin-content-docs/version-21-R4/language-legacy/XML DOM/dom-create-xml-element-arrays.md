...
<!--REF #_command_.DOM Create XML element arrays.Syntax-->**DOM Create XML element arrays** ( *arrayNomesAtrib* : Text ; *xRota* : Text {; ...(*atribNomesArray* : Text array ; *atribValoresArray* : Text array)} ) : Text<!-- END REF-->
