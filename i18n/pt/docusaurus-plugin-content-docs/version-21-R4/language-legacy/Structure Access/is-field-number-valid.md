...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *pontTabela* : Pointer ; *numCampo* : Integer ) : Boolean<br/>**Is field number valid** ( *numTabela* : Integer ; *numCampo* : Integer ) : Boolean<!-- END REF--> 
