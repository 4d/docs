...
<!--REF #_command_.ST SET TEXT.Syntax-->**ST SET TEXT** ( * ; *objeto* : Text ; *novoTexto* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<br/>**ST SET TEXT** ( *objeto* : Variable, Field ; *novoTexto* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<!-- END REF-->
