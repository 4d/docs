...
<!--REF #_command_.ST GET URL.Syntax-->**ST GET URL** ( * ; *objeto* : Text ; *textoURL* : Text ; *enderecoURL* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<br/>**ST GET URL** ( *objeto* : Variable, Field ; *textoURL* : Text ; *enderecoURL* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<!-- END REF-->
