...
<!--REF #_command_.QUERY BY ATTRIBUTE.Syntax-->**QUERY BY ATTRIBUTE** ( {*umaTabela* : Table ;}{*opConj* : &, \|, # ;} *campoObjeto* : Field ; *caminhoAtributo* : Text ; *opPesq* : Text, >, <, >=, <=, #, =, \|, % ; *valor* : Text, Real, Date, Time {; *} )<!-- END REF-->
