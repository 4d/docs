...
<!--REF #_command_.OBJECT SET VISIBLE.Syntax-->**OBJECT SET VISIBLE** ( * ; *objeto* : Text ; *visivel* : Boolean )<br/>**OBJECT SET VISIBLE** ( *objeto* : Variable, Field ; *visivel* : Boolean )<!-- END REF-->
