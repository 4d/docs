...
Pode definir a opção "Multi linha" de um objeto utilizando a lista de propriedades ou utilizando o comando [OBJECT SET MULTILINE](../commands/object-set-multiline).  
