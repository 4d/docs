...
<!--REF #_command_.OBJECT SET PLACEHOLDER.Syntax-->**OBJECT SET PLACEHOLDER** ( * ; *objeto* : Text ; *textoExemplo* : Text )<br/>**OBJECT SET PLACEHOLDER** ( *objeto* : Variable, Field ; *textoExemplo* : Text )<!-- END REF-->
