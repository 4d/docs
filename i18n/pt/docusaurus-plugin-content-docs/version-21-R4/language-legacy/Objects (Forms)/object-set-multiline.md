...
<!--REF #_command_.OBJECT SET MULTILINE.Syntax-->**OBJECT SET MULTILINE** ( * ; *objeto* : Text ; *multilinha* : Integer )<br/>**OBJECT SET MULTILINE** ( *objeto* : Variable, Field ; *multilinha* : Integer )<!-- END REF-->
