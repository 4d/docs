...
<!--REF #_command_.OBJECT SET INDICATOR TYPE.Syntax-->**OBJECT SET INDICATOR TYPE** ( * ; *objeto* : Text ; *indicador* : Integer )<br/>**OBJECT SET INDICATOR TYPE** ( *objeto* : Variable, Field ; *indicador* : Integer )<!-- END REF-->
