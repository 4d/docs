...
<!--REF #_command_.WA GET URL HISTORY.Syntax-->**WA GET URL HISTORY** ( * ; *objeto* : Text ; *arrayURLs* : Text array {; *endereço* : Integer {; *arrTitulos* : Text array}} )<br/>**WA GET URL HISTORY** ( *objeto* : Variable, Field ; *arrayURLs* : Text array {; *endereço* : Integer {; *arrTitulos* : Text array}} )<!-- END REF-->
