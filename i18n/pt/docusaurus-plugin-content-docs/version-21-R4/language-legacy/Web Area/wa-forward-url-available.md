...
<!--REF #_command_.WA Forward URL available.Syntax-->**WA Forward URL available** ( * ; *objeto* : Text ) : Boolean<br/>**WA Forward URL available** ( *objeto* : Variable, Field ) : Boolean<!-- END REF-->
