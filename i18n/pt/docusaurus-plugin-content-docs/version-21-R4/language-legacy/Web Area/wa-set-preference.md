...
<!--REF #_command_.WA SET PREFERENCE.Syntax-->**WA SET PREFERENCE** ( * ; *objeto* : Text ; *seletor* : Integer ; *valor* : Boolean )<br/>**WA SET PREFERENCE** ( *objeto* : Variable, Field ; *seletor* : Integer ; *valor* : Boolean )<!-- END REF-->
