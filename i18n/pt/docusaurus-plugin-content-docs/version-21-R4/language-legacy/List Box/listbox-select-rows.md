...
<!--REF #_command_.LISTBOX SELECT ROWS.Syntax-->**LISTBOX SELECT ROWS** ( * ; *objeto* : Text ; *seleção* : Object, Collection {; *ação* : Integer} )<br/>**LISTBOX SELECT ROWS** ( *objeto* : Variable ; *seleção* : Object, Collection {; *ação* : Integer} )<!-- END REF-->
