...
<!--REF #_command_.LISTBOX Get rows height.Syntax-->**LISTBOX Get rows height** ( * ; *objeto* : Text {; *unidade* : Integer} ) : Integer<br/>**LISTBOX Get rows height** ( *objeto* : Variable {; *unidade* : Integer} ) : Integer<!-- END REF-->
