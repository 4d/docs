...
<!--REF #_command_.LISTBOX SELECT ROW.Syntax-->**LISTBOX SELECT ROW** ( * ; *objeto* : Text ; *posiçao* : Integer {; *açao* : Integer} )<br/>**LISTBOX SELECT ROW** ( *objeto* : Variable ; *posiçao* : Integer {; *açao* : Integer} )<!-- END REF-->
