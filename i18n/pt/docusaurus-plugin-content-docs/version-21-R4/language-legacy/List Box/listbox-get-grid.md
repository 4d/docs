...
<!--REF #_command_.LISTBOX GET GRID.Syntax-->**LISTBOX GET GRID** ( * ; *objeto* : Text ; *horizontal* : Boolean ; *vertical* : Boolean )<br/>**LISTBOX GET GRID** ( *objeto* : Variable ; *horizontal* : Boolean ; *vertical* : Boolean )<!-- END REF-->
