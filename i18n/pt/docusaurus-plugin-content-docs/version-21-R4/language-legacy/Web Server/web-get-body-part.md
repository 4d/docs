...
No parâmetro *parte*, passe o número da parte a analisar. Podes obter o número total de partes com comando [WEB Get body part count](../commands/web-get-body-part-count).  
