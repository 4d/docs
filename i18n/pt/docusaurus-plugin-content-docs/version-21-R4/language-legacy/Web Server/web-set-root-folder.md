...
Pode saber a qualquer momento a localização da pasta raiz utilizando o comando [Get 4D folder](../commands/get-4d-folder).

Se especificar uma rota de acesso inválida, será gerado um erro do administrador arquivos do sistema operativo. Pode interceptar o erro com um método [ON ERR CALL](../commands/on-err-call). Se o método mostrar uma caixa de diálogo de alerta ou uma mensagem, aparecerá do lado do navegador.
