...
As tags 4D, como `4DEVAL`, `4DTEXT`, `4DHTML`... Por ejemplo, la petición *http://www.server.com/4DACTION/login* provoca la ejecución del método proyecto ***login***, si existe. bem como o [`/4DACTION URL`](./httpRequests.md#4daction) permitem que você acione a execução de qualquer método projeto de um projeto 4D publicado na Web.
