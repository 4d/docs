...
| `strict`    | Parâmetros | `False`      | Whether to enforce strict schema validation for function parameters.                                     |
...
| Propriedade  | Tipo   | Descrição                                                                        |
| ------------ | ------ | -------------------------------------------------------------------------------- |
| `parâmetros` | Object | Parameters definition for the function using JSON schema format. |
...
| ---------- | ---------- | --------------------------------- |
| *objeto*   | Object     | Configuration object for the tool |
| Resultados | OpenAITool | New instance of OpenAITool        |
