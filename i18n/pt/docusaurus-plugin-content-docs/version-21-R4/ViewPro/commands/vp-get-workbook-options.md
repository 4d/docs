...
| Resultados | Object | <- | Objeto que contém as opções do livro de trabalho |
...
retorna um objeto que contém todas as opções de pasta de trabalho em *vpAreaName*<!-- END REF -->
