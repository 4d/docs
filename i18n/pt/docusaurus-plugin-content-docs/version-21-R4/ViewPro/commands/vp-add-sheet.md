...
Se *índice* exceder o número de folhas, o comando insere a nova folha após as já existentes. In *index*, you can pass an index for the new sheet. Se o *índice* passado é inferior a ou igual a 0, o comando insere a nova folha no início.
