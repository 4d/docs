...
As preferências do usuário especificam várias configurações que afetam seu ambiente de trabalho, por exemplo, opções padrão, temas de exibição, recursos do Editor de código, atalhos etc. Eles são aplicados a todos os projetos abertos com sua aplicação 4D ou 4D Server. Eles são aplicados a todos os projetos abertos com sua aplicação 4D ou 4D Server.
