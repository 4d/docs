...
- Se o menu pop-up estiver **separado**, o evento só será gerado quando ocorrer um clique na parte do botão com a seta. Note that the [standard action](/Desktop/standard-actions) assigned to the button (if any) is not executed in this case.
