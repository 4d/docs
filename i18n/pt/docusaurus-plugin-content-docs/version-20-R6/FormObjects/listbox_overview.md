...
| [Caixa de listagem hierárquica](properties_Object.md#hierarchical-list-box)                                                                                                                               | X              |                  |                                      |
...
- A coluna da célula deve ter sido definida como [Enterable](propriedades_Entry.md#enterable) (caso contrário, as células da coluna nunca poderão ser acessadas).
...
| Estilo de letra | [Row Style Array](properties_Text.md#row-style-array)                                      | [Style Expression](properties_Text.md#style-expression)                                    | [Style Expression](properties_Text.md#style-expression) ou [Meta info expression](properties_Text.md#meta-info-expression)                                      |
