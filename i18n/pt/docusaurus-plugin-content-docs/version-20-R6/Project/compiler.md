...
- Na seção ***Erros gerais***, todas as impossibilidades de tipagem e ambiguidades de identidade estão agrupadas. There are two cases in which the compiler reports a general error:
