...
| .**accessTokenOAuth2**: Texto<br/>.**accessTokenOAuth2**: Objeto<br/>Cadeia ou objeto token que representa as credenciais de autorização OAuth2. Usado somente com OAUTH2 `authenticationMode`. Se `accessTokenOAuth2` for usado, mas `authenticationMode` for omisso, o protocolo OAuth 2 será usado (se permitido pelo servidor). Not returned in *[SMTP transporter](#smtp-transporter-object)* object. | nenhum                                                                                           |
...
| **password** : Text<br/>Senha do usuário para autenticação no servidor. Not returned in *[SMTP transporter](#smtp-transporter-object)* object.                                                                                                                                                                                                                                                                                                                                                                | nenhum                                                                                           |
...
A função retorna um [**objeto SMTP transporter**](#smtp-transporter-object). Todas as propriedades retornadas são **apenas leitura**.
