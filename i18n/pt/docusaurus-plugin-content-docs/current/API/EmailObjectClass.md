...
Os objetos de anexo são definidos por meio do comando [`MAIL New attachment`](MailAttachmentClass.md#mail-new-attachment). Attachment objects have specific [properties and functions](MailAttachmentClass.md).
