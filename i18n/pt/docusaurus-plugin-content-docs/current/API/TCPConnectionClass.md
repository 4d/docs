...
A propriedade `.listener` contém <!-- REF #TCPConnection.listener.Summary -->o objeto [`TCPListener`](./TCPListenerClass.md) que criou a `TCPConnection`, se houver<!-- END REF -->. Essa propriedade é **somente leitura**.
