...
> O número da versão do 4D Volume Desktop deve coincidir com o número da versão de 4D Developer Edition. Por exemplo, se você usar 4D v19, você deve selecionar um volume 4D na área de trabalho v19.
