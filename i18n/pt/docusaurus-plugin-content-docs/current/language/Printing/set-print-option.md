...
| ---------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Paper option                 | 1     | Se usar apenas *valor1*, contém o nome do papel. SE usar ambos parâmetros, *value1* contém a largura do papel e *valor2* contém a altura do papel. A largura e a altura são expressas em pontos. Use o comando [PRINT OPTION VALUES](print-option-values.md) para obter o nome, altura e largura de todos os formatos de papel oferecidos pela impressora.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Quando tiver fixado utilizando este comando, uma opção de impressão será conservada durante toda a sessão para toda a aplicação 4D. Será utilizada pelos comandos [PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form) e [QR REPORT](qr-report.md) e [WP PRINT](../WritePro/commands-legacy/wp-print.md), como também pela impressão de 4D, incluindo em modo Desenho.
