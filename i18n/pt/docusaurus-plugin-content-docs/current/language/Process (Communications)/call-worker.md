...
O processo worker aparece na lista de processos de Explorador de execução e é devolvido pelo comando [Process info](./commands/process-info) quando se aplicar a este processo.
