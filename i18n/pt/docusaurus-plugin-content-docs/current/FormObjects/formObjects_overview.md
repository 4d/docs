...
- **Linguagem 4D**: os comandos do tema `Objetos (Formulários)`, como [`OBJECT DUPLICATE`](../commands-legacy/object-duplicate) ou [`OBJECT SET FONT STYLE`](../commands-legacy/object-set-font-style), permitem criar e definir objetos de formulário.
