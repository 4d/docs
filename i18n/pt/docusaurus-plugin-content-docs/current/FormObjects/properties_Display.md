...
Formatos de hora personalizados podem ser criados usando vários padrões descritos na página [**Formato de Data e Hora**](../Project/date-time-formats.md). Por exemplo:
...
| Nome       | Tipo de dados | Valores possíveis                                  |
| ---------- | ------------- | -------------------------------------------------- |
| timeFormat | string        | <li>Formatos incorporados: "systemShort", "systemMedium", "systemLong", "iso8601", "hh_mm_ss", "hh_mm", "hh_mm_am", "mm_ss", "HH_MM_SS", "HH_MM", "MM_SS" + " blankIfNull"</li><li>Formatos personalizados: qualquer formato criado usando um [padrão suportado](../Project/date-time-formats.md) + " blankIfNull"</li> |
...
4D não leva essa propriedade em conta se o objeto foi escondido usando o comando [`OBJETOS SET VISIBLE`](https://doc.4d.com/4dv20/help/command/en/page603.html) ; neste caso, o objeto permanece invisível independentemente de o registro estar ou não selecionado.
