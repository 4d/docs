...
| objeto | any | &rarr; | Nome do objeto (se * for especificado) ou Campo ou variável (se * for omitido) |
| opcao | Integer | &rarr; | Opção a definir |
| valor | Integer | &rarr; | Novo valor da opção |
