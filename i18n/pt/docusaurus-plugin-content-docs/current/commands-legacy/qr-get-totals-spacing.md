...
| subtotal | Integer | &srarr; | Nº de subtotal |
| valor | Integer | &harr; | 0= sem espaço, 32000=insere um salto de página, >0=espaço adicionado no topo do nível de quebra, <0=incremento proporcional |
