...
| --- | --- | --- | --- |
| campo | Field | &rarr; | campo para o qual criar ou apagar o índice |
| indice | Boolean, Integer | &rarr; | True = criar índice, False = apagar índice, ou Criar um índice do tipo: -1=palavras chaves, 0= por padrão, 1=B-Tree padrão, 3=B-Tree cluster |
| * | Operator |  &rarr; | Índice assincrônico se * for passado |
