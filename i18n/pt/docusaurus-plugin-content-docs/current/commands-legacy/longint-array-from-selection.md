...
| --- | --- | --- | --- |
| tabela | Tabela | &#x1F852; | Tabela da seleção atual |
| arrayRegistro | Array inteiro longo | &#x1F858; | Array dos números gravados |
| seleçao | String | &#x1F852; | Nome da seleção escolhida ou a seleção atual se este parâmetro for omitido |
