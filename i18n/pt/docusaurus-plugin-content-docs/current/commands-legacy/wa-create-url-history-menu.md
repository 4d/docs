...
<!--REF #_command_.WA Create URL history menu.Syntax-->**WA Create URL history menu** ( {* ;} *objeto* {; *endereço*} ) -> Resultado<!-- END REF-->
...
| endereço | Integer | &srarr; | 0 ou omitido = Lista de URLs anteriores; 1 = Lista de próximas URLs |
