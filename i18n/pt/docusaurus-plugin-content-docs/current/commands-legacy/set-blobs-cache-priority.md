...
| --- | --- | --- | --- |
| Table | Table | &rarr; | Tabela cujo valor de prioridade de dados dos "blobs" vai ser estabelecido para a sessão |
| prioridade | Integer | &rarr; | Valor de prioridade de cache para BLOBS na tabela |
