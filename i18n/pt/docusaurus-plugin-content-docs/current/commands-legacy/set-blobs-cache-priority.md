...
| --- | --- | --- | --- |
| Table | Table | &srarr; | Tabela cujo valor de prioridade de dados dos "blobs" vai ser estabelecido para a sessão |
| prioridade | Integer | &srarr; | Valor de prioridade de cache para BLOBS na tabela |
