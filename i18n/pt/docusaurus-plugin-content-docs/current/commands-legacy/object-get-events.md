...
| objeto | any | &rarr; | Nome de objeto "" para designar o formulário (se for especificado *) ou<br/>Campo ou variável (se for omitido *) |
| arrEvents | Integer array | &larr; | Array de eventos desativados |
