...
| --- | --- | --- | --- |
| subMenu | Text | &harr; | Referência de menu contendo o item selecionado |
| Resultado | Integer | &larr; | Comando de menu selecionado "Palavra Superior": número de menu Palavra inferior: Número de comando de menu |
