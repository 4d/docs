...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual vai reduzir a seleção, ou tabela padrão, se omitido |
| numero | Integer | &srarr; | Número de registros para manter selecionados |
