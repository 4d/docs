...
| --- | --- | --- | --- |
| seculo | Integer | &rarr; | Século por padrão (menos um) para a entrada de anos com dois dígitos |
| anoPivo | Integer | &rarr; | Ano pivô para a entrada de anos com dois dígitos |
