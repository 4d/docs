...
| --- | --- | --- | --- |
| fonte | Text | &srarr; | Cadeia da qual vai apagar caracteres |
| posiçao | Integer | &srarr; | Primeiro caractere a apagar |
| numCaracteres | Integer | &srarr; | Número de caracteres a apagar |
