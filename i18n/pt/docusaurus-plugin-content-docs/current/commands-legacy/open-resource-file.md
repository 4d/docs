...
<!--REF #_command_.Open resource file.Syntax-->**Open resource file** ( *resNomArq* {; *tipoArquivo*} ) -> Resultado<!-- END REF-->
<!--REF #_command_.Open resource file.Params-->
| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| resNomArq | String | &#x1F852; | Nome curto ou longo ou arquivo de resource ou string Vazia para caixa de diálogo Abrir Arquivo |
| tipoArquivo | String | &#x1F852; | Tipo de arquivo Mac OS (string de 4-caracteres), ou arquivo de extensao Windows  (string 1- a 3-caracteres), ou Todos arquivos, se omitido. |
| Resultado | refDoc | &#x1F850; | Número de referência do arquivo de Resouce |
