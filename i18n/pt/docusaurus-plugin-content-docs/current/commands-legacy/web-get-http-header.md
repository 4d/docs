...
| --- | --- | --- | --- |
| cabeçalho&#124;arrayCampo | Texto, Array texto | &harr; | Petição HTTP cabeçalho ou campos HTTP cabeçalho |
| valorArray | Text array | &harr; | Conteúdo dos campos cabeçalho HTTP |
