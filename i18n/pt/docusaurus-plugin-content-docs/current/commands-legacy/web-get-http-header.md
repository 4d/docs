...
| --- | --- | --- | --- |
| cabeçalho&#124;arrayCampo | Texto, Array texto | &larr; | Petição HTTP cabeçalho ou campos HTTP cabeçalho |
| valorArray | Text array | &larr; | Conteúdo dos campos cabeçalho HTTP |
