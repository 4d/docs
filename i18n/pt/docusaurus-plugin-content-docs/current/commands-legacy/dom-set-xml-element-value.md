...
| xRota | Text | &rarr; | Rota do xRota do elemento XML |
| valorElemento | Text, Variable | &rarr; | Novo valor do elemento |
| * | Operador | &rarr; | Se passado: estabelece o valor em CDATA |
