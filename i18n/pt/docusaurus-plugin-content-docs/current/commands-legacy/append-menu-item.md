...
| --- | --- | --- | --- |
| menu | Inteiro longo | &#x1F852; | Número de menu ou menu de referência |
| itemTexto | Texto | &#x1F852; | Texto para os novos itens de menu |
| subMenu | MenuRef | &#x1F852; | Referência do submenu associado com o item |
