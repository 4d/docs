...
| --- | --- | --- | --- |
| $1 | Inteiro longo | &#x1F858; | Número de usuário utilizado internamente por 4D Server para identificar os usuários |
...
| $0 | Inteiro longo | &#x1F850; | 0 se omitido = conexão aceita; outro valor = conexão rejeitada |
