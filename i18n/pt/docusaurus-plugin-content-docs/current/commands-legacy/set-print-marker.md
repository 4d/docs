...
| --- | --- | --- | --- |
| markNum | Integer | &srarr; | Número do marcador |
| posiçao | Integer | &srarr; | Nova posição do marcador |
| * | Operador | &srarr; | Se passado = mover marcadores seguintes; se omitido = não move os marcadores seguintes |
