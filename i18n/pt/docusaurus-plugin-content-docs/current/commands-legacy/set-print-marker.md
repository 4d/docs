...
| --- | --- | --- | --- |
| markNum | Integer | &rarr; | Número do marcador |
| posiçao | Integer | &rarr; | Nova posição do marcador |
| * | Operador | &rarr; | Se passado = mover marcadores seguintes; se omitido = não move os marcadores seguintes |
