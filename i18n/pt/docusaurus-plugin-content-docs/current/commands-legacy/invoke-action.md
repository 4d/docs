...
| --- | --- | --- | --- |
| ação | Text | &rarr; | Nome ação padrão ou padrão incluindo parâmetro se exigido |
| alvo | Integer | &rarr; | Define onde executar a ação: formulário atual (padrão) ou formulário principal |
