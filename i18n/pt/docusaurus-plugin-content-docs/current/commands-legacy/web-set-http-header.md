...
| --- | --- | --- | --- |
| cabeçalho&#124;arrayCampo | Texto, Array texto | &rarr; | Campo ou variável contendo o cabeçalho HTTP requisitado ou campos cabeçalho HTTP |
| valorArray | Text array | &rarr; | Conteúdo de campo de cabeçalho HTTP |
