...
| --- | --- | --- | --- |
| array | Array | &rarr; | Array a ser ordenado |
| > or < | Operador | &rarr; | ">" para ordenar em ordem crescente, ou "<" para ordernar em ordem decrescente, ou ordem crescente se omitido |
