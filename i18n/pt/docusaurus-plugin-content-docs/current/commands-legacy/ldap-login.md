...
| --- | --- | --- | --- |
| url | Text | &rarr; | URL do servidor LDAP ao qual vai conectar |
| login | Text | &rarr; | Login do usuário |
| senha | Text | &rarr; | Senha do login |
| digest | Integer | &rarr; | 0 = envia senha em digest MD5 (padrão), 1 = envia senha sem criptografia |
