...
| --- | --- | --- | --- |
| opçao | Integer | &srarr; | Opção a ser estabelecida |
| valor | Boolean | &srarr; | Novo valor da opção |
| * | Operador | &srarr; | Se passado: modificação apenas se aplica à próxima chamada |
