...
| --- | --- | --- | --- |
| opçao | Integer | &rarr; | Opção a ser estabelecida |
| valor | Boolean | &rarr; | Novo valor da opção |
| * | Operador | &rarr; | Se passado: modificação apenas se aplica à próxima chamada |
