...
| fila | Integer | &srarr; | Numero de fila |
| cor | Text, Integer | &srarr; | Valor de cor RGB |
| tipoCor | Integer | &srarr; | Cor de fonte do Listbox (por padrão) ou cor de fundo do Listbox |
