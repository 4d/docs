...
| --- | --- | --- | --- |
| dadosEntrada | Text | &srarr; | Dados que contém as etiquetas HTML a processar |
| dadosSaida | Text | &harr; | Dados processados |
| param | Expression | &srarr; | Parâmetros passados ao template sendo executado |
