...
<!--REF #_command_.ARRAY INTEGER.Summary-->O comando ARRAY INTEGER cria e/ou redimensiona um array de elementos de tipo *Inteiro* de 2 bytes de memória.<!-- END REF-->
