...
| --- | --- | --- | --- |
| tipoDestino | Inteiro longo | &#x1F852; | 0 - seleção atual 1 - conjunto 2 - seleção temporária 3 - variável |
| objetoDestino | String, Variável | &#x1F852; | Nome do conjunto, ou nome da seleção temporária, ou Variável |
| destPonteiro | Ponteiro | &#x1F852; | Poneiro a variável local se destinação for Tipo=3 |
