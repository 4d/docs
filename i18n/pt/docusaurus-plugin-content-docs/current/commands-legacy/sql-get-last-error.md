...
| --- | --- | --- | --- |
| codigoErro | Integer | &harr; | Código do Erro |
| textoErro | Text | &harr; | Erro do texto |
| erroODBC | Text | &harr; | Código do erro ODBC |
| erroSQLServer | Integer | &harr; | Código de erro nativo do servidor |
