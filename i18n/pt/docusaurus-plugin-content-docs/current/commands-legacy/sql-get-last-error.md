...
| --- | --- | --- | --- |
| codigoErro | Integer | &larr; | Código do Erro |
| textoErro | Text | &larr; | Erro do texto |
| erroODBC | Text | &larr; | Código do erro ODBC |
| erroSQLServer | Integer | &larr; | Código de erro nativo do servidor |
