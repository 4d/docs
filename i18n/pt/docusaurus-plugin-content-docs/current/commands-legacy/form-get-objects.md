...
| --- | --- | --- | --- |
| arrObjetos | Text array | &larr; | Nome dos objetos do formulário |
| arrVariaveis | Pointer array | &larr; | Ponteiros a variáveis ou campos associados aos objetos |
| arrPags | Array integer | &larr; | Número de página de cada objeto |
| opcaoPag | Integer, * | &rarr; | 1=Página atual do formulário, 2=Todas as páginas, 4=Páginas herdadas<br/>Se passar * (obsoleto) = página atual com objetos herdados |
