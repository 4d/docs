...
| --- | --- | --- | --- |
| arrObjetos | Text array | &harr; | Nome dos objetos do formulário |
| arrVariaveis | Pointer array | &harr; | Ponteiros a variáveis ou campos associados aos objetos |
| arrPags | Array integer | &harr; | Número de página de cada objeto |
| opcaoPag | Integer, * | &srarr; | 1=Página atual do formulário, 2=Todas as páginas, 4=Páginas herdadas<br/>Se passar * (obsoleto) = página atual com objetos herdados |
