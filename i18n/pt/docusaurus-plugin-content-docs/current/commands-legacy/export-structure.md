...
| --- | --- | --- | --- |
| estruturaXML | Text | &larr; | Exportação da definição XML da estrutura de banco de dados 4D |
| formato | Text | &rarr; | Formato de exportação: formato xml (padrão) ou formato html |
