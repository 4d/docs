...
| --- | --- | --- | --- |
| estruturaXML | Text | &harr; | Exportação da definição XML da estrutura de banco de dados 4D |
| formato | Text | &srarr; | Formato de exportação: formato xml (padrão) ou formato html |
