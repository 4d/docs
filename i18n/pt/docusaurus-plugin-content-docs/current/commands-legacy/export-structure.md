...
| --- | --- | --- | --- |
| estruturaXML | Variável texto | &#x1F858; | Exportação da definição XML da estrutura de banco de dados 4D |
| formato | String | &#x1F852; | Formato de exportação: formato xml (padrão) ou formato html |
