...
| novoText | String | &#x1F852; | Novo texto do elemento |
| novoNum | Inteiro longo | &#x1F852; | Novo número de referência do elemento |
| sublista | ListRef | &#x1F852; | Nova sub-lista associada ao elemento, ou 0 = nenhuma sub-lista (separar atual, se existe), ou -1 = nenhuma muda |
| expandida | Booleano | &#x1F852; | Indica se a sub-lista deve ser expandida ou contraída |
