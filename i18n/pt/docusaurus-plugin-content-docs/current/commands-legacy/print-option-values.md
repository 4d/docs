...
| --- | --- | --- | --- |
| opçao | Integer | &rarr; | Número de opção |
| arrayNoms | Text array | &larr; | Nomes dos valores |
| info1Array | Integer array | &larr; | Valores (1) da opção |
| info2Array | Integer array | &larr; | Valores (2) da opção |
