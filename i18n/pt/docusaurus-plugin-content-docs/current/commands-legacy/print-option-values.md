...
| --- | --- | --- | --- |
| opçao | Integer | &srarr; | Número de opção |
| arrayNoms | Text array | &harr; | Nomes dos valores |
| info1Array | Integer array | &harr; | Valores (1) da opção |
| info2Array | Integer array | &harr; | Valores (2) da opção |
