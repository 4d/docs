...
| --- | --- | --- | --- |
| nomeMetodo | String | &#x1F852; | Nome do método de projeto a ser executado |
| resultado | Variável, Operador | &#x1F858; | Variável que recebe o método de resultado ou * por um método não retornando um resultado |
