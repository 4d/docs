...
| --- | --- | --- | --- |
| nomeMetodo | Text | &srarr; | Nome do método de projeto a ser executado |
| resultado | Variable, * | &harr; | Variável que recebe o método de resultado ou * por um método não retornando um resultado |
