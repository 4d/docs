...
| --- | --- | --- | --- |
| booleanArr | Array booleano | &#x1F858; | Array para indicar se um registro está no conjunto ou não |
| conjunto | String | &#x1F852; | Nome do conjunto ou UserSet se o parâmetro for omitido |
