...
| --- | --- | --- | --- |
| booleanArr | Boolean array | &harr; | Array para indicar se um registro está no conjunto ou não |
| conjunto | Text | &srarr; | Nome do conjunto ou UserSet se o parâmetro for omitido |
