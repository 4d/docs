...
| --- | --- | --- | --- |
| Table | Table | &srarr; | Tabela formulário |
| nomeForm | Text | &srarr; | Nome do formulário "clássico" projeto ou tabela |
| Resultado | Object | &larr; | nomeForm é convertido a um formulário dinâmico |
