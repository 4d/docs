...
| --- | --- | --- | --- |
| * | Operador | &srarr; | If specified, object is an object name (string)<br/>If omitted, object is a variable |
| object | any | &srarr; | Object name (if * is specified) or <br/>Variable (if * is omitted) |
| recursive | Boolean | &srarr; | True = expand sublevels<br/>False = do not expand sublevels |
| selector | Integer | &srarr; | Part of list box to expand |
| linha &#124; nivel | Inteiro longo | &srarr; | Number of break row to expand or <br/>Number of list box level to expand |
| coluna | Integer | &srarr; | Number of break column to expand |
