...
| --- | --- | --- | --- |
| caminho | Text, Text array | &rarr; | Caminho do método |
| atributos | Object, Object array | &larr; | Atributos para métodos selecionados |
| * | Operador | &rarr; | se passado = comando aplica para banco de dados local quando executado a partir de um componente (parâmetro ignorado fora desse contexto) |
