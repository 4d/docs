...
| --- | --- | --- | --- |
| seletor | Integer | &srarr; | Categoria objeto |
| nomeObjeto | Text | &srarr; | Nome do objeto |
| nomeSubformulario | Text | &srarr; | Nome de objeto de subformulário |
| Resultado | Pointer | &larr; | Ponteiro à variável de objeto |
