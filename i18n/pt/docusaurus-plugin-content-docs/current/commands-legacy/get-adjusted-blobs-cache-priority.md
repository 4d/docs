...
| --- | --- | --- | --- |
| Table | Table | &srarr; | Tabela para a qual o valor de prioridade dos "blobs" vai ser recuperada |
| Resultado | Integer | &larr; | Valor de prioridade atual para campos "blobs" |
