...
| --- | --- | --- | --- |
| fonte | Text | &rarr; | Cadeia da qual se tira a substring |
| aPartirDe | Integer | &rarr; | Posição do primeiro caractere |
| numCars | Integer | &rarr; | Número de caracteres a pegar |
