...
| --- | --- | --- | --- |
| refGrupo | Integer | &rarr; | Número de referencia ID de grupo |
| nome | Text | &larr; | Nome do grupo |
| proprietario | Integer | &larr; | Número de ID do proprietário do grupo |
| membros | Integer array | &larr; | Membros do grupo |
