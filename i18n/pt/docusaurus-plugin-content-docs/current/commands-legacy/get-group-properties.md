...
| --- | --- | --- | --- |
| refGrupo | Integer | &srarr; | Número de referencia ID de grupo |
| nome | Text | &harr; | Nome do grupo |
| proprietario | Integer | &harr; | Número de ID do proprietário do grupo |
| membros | Integer array | &harr; | Membros do grupo |
