...
| --- | --- | --- | --- |
| rotaDoc | String | &#x1F852; | Nome ou rota de acesso do documento para recuperar ícone, ou string vazia para caixa de diálogo Abrir Arquivo |
| icone | Campo imagem, Variável Imagem | &#x1F858; | Variavel imagem ou campo |
| tamanho | Inteiro longo | &#x1F852; | Tamanho da imagem retornada (em pixels) |
