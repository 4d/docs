...
| --- | --- | --- | --- |
| redimensao | Booleano | &#x1F852; | True: o formulário pode ser redimensionado horizontalmente; False - o formulário não pode ser redimensionado horizontalmente |
| larguraMin | Inteiro longo | &#x1F852; | Melhor largura de formulário permitida (píxels) |
| larguraMax | Inteiro longo | &#x1F852; | Maior largura de formulário permitida (píxels) |
