...
| --- | --- | --- | --- |
| valorXML | Text | &srarr; | Valor do tipo Texto que vem de uma estrutura XML |
| objeto4D | Field, Variable | &harr; | Variável 4D ou campo que recebe o valor XML convertido |
