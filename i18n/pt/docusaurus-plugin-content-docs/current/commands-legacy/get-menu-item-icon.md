...
| menuItem | Integer | &srarr; | Número de menu de item ou -1 para o último item adicionado ao menu |
| refIcone | Text, Integer | &harr; | Nome ou número da imagem associada com o item de menu |
