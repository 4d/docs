...
<!--REF #_command_.LISTBOX Get static columns.Syntax-->**LISTBOX Get static columns** ( {* ;} *objeto* ) -> resultado<!-- END REF-->
...
| resultado | Inteiro longo | &#x1F850; | Número de colunas estáticas |
