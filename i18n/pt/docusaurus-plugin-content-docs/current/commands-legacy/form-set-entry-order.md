...
| --- | --- | --- | --- |
| nomeObj | Text array | &srarr; | Array de nomes de objeto na sua ordem de entrada esperada |
| numPagina | Integer | &srarr; | Números de página para estabelecer a ordem de entrada (página atual se omitido) |
