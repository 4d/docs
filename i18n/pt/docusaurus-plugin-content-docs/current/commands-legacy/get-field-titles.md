...
| --- | --- | --- | --- |
| tabela | Table | &rarr; | Tabela para qual você deseja encontrar os nomes dos campos |
| titulosCampos | Text array | &larr; | Nomes atuais dos campos |
| numCampos | Integer array | &larr; | Números de Campos |
