...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para qual você deseja encontrar os nomes dos campos |
| titulosCampos | Text array | &harr; | Nomes atuais dos campos |
| numCampos | Integer array | &harr; | Números de Campos |
