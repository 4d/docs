...
| --- | --- | --- | --- |
| comCache | Booleano | &#x1F852; | True para retornar a descrição web cache. Senão (pré-determinado) a descrição da cache não é retornada |
| Resultado | Objeto | &#x1F850; | Informação no servidor Web executando e servidor SOAP |
