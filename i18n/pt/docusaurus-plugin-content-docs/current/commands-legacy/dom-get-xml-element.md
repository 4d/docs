...
| nomeElemento | Text | &srarr; | Nome do elemento a obter |
| index | Integer | &srarr; | Número de índice do elemento a obter |
| valorElemento | Variable | &harr; | Valor do elemento |
| Resultado | Text | &larr; | referência XML (16 caracteres) |
