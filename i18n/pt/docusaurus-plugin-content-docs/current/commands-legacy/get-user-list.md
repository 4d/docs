...
| --- | --- | --- | --- |
| nomUsuarios | Array string | &#x1F858; | Nomes dos usuários como aparecem na janela de editor de senhas |
| numUsuarios | Array inteiro longo | &#x1F858; | Números correspondentes de referências dos usuários |
