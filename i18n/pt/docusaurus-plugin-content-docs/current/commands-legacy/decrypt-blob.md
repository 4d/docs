...
| --- | --- | --- | --- |
| aDecifrar | Blob | &srarr; | Dados a decifrar |
| &harr; | Dados decifrados |
| enviarChavePub | Blob | &srarr; | Chave pública do emissor |
| recepChavePriv | Blob | &srarr; | Chave privada do receptor |
