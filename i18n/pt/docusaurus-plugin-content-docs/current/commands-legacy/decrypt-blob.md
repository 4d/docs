...
| --- | --- | --- | --- |
| aDecifrar | Blob | &rarr; | Dados a decifrar |
| &larr; | Dados decifrados |
| enviarChavePub | Blob | &rarr; | Chave pública do emissor |
| recepChavePriv | Blob | &rarr; | Chave privada do receptor |
