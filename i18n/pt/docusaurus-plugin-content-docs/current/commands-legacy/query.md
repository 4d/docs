...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual devolver uma seleção de registros ou Tabela por padrão, se for omitido |
| criterioPesquisa | Expression | &srarr; | Critério de pesquisa |
| * | Operador | &srarr; | Continuar a execução da pesquisa |
