...
| offset | Inteiro longo | &#x1F852; | Posição de início de inserção dos bytes |
| len | Inteiro longo | &#x1F852; | Número de bytes a ser inserido |
| filler | Inteiro longo | &#x1F852; | Valor de byte padrão (0x00..0xFF) 0x00 se omitido |
