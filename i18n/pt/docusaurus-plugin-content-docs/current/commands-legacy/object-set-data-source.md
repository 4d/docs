...
| objeto | any | &srarr; | Nome de objeto (se * for especificado) o<br/>Campo ou variável (se * for omitido) |
| fonteDados | Pointer | &srarr; | Ponteiro a nova fonte de dados do objeto |
