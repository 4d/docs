...
| objeto | any | &rarr; | Nome de objeto (se * for especificado) o<br/>Campo ou variável (se * for omitido) |
| fonteDados | Pointer | &rarr; | Ponteiro a nova fonte de dados do objeto |
