...
| --- | --- | --- | --- |
| valores | Field | &rarr; | Campo númerico ou variável onde quer devolver o subtotal |
| saltoPag | Integer | &rarr; | Nivel de quebra para o qual realizar um salto de página |
