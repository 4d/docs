...
| --- | --- | --- | --- |
| objeto | Text | &srarr; | Nome do objeto que indica os limites do formulário |
| horizontal | Integer | &srarr; | Se passada *: margem horizontal (píxels) Se omitida *: largo (píxels) |
| vertical | Integer | &srarr; | Se passada *: margem vertical (píxels) Se omitida *: altura (píxels) |
| * | Operador | &srarr; | • Se passado: agregar as margens definidas pelos parâmetros horizontal e vertical (tamanho automático ou baseado em um objeto, se passado um objeto) • Se omitido: utilizar horizontal e vertical como largura e altura do formulário |
