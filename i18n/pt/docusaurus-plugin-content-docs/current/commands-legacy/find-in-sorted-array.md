...
| --- | --- | --- | --- |
| array | Array | &rarr; | Array para pesquisar |
| valor | Expression | &rarr; | Valor do mesmo tipo para procurar no array |
| > or < | Operador | &rarr; | > se o array está classificado em ordem crescente, < se ele está em ordem decrescente |
| posPrim | Integer | &larr; | Posição da sua primeira ocorrência se o valor for encontrado; caso contrário, a posição em que o valor deve ser inserido |
| posUlt | Integer | &larr; | Posição de sua última ocorrência se o valor for encontrado; caso contrário, mesmo que posPrim |
