...
| --- | --- | --- | --- |
| buildNum | Integer | &harr; | Número de build |
| * | Operador | &srarr; | Se passar número de versão longo, caso contrário número de versão curto |
| Resultado | Text | &larr; | Número de versão em uma string codificada |
