...
| --- | --- | --- | --- |
| seletor | String | &#x1F852; | Chave que designa um tema ou página ou um grupo de parâmetros da caixa de diálogo Preferências |
| acesso | Booleano | &#x1F852; | True=Bloquear as outras páginas da caixa de diálogo, False ou se omitir=Deixar ativas as outras páginas da caixa de diálogo |
| tipoConfiguração | Inteiro longo | &#x1F852; | 0 ou omitido = configuração da estrutura; 1 = configuração de usuário, 2 = Configuração usuário para arquivo de dados |
