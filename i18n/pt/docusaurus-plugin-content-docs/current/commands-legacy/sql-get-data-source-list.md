...
| --- | --- | --- | --- |
| tipoFonte | Integer | &srarr; | Tipo da fonte: usuário ou sistema |
| arrayNomesFontes | Text array | &harr; | Array dos nomes das fontes dos dados |
| arrayDrivers | Text array | &harr; | Array dos drives das fontes |
