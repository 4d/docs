...
| --- | --- | --- | --- |
| nome | Text | &srarr; | Nome do parâmetro a incluir na petição SOAP |
| valor | Variable | &srarr; | Variável 4D que contém o valor do parâmetro |
| tipoSoap | Text | &srarr; | Tipo SOAP do parâmetro |
