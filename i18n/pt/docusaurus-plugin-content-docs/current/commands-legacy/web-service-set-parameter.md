...
| --- | --- | --- | --- |
| nome | Text | &rarr; | Nome do parâmetro a incluir na petição SOAP |
| valor | Variable | &rarr; | Variável 4D que contém o valor do parâmetro |
| tipoSoap | Text | &rarr; | Tipo SOAP do parâmetro |
