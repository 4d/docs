...
| --- | --- | --- | --- |
| resNum | Integer | &rarr; | Nº do recurso ou atributo "id" do elemento "group" (XLIFF) |
| cadeias | Text array | &larr; | Strings do recurso STR# ou strings do elemento "group"(XLIFF) |
