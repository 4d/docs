...
| --- | --- | --- | --- |
| resNum | Integer | &srarr; | Nº do recurso ou atributo "id" do elemento "group" (XLIFF) |
| cadeias | Text array | &harr; | Strings do recurso STR# ou strings do elemento "group"(XLIFF) |
