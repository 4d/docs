...
| --- | --- | --- | --- |
| resNum | Inteiro longo | &#x1F852; | Nº do recurso ou atributo "id" do elemento "group" (XLIFF) |
| cadeias | Array string | &#x1F858; | Strings do recurso STR# ou strings do elemento "group"(XLIFF) |
