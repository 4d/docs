...
| --- | --- | --- | --- |
| textoHTML | Texto | &#x1F852; | Texto do campo HTML ou variável a ser enviado ao navegador Web |
| semContexto | Texto | &#x1F852; | True = Vai para o modo não contextual se False; se omitido = permanece no modo atual. |
