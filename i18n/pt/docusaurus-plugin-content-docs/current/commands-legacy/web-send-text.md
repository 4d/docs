...
| --- | --- | --- | --- |
| textoHTML | Text | &rarr; | Texto do campo HTML ou variável a ser enviado ao navegador Web |
| semContexto | Text | &rarr; | True = Vai para o modo não contextual se False; se omitido = permanece no modo atual. |
