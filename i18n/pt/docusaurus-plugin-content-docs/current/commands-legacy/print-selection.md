...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual imprimir a seleção, ou Tabela por padrão, se for omitido |
| * &#124; > | Operador | &srarr; | * para apagar as caixas de diálogo de impressão, ou > para não reiniciar as preferências de impressão |
