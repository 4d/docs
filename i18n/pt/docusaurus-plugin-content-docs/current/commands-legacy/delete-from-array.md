...
| --- | --- | --- | --- |
| array | Array | &srarr; | Array do qual apagar os elementos |
| posição | Integer | &srarr; | Elemento onde se inicia o processo |
| quantos | Integer | &srarr; | Número de elementos a apagar |
