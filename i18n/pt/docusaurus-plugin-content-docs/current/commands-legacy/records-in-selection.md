...
| --- | --- | --- | --- |
| tabela | Tabela | &#x1F852; | Tabela para a qual retornar número dos registros selecionados, ou tabela padrão, se omitido |
| Resultado | Inteiro longo | &#x1F850; | Registros em seleção da tabela |
