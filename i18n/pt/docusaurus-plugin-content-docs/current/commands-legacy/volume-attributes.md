...
| --- | --- | --- | --- |
| volume | Text | &rarr; | Nome volume |
| tamanho | Real | &larr; | Tamanho do volume expresso em bytes |
| usado | Real | &larr; | Espaço usado expresso em bytes |
| livre | Real | &larr; | Espaço livre expresso em bytes |
