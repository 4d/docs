...
<!--REF #_command_.List item parent.Syntax-->**List item parent** ( {* ;} *lista* ; refElem | * ) -> Resultado<!-- END REF-->
...
| Resultado | Inteiro longo | &#x1F850; | Número de referência do elemento pai ou 0 se não há |
