...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( {* ;} *objeto* {; *unidade*} ) -> resultado<!-- END REF-->
<!--REF #_command_.LISTBOX Get footers height.Params-->
| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| * | Operador | &#x1F852; | Se especificado, objeto é um nome de objeto(cadeia)Se omitido, objeto é uma variável |
| objeto | Objeto de formulário | &#x1F852; | Nome de objeto (se especificado *) ouVariável (se omitido *) |
| unidade | Inteiro longo | &#x1F852; | Unidade de valor de altura:0 se omitido = píxeles, 1 = linhas |
| resultado | Inteiro longo | &#x1F850; | Alto da linha |
