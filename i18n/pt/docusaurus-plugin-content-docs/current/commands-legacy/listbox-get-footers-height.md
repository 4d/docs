...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( * ; *objeto* : Text {; *unidade* : Integer} ) : Integer<br/>**LISTBOX Get footers height** ( *objeto* : Field, Variable {; *unidade* : Integer} ) : Integer<!-- END REF-->
