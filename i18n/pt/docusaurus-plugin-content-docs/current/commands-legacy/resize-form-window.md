...
| --- | --- | --- | --- |
| largura | Integer | &rarr; | Pixels a adicionar ou remover da largura da janela do formulário atual |
| altura | Integer | &rarr; | Pixels a adicionar ou remover da altura da janela do formulário atual |
