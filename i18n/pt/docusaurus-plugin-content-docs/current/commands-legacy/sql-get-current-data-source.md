...
<!--REF #_command_.SQL Get current data source.Syntax-->**SQL Get current data source**  -> Resultado<!-- END REF-->
<!--REF #_command_.SQL Get current data source.Params-->
| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| Resultado | Text | &larr; | Nome da fonte de dados atualmente sendo usada |
