...
| --- | --- | --- | --- |
| rota | Text, Text array | &rarr; | Texto ou array de texto que contém uma ou várias rotas de método |
| comentários | Text, Text array | &larr; | Comentários dos métodos designados |
