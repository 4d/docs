...
| --- | --- | --- | --- |
| campoN | Field | &rarr; | Iniciar campo da relação |
| um | Integer | &larr; | Estado das relações Muitos a Um |
| muitos | Integer | &larr; | Estado da relação Um a Muitos |
| * | Operador | &rarr; | Se passado: um e muitos retorna o estado atual da relação (valores 2 ou 3 apenas) * se omitido (padrão): um e muitos podem retornar o valor 1 se a relação não foi modificada através de programação |
