...
| dados | Text, Variable | &srarr; | Texto ou variáveis a inserir no documento |
| * | Operador | &srarr; | Se passado: criptografa os caracteres especiais; se omitido: não codifica. |
