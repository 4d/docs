...
| --- | --- | --- | --- |
| parte | Integer | &srarr; | Número de parte |
| conteudo | Blob, Text | &harr; | Conteúdo de parte |
| nome | Text | &harr; | Nome da variável "input" |
| tipoMime | Text | &harr; | Tipo mime do arquivo |
| nomArquivo | Text | &harr; | Nome do arquivo enviado |
