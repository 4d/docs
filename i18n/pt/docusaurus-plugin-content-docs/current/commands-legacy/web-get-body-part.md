...
| --- | --- | --- | --- |
| parte | Integer | &rarr; | Número de parte |
| conteudo | Blob, Text | &larr; | Conteúdo de parte |
| nome | Text | &larr; | Nome da variável "input" |
| tipoMime | Text | &larr; | Tipo mime do arquivo |
| nomArquivo | Text | &larr; | Nome do arquivo enviado |
