...
<!--REF #_command_.On Backup Startup database method.Syntax-->**On Backup Startup database method**  -> Resultado<!-- END REF-->
<!--REF #_command_.On Backup Startup database method.Params-->
| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| Resultado | Inteiro longo | &#x1F850; | 0 = backup can be launched; value other than 0 = backup not authorized |
...
* Se $0 # 0, o backup não é autorizado. A operação é cancelada e retorna um erro. Você pode obter o erro utilizando o comando [GET BACKUP INFORMATION](get-backup-information.md "GET BACKUP INFORMATION").
