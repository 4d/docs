...
| menuItem | Integer | &srarr; | Número do item de menu ou -1 para o último item adicionado ao menu |
| iconeRef | Text, Integer | &srarr; | Nome ou número de imagem a ser associado com o item de menu |
