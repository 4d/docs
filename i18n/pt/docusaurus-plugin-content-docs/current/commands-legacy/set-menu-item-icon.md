...
| menuItem | Integer | &rarr; | Número do item de menu ou -1 para o último item adicionado ao menu |
| iconeRef | Text, Integer | &rarr; | Nome ou número de imagem a ser associado com o item de menu |
