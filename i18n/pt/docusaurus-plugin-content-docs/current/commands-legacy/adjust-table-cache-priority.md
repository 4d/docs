...
| --- | --- | --- | --- |
| Table | Table | &rarr; | Tabela cujo valor de prioridade de dados escalares vai ser ajustada |
| prioridade | Integer | &rarr; | Valor de prioridade de cache para a tabela |
