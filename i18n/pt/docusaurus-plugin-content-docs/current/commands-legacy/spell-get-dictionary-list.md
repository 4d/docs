...
| --- | --- | --- | --- |
| lingID | Integer array | &larr; | IDs únicos das linguagens |
| lingArquivos | Text array | &larr; | Nomes dos arquivos de linguagem instalados |
| lingNoms | Text array | &larr; | Nomes locais das linguagens |
