...
| --- | --- | --- | --- |
| raiz | Text | &srarr; | Nome do elemento raiz |
| nomeEspaço | Text | &srarr; | Valor do espaço de nome (namespace) |
| nSNome | Text | &srarr; | Nome do Namespace |
| nSValor | Text | &srarr; | Valor do Namespace |
