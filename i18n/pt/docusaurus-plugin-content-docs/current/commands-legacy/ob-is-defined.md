...
| propriedade | Texto | &#x1F852; | Se passar = propriedade a verificar, se omitir = verificar o objeto |
| Resultado | Booleano | &#x1F850; | Se a propriedade se omite: True se objeto está definido, caso contrário False.<br/>Se a propriedade passar: True se propriedade está definida, caso contrário False |
