...
| aparencia | Integer | &srarr; | Estilo gráfico da lista 1 = Lista hierárquica à Macintosh 2 = Lista hierárquica à Windows 0 = Aparição auto dependendo da plataforma |
| icone | Integer | &srarr; | ID de recurso Mac OS ‘cicn’ ou 0 = ícone por padrão da plataforma |
| alturaLinha | Integer | &srarr; | Altura mínima da linha expressada em pixels |
| duploClique | Integer | &srarr; | Expandir/Contrair sub-lista com duplo-clique 0 = Sim, 1= Não |
| multiSeleçao | Integer | &srarr; | Seleções múltiplas: 0 = Não (por padrão), 1 = Sim |
| editavel | Integer | &srarr; | 0=Lista não é editável pelo usuário, 1=Lista não é editável pelo usuário (padrão) |
