...
| --- | --- | --- | --- |
| tabela | Tabela | &#x1F852; | Tabela a mostrar por padrão no editor de fórmulas |
| formula | Texto | &#x1F852; | Variável que contem a fórmula a mostrar no editor de fórmulas ou "" somente para mostrar o editor |
