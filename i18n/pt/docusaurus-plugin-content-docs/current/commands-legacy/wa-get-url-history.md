...
| arrayURLs | Text array | &larr; | Array das URLs visitadas |
| endereço | Integer | &rarr; | 0 ou omitido = Lista das URLs anteriores; 1 = Lista das próximas URLs |
| arrTitulos | Text array | &larr; | Array de titulos |
