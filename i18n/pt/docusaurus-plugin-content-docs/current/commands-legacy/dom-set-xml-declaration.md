...
| codificaçao | String | &#x1F852; | Conjunto de caracteres usado no documento XML |
| autonomo | Booleano | &#x1F852; | True=documento é autônomo; False (padrão) = documento não é autônomo |
| recuo | Booleano | &#x1F852; | ***Obsoleto, não usar*** |
