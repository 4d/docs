...
| codificaçao | Text | &rarr; | Conjunto de caracteres usado no documento XML |
| autonomo | Boolean | &rarr; | True=documento é autônomo; False (padrão) = documento não é autônomo |
| recuo | Boolean | &rarr; | ***Obsoleto, não usar*** |
