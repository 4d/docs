...
| --- | --- | --- | --- |
| real | Real | &srarr; | Valor de tipo real a escrever no BLOB |
| Blob | Blob | &srarr; | BLOB a receber o valor Real |
| realFormat | Integer | &srarr; | 0 Formato real nativo 1 Formato real estendido 2 Formato real doble Macintosh 3 Formato real duplo Windows |
| offset &#124; * | Variável, Operador | &srarr; | Offset no BLOB (expressado em bytes) ou * para adicionar o valor |
| &harr; | Novo offset depois da escritura se * for omitido |
