...
| --- | --- | --- | --- |
| arrayCodec | Text array | &harr; | Identificadores de codecs de imagens disponíveis |
| arrayNomes | Text array | &harr; | Nomes dos Codecs de imagens |
| * | Operador | &srarr; | Retorna a lista de Codecs de leitura |
