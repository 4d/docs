...
| --- | --- | --- | --- |
| arrayCodec | Text array | &larr; | Identificadores de codecs de imagens disponíveis |
| arrayNomes | Text array | &larr; | Nomes dos Codecs de imagens |
| * | Operador | &rarr; | Retorna a lista de Codecs de leitura |
