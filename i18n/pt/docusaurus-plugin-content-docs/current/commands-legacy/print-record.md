...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual imprimir o registro, ou Tabela padrão, caso omitido |
| * &#124; > | Operador | &srarr; | * to suppress the printing dialog box, or > to not reinitialize print settings |
