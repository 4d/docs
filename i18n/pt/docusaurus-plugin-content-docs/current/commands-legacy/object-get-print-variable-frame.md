...
| tamVariavel | Booleano | &#x1F858; | True = Impressão tamanho variável, False = impressão tamanho fixo |
| subformFixo | Inteiro longo | &#x1F858; | Opção para impressão de sub formulários de tamanho fixo |
