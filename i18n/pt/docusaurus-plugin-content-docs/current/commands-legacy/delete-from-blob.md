...
| --- | --- | --- | --- |
| Blob | Blob | &srarr; | BLOB do qual deletar bytes |
| offset | Integer | &srarr; | Offset inicial onde os bytes serão deletados |
| tamanho | Integer | &srarr; | Número de bytes a serem excluídos |
