...
| --- | --- | --- | --- |
| Blob | Blob | &rarr; | BLOB do qual deletar bytes |
| offset | Integer | &rarr; | Offset inicial onde os bytes serão deletados |
| tamanho | Integer | &rarr; | Número de bytes a serem excluídos |
