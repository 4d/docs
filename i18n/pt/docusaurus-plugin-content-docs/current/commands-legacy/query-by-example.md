...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual vai retornar a seleção de registros, ou a tabela Padrão, se omitido |
| * | Operador | &srarr; | Se passado, a barra de rolagem não será exibida |
