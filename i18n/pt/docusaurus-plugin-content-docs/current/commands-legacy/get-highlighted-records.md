...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual os registros selecionados serão lidos. Se omitido, a tabela do formulário atual |
| nomConjunto | Text | &srarr; | Conjunto onde os nomes selecionados serão armazenados |
