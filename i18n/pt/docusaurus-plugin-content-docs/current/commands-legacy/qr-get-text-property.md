...
| numLinha | Integer | &srarr; | N° da linha |
| propriedade | Integer | &srarr; | Número da propriedade |
| Function result | Inteiro longo, String | &larr; | Valor da propriedade selecionada |
