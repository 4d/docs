...
| objeto | any | &rarr; | Nome de objeto (se * é específico) ou variável ou campo (se * é omitido) |
| inicioSel | Integer | &rarr; | início da seleção de texto |
| fimSel | Integer | &rarr; | Fim da seleção de texto |
| nomeAtributo | Integer | &rarr; | Atributo a ser lido |
| valorAtrib | Variable | &larr; | Valor atual do atributo |
