...
| --- | --- | --- | --- |
| lista | Text, Integer | &srarr; | Lista da qual copiar os itens de primeiro nível |
| array | Array | &harr; | Array para o qual copiar os itens da lista |
| itemRefs | Array | &harr; | Números de referência da lista de itens |
