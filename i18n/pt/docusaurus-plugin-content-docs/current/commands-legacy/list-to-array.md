...
| --- | --- | --- | --- |
| lista | Text, Integer | &rarr; | Lista da qual copiar os itens de primeiro nível |
| array | Array | &larr; | Array para o qual copiar os itens da lista |
| itemRefs | Array | &larr; | Números de referência da lista de itens |
