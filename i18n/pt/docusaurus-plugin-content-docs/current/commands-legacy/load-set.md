...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela à qual o conjunto pertence, ou tabela padrão, se omitido |
| conjunto | Text | &srarr; | Nome do conjunto a ser criado em memória |
| documento | Text | &srarr; | Documento que contém o conjunto |
