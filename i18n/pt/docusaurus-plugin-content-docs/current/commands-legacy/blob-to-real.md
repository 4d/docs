...
| --- | --- | --- | --- |
| Blob | Blob | &srarr; | BLOB do qual obter o valor de tipo Real |
| formatoReal | Integer | &srarr; | 0 Formato real nativo 1 Formato real extendido 2 Formato real duplo Macintosh 3 Formato real duplo Windows |
