...
| --- | --- | --- | --- |
| tabela | Tabela | &#x1F852; | Tabela cujos registros foram selecionados se omitidos, tabela do formulário atual |
| nomConjunto | String | &#x1F852; | Conjunto de registros a selecionar ou Userset se omitido |
