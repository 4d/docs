...
| --- | --- | --- | --- |
| rotaPasta | String | &#x1F852; | Rota da pasta destino para arquivos projeto |
| opções | Objeto | &#x1F852; | Opções de exportação |
| Resultado | Objeto | &#x1F850; | Estado de validação e mensagens (se houver) |
