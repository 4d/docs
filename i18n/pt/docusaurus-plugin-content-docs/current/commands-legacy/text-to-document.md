...
| --- | --- | --- | --- |
| nomeArquivo | Text | &srarr; | Nome do documento ou caminho de acesso ao documento |
| texto | Text | &srarr; | Texto a armazenar no documento |
| conjCaracteres | Text, Integer | &srarr; | Nome ou número do conjunto de caracteres |
| modoRetorno | Integer | &srarr; | Modo de processamento para os retornos de linha |
