...
| --- | --- | --- | --- |
| refElementoTarget | Text | &srarr; | Referência do elemento XML pai |
| refElementoFonte | Text | &srarr; | Referência do elemento XML a anexar |
| Resultado | Text | &larr; | Referência do novo elemento XML |
