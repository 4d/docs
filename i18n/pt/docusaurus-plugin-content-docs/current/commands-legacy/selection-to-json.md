...
| --- | --- | --- | --- |
| aTable | Table | &srarr; | Tabela a serializar |
| oField | Field | &srarr; | Campo(s) cujo(s) conteúdos devem ser serializados |
| modelo | Object | &srarr; | Objeto para a seleção de etiquetas e de campos |
