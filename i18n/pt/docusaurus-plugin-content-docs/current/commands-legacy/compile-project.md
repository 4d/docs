...
| --- | --- | --- | --- |
| arquivoProjeto | 4D.File | &srarr; | Arquivo .4DProject a compilar |
| opções | Object | &srarr; | Objeto que especifica opções de compilação |
| Resultado | Object | &larr; | Objeto que contém informação do status da compilação |
