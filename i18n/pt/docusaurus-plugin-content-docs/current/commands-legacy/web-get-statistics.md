...
| --- | --- | --- | --- |
| paginas | Text array | &harr; | Nomes das páginas mais consultadas |
| hits | Integer array | &harr; | Nomes de hits para cada página |
| uso | Integer | &harr; | Porcentagem de cache usado |
