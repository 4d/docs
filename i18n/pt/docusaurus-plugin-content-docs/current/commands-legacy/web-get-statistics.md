...
| --- | --- | --- | --- |
| paginas | Text array | &larr; | Nomes das páginas mais consultadas |
| hits | Integer array | &larr; | Nomes de hits para cada página |
| uso | Integer | &larr; | Porcentagem de cache usado |
