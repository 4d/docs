...
<!--REF #_command_.OB Get.Syntax-->**OB Get** ( *objeto* ; *propriedade* {; *tipo*} ) -> Resultado<!-- END REF-->
...
| tipo | Integer | &srarr; | Tipo ao qual converter o valor |
| Resultado | Expression | &larr; | Valor atual de propriedade |

<!-- END REF-->

#### Descrição 

<!--REF #_command_.OB Get.Summary-->O comando **OB Get** devolve o valor atual da *propriedade* do *objeto*, convertido opcionalmente no *tipo* definido.<!-- END REF-->
