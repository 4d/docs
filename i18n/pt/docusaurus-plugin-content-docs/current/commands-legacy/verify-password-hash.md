...
| hash | Text | &srarr; | O hash da senha |
...
Os erros abaixo podem ser devolvidos. Pode revisar um erro com os comandos [GET LAST ERROR STACK](get-last-error-stack.md) e [ON ERR CALL](on-err-call.md).  
