...
<!--REF #_command_.LISTBOX Get rows height.Syntax-->**LISTBOX Get rows height** ( {* ;} *objeto* {; *unidade*} ) -> Resultado<!-- END REF-->
...
| unidade | Integer | &rarr; | Unidade do valor da altura: 0 ou omitido = pixels, 1 = linhas |
