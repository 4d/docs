...
| --- | --- | --- | --- |
| array | Array | &srarr; | Array do qual se copia os elementos de array |
| lista | Text, Integer | &srarr; | Lista na qual se copia os elementos de array |
| itemRefs | Array | &srarr; | Arrays numéricos do número de referência dos elementos |
