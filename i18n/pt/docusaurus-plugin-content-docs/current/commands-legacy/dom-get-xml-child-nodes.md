...
| --- | --- | --- | --- |
| elemRef | Text | &rarr; | Elemento XML de referência |
| arrTiposFilhos | Integer array | &larr; | Tipos de nodos filhos |
| arrRefsNodos | Text array | &larr; | Referência ou valores dos nodos filhos |
