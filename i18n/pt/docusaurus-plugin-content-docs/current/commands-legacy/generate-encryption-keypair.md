...
| --- | --- | --- | --- |
| chavPriv | Blob | &larr; | BLOB que contém a chave privada |
| chavPublica | Blob | &larr; | BLOB que contém a chave pública |
| tamanho | Integer | &rarr; | Tamanho da chave (bits) [512...2048]. O valor normal é  512 |
