...
| --- | --- | --- | --- |
| Field | Field | &rarr; | Campo cujo valor de prioridade de índices vai ser estabelecida para a sessão |
| prioridade | Integer | &rarr; | Valor de prioridade cache para o campo índice |
