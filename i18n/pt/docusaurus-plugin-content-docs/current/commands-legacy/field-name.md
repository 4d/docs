...
| --- | --- | --- | --- |
| pontCampo&#124;numTabela | Ponteiro, Inteiro longo | &rarr; | Ponteiro Campo ou número da tabela |
| numCampo | Integer | &rarr; | Número do campo se a o número da tabela foi passado no primeiro parâmetro |
