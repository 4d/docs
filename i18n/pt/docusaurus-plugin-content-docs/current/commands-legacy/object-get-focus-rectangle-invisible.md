...
<!--REF #_command_.OBJECT Get focus rectangle invisible.Syntax-->**OBJECT Get focus rectangle invisible** ( {* ;} *objeto* ) -> Resultado<!-- END REF-->
...
| Resultado | Booleano | &#x1F850; | True = retângulo de foco oculto, False = retângulo de foco visível |
