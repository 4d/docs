...
| --- | --- | --- | --- |
| tabela | Table | &srarr; | Tabela para a qual se importará os dados, ou tabela Padrão, se omitido |
| documento | Text | &srarr; | Documento texto do qual se importará os dados |
