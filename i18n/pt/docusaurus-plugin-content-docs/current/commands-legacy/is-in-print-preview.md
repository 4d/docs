...
<!--REF #_command_.Is in print preview.Syntax-->**Is in print preview**  -> Resultado<!-- END REF-->
<!--REF #_command_.Is in print preview.Params-->
| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| Resultado | Booleano | &#x1F850; | True = Vista previa de impressão,<br/>False = Não vista previa de impressão |
