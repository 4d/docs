...
<!--REF #_command_.Trigger event.Summary-->Quando chamado de dentro de um trigger, o comando **[Trigger event](../commands/trigger-event)** retorna um valor numérico que indica o tipo do evento do banco, em outras palavras, a razão pela qual é chamado o trigger.<!-- END REF-->  
