...
O comando utiliza por padrão o conjunto de caracteres UTF-8\. Os documentos em formato SYLK utilizam geralmente o conjunto de caracteres ISO-8859-1, pode utilizar o comando [USE CHARACTER SET](../commands/use-character-set) para especificar o conjunto de caracteres apropriado.
