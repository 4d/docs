...
O comando utiliza por padrão o conjunto de caracteres UTF-8\. Os documentos com formato DIF utilizam geralmente o conjunto de caracteres IBM437, pode ser necessário utilizar o comando [USE CHARACTER SET](../commands/use-character-set) para definir o conjunto de caracteres apropriado.
