...
<!--REF #_command_.OBJECT SET THREE STATES CHECKBOX.Syntax-->**OBJECT SET THREE STATES CHECKBOX** ( * ; *objeto* : Text ; *tresEsta* : Boolean )<br/>**OBJECT SET THREE STATES CHECKBOX** ( *objeto* : Variable, Field ; *tresEsta* : Boolean )<!-- END REF-->
