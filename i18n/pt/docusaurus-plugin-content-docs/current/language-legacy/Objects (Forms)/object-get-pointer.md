...
**Nota**: este funcionamento é estritamente equivalente ao funcionamento previo do comando [Self](../commands/self). O comando [Self](../commands/self) se conserva apenas por razões de compatibilidade.
...
**Nota**: este funcionamento é estritamente equivalente ao comando [Focus object](../commands/focus-object). Esse comando agora é obsoleto a partir de 4D v12.
