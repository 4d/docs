...
<!--REF #_command_.OBJECT SET ENTERABLE.Syntax-->**OBJECT SET ENTERABLE** ( * ; *objeto* : Text ; *editavel* : Boolean, Integer )<br/>**OBJECT SET ENTERABLE** ( *objeto* : Variable, Field, Table ; *editavel* : Boolean, Integer )<!-- END REF-->
