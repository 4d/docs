...
O parâmetro *tecla* devolve o caracter associado à tecla (no caso de uma tecla estandarte) ou uma cadeia entre colchetes que designa a tecla (no caso de uma tecla função). Pode comparar este valor com as constantes do tema *Atalhos de teclado* (ver o comando [OBJECT SET SHORTCUT](../commands/object-set-shortcut)).  
