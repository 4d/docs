...
Para guardar um novo registro criado com [CREATE RECORD](../commands/create-record) ou [DUPLICATE RECORD](../commands/duplicate-record)
* Para guardar dados desde [RECEIVE RECORD](../commands/receive-record)
