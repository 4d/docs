...
**\*** **As estruturas virtuais são definidas utilizando os comandos [SET TABLE TITLES](../commands/set-table-titles) e [SET FIELD TITLES](../commands/set-field-titles) (\** **parâmetro requerido).* 
