...
<!--REF #_command_.DELETE FOLDER.Syntax-->**DELETE FOLDER** ( *pasta* : Text {; *delete Opcao* : Integer} )<!-- END REF-->
...
Pode interceptar estes erros usando o método isntalado pelo comando [ON ERR CALL](../commands/on-err-call).
