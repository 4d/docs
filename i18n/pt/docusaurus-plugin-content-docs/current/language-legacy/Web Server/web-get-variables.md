...
Este comando pode ser chamado, se for necessário, no [On Web Connection](../commands/on-web-connection-database-method) ou em qualquer outro método 4D que resulte do envio de um formulário.
