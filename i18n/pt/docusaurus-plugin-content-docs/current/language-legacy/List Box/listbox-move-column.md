...
<!--REF #_command_.LISTBOX MOVE COLUMN.Syntax-->**LISTBOX MOVE COLUMN** ( * ; *objeto* : Text ; *colPosition* : Integer )<br/>**LISTBOX MOVE COLUMN** ( *objeto* : Variable ; *colPosition* : Integer )<!-- END REF-->
