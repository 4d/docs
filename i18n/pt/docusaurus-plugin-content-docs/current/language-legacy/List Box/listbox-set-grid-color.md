...
<!--REF #_command_.LISTBOX SET GRID COLOR.Syntax-->**LISTBOX SET GRID COLOR** ( * ; *objeto* : Text ; *cor* : Text, Integer ; *horizontal* : Boolean ; *vertical* : Boolean )<br/>**LISTBOX SET GRID COLOR** ( *objeto* : Variable ; *cor* : Text, Integer ; *horizontal* : Boolean ; *vertical* : Boolean )<!-- END REF-->
