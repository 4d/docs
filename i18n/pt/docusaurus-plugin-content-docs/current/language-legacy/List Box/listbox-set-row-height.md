...
<!--REF #_command_.LISTBOX SET ROW HEIGHT.Syntax-->**LISTBOX SET ROW HEIGHT** ( * ; *objeto* : Text ; *linha* : Integer ; *altura* : Integer )<br/>**LISTBOX SET ROW HEIGHT** ( *objeto* : Variable ; *linha* : Integer ; *altura* : Integer )<!-- END REF-->
