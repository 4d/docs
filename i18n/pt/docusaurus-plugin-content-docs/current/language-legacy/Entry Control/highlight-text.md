...
<!--REF #_command_.HIGHLIGHT TEXT.Syntax-->**HIGHLIGHT TEXT** ( * ; *area* : Text ; *inicioSel* : Integer ; *fimSel* : Integer )<br/>**HIGHLIGHT TEXT** ( *area* : Variable, Field ; *inicioSel* : Integer ; *fimSel* : Integer )<!-- END REF-->
