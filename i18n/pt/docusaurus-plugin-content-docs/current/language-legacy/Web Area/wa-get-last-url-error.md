...
<!--REF #_command_.WA GET LAST URL ERROR.Syntax-->**WA GET LAST URL ERROR** ( * ; *objeto* : Text ; *url* : Text ; *descriçao* : Text ; *codigoErro* : Integer )<br/>**WA GET LAST URL ERROR** ( *objeto* : Variable, Field ; *url* : Text ; *descriçao* : Text ; *codigoErro* : Integer )<!-- END REF-->
