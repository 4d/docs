...
<!--REF #_command_.WA Get last filtered URL.Syntax-->**WA Get last filtered URL** ( * ; *objeto* : Text ) : Text<br/>**WA Get last filtered URL** ( *objeto* : Variable, Field ) : Text<!-- END REF-->
