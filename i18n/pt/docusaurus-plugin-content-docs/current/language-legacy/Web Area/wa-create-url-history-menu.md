...
<!--REF #_command_.WA Create URL history menu.Syntax-->**WA Create URL history menu** ( * ; *objeto* : Text {; *endereço* : Integer} ) : Text<br/>**WA Create URL history menu** ( *objeto* : Variable, Field {; *endereço* : Integer} ) : Text<!-- END REF-->
