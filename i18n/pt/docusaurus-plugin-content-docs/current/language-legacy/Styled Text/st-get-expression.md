...
<!--REF #_command_.ST Get expression.Syntax-->**ST Get expression** ( * ; *objeto* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )  : Text<br/>**ST Get expression** ( *objeto* : Variable, Field {; *inicioSel* : Integer {; *fimSel* : Integer}} )  : Text<!-- END REF-->
