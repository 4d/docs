...
<!--REF #_command_.ST INSERT URL.Syntax-->**ST INSERT URL** ( * ; *objeto* : Text ; *textoURL* : Text ; *enderecoURL* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<br/>**ST INSERT URL** ( *objeto* : Variable, Field ; *textoURL* : Text ; *enderecoURL* : Text {; *inicioSel* : Integer {; *fimSel* : Integer}} )<!-- END REF-->
