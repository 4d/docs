...
<!--REF #_command_.SET PICTURE FILE NAME.Syntax-->**SET PICTURE FILE NAME** ( *imagem* : Picture ; *nomArquivo* : Text )<!-- END REF-->
<!--REF #_command_.SET PICTURE FILE NAME.Params-->
<div class="no-index">

| Parâmetro | Tipo |  | Descrição |
| --- | --- | --- | --- |
| imagem | Picture | &#8594; | Imagem para à qual definir o nome por padrão |
