...
<!--REF #_command_.SET PICTURE METADATA.Syntax-->**SET PICTURE METADATA** ( *imagem* : Picture ; *nomeMeta* : Text ; *conteudoMeta* : Variable, Expression {; ...(*nomeMeta* : Text ; *conteudoMeta* : Variable, Expression )} )<!-- END REF-->
