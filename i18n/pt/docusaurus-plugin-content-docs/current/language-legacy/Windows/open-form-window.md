...
- o caminho (na sintaxe POSIX) para um arquivo .json válido que contém uma descrição do formulário a ser usado. See *Form file path*;
...
| Propriedade                          | Modal form dialog box | Movable form dialog box | Movable form dialog box no title |
| ------------------------------------ | --------------------- | ----------------------- | -------------------------------- |
| Can have a title                     | Não                   | Sim                     | Não                              |
| Can have a close box or equivalent   | Não                   | Sim                     | Sim                              |
| Can be resized                       | Não                   | Sim                     | Sim                              |
| Can be minimized/maximized or zoomed | Não                   | Sim                     | Sim                              |
| Suitable for scroll bars             | Não                   | Não                     | Não                              |
| Modal                                | Sim                   | Yes, but can be moved   | Yes, but can be moved            |
...
| Propriedade                          | Plain form window | Plain form window no title |
| ------------------------------------ | ----------------- | -------------------------- |
| Can have a title                     | Sim               | Não                        |
| Can have a close box or equivalent   | Sim               | Sim                        |
| Can be resized                       | Sim               | Sim                        |
| Can be minimized/maximized or zoomed | Sim               | Sim                        |
| Suitable for scroll bars             | Sim               | Sim                        |
| Modal                                | Não               | Não                        |
