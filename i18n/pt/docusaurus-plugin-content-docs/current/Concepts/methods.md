...
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Métodos projeto**                               | Por demanda, quando o nome do método projeto é chamado (ver [Chamando a métodos projeto](#chamando-metodos-projeto))                                                                                                                | Sim                                      | Pode conter qualquer código para executar ações personalizadas. Quando um método projeto for criado, se torna parte da linguagem do banco de dados na qual foi criado.                                                                                                                                    |
