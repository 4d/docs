...
A [caixa de diálogo de erro 4D](../Debugging/basics.md) mostra o código e a mensagem para o usuário. Expand the **Details** area and click on the **Save...** or **Copy** button:
