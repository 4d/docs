...
- As células da caixa de listagem são compatíveis com o preenchimento [horizontal](../FormObjects/properties_CoordinatesAndSizing.md#horizontal-padding) e [vertical](../FormObjects/properties_CoordinatesAndSizing.md#vertical-padding) .
