...
| AIProviders.json                             | [AI provider configuration file](../settings/ai.md#aiprovidersjson) for Structure Can be overriden by an AIProviders.json file added in *[user settings](#settings-user)* or *[user settings for data](#settings-user-data)* (see also [Priority of settings](../settings/overview.md#priority-of-settings).                                                                                                                                                                                                                                                                                                                                                                                                         | JSON    |
