...
| --- | --- | --- | --- |
| targetObj | Object | &rarr; | Range ou elemento |
| wpSection | Object | &rarr; | Seção 4D Write Pro |
| subSectionType | Integer | &rarr; | Tipo de subseção (wk first page, wk left page, ou wk right page) |
| Resultado | Object | &larr; | Subseção |
