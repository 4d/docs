...
| wpArea | String, Objeto | &#x1F852; | Nome objeto formulário (se * for especificado) ou variável objeto ou campo 4D Write Pro (se * for omitido) |
| Resultado | Objeto | &#x1F850; | Propriedades vista atual |
