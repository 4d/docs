...
| wpArea | Text, Object | &rarr; | Nome objeto formulário (se * for especificado) ou variável objeto ou campo 4D Write Pro (se * for omitido) |
| Resultado | Object | &larr; | Propriedades vista atual |
