...
| indiceSecao | Integer | &rarr; | Indice seção |
| subsecaoTipo | Integer | &rarr; | Tipo sub-seção (wk first page, wk left page ou wk right page) |
| Resultado | Object | &larr; | Cabeçalho 4D Write Pro |
