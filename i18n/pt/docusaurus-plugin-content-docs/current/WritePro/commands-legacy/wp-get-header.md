...
| indiceSecao | Inteiro longo | &#x1F852; | Indice seção |
| subsecaoTipo | Inteiro longo | &#x1F852; | Tipo sub-seção (wk first page, wk left page ou wk right page) |
| Resultado | Objeto | &#x1F850; | Cabeçalho 4D Write Pro |
