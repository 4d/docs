...
| numCol | Integer | &rarr; | Número da coluna |
| numColunas | Integer | &rarr; | Número de colunas a inserir (valor predefinido = 1) |
| Resultado | Object | &larr; | Range/seleção de colunas da tabela |
