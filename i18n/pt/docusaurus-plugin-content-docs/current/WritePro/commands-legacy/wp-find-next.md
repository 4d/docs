...
<!--REF #_command_.WP Find next.Syntax-->**WP Find next** ( *objAlvo* : Object ; *pesquisarDepois* : Object ; *valorPesquisa* : Text ; *condiçãoPesquisa* : Integer {; *valorSubstituir* : Text} ) -> Resultado<!-- END REF-->
