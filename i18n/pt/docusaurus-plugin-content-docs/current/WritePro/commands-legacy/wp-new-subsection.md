...
| --- | --- | --- | --- |
| wpSeção | Object | &rarr; | seção 4D Write Pro |
| subSeçãoTipo | Integer | &rarr; | Tipo de subseção (wk first page, wk left page ou wk right page) |
| Resultado | Object | &larr; | Nova subseção |
