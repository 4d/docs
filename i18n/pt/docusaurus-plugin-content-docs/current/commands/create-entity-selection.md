...
| --------- | ----------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------- |
| dsTable   | Tabela                              | &#x1F852 | Tabela do banco de dados 4D cuja seleção atual se utilizará para construir a seleção de entidades |
| settings  | Object                              | &#x1F852 | Opção de construção: context                                                      |
| Resultado | 4D. EntitySelection | &#x1F850 | Seleção de entidades que coincidem com a classe de dados relacionada com a tabela dada            |
