...
| --------- | ---------------------------------- | ------------------------------- | --------------------------------------------------------------------------------- |
| server    | Object                             | &amp;srarr; | Informação de servidor de correio                                                 |
| Resultado | 4D.POP3Transporter | &amp;larr;  | [POP3 transporter object](../API/POP3TransporterClass.md#pop3-transporter-object) |
...
| **.password** : Text<br/>Senha do usuário para autenticação no servidor. Not returned in *[SMTP transporter](../API/POP3TransporterClass.md#smtptransporterobject)* object.                                                                                                                                                                                                                                                                                                                                               | nenhum                                                            |
