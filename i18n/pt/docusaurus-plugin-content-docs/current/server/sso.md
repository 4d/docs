...
Quando você marca essa opção, 4D se conecta de forma transparente ao Active Directory do servidor de domínio do Windows e obtém os tokens de autenticação disponíveis.
...
|                                                                                     | NTLM                                                               | Kerberos                                                               |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| 4D Server and 4D remote are on different machines                                   | sim                                                                | sim                                                                    |
| 4D Server user is on domain                                                         | sim                                                                | sim                                                                    |
| 4D remote is on the same AD as 4D Server user                                       | yes or no(\*)                                   | sim                                                                    |
| SPN is filled in on 4D Server                                                       | não                                                                | yes(\*\*)                                           |
