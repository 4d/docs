...
Dados dois números reais *a* e *b*, se [Abs](../commands/abs)(a-b) é maior a epsilon, os números são considerados como diferentes; do contrário, os números são considerados iguais.
