...
Este comando pode ser chamado desde qualquer método (*On Web Authentication Database Method* ou [On Web Connection](../commands/on-web-connection-database-method), método chamado por '*/4DACTION*'...) executado em um processo web.
...
* Pode enviar diferentes páginas em função do idioma do navegador (por exemplo em [On Web Connection](../commands/on-web-connection-database-method)):
...
* Este é um exemplo de hosts virtuais (por exemplo no [On Web Connection](../commands/on-web-connection-database-method)). Os seguintes nomes "home\_site.com", "home\_site1.com" e "home\_site2.com" apontam ao mesmo endereço IP, por exemplo 192.1.2.3.
