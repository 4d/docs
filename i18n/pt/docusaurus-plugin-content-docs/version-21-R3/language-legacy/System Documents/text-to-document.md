...
<!--REF #_command_.TEXT TO DOCUMENT.Syntax-->**TEXT TO DOCUMENT** ( *nomeArquivo* : Text ; *texto* : Text {; *conjCaracteres* : Text, Integer {; *modoRetorno* : Integer}} )<!-- END REF-->
...
Se deseja que o usuário seja capaz de indicar o nome ou a localização do documento, utilize os comandos [Open document](../commands/open-document) ou [Create document](../commands/create-document) , assim como a variável do sistema *Document*.
