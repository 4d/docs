...
Para poder executar o formulário diretamente passando o objeto resultante ao comando [DIALOG](../commands/dialog), **FORM Convert to dynamic** aplica regras específicas ao converter o formulário:
