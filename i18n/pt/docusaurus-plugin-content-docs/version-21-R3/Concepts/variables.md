...
| `Error`, `Error line`           | Integer | Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands/on-err-call). Veja [Tratamento de erros no método](../Concepts/error-handling.md#handling-errors-within-the-method).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `Error method`, `Error formula` | Text    | Usado em um método de captura de erro instalado pelo comando [`ON ERR CALL`](../commands/on-err-call). Veja [Tratamento de erros no método](../Concepts/error-handling.md#handling-errors-within-the-method).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
