...
Os objetos de anexo são definidos por meio do comando [`MAIL New attachment`](../commands/mail-new-attachment). Os objetos anexo têm [propriedades e funções](MailAttachmentClass.md) específicas.
