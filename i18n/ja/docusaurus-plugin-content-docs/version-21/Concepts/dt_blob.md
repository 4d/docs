...
値がBLOB なのかオブジェクトなのかを判断するためには、[Value type](../commands-legacy/value-type.md) コマンドを使用します。値がBLOB なのかオブジェクトなのかを判断するためには、[Value type](../commands-legacy/value-type.md) コマンドを使用します。
