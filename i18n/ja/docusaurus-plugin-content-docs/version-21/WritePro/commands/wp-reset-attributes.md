...
**WP RESET ATTRIBUTES** コマンドを使用して属性の値が削除された場合、*targetObj* あるいは *sectionOrSubsection* にはデフォルトの値が適用されます。 デフォルトの値は[4D Write Pro 属性](../4d-write-pro-attributes) の章にまとめられています。
