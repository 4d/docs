...
**Trim** コマンドは<!--REF #_command_.Trim.Summary-->*aString* 引数の文字列の前後の **空白** を削除し、元の文字列を変更することなく新しい文字列を返します<!-- END REF-->。 **空白** にはスペース、タブ、LF、CR などが含まれます。**空白** にはスペース、タブ、LF、CR などが含まれます。
