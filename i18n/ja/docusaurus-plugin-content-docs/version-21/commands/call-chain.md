...
<!--REF #_command_.Call chain.Summary-->**Call chain** コマンドは、カレントプロセス内におけるメソッド呼び出しチェーンの各ステップを説明するオブジェクトのコレクションを返します。<!-- END REF--> これはデバッガウィンドウと同じ情報を提供します。  これはデバッガウィンドウと同じ情報を提供します。 こちらの方が、コンパイルモードを含めてあらゆる4D 環境から実行可能であるという利点があります。
