...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| folderPath | Text | &#8594;  | プロジェクトファイルの保存先フォルダーのパス |
...
*folderPath* 引数には、書き出されたファイルを保存するフォルダーのシステムパスを渡します。

*options* 引数を使用すると、変換のプロセスをカスタマイズすることができます。*options* オブジェクトには、以下のプロパティを格納することができます:

| **プロパティ名**        | **値の型**   | **詳細**                                                                                                                                                                                                                                                                                                                         |
| ----------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| withLog           | ブールまたは文字列 | <table><tbody><tr><td>true または "always": 指定先のLogs フォルダーに変換ログファイルを作成します</td></tr><tr><td>"ifNotEmpty": 変換ログファイルに何らかのメッセージが含まれる場合にのみ変換ログファイルを作成します</td></tr><tr><td>false または省略(デフォルト): 変換ログファイルを作成しません</td></tr></tbody></table> |
| makeProject       | ブール       | true を渡すと"Project" フォルダーに.4DProject ファイルを書き出します。                                                                                                                                                                                                                                                                                |
...
| forms             | ブール       | フォームを書き出すにはtrue                                                                                                                                                                                                                                                                                                                |
| folders           | ブール       | エクスプローラーフォルダー定義を書き出すにはtrue                                                                                                                                                                                                                                                                                                      |
...
| resources         | ブール       | Resources フォルダーを書き出すにはtrue                                                                                                                                                                                                                                                                                                      |
...
データベースストラクチャーを、"Export" というフォルダーに、デフォルトの設定で書き出したい場合を考えます:
