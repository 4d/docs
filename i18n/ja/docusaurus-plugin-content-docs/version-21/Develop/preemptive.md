...
[ワーカープロセス](processes.md#ワーカープロセス) という新種のプロセスによって、プリエンプティブプロセスを含むあらゆるプロセス間でデータの交換ができるようになります。[ワーカープロセス](processes.md#ワーカープロセス) は、プリエンプティブプロセスを含むあらゆるプロセス間でデータの交換ができます。
