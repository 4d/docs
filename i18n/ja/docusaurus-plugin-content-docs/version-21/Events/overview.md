...
コードの中では、トリガーされたイベントを返す [`FORM Event`](../commands/form-event.md) コマンドを使ってイベントを制御します。 例: 例:
...
それぞれのイベントは、[`FORM Event`](../commands/form-event.md) コマンドによってオブジェクトとして返されます。 デフォルトで、以下のプロパティが含まれています: デフォルトで、以下のプロパティが含まれています:
