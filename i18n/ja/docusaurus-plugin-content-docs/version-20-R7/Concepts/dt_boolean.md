...
4Dにはブール演算に使用することのできる、ブール関数があります: `True`, `False`, `Not`。 詳細については、これらのコマンドの説明を参照ください。 詳細については、これらのコマンドの説明を参照ください。 詳細については、これらのコマンドの説明を参照ください。 詳細については、これらのコマンドの説明を参照ください。
