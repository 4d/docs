...
`On Printing Break` イベントは、**出力フォーム** のコンテキストでのみ使用できます。 このイベントは、出力フォームのブレークエリアが印刷されようとするたびに発生し、これによってブレーク値を評価できるようになります。 このイベントは、出力フォームのブレークエリアが印刷されようとするたびに発生し、これによってブレーク値を評価できるようになります。 このイベントは、出力フォームのブレークエリアが印刷されようとするたびに発生し、これによってブレーク値を評価できるようになります。
