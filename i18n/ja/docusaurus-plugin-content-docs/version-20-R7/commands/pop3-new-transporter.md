...
| **.password** : Text<br/>サーバーとの認証のためのユーザーパスワード。 Not returned in *[POP3 transporter](../API/POP3TransporterClass.md#pop3-transporter-object)* object.                                                                                                                                                                                                                                                              | なし                               |
