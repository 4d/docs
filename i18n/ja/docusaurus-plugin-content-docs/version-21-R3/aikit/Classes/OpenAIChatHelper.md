...
ユーザープロンプトをチャットに送信し、対応する補完の結果を返します。 You can pass either a simple text string or an [OpenAIMessage](OpenAIMessage.md) object for more advanced scenarios like including images or files.
