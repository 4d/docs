...
> ユーザーとグループのエディターは、[EDIT ACCESS](../commands/edit-access) コマンドを使用することでランタイムで表示することもできます。ユーザーとグループの設定は、アプリケーション実行中でも `Users and Groups` テーマの 4Dランゲージコマンドを使って編集することができます。
...
2. ユーザーリストの下にある追加ボタン ![](../assets/en/Users/PlussNew.png) をクリックします。または <br />
