...
<!--REF #_command_.OBJECT Get list name.Syntax-->**OBJECT Get list name** ( * ; *object* : Text {; *listType* : Integer} ) : Text<br/>**OBJECT Get list name** ( *object* : Variable, Field {; *listType* : Integer} ) : Text<!-- END REF-->
