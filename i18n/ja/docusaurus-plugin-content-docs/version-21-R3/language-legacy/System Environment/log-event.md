...
| 定数                           | 型    | 値 | コメント                                                                                                                                                                                                                                                                         |
| ---------------------------- | ---- | - | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Into 4D commands log         | 倍長整数 | 3 | この値は4Dのコマンドログファイルがアクティブである場合、このファイルに*message*の内容を記録するよう4Dに指示します。4Dコマンドログファイルは[SET DATABASE PARAMETER](../commands/set-database-parameter)コマンド (セレクター34) を使用して有効にできます。 **注:** 4Dのログファイルは、**Logs**フォルダーに配置されます([Get 4D folder](../commands/get-4d-folder)コマンドを参照) 。                               |
