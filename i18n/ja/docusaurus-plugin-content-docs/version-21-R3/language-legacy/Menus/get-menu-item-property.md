...
*property* 引数には、値を取得したいプロパティを渡します。“*Menu Item Properties*”テーマの定数またはカスタムプロパティに対応する文字列を使用できます。メニュープロパティとその値に関する詳細は[SET MENU ITEM PROPERTY](../commands/set-menu-item-property) コマンドの説明を参照してください。
