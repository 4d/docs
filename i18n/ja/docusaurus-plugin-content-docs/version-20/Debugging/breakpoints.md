...
ブレークリストは、デバッガーウィンドウ又はコードエディターで作成したブレークポイントを管理することが出来るランタイムエクスプローラーのページです。 ランタイムエクスプローラーの詳細については、[デザインリファレンスマニュアル](https://doc.4d.com/4Dv19/4D/19/Runtime-Explorer.200-5416614.ja.html) を参照ください。
...
2. 次に **ALERT** ラベルをクリックし、キャッチしたいコマンドの名前を入力します。
...
1. リスト中のコマンド選択します。
2. **Backspace** または **Delete** キーを押すか、リスト下部にある **削除** ボタンをクリックします。
