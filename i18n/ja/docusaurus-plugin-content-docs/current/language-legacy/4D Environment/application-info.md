...
| useQUICNetworkLayer                                                              | boolean    | アプリケーションサーバーとDB4D サーバーが[QUIC ネットワークレイヤー](../../settings/client-server.md#network-layer) を使用している場合にはTrue 。 スタンドアロン環境では返されません。 取り得る値: true/false。                                                                                                                                                                                                                                                                                                                                                                  | false                                                                                                                                                                                                                 |
