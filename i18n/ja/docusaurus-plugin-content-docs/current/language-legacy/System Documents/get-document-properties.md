...
<!--REF #_command_.GET DOCUMENT PROPERTIES.Syntax-->**GET DOCUMENT PROPERTIES** ( *document* : Text ; *locked* : Boolean ; *invisible* : Boolean ; *created on* : Date ; *created at* : Time ; *modified on* : Date ; *modified at* : Time )<!-- END REF-->
