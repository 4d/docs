...
<!--REF #_command_.SET DOCUMENT PROPERTIES.Syntax-->**SET DOCUMENT PROPERTIES** ( *document* : Text ; *locked* : Boolean ; *invisible* : Boolean ; *created on* : Date ; *created at* : Time ; *modified on* : Date ; *modified at* : Time )<!-- END REF-->
