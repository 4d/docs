...
| 引数          | 型      |                              | 説明                                 |
| ----------- | ------ | ---------------------------- | ---------------------------------- |
| section     | オブジェクト | &#x1F852 | 4D Write Pro section               |
| wpDoc       | オブジェクト | &#x1F852 | 4D Write Pro document              |
| indexNumber | 整数     | &#x1F852 | Index of the section to be deleted |
| count       | 整数     | &#x1F852 | Number of sections to be deleted   |
