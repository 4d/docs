...
**互換性に関する注意**: [**ST INSERT EXPRESSION**](../commands-legacy/st-insert-expression)、 [**ST Get expression**](../commands-legacy/st-get-expression)、 [**ST COMPUTE EXPRESSIONS**](../commands-legacy/st-compute-expressions)、および [**ST FREEZE EXPRESSIONS**](../commands-legacy/st-freeze-expressions) コマンドを使用して式を管理するのは、廃止予定となっていますが、互換性のために4D Write Pro では引き続きサポートされています。
...
| プロパティ                                                                          | 型      | 説明                                                                                                                                                                                                                                            |
| ------------------------------------------------------------------------------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [This](../commands/this).title                              | Text   | wk title 属性で定義されているタイトル                                                                                                                                                                                                                       |
| [This](../commands/this).author                             | Text   | wk author 属性で定義されている作者                                                                                                                                                                                                                        |
| [This](../commands/this).subject                            | Text   | wk subject 属性で定義されている主題                                                                                                                                                                                                                       |
| [This](../commands/this).company                            | Text   | wk company 属性で定義されている会社                                                                                                                                                                                                                       |
| [This](../commands/this).notes                              | Text   | wk notes 属性で定義されている注記                                                                                                                                                                                                                         |
| [This](../commands/this).dateCreation                       | Date   | wk date creation 属性で定義されている作成日                                                                                                                                                                                                                |
| [This](../commands/this).dateModified                       | Date   | wk date modified 属性で定義されている変更日                                                                                                                                                                                                                |
| [This](../commands/this).pageNumber (\*) | Number | 以下の場所から定義されているページ番号:<li>- ドキュメントの開始からのページ番号(デフォルト)</li><li>- セクションの開始から定義されている場合には、セクションの開始からのページ番号</li> このフォーミュラは常に動的です。つまり[**WP FREEZE FORMULAS**](commands-legacy/wp-freeze-formulas.md) コマンドの影響を受けません。 |
| [This](../commands/this).pageCount (\*)  | Number | ページ数: 総合のページ数。<br/>このフォーミュラは常に動的です。つまり[**WP FREEZE FORMULAS**](commands-legacy/wp-freeze-formulas.md) コマンドの影響を受けません。                                                                                                          |
| [This](../commands/this).document                           | Object | 4D Write Pro ドキュメント                                                                                                                                                                                                                           |
| [This](../commands/this).data                               | Object | [**WP SET DATA CONTEXT**](commands-legacy/wp-set-data-context.md) コマンドで設定された4D Write Pro ドキュメントのデータコンテキスト                                                                                                                                     |
| [This](../commands/this).sectionIndex                       | Number | 4D Write Pro ドキュメント内のセクションのインデックス(1から開始)                                                                                                                                                                                   |
| [This](../commands/this).pageIndex                          | Number | 4D Write Pro ドキュメント内の実際のページ番号(1から開始、セクションのページ番号とは無関係)                                                                                                                                                                      |
| [This](../commands/this).sectionName                        | 文字列    | ユーザーが与えたセクションの名前                                                                                                                                                                                                                              |
...
| When a datasource has been defined for the table                                                                       | [This](../commands/this).table.dataSource | Object (フォーミュラ)                          | Datasource as a formula                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                        | [This](../commands/this).tableData                        | Collection or Entity selection (usually) | Evaluated table.dataSource                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| In each data row when a table datasource returns a collection or an entity selection                                   | [This](../commands/this).item.xxx         | 制限なし                                                        | Mapped to each item of the table datasource collection or entity selection, for example **This.item.firstName** if the associated entity has the *firstName* attribute                                                                                                                                                                                                                                                                                                                                |
...
[**Current date**](../commands-legacy/current-date) コマンド、日付型変数、あるいは日付を返すメソッドがフォーミュラに挿入された場合、この日付はsystem date short フォーマットを使用してテキストをへと自動的に変換されます。

**時間**

[**Current time**](../commands-legacy/current-time) コマンド、時間型変数、あるいは時間を返すメソッドがフォーミュラに挿入される場合、この時間は [**String**](../commands/string) コマンドでくくってあげる必要があります。JSON では時間型はサポートされていないからです。 以下のフォーミュラの例を参考にして下さい:
...
4D Write Pro ドキュメントに挿入されたテーブルおよびフィールドの式はデータベースのバーチャルストラクチャー定義をサポートします。  フォーミュラに公開されるバーチャルストラクチャーは[**SET FIELD TITLES**](../commands-legacy/set-field-titles)(...;\*) および [**SET TABLE TITLES**](../commands-legacy/set-table-titles)(...;\*) コマンドを通して定義されます。
