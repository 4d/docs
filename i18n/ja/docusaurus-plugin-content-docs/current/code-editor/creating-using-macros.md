...
4D offers a set of default macros containing, for example, control flow keywords. このマクロは 4Dを初回起動する際、マシンのアクティブ4Dフォルダー内の "Macros v2" フォルダーに作成される*Macros.xml* ファイルに含まれます。
