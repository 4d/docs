...
| *4D Desktop*                  | コンピューターごとのライセンス、スタンドアロン4D アプリケーションを使用するのに必要      | ユーザーマシン上での[初回起動時](#初回のアクティベーション) のダイアログボックス               |
| *4D Desktop Business Edition* | スタンドアロン4D アプリケーション用の埋め込みカスタムライセンス                | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
| *4D Server OEM*               | 埋め込まれたカスタムのライセンス。 詳細は 4D 営業部にお問い合わせ下さい。          | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
| *4D OEM Desktop*              | 埋め込まれたカスタムのライセンス。 詳細は 4D 営業部にお問い合わせ下さい。          | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
| *4D XML Keys Activation*      | 非自動埋め込みモードの4D Server OEM ライセンスをアクティベートするのに使用されます | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
...
| オンラインアクティベーションに失敗します。                                  | アンチウィルス、ファイアウォール、プロキシ                | 1- 一時的にアンチウィルスソフトやファイアウォールを無効にしてください<br />または <br />2- オフラインアクティベーションを試してください。 (ただし "R" バージョン用のライセンスでは利用不可) |
