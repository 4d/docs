...
| *4D Desktop Business*    | Embedded custom license for stand-alone 4D applications                 | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
| *4D Server OEM*          | 埋め込まれたカスタムのライセンス。詳細は 4D 営業部にお取り合わせ下さい。                                  | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
| *4D XML Keys Activation* | Used to activate 4D Server OEM licenses in non-automatic embedding mode | ビルドアプリケーションダイアログの[ライセンスページ](../Desktop/building.md#ライセンス) |
