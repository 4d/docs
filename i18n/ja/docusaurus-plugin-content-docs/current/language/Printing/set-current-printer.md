...
このコマンドは [PRINT SELECTION](print-selection.md)、[PRINT RECORD](print-record.md)、[Print form](./commands/print-form)、および [QR REPORT](qr-report.md) コマンドと一緒に使用することができ、デザインモードを含め、4Dにおけるすべての印刷に対して適用されます。  
