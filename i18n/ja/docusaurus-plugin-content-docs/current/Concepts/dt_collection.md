...
| --------- | -------------------------------------- | -------------------------------------------- | -------------------------------------- | -------------------------------------------- | -------------------------------------------- | ------------------------------------------ | -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | -------------------------------------- |
| コレクション要素型 | text                                   | number                                       | number                                 | number                                       | boolean                                      | オブジェクトあるいはnull                             | picture                                      | SET DATABASE PARAMETERコマンドの[Dates inside objects](../commands/set-database-parameter#dates-inside-objects-85) 引数に従ったテキストまたは日付 | 秒数                                     | 4D.Blob                |