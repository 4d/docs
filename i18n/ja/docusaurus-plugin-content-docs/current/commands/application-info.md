...
| 引数  | 型      |                             | 説明                                                |
| --- | ------ | --------------------------- | ------------------------------------------------- |
| 戻り値 | Object | &#8592; | Information about the active application activity |
...
| headless                                                                         | boolean    | アプリケーションがヘッドレスモードで実行されている場合は true. Possible values: true, false. For more information, see [Command Line Interface](../Admin/cli.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | false                                                                                                                                                                                                                 |
...
| portID                                                                           | number     | 4D Server: port for active listening, 4D remote: port for remote connections. Not returned in standalone environment. 最小値: 1\. For more information, see [Port Number](../settings/client-server.md#port-number).                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 19814                                                                                                                                                                                                                 |
...
| useLegacyNetworkLayer                                                            | boolean    | アプリケーションサーバーに旧式ネットワークレイヤーが使用されている場合は true. Not returned in standalone environment. Possible values: true, false. For more information, see [Network layer](../settings/client-server.md#network-layer).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | false                                                                                                                                                                                                                 |
