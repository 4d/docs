...
| 引数             | 型                         |                            | 説明                                                                |
| -------------- | ------------------------- | :------------------------: | ----------------------------------------------------------------- |
| path           | テキスト                      | &#8594 | フォルダーパス                                                           |
| folderConstant | 整数                        | &#8594 | 4Dフォルダー定数                                                         |
| pathType       | 整数                        | &#8594 | `fk posix path` (デフォルト) または `fk platform path` |
| \*             | operator                  | &#8594 | ホストデータベースのフォルダーを返すには \* を渡します                                     |
| 戻り値            | 4D.Folder | &#8592 | 新規フォルダーオブジェクト                                                     |
