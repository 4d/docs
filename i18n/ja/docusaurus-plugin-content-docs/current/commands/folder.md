...
| 引数             | 型                         |                              | 説明                                                                |
| -------------- | ------------------------- | :--------------------------: | ----------------------------------------------------------------- |
| path           | テキスト                      | &#x1F852 | フォルダーパス                                                           |
| folderConstant | 整数                        | &#x1F852 | 4Dフォルダー定数                                                         |
| pathType       | 整数                        | &#x1F852 | `fk posix path` (デフォルト) または `fk platform path` |
| \*             | operator                  | &#x1F852 | ホストデータベースのフォルダーを返すには \* を渡します                                     |
| 戻り値            | 4D.Folder | &#x1F850 | 新規フォルダーオブジェクト                                                     |
