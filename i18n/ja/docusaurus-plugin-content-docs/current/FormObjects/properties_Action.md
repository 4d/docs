...
詳細については、[ドラッグ＆ドロップ](../Desktop/drag-and-drop.md) を参照してください。
...
アクティブオブジェクトにより実行される典型的な処理 (例: レコードの入力・取り消し・削除、レコード間の移動、マルチページフォームでのページ間の移動、など)  は、4D より標準アクションとして提供されています。 詳細な情報に関しては、[標準アクション](/Desktop/standard-actions) の章を参照ください。 また、[4D Write Pro エリア専用の標準アクション](../WritePro/user-legacy/standard-actions.md) もあります。
...
| 名称     | データタイプ | とりうる値                                                                                                                    |
| ------ | ------ | ------------------------------------------------------------------------------------------------------------------------ |
| action | string | 有効な[標準アクション](/Desktop/standard-actions) の名前、または [4D Write Pro 標準アクション](../WritePro/user-legacy/standard-actions.md) の名前。 |
