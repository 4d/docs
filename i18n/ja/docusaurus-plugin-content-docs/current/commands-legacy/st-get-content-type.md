...
<!--REF #_command_.ST Get content type.Syntax-->**ST Get content type** ( {* ;} *object* {; *startSel* {; *endSel* {; *startBlock* {; *endBlock*}}}} ) -> 戻り値<!-- END REF-->
...
| startBlock | Integer | &harr; | 選択範囲内の、同一のタイプの開始地点 |
| endBlock | Integer | &harr; | 選択範囲内の、同一のタイプの終了地点 |
