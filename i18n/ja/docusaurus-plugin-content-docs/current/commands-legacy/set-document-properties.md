...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| document | Text | &srarr; | ドキュメント名 またはドキュメントの完全なパス名 |
| locked | Boolean | &srarr; | ロックの場合はTrue、アンロックの場合はFalse |
| invisible | Boolean | &srarr; | 非表示の場合はTrue、表示の場合はFalse |
| created on | 日付 | &srarr; | 作成日 |
| created at | 時間 | &srarr; | 作成時間 |
| modified on | 日付 | &srarr; | 更新日 |
| modified at | 時間 | &srarr; | 更新時間 |
