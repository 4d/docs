...
| moveH | Integer | &rarr; | オブジェクトの水平移動量 (>0 = 右方向, <0 =左方向) |
| moveV | Integer | &rarr; | オブジェクトの垂直移動量 (>0 = 下方向, <0 = 上方向) |
| resizeH | Integer | &rarr; | オブジェクトの水平方向へのサイズ変更値 |
| resizeV | Integer | &rarr; | オブジェクトの垂直方向へのサイズ変更値 |
