...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| errorMethod | Text | &srarr; | 実行されるエラーメソッド, または 空の文字列でエラーのトラップ停止 |
| scope | Integer | &srarr; | エラーメソッドのスコープ |
