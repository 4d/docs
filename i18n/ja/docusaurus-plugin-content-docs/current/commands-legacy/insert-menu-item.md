...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| menu | Integer | &rarr; | メニュー番号またはメニュー参照 |
| afterItem | Integer | &rarr; | メニュー項目番号 |
| itemText | Text | &rarr; | 挿入するメニュー項目のテキスト |
| subMenu | Text | &rarr; | 項目に割り当てるサブメニュの参照 |
| process | Integer | &rarr; | プロセス参照番号 |
| * | 演算子 | &rarr; | 指定時: メタ文字を標準文字として扱う |
