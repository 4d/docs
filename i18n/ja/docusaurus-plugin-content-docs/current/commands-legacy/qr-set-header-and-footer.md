...
| leftTitle | Text | &rarr; | 左側に表示されるテキスト |
| centerTitle | Text | &rarr; | 中央に表示されるテキスト |
| rightTitle | Text | &rarr; | 右側に表示されるテキスト |
| height | Integer | &rarr; | ヘッダまたはフッタの高さ |
| picture | Picture | &rarr; | 表示するピクチャ |
| pictAlignment | Integer | &rarr; | ピクチャの整列属性 |
