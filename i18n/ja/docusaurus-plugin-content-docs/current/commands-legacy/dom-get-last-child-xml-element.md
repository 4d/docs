...
<!--REF #_command_.DOM Get last child XML element.Syntax-->**DOM Get last child XML element** ( *elementRef* {; *childElemName* {; *childElemValue*}} ) -> 戻り値<!-- END REF-->
<!--REF #_command_.DOM Get last child XML element.Params-->
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| elementRef | Text | &rarr; | XML要素参照 |
| childElemName | Text | &larr; | 子要素名 |
| childElemValue | Text | &larr; | 子要素値 |
