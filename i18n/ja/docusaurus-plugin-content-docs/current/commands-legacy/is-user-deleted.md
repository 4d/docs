...
<!--REF #_command_.Is user deleted.Syntax-->**Is user deleted** ( *userNumber* ) -> 戻り値<!-- END REF-->
<!--REF #_command_.Is user deleted.Params-->
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| userNumber | 倍長整数 | &#x1F852; | ユーザーID番号 |
| 戻り値 | ブール | &#x1F850; | TRUE = ユーザーアカウントが削除されている、または存在しない場合；FALSE = ユーザーアカウントがアクティブな場合 |
