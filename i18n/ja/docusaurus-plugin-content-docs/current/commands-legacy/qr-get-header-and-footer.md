...
| leftTitle | Text | &harr; | 左側に表示されるテキスト |
| centerTitle | Text | &harr; | 中央に表示されるテキスト |
| rightTitle | Text | &harr; | 右側に表示されるテキスト |
| height | Integer | &harr; | ヘッダまたはフッタの高さ |
| picture | Picture | &harr; | 表示するピクチャ |
| pictAlignment | Integer | &harr; | ピクチャの整列属性 |
