...
| title | Text | &rarr; | カラムタイトル |
| object | Field, Variable | &rarr; | カラムに割り当てられたオブジェクト |
| hide | Integer | &rarr; | 0 = 表示, 1 = 非表示 |
| size | Integer | &rarr; | カラムサイズ |
| repeatedValue | Integer | &rarr; | 0 = 繰り返ししない, 1 = 繰り返す |
| displayFormat | Text | &rarr; | データの表示フォーマット |
