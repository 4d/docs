...
| newItemText | Text | &rarr; | 新しい項目テキスト |
| newItemRef | Integer | &rarr; | 新しい項目参照番号 |
| sublist | Integer | &rarr; | 項目に添付する新しいサブリスト, または 0: サブリストがない場合 (現在のサブリストを取り除く), または -1: 変更しない |
| expanded | Boolean | &rarr; | オプションのサブリストの展開/折りたたみ |
