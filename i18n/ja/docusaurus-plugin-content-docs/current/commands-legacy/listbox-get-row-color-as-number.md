...
<!--REF #_command_.LISTBOX Get row color as number.Syntax-->**LISTBOX Get row color as number** ( {* ;} *object* ; *row* {; *colorType*} )  -> 戻り値<!-- END REF-->
...
| colorType | Integer | &rarr; | Listbox font color (デフォルト値) または Listbox background color |
