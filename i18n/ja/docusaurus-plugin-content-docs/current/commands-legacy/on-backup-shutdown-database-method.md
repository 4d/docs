...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| $1 | 倍長整数 | &larr; | 0 = バックアップは正しく実行された; 0以外の値 = エラー、ユーザーにより中断された、またはOn Backup Startupから返されたコード |
...
いずれの場合も[GET BACKUP INFORMATION](get-backup-information.md)コマンドを使用してエラーに関する情報を入手できます。
