...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| icon | Picture | &rarr; | ドラッグ中に表示するアイコン |
| horOffset | Integer | &rarr; | カーソルから見てアイコンの左端との水平方向の距離を指定(>0 は左方向に、<0 は右方向に移動) |
| vertOffset | Integer | &rarr; | カーソルから見てアイコンの上端との垂直方向の距離を指定(>0 は上方向に、<0 は下方向に移動) |
