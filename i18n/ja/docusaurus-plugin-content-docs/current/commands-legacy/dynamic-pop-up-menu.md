...
<!--REF #_command_.Dynamic pop up menu.Syntax-->**Dynamic pop up menu** ( *menu* {; *default* {; *xCoord* ; *yCoord*}} )  -> 戻り値<!-- END REF-->
...
* 関連付けられた標準アクションがポップアップメニューのコンテキストで有効化されていない(つまり呼び出すことができない)場合、項目は自動的に非表示にされます。アクションが有効化されているかいないかは、[Get action info](get-action-info.md) コマンドを使用して調べることができます。
