...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| srcBlob | Blob | &srarr; | コピー元BLOB |
| dstBlob | Blob | &srarr; | コピー先BLOB |
| srcOffset | Integer | &srarr; | コピー元のコピー開始位置 |
| dstOffset | Integer | &srarr; | コピー先のコピー開始位置 |
| len | Integer | &srarr; | コピーするバイト数 |
