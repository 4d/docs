...
| object | any | &rarr; | オブジェクト名 (* 指定時) または <br/>フィールドまたは変数 (* 省略時) |
| foregroundColor | Text, Integer | &larr; | 描画色のRGBカラー値 |
| backgroundColor | Text, Integer | &larr; | 背景色のRGBカラー値 |
| altBackgrndColor | Text, Integer | &larr; | 奇数行の色のRGBカラー値 |
