...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| destinationType | Integer | &rarr; | 0=カレントセレクション, 1=セット, 2=命名セレクション, 3=変数 |
| destinationObject | Text, Variable | &rarr; | セット名、命名セレクション名、変数、または空の文字列 |
| destinationPtr | Pointer | &rarr; | destinationType=3のとき変数へのポインター |
