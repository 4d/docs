...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| destinationType | Integer | &srarr; | 0=カレントセレクション, 1=セット, 2=命名セレクション, 3=変数 |
| destinationObject | Text, Variable | &srarr; | セット名、命名セレクション名、変数、または空の文字列 |
| destinationPtr | Pointer | &srarr; | destinationType=3のとき変数へのポインター |
