...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| mouseX | Real | &larr; | マウスの水平座標 |
| mouseY | Real | &larr; | マウスの垂直座標 |
| mouseButton | Integer | &larr; | マウスボタンンのステータス 0 = 何もしていない 1 = ボタンの押下 2 = 右マウスボタンの押下 3 = 両方のボタンの押下 |
| * | 演算子 | &rarr; | 指定した場合、グローバルの座標システムが使用される。 省略した場合、ローカルの座標システムが使用される |
