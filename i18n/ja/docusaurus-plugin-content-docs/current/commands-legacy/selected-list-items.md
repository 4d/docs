...
| itemsArray | Integer array | &harr; | 2番目の * 省略時: 配列にはリスト中で選択された 項目の位置配列が返される 2番目の * 指定時: 配列には選択された項目の 参照が返される |
| * | 演算子 | &srarr; | 省略時: 項目位置 指定時: 項目参照 |
| 戻り値 | Integer | &larr; | 2番目の * 省略時: 展開/折りたたまれたされたリスト中 現在選択されている項目位置 2番目の * 指定時: 選択されている項目の参照 |
