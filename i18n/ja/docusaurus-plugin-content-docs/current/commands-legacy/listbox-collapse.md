...
| recursive | Boolean | &rarr; | True = サブレベルを折りたたむ<br/>False = サブレベルを折りたたまない |
| selector | Integer | &rarr; | 折りたたむリストボックスのパーツ |
| line | Integer | &rarr; | 折り畳むブレーク行の番号、または折り畳むリストボックスレベルの番号 |
| column | Integer | &rarr; | 折り畳むブレーク列の番号 |
