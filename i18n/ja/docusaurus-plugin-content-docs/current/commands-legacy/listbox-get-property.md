...
<!--REF #_command_.LISTBOX Get property.Syntax-->**LISTBOX Get property** ( {* ;} *object* ; *property* ) -> 戻り値<!-- END REF-->
...
| property | Integer | &srarr; | 値を取得したいプロパティ |
| 戻り値 | Integer, Text | &larr; | 現在値 |
