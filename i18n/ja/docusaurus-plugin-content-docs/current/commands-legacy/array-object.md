...
| size | Integer | &srarr; | 配列の要素の数、もしくはsize2が指定されていた場合は配列の数 |
| size2 | Integer | &srarr; | 2次元配列の要素の数 |

<!-- END REF-->

#### 説明 

<!--REF #_command_.ARRAY OBJECT.Summary-->**ARRAY OBJECT**コマンドは、メモリ上にランゲージオブジェクト型の要素の配列を作成・リサイズします。<!-- END REF-->
