...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| fontFamily | Text | &srarr; | フォントファミリー名 |
| fontStyleList | Text array | &harr; | フォントファミリーによってサポートされるフォントスタイルの一覧 |
| fontNameList | Text array | &harr; | フォントファミリーによってサポートされるフォント名の完全な一覧 |
