...
| 引数 | 型 |  | 説明 |
| --- | --- | --- | --- |
| fontFamily | Text | &rarr; | フォントファミリー名 |
| fontStyleList | Text array | &larr; | フォントファミリーによってサポートされるフォントスタイルの一覧 |
| fontNameList | Text array | &larr; | フォントファミリーによってサポートされるフォント名の完全な一覧 |
