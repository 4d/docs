...
プロジェクトファイルは [コンパイル](../Project/compiler.md) し、簡単に運用することができます。 プロジェクトをもとに、次の 3種のアプリケーションを作成することができます:
...
[`.4DLink` ファイル](#4dlinkファイルについて) を使用して、4D アプリケーションとターゲットの4D プロジェクトを起動することができます。 これをおこなうには 2つの方法があります:
