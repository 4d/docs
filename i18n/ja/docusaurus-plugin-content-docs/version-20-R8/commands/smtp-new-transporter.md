...
| **password** : Text<br/>サーバーとの認証のためのユーザーパスワード。 これは *[SMTP transporter](../API/SMTPTransporterClass.md#smtp-transporter-object)* オブジェクトでは返されません。                                                                                                                                                                                                                                                                               | なし                                                                                               |
