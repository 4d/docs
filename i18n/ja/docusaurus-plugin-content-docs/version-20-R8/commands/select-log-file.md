...
*logFile* 引数には、作成したいログファイルの名前または完全パス名を渡します。 If you only pass a name, the file will be created in the "Logs" folder of the database located next to the database structure file.
