...
*sheetOptions* には、設定するオプションの定義を格納したオブジェクトを渡します。 利用可能なオプション一覧については、[シートオプション](../configuring.md#シートオプション) を参照ください。 利用可能なオプション一覧については、[シートオプション](../configuring.md#シートオプション) を参照ください。
