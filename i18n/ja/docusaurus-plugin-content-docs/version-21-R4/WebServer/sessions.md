...
セッショントークンは[リモートユーザーセッション](../Desktop/sessions.md) から作成しWeb セッションと共有することが可能で、これによりWeb ベースのインターフェースを使用したデスクトップアプリケーションを実装することが可能です。 セッショントークンは[リモートユーザーセッション](../Desktop/sessions.md) から作成しWeb セッションと共有することが可能で、これによりWeb ベースのインターフェースを使用したデスクトップアプリケーションを実装することが可能です。 [Webアクセスのためにリモートセッションを共有する](../Desktop/sessions.md#sharing-a-remote-session-for-web-accesses) を参照して下さい。
