...
指定されたフォルダーが定義された場所にない場合、または*certificatesFolder* に渡したパス名が有効でない場合、エラーが生成されます。このエラーは [ON ERR CALL](../commands/on-err-call) によって実装されたエラーハンドリングメソッドによって割り込むことができます。
