...
| HTTP Client log file              | 倍長整数 | 24 | [HTTP SET OPTION](../commands/http-set-option)(HTTP client log;value) コマンドによって作成されたログファイル。Logs フォルダに保存されています。                                                                                                                                                                                                                                          |
...
| IMAP Log file                     | 倍長整数 | 23 | [SET DATABASE PARAMETER](../commands/set-database-parameter)(IMAP Log) コマンドによって作成されたログファイル。データベースのLogs フォルダに保存されています。                                                                                                                                                                                                                                  |
...
| POP3 Log file                     | 倍長整数 | 21 | [SET DATABASE PARAMETER](../commands/set-database-parameter)(POP3 Log) コマンドで作成されたログファイル。データベースのLogs フォルダに保存されています。                                                                                                                                                                                                                                     |
