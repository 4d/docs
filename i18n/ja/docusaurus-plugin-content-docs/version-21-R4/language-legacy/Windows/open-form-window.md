...
| プロパティ                                | Modal form dialog box | Movable form dialog box | Movable form dialog box no title |
| ------------------------------------ | --------------------- | ----------------------- | -------------------------------- |
| Can have a title                     | ×                     | ◯                       | ×                                |
| Can have a close box or equivalent   | ×                     | ◯                       | ◯                                |
| Can be resized                       | ×                     | ◯                       | ◯                                |
| Can be minimized/maximized or zoomed | ×                     | ◯                       | ◯                                |
| Suitable for scroll bars             | ×                     | ×                       | ×                                |
| Modal                                | ◯                     | Yes, but can be moved   | Yes, but can be moved            |
...
| プロパティ                                | Plain form window | Plain form window no title |
| ------------------------------------ | ----------------- | -------------------------- |
| Can have a title                     | ◯                 | ×                          |
| Can have a close box or equivalent   | ◯                 | ◯                          |
| Can be resized                       | ◯                 | ◯                          |
