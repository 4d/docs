...
| `form-theme`           | <ul><li>**fluent-ui**</li><li>**win-classic**</li><li>**liquid-glass**</li><li>**mac-classic**</li></ul> | 使用するプラットフォームテーマ。 使用するプラットフォームテーマ。 **fluent-ui** テーマについての詳細な情報については、[こちらの章](./forms.md#fluent-ui-レンダリング) を参照してください。 |
