...
## 4Dランゲージは従来のコンピューター言語ですか

従来のコンピューター言語に馴れ親しんでいる方は、本節を参照してください。それ以外の方は、この章を読みとばしても構いません。

4Dランゲージは従来のコンピューター言語とは異なります。 4Dランゲージは、今日のコンピューターで使用できる最も先進的で柔軟性のある言語の1つです。 4D ランゲージは、人が作業をおこなうように処理するよう設計されています。
