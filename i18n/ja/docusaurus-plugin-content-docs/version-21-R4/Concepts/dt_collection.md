...
| -------------------------------------------- | ---------------------------------------- | ---------------------------------------- | ---------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------- |
| [`ARRAY TEXT`](../commands/array-text)       | ""                                       | "false" あるいは "true"                      | "Infinity" | 小数点付き(必要であれば)の数値                 | Text                                                                                                                                      | SET DATABASE PARAMETERコマンドの[Dates inside objects](../commands/set-database-parameter#dates-inside-objects-85) 引数に従ったオブジェクトの日付からテキストへの変換 | "[object Object]" | "[object Object]" | "," (カンマ)で区切られたコレクション要素 | "[object Object]" |
...
| コレクション要素型 | string                                 | number                                       | number                                 | number                                       | boolean                                      | オブジェクトあるいはnull                             | picture                                      | SET DATABASE PARAMETERコマンドの[Dates inside objects](../commands/set-database-parameter#dates-inside-objects-85) 引数に従った文字列または日付 | 秒数                                     | 4D.Blob                |   |