...
| プロパティ           | 型       | 説明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [type](#type)   | text    | 作成するキーのタイプを定義します: <li>"RSA": [.size](#size) をサイズとして使用して、RSA 鍵ペアを生成します。</li><li>"ECDSA": [.curve](#curve) を使用した楕円曲線デジタル署名アルゴリズム (Elliptic Curve Digital Signature Algorithm) 鍵ペア。 ECDSA キーは暗号化には使用できず、署名にのみ使用可能という点に注意してください。</li><li>"PEM": [.pem](#pem) を使用してPEM フォーマットの鍵ペア定義をロードします。</li><li>"ECDSA": [.curve](#curve) を使用した楕円曲線デジタル署名アルゴリズム (Elliptic Curve Digital Signature Algorithm) 鍵ペア。 ECDSA キーは暗号化には使用できず、署名にのみ使用可能という点に注意してください。</li><li>"PEM": [.pem](#pem) を使用してPEM フォーマットの鍵ペア定義をロードします。</li> |
