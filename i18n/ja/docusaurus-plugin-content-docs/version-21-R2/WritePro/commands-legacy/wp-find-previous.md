...
<!--REF #_command_.WP Find previous.Syntax-->**WP Find previous** ( *targetObj* : Object ; *searchBefore* : Object ; *searchValue* : Text ; *searchCondition* : Integer {; *replaceValue* : Text} ) -> 戻り値<!-- END REF-->
