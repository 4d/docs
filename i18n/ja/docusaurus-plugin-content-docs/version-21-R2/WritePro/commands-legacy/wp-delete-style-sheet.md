...
* 削除するスタイルシートオブジェクト([WP New style sheet](../WritePro/commands/wp-new-style-sheet) コマンドで作成、または[WP Get style sheet](../WritePro/commands/wp-get-style-sheet) 返されるオブジェクト)を*styleSheetType* 引数で指定
