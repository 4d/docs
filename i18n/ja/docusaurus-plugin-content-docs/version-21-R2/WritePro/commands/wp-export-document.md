...
| wk pdf               | 5 | .pdf 拡張子。 4D Write Pro ドキュメントはページビューモードに基づいてPDF フォーマットで保存されています。 The following metadata is exported in a PDF document: Title / Author / Subject / Content creator<br/> **Notes**: <ul><li>Expressions are automatically frozen when document is exported</li><li> Links to methods are NOT exported</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
