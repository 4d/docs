...
- The 4D internal build numbering has been modified as of 4D v19 R7:
    ...
    - releases from 4D v19 R7 will be numbered 100xxx. Note that a specific 4D version is still uniquely identified by a branch name and a build number. ビルド番号は時系列に増加します。
