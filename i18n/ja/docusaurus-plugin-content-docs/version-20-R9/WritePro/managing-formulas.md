...
| [This](../commands/this.md).pageNumber (\*) | Number | 定義されているページ番号:<li>- ドキュメントの開始からのページ番号(デフォルト) あるいは </li><li>- セクションの開始ページから定義されている場合にはセクションの開始ページからのページ番号。</li> このフォーミュラは常にダイナミックであり、[**WP FREEZE FORMULAS**](commands-legacy/wp-freeze-formulas.md) コマンドの影響をうけません。 |
| [This](../commands/this.md).pageCount (\*)  | Number | ページカウント: 合計のページ数。<br/> このフォーミュラは常にダイナミックであり、[**WP FREEZE FORMULAS**](commands-legacy/wp-freeze-formulas.md) コマンドの影響をうけません。                                                                                                           |
