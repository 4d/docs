...
| 水平移動     | Picture + Number       | ピクチャー | 指定ピクセル分、ピクチャーを横に移動します。                                                                                             |
| 垂直移動     | Picture / Number       | ピクチャー | 指定ピクセル分、ピクチャーを縦に移動します。                                                                                             |
| リサイズ     | Picture * Number       | ピクチャー | 割合によってピクチャーをサイズ変更します。                                                                                              |
| 水平スケール   | Picture *+ Number      | ピクチャー | 割合によってピクチャー幅をサイズ変更します。                                                                                             |
| 垂直スケール   | Picture *&#124; Number | ピクチャー | 割合によってピクチャー高さをサイズ変更します。                                                                                            |
| キーワードを含む | Picture % String       | ブール   | 文字列が、ピクチャー式に格納されたピクチャーに関連付けられている場合に true を返します。 `GET PICTURE KEYWORDS` を参照ください                                     |
