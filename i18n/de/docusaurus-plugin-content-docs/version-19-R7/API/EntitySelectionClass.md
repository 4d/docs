...
| Ergebnis        | 4D.EntitySelection | -> | Entity selection including the added *entity* or *entitySelection*|<!-- END REF -->
...
| keepOrder       | Ganzzahl           | -> | `dk keep ordered` (integer) to keep the initial order in the resulting entity selection             |
