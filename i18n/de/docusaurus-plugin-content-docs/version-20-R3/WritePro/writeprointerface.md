...
| Attribute            | Typ        | Mandatory | Beschreibung                                                                                                                                             |
|:-------------------- |:---------- |:--------- |:-------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Attribute | Typ        | Mandatory | Beschreibung                                                                          |
|:--------- |:---------- |:--------- |:------------------------------------------------------------------------------------- |
| Tabellen  | Collection |           | Collection of translated table objects                                                |
...
| Attribute | Typ    | Mandatory | Beschreibung                                                                                                                          |
|:--------- |:------ |:--------- |:------------------------------------------------------------------------------------------------------------------------------------- |
| default   | Objekt |           | Object containing the default style applicable to all rows.                                                                           |
| tabelle   | Objekt |           | Object containing the style definition applicable to the table.                                                                       |
| rows      | Objekt |           | Object containing the style definition applicable to all rows.                                                                        |
| cells     | Objekt |           | Object containing the style definition applicable to all cells.                                                                       |
| header1   | Objekt |           | Object containing the style definition applicable to the first header row.                                                            |
| header2   | Objekt |           | Object containing the style definition applicable to the second header row.                                                           |
| header3   | Objekt |           | Object containing the style definition applicable to the third header row.                                                            |
| header4   | Objekt |           | Object containing the style definition applicable to the fourth header row.                                                           |
| header5   | Objekt |           | Object containing the style definition applicable to the fifth header row.                                                            |
| headers   | Objekt |           | Object containing the style definition applicable to the header rows, if a specific header (like header1, header2...) is not defined. |
| data      | Objekt |           | Object containing the style definition applicable to the repeated data row.                                                           |
| break1    | Objekt |           | Object containing the style definition applicable to the first break row.                                                             |
| break2    | Objekt |           | Object containing the style definition applicable to the second break row.                                                            |
| break3    | Objekt |           | Object containing the style definition applicable to the third break row.                                                             |
| break4    | Objekt |           | Object containing the style definition applicable to the fourth break row.                                                            |
| break5    | Objekt |           | Object containing the style definition applicable to the fifth break row.                                                             |
| breaks    | Objekt |           | Object containing the style definition applicable to the break rows, if a specific break (like break1, break2...) is not defined.     |
| bcor      | Objekt |           | Object containing the style definition applicable to the bottom carry-over row.                                                       |
