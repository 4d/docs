...
| Ergebnis  | cs.DataStore | <- | Reference to the datastore|<!-- END REF -->
...
| Ergebnis       | cs.DataStore | <- | Datastore object|<!-- END REF -->
...
| Parameter | Typ    |    | Beschreibung                                                                                           |
| --------- | ------ |:--:| ------------------------------------------------------------------------------------------------------ |
| Ergebnis  | Objekt | <- | Information about the encryption of the current datastore and of each table|<!-- END REF -->
...
| Parameter | Typ  |    | Beschreibung                                                              |
| --------- | ---- | -- | ------------------------------------------------------------------------- |
| Ergebnis  | Zahl | <- | Current value of the global modification stamp|<!-- END REF -->
...
| Parameter | Typ    |    | Beschreibung                                    |
| --------- | ------ |:--:| ----------------------------------------------- |
| Ergebnis  | Objekt | <- | Datastore properties|<!-- END REF -->

|

#### Beschreibung

The `.getInfo()` function <!-- REF #DataStoreClass.getInfo().Summary -->The `.getInfo()` function<!-- END REF -->. This function is useful for setting up generic code.

**Returned object**

| Property   | Typ     | Beschreibung                                                                                                                                         |
| ---------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| typ        | string  | <li>"4D": main datastore, available through ds </li><li>"4D Server": remote datastore, open with Open datastore</li>                                                                                                 |
...
| Ergebnis    | Objekt | <- | Description of the optimization context|<!-- END REF -->
...
| Parameter | Typ        |    | Beschreibung                                                                            |
| --------- | ---------- |:--:| --------------------------------------------------------------------------------------- |
| Ergebnis  | Collection | <- | Collection of objects, where each object describes a request|<!-- END REF -->
...
| Parameter | Typ     |    | Beschreibung                                                                                              |
| --------- | ------- |:--:| --------------------------------------------------------------------------------------------------------- |
| Ergebnis  | Boolean | <- | True if the Data Explorer access is disabled, False if it is enabled (default)|<!-- END REF -->
...
| Parameter | Typ     |    | Beschreibung                              |
| --------- | ------- | -- | ----------------------------------------- |
| Ergebnis  | Boolean | <- | True if locked|<!-- END REF -->
...
| Ergebnis      | Objekt | <- | Result of the encryption key matching|<!-- END REF -->
...
| pageLength      | Ganzzahl     | -> | Page length of the entity selection linked to the context (default is 80)|<!-- END REF -->
