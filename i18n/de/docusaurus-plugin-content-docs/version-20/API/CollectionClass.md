...
| Parameter | Typ      |    | Beschreibung                                         |
| --------- | -------- |:--:| ---------------------------------------------------- |
| index     | Ganzzahl | -> | Index of element to return                           |
| Ergebnis  | any      | <- | The element at that index|<!-- END REF -->
...
| options      | Ganzzahl   | -> | `ck diacritical`, `ck count values`                                 |
...
| Parameter | Typ        |    | Beschreibung                                                          |
| --------- | ---------- |:--:| --------------------------------------------------------------------- |
| depth     | Ganzzahl   | -> | How deep a nested collection structure should be flattened. Default=1 |
| Ergebnis  | Collection | <- | Flattened collection|<!-- END REF -->
...
| methodName | Text        | -> | Name of a method                                                                          |
| param      | any         | -> | Parameter(s) to pass to *formula* or *methodName*                                         |
| Ergebnis   | Collection  | <- | Collection of transformed values and flattened by a depth of 1|<!-- END REF -->
...
| startFrom | Ganzzahl   | -> | Index to start the search at                                             |
| Ergebnis  | Boolean    | <- | True if *toSearch* is found in the collection|<!-- END REF -->
