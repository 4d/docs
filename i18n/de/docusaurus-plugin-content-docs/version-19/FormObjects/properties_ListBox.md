...
4D creates a default set named *ListBoxSetN* where *N* starts at 0 and is incremented according to the number of list boxes in the form. If necessary, you can modify the default set. It can be a local, process or interprocess set (we recommend using a local set, for example *$LBSet*, in order to limit network traffic). It is then maintained automatically by 4D. It is then maintained automatically by 4D. It is then maintained automatically by 4D. If the user selects one or more rows in the list box, the set is updated immediately. It is then maintained automatically by 4D. If the user selects one or more rows in the list box, the set is updated immediately. If you want to select one or more rows by programming, you can apply the commands of the “Sets” theme to this set.
...
| Name              | Datentyp | Possible Values |
| ----------------- | -------- | --------------- |
| lockedColumnCount | ganzzahl | minimum: 0      |
...
| Name              | Datentyp | Possible Values |
| ----------------- | -------- | --------------- |
| staticColumnCount | ganzzahl | minimum: 0      |
