...
| firstPageNumber | Lange Ganzzahl | The page number to print on the first page.Default value = 1                                                                                                                                        |
...
| fitPagesTall   | Lange Ganzzahl | The number of vertical pages (portrait orientation) to check when optimizing printing. Default value = -1    |
| fitPagesWide   | Lange Ganzzahl | The number of horizontal pages (landscape orientation) to check when optimizing printing. Default value = -1 |
