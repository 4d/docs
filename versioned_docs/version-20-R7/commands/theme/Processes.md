...
|[**Session storage** ( *id* ) : Object](../../commands-legacy/session-storage)<br/>The **Session storage** command returns the storage object of the session whose unique identifier you passed in the *id* parameter.|
