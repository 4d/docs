...
| **Method information** | ![method-information-icon](../assets/en/code-editor/method-information.png) | Displays the [Method Properties](../Project/code-overview.md#project-method-properties) dialog box (project methods only). |
