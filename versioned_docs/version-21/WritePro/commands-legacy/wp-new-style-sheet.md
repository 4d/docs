...
You can specify the attributes of the style sheet using the [WP SET ATTRIBUTES](./commands/wp-set-attributes) command or the object notation (see [4D Write Pro Attributes](../4d-write-pro-attributes)). For the list of available attributes, see the *Style sheet attributes* section.
