...
* Formulas inserted in styled text areas or 4D Write Pro documents through the [ST INSERT EXPRESSION](./commands/st-insert-expression) command - disallowed methods are automatically rejected.
