...
| ---------------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Paper option                 | 1     | If you use only *value1*, it contains the name of the paper. If you use both parameters, *value1* contains the paper width and *value2* contains the paper height. The width and height are expressed in points. Use the [PRINT OPTION VALUES](print-option-values.md) command to get the name, height and width of all the paper formats offered by the printer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
Once set using this command, a print option is kept throughout the duration of the session for the entire 4D application. It will be used by the [PRINT SELECTION](print-selection.md), [PRINT RECORD](print-record.md), [Print form](./commands/print-form), [QR REPORT](qr-report.md) and [WP PRINT](../WritePro/commands-legacy/wp-print.md) commands, as well as for all 4D printing, including that in Design mode.
