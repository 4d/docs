...
|**.password** : Text<br/>User password for authentication on the server. Not returned in *[POP3 transporter](#pop3-transporter-object)* object.|none|
