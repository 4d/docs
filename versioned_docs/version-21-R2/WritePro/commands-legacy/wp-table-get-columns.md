...
<!--REF #_command_.WP Table get columns.Syntax-->**WP Table get columns** ( *targetObj* : Object ) : Object<br/>**WP Table get columns** ( *tableRef* : Object ; *startCol* : Integer {; *numCols* : Integer} ) : Object<!-- END REF-->
