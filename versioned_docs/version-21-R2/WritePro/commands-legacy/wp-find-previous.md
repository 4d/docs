...
<!--REF #_command_.WP Find previous.Syntax-->**WP Find previous** ( *targetObj* : Object ; *searchBefore* : Object ; *searchValue* : Text ; *searchCondition* : Integer {; *replaceValue* : Text} ) : Object<!-- END REF-->
