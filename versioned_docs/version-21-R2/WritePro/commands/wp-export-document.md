...
| fileObj | [4D.File](../../API/FileClass.md)  | &#8594; | File object to export |
...
| wk pdf               | 5     | .pdf extension. 4D Write Pro document is saved in PDF format, based on Page view mode. The following metadata is exported in a PDF document: Title / Author / Subject / Content creator<br/> **Notes**: <ul><li>Expressions are automatically frozen when document is exported</li><li> Links to methods are NOT exported</li></ul> |
