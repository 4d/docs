...
This option enables user access to [Qodly Studio](developer.4d.com/qodly/) for the current project. Note that global access must be allowed at the [application level](../Admin/webAdmin.md).
