...
<!--REF #_command_.HTTP Parse message.Summary-->The documentation for this command is available on [developer.<!-- END REF-->4d.com.](../API/HTTPRequestClass.md#http-parse-messege)
