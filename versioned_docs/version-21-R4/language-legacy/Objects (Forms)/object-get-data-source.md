...
You can define the data source for an object in Design mode using the Property List, or using the [OBJECT SET DATA SOURCE](../commands/object-set-data-source) command.
