...
**Note:** You can also modify the icon associated with an item using the [SET LIST ITEM PROPERTIES](../commands/set-list-item-properties) command. However, this command only accepts static picture references (resource references or pictures from the picture library).
