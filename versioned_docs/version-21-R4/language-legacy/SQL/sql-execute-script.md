...
<!--REF #_command_.SQL EXECUTE SCRIPT.Syntax-->**SQL EXECUTE SCRIPT** ( *scriptPath* : Text ; *errorAction* : Integer {; ...(*attribName* : Text ; *attribValue* : any)} )<!-- END REF-->
...
| attribValue | any | &#8594;  | Value of attribute |
</div>
<!-- END REF-->
