...
This command has the same functioning as the [VERIFY DATA FILE](../commands/verify-data-file) command, except that it only applies to the current data file of the open database. It therefore does not require parameters specifying the structure and data.

Refer to the [VERIFY DATA FILE](../commands/verify-data-file) command for a description of the parameters.
