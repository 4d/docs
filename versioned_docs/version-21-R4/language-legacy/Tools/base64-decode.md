...
<!--REF #_command_.BASE64 DECODE.Syntax-->**BASE64 DECODE** ( *toDecode* : Text, Blob {; *decoded* : Text, Blob}{; *} )<!-- END REF-->
<!--REF #_command_.BASE64 DECODE.Params-->
<div class="no-index">

| Parameter | Type |  | Description |
| --- | --- | --- | --- |
| toDecode | Text, Blob | &#8596;  |*in:* Encoded value to decode<br/>*out:* Decoded value (if decoded parameter omitted)|
...
<!--REF #_command_.BASE64 DECODE.Summary-->The **BASE64 DECODE** command decodes the text or blob value coded in Base64 or Base64URL format passed in the *toDecode* parameter.<!-- END REF--> For more information on Base64 and Base64URL formats, please refer to the [BASE64 ENCODE](../commands/base64-encode) command description. 
