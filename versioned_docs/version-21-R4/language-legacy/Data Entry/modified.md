...
**Note:** **Modified** always returns [True](../commands/true) after the execution of the [PUSH RECORD](../commands/push-record) and [POP RECORD](../commands/pop-record) commands.
