...
- If the pop-up menu is **separated**, the event is only generated when a click occurs on the portion of the button with the arrow. Note that the [standard action](/Desktop/standard-actions) assigned to the button (if any) is not executed in this case.
