...
The [4D error dialog box](../Debugging/basics.md) displays the code and the message to the user. Expand the **Details** area and click on the **Save...** or **Copy** button:
