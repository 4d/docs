...
|**.password** : Text  User password for authentication on the server. Not returned in *[SMTP transporter](./SMTPTransporterClass.md#smtp-transporter-object)* object.|none|
