...
This command can be called, if necessary, in the [On Web Connection](./on-web-connection-database-method.md) or any other 4D method resulting from a form submission.
