...
This command can be called using a Web database method (*On Web Authentication Database Method*, [On Web Connection](./on-web-connection-database-method.md)) or any Web method. 
