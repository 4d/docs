...
- You can also [attach the Qodly Studio debugger to a 4D Server application](developer.4d.com/qodly/4DQodlyPro/debugging#using-qodly-debugger-on-4d-server) if you need to debug Qodly pages in a deployed environment.
