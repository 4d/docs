...
**WARNING:** If you call the command [Keystroke](../commands/keystroke) after calling **FILTER KEYSTROKE**, the character you pass to this command is returned instead of the character actually entered.
