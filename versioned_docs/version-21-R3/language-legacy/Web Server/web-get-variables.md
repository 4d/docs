...
This command can be called, if necessary, in the [On Web Connection](../commands/on-web-connection-database-method) database method) or any other 4D method resulting from a form submission.
