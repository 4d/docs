...
<!--REF #_command_.LISTBOX GET PRINT INFORMATION.Syntax-->**LISTBOX GET PRINT INFORMATION** ( * ; *object* : Text ; *selector* : Integer ; *info* : Integer, Boolean )<br/>**LISTBOX GET PRINT INFORMATION** ( *object* : Variable ; *selector* : Integer ; *info* : Integer, Boolean )<!-- END REF-->
...
| info | Integer, Boolean | &#8592; | Current value |
</div>
<!-- END REF-->
...
This command must be called in the context of the printing of a list box via the [Print object](../commands/print-object) command. Outside of this context, it will not return significant values.
...
| lk printed rows            | Integer | 1     | Returns in *info* the number of rows actually printed during the last call to the [Print object](../commands/print-object) command. This number includes any break rows added in the case of a hierarchical list box. For example, *info* is 10 if the list box contains 20 rows and the odd-numbered rows were hidden.                                                                                                        |
