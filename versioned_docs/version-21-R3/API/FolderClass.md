...
The `4D.Folder.new()` function <!-- REF #4D.Folder.new().Summary -->creates and returns a new object of the `4D.Folder` type<!-- END REF -->. It is identical to the [`Folder`](../commands/folder) command (shortcut).

> It is recommended to use the [`Folder`](../commands/folder) shortcut command instead of `4D.Folder.new()`.
