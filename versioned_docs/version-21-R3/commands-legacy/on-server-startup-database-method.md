...
To automatically execute code on a client machine when a remote 4D connects to the server, use the [On Startup database method](../commands/on-startup-database-method).
