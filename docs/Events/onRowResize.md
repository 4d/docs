...
This event is generated when the height of a row is modified by a user in a 4D View Pro document. In this context, the object returned by the `FORM Event` command contains:
