...
|---|---|---|
|2|[Input](FormObjects/input_overview.md) of the `picture` [Type](properties_Object.md#type)|The user has just released the left mouse button in a Picture object|
...
> If the [Draggable](FormObjects/propertiesAction.md#draggable) option is enabled for the picture object, the `On Mouse Up` event is never generated. 
