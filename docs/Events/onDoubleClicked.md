...
The `On Double Clicked` event is not supported with [**steppes**r](FormObjects/stepper.md) on Windows with [Fluent UI](../FormEditor/forms.md#fluent-ui-rendering) theme enabled.  
