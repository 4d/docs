...
> The URL being loaded is different from the [current URL](FormObjects/propertiesWebArea.md#url-variable-and-wa-open-url-command) (refer to the description of the `WA Get current URL` command).