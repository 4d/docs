...
The *objects* parameter is used to designate which types of objects will be checked. Two types of objects can be checked: records and indexes. You can use the following constants, found in the “[Data File Maintenance](/4Dv20R6/4D/20-R6/Data-File-Maintenance.302-6958438.en.html)” theme:
...
The *options* parameter is used to set verification options. The following options are available, found in the “[Data File Maintenance](/4Dv20R6/4D/20-R6/Data-File-Maintenance.302-6958438.en.html)” theme:  
