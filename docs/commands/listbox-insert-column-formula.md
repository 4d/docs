...
This type of contents can only be used when the “Data Source” property of the list box is set to **Current Selection**, **Named Selection**, or **Collection or Entity Selection** (for more information about this, please refer to the [Managing List Box Objects](/4Dv20R6/4D/20-R6/Managing-List-Box-Objects.300-6958138.en.html) section).
...
The *dataType* parameter can be used to designate the type of data resulting from the execution of the formula. You must pass one of the following constants of the “[Field and Variable Types](/4Dv20R6/4D/20-R6/Field-and-Variable-Types.302-6958439.en.html)” theme in this parameter:
