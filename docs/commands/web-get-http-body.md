...
This command can be called using a Web database method ([On Web Authentication Database Method](/4Dv20R6/4D/14-R2/On-Web-Authentication-Database-Method.300-1342178.en.html), [QR SET DESTINATION](qr-set-destination.md)) or any Web method. 
