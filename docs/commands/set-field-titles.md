...
Using this command, you can also rename the labels of the fields in your forms on the fly, if you used dynamic names. For more information about inserting dynamic field and table names in forms, refer to [Using references in static text](/4Dv20R6/4D/20-R6/Using-references-in-static-text.300-7003269.en.html) in the *4D Design Reference* manual.
