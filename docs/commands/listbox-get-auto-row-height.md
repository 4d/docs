...
<!--REF #_command_.LISTBOX Get auto row height.Syntax-->**LISTBOX Get auto row height** ( {* ;} *object* ; *selector* {; *unit*} )  -> Function result<!-- END REF-->
...
In *selector*, pass the type of value to get. You can use one of the following constants from the [List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html) theme:
...
By default, the command returns the value in pixels. You can pass one of the following constants from the [List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html) theme in the *unit* parameter to define the unit to use:
