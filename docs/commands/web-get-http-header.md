...
This command can be called from within any method ([On Web Authentication Database Method](/4Dv20R6/4D/14-R2/On-Web-Authentication-Database-Method.300-1342178.en.html) or [QR SET DESTINATION](qr-set-destination.md), method called by "*/4DACTION*"...) executed in a Web process. 
