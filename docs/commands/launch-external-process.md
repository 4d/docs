...
<!--REF #_command_.LAUNCH EXTERNAL PROCESS.Summary-->Starting with 4D v19 R4, we recommend the use of the [**SystemWorker class**](https://developer.<!-- END REF-->4d.com/docs/API/SystemWorkerClass.html) to run and control external processes. However, this command is still supported. 
