...
| --- | --- | --- | --- |
| arrActivities | arrUUID | Object array, Text array | <-> | Complete description of operations (object array) or
Operation UUIDs (text array) |
| arrStart | Text array | <-> | Operation start times |
| arrDuration | Longint array | <-> | Operation durations in milliseconds |
