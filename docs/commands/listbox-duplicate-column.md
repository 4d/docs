...
By default, all style options (size, color, formats, etc.) set for the source column by means of the Property list or using object management commands ([\_o\_OBJECT SET COLOR](/4Dv20R6/4D/20-R6/o-OBJECT-SET-COLOR.301-6957641.en.html), etc.) are applied to the copy. The object method and the settings of the form events are also duplicated.   
