...
The optional *refMode* parameter indicates the way that references found in *object* must be returned. In *refMode*, pass one of the following constants, found in the "[Multistyle Text](/4Dv20R6/4D/20-R6/Multistyle-Text.302-6958494.en.html)" theme (you can pass a single constant or a combination):
