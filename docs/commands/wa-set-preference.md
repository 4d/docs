...
Pass the preference to be modified in the *selector* parameter and the value to be assigned to it in the *value* parameter. In *selector*, you can pass one of the following constants, found in the [Web Area](/4Dv20R6/4D/20-R6/Web-Area.302-6958475.en.html) theme:
