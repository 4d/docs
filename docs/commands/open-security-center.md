...
<!--REF #_command_.OPEN SECURITY CENTER.Summary-->The OPEN SECURITY CENTER command displays the Maintenance and Security Center (MSC) window.<!-- END REF--> For more information, please refer to the [Maintenance and security center](/4Dv20R6/4D/20-R6/Maintenance-and-security-center.200-7003214.en.html) page. 
