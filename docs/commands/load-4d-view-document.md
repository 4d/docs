...
**Note**: If you need to convert documents from 4D View to 4D View Pro, it is recommended to use the dedicated [](/4Dv20R6/index.en.html) command which performs a direct and transparent conversion. 
