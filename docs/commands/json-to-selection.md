...
If a record is locked by another process during the execution of the command, it is not modified. All the locked records are placed in the [The LockedSet System Set](/4Dv20R6/4D/20-R6/Sets.300-6959005.en.html#35561). After the execution of **JSON TO SELECTION**, you can test whether the *LockedSet* set contains any records that were locked.
