...
**Note:** This example uses the **selected element** of the array. Keep in mind that the selected element is not meaningful if the array contains more than 32,767 elements (see [Arrays and Form Objects](/4Dv20R6/4D/20-R6/Arrays-and-Form-Objects.300-6958351.en.html)). In this case, you need to use a longint variable to store the result of **Find in array**.
