...
In the *horizontal* parameter, you pass a value indicating the horizontal resizing option that you want to specify for the *object*. You can pass one of the following constants, found in the [Form Objects (Properties)](/4Dv20R6/4D/20-R6/Form-Objects-Properties.302-6958435.en.html) theme:
...
In the *vertical* parameter, you pass a value indicating the vertical resizing option that you want to specify for the *object*. You can pass one of the following constants, found in the [Form Objects (Properties)](/4Dv20R6/4D/20-R6/Form-Objects-Properties.302-6958435.en.html) theme:
