...
**index = Integer**  
In this case, the command creates an index of the type specified for *aField*. You can pass one of the following constants, found in the “[Index Type](/4Dv20R6/4D/20-R6/Index-Type.302-6958469.en.html)” theme:
