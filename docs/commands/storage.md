...
Since the catalog returned by **Storage** is a *shared object*, it follows the rules described in the [Shared objects and shared collections](/4Dv20R6/4D/20-R6/Shared-objects-and-shared-collections.300-6957624.en.html) section, but with some specificities:
...
* Adding a property to this object must be surrounded by the [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure, otherwise an error is returned. Reading an attribute outside of a [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure is, however, possible.
* When surrounded by the [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure, first-level attributes of **Storage** are locked for other processes.
