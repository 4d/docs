...
* The *\** parameter causes a print job using the current print parameters (default parameters or those defined by the [\_o\_PAGE SETUP](/4Dv20R6/4D/20-R6/o-PAGE-SETUP.301-6957638.en.html) and/or [SET PRINT OPTION](set-print-option.md) commands).
