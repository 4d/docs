...
**Note:** This command can only be used when the “Data Source” property of the list box is set to **Current Selection** or **Named Selection** (for more information about this, please refer to the [Managing List Box Objects](/4Dv20R6/4D/20-R6/Managing-List-Box-Objects.300-6958138.en.html) section). It does nothing if you use it with a listbox that is associated with an array, a collection or an entity selection.
