...
In all cases, 4D converts the collection elements or values according to the type of *array* (if necessary). Conversion rules are detailed in the [Type conversions between collections and 4D arrays](/4Dv20R6/4D/20-R6/Type-conversions-between-collections-and-4D-arrays.300-6958644.en.html) page.
