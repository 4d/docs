...
The **CALL WORKER** command encapsulates the *param* parameters into a message and posts it in the worker's message box. For more information on worker processes, please refer to the [About workers](/4Dv20R6/4D/20-R6/About-workers.300-6958856.en.html) section.
