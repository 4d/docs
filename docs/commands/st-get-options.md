...
Pass the code of the option to get in the *option* parameter. The command returns the current value of this option in *value*. For both these parameters, you can use the following constants, found in the "[Multistyle Text](/4Dv20R6/4D/20-R6/Multistyle-Text.302-6958494.en.html)" theme:
