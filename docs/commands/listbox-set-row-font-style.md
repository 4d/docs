...
In *style*, you pass a style value. You must use one (or a combination) of the constants found in the [Font Styles](/4Dv20R6/4D/20-R6/Font-Styles.302-6958451.en.html) theme: 
