...
<!--REF #_command_.Compile project.Summary-->**Compile project** allows you to compile the current host project or the project specified in the *projectFile* parameter.<!-- END REF--> For more information on compilation, see the [Compilation page on developer.4d.com](https://developer.4d.com/docs/Project/compiler.html).
...
The resulting compiled code will be stored in the DerivedData or Libraries folder of the project, depending on the *targets* property of the *options* parameter. If you want to create .4dz files, you still need to manually zip the compiled project or use the [build application](https://developer.4d.com/docs/Desktop/building.html) feature.
