...
**Note:** You can evaluate the value returned using the Shift key mask and Option key mask constants of the “[Events (Modifiers)](/4Dv20R6/4D/20-R6/Events-Modifiers.302-6958468.en.html)” theme.
