...
<!--REF #_command_.Null.Syntax-->**Null**  -> Function result<!-- END REF-->
...
| object variables ([C\_OBJECT](c-object.md))             | See (\*) below                                                                                                                                                                                                                                                     |
| collection variables ([C\_COLLECTION](c-collection.md)) | See (\*) below                                                                                                                                                                                                                                                     |
| pointer variables ([C\_POINTER](c-pointer.md))          | See (\*) below                                                                                                                                                                                                                                                     |
| picture variables ([C\_PICTURE](c-picture.md))          | (\*) Assigning the **null** value to such a variable type clears its contents. In this case, it has the same effect as calling the [CLEAR VARIABLE](clear-variable.md) command.                                                                                    |
| variant variables ([C\_VARIANT](c-variant.md))          |                                                                                                                                                                                                                                                                    |
