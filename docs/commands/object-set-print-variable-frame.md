...
* Text or Picture type variables and fields (see [Print Variable Frame](/4Dv20R6/4D/20-R6/Print-Variable-Frame.300-7003360.en.html) in the *Design Reference* manual)
* 4D Write Pro areas (see [Using a 4D Write Pro area](/4Dv20R6/4D/20-R6/Using-a-4D-Write-Pro-area.200-6993929.en.html) in the 4D Write Pro reference manual).
