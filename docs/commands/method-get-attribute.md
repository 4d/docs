...
In the *attribType* parameter, pass a value indicating the type of attribute to get. You can use the following constants, found in the [Design Object Access](/4Dv20R6/4D/20-R6/Design-Object-Access.302-6958460.en.html) theme:
