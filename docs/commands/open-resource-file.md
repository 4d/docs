...
* On Windows, if you use the Open File dialog box, all files are presented by default. To show a particular type of file, in *fileType*, pass a 1- to 3-character Windows file extension or a Macintosh file type mapped using the [\_o\_MAP FILE TYPES](/4Dv20R6/4D/20-R6/o-MAP-FILE-TYPES.301-6957647.en.html) command.
...
The following example displays the Open file dialog box showing files created by the [](/4Dv20R6/index.en.html) command, using the default file type:
