...
To process an event, you must test the value of the $1 parameter within the method and compare it to one of the following constants, found in the [Database Events](/4Dv20R6/4D/20-R6/Database-Events.302-6958461.en.html) theme:
