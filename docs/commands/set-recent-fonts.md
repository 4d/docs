...
This menu contains the names of the last fonts selected during the session. It is used in particular by [Programming Notes](/4Dv20R6/4D/20-R6/Programming-Notes.300-6958941.en.html) areas. 
