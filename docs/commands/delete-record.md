...
Deleting records is a permanent operation and cannot be undone (except when it is executed during a transaction, see [Using Transactions](/4Dv20R6/4D/20-R6/Using-Transactions.300-6958365.en.html)).
