...
In *selector*, pass the type of value to set. You can use one of the following constants from the [List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html) theme:
...
The *unit* parameter can be set using one of the following constants from the [List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html) theme:
