...
* it is executed by a user other than the Designer or the Administrator (in this case, the error -9991 is generated, see the [Database Engine Errors (-10602 -> 4004)](/4Dv20R6/4D/20-R6/Database-Engine-Errors-10602-4004.300-6958288.en.html) section).
