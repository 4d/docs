...
In this case, the command will print the section designated by the *marker*. Pass one of the constants of the [Form Area](/4Dv20R6/4D/20-R6/Form-Area.302-6958524.en.html) theme in the marker parameter:
