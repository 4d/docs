...
These constants are found in the "[Multistyle Text](/4Dv20R6/4D/20-R6/Multistyle-Text.302-6958494.en.html)" theme: 
...
**Note:** **ST FREEZE EXPRESSIONS** does not freeze 4D Write Pro expressions containing *$wp\_pageNumber* or *$wp\_pageCount*. For more information, please refer to the [Managing formulas](/4Dv20R6/4D/20-R6/Managing-formulas.300-6993925.en.html) section. 
