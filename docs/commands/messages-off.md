...
**Note for 4D Server:** Progress message windows are not shown on the server since these operations are automatically listed on the [\_o\_PAGE SETUP](/4Dv20R6/4D/20-R6/o-PAGE-SETUP.301-6957638.en.html) of the administration window. If you want to force these progress windows to be displayed, you must call the [MESSAGES ON](messages-on.md) command on the server. 
