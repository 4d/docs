...
The fourth pointer corresponds either to a Boolean array (Hidden Rows Array), or to a longint array (array used to set hidden, disabled and non-selectable rows) based on the implementation used for the row control array (see [List box specific properties](/4Dv20R6/4D/20-R6/List-box-specific-properties.300-7003332.en.html)).  
