...
A build application settings file is an XML file that contains all the parameters used to generate an application. Most parameters can be seen in the Build Application dialog box (for more information, refer to the [Application builder](/4Dv20R6/4D/20-R6/Application-builder.300-7003417.en.html) section of the 4D Design Reference manual).
