...
In *complexType*, you must pass one of the following constants, located in the theme [Web Services (Client)](/4Dv20R6/4D/20-R6/Web-Services-Client.302-6958518.en.html):
