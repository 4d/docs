...
| $2            | Longint  | Number of the command selected. To compare with the following constants of the [QR Commands](/4Dv20R6/4D/20-R6/QR-Commands.302-6958472.en.html) theme (only listed events are supported): Constant Value Comment qr cmd generate 2008 Use of command [QR RUN](qr-run.md) recommended qr cmd open 2001 qr cmd page setup 2006 qr cmd print preview 2007 qr cmd save 2002 qr cmd save as 2003 |
