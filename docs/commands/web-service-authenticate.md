...
**Note:** For more information about the BASIC and DIGEST authentication methods, refer to the [Connection Security](/4Dv20R6/4D/14-R2/Connection-Security.300-1342179.en.html) section. 
