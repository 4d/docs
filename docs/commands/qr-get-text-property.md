...
* one of the constants of the [QR Rows for Properties](/4Dv20R6/4D/20-R6/QR-Rows-for-Properties.302-6958428.en.html) theme:  
...
*property* is the value of the text attribute to get. You can use the constants of the [QR Text Properties](/4Dv20R6/4D/20-R6/QR-Text-Properties.302-6958492.en.html) theme, and the following values can be returned:
