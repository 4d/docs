...
* **automatic location**  
You can designate two automatic locations using the following constants, found in the [Data File Maintenance](/4Dv20R6/4D/20-R6/Data-File-Maintenance.302-6958438.en.html) theme:  
