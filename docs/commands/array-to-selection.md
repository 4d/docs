...
**Note:** Since it can create new records, this command does not take a table's read-only state (if any) into account (see [Record Locking](/4Dv20R6/4D/20-R6/Record-Locking.300-6958117.en.html)). 
