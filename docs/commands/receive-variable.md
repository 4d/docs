...
2. This command does not support array variables. If you want to send and receive arrays from a document or over a serial port, use the [BLOB Commands](/4Dv20R6/4D/14-R2/BLOB-Commands.300-1342098.en.html).
