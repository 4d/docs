...
You can compare the values returned in the *one* and *many* parameters with the constants of the “[Relations](/4Dv20R6/4D/20-R6/Relations.302-6958476.en.html)” theme: 
