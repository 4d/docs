...
* in SDI mode on Windows, if it is called from a process without a form window. For more information on this mode, please refer to the [SDI mode on Windows](/4Dv20R6/4D/16-R4/SDI-mode-on-Windows.300-3331617.en.html) section.
