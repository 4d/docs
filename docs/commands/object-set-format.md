...
* either a **predefined format** available though constants of the [Date Display Formats](/4Dv20R6/4D/20-R6/Date-Display-Formats.302-6958450.en.html) or [Time Display Formats](/4Dv20R6/4D/20-R6/Time-Display-Formats.302-6958440.en.html) theme (longint value). In this case, you must pass [Char](char.md)(n) in *displayFormat*, where *n* is the constant:  
