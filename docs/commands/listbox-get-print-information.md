...
Pass a value indicating the information you want to find out in *selector* and a variable of the number or BLOB type in *info*. In *selector*, you can pass one of the following constants, found in the "[List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html)" theme:
