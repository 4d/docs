...
If you pass the *modifiers* parameter, you pass one or a combination of the [Events (Modifiers)](/4Dv20R6/4D/20-R6/Events-Modifiers.302-6958468.en.html) constants:
