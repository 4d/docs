...
| object | Form object | -> | Object name or "" to designate the form (if * is specified) or
...
You use the *mode* parameter to set the overall processing to be carried out for the array elements. To do this, you can pass one of the following constants, found in the "[Form Objects (Properties)](/4Dv20R6/4D/20-R6/Form-Objects-Properties.302-6958435.en.html)" theme:
