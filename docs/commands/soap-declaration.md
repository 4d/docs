...
**Note:** Even when the this command is used, it is still necessary to declare 4D variables and arrays in the Compiler\_Web method using commands of the “[Compiler](compiler.md)” theme.
...
In *type*, pass the corresponding 4D type. Most types of 4D variables and arrays can be used. You can use the following predefined constants, located in the “[Field and Variable Types](/4Dv20R6/4D/20-R6/Field-and-Variable-Types.302-6958439.en.html)” theme, as well as, for XML types, two constants of the [Web Services (Server)](/4Dv20R6/4D/20-R6/Web-Services-Server.302-6958508.en.html) theme:
...
In *input\_output*, pass a value indicating whether the processed parameter is “incoming” (i.e. corresponding to a value received by the method) or “outgoing” (i.e. corresponding to a value returned by the method). You can use the following predefined constants, located in the [Web Services (Server)](/4Dv20R6/4D/20-R6/Web-Services-Server.302-6958508.en.html) theme:
...
Note that the COMPILER\_WEB method is also called by the 4D Web server when receiving “conventional” Web requests of the POST type (see [URLs and Form Actions](/4Dv20R6/4D/14-R2/URLs-and-Form-Actions.300-1342176.en.html) section). 
