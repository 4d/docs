...
<!--REF #_command_.New shared object.Summary-->The **New shared object** command creates a new empty or prefilled shared object and returns its reference.<!-- END REF--> Adding or editing a property to this object must be surrounded by the [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure, otherwise an error is generated. Reading a property without a [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure is, however, possible. 

**Note:** For more information on *shared objects*, please refer to the [Shared objects and shared collections](/4Dv20R6/4D/20-R6/Shared-objects-and-shared-collections.300-6957624.en.html) page.
