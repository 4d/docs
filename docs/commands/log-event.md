...
The optional *outputType* parameter specifies the output channel taken by the *message*. You can pass one of the following constants, located in the "[Log Events](/4Dv20R6/4D/20-R6/Log-Events.302-6958459.en.html)" theme, in this parameter:
...
4D provides you with the following predefined constants, placed in the “[Log Events](/4Dv20R6/4D/20-R6/Log-Events.302-6958459.en.html)” category:
