...
* or a constant (or its value) from the [Shortcut and Associated Keys](/4Dv20R6/4D/20-R6/Shortcut-and-Associated-Keys.302-6958463.en.html) theme:  
...
In the *modifiers* parameter, you can pass one or more modifier keys to associate with the shortcut. To set the *modifiers* parameter, pass one or more of the following "Mask" type constants found in the [Events (Modifiers)](/4Dv20R6/4D/20-R6/Events-Modifiers.302-6958468.en.html) theme:
