...
(\*) 4D returns IPv4 addresses in a hybrid IPv6/IPv4 format written with a 96-bit prefix, for example ::ffff:192.168.2.34 for the IPv4 address 192.168.2.34\. For more information, refer to the [Support of IPv6](/4Dv20R6/4D/14-R2/Support-of-IPv6.300-1342172.en.html) section. 
