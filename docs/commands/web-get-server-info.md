...
| cache                       | Object         | *This property is included only if the* withCache *parameter is True*. Describes the contents of the web server cache (see [cache property](/4Dv20R6/4D/20-R6/WEB-Get-server-info.301-6957744.en.html#3514248) below)                                                                    |
...
| *webInactiveProcessTimeout* | Number         | **Not significant in scalable web sessions mode, see [Web Sessions Management (Legacy)](/4Dv20R6/4D/20-R6/Web-Sessions-Management-Legacy.300-6957735.en.html)**. Life duration of the inactive session processes (corresponds to the Web inactive process timeout web option)            |
| *webInactiveSessionTimeout* | Number         | **Not** **significant** **in** **scalable** **web sessions mode, see [Web Sessions Management (Legacy)](/4Dv20R6/4D/20-R6/Web-Sessions-Management-Legacy.300-6957735.en.html)**. Life duration of the inactive sessions (corresponds to the Web inactive session timeout web option)     |
...
| *webMaxConcurrentProcesses* | Number         | **Not** **significant** **in** **scalable** **web sessions mode, see [Web Sessions Management (Legacy)](/4Dv20R6/4D/20-R6/Web-Sessions-Management-Legacy.300-6957735.en.html)**. Maximum number of concurrent web processes (corresponds to the Web max concurrent processes web option) |
