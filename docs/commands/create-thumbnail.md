...
The optional parameter *mode* defines the thumbnail creation mode, i.e. the resizing mode. Three modes are available. The following predefined constants are provided by 4D in the “[Picture Display Formats](/4Dv20R6/4D/20-R6/Picture-Display-Formats.302-6958441.en.html)” constant theme:
