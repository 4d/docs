...
* The optional *options* parameter is used to set various compacting options. To do so, use the following constants, found in the “[Data File Maintenance](/4Dv20R6/4D/20-R6/Data-File-Maintenance.302-6958438.en.html)” theme. You can pass several options by combining them:  
