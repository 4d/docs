...
The [Object](# "Data structured as a native 4D object") type is supported by the 4D language starting with v14\. Objects of this type are managed by the commands of the [Objects (Language)](objects-language.md) theme or through object notation (see [Using object notation](/4Dv20R6/4D/20-R6/Using-object-notation.300-6957621.en.html)). 
