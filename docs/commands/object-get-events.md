...
Pass a longint array in the *arrEvents* parameter. When the command is executed, this array is automatically sized and receives all the predefined or custom form events that are enabled for the object or the form. You can compare the values received with the constants of the "[Form Events](/4Dv20R6/4D/20-R6/Form-Events.302-6958427.en.html)" theme.
