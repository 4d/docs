...
The format is specified in the same way as it would be for a number field on a form. See the section [Display formats](/4Dv20R6/4D/20-R6/Display-formats.300-7003356.en.html) in the 4D Design Reference manual for more information about formatting numbers. You can also pass the name of a custom style in *format*. The custom style name must be preceded by the *“|”* character.
...
* either a predefined format available though the following constants of the [Date Display Formats](/4Dv20R6/4D/20-R6/Date-Display-Formats.302-6958450.en.html) theme (longint value):  
...
* either a predefined format available though the following constants of the [Time Display Formats](/4Dv20R6/4D/20-R6/Time-Display-Formats.302-6958440.en.html) theme (longint value):  
| Constant                     | Value | Comment                                                                                                                                                                                                                               |  
| ---------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |  
