...
Pass a value indicating the list to recover in *direction*. You can use one of the following constants, found in the [Web Area](/4Dv20R6/4D/20-R6/Web-Area.302-6958475.en.html) theme:
