...
If there is an [On Server Shutdown Database Method](/4Dv20R6/4D/20-R6/On-Server-Shutdown-Database-Method.301-7182876.en.html), it is executed after the delay set by the *time* parameter, or after all clients have disconnected, depending on your parameters.
