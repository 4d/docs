...
The optional *type* parameter allows you to specify a type for the window. You must pass one of the following predefined constants (placed in the [Open Form Window](/4Dv20R6/4D/20-R6/Open-Form-Window.302-6958497.en.html) theme):
...
Window types are detailed in the [Window Types](/4Dv20R6/4D/20-R6/Window-Types.300-6958184.en.html) section.
...
The optional parameter *hPos* allows you to define the horizontal position of the window. You can pass a defined position in pixels or one of the following predefined constants placed in the [Open Form Window](/4Dv20R6/4D/20-R6/Open-Form-Window.302-6958497.en.html) theme:
...
The optional parameter *vPos* allows you to define the vertical position of the window. You can pass a defined position in pixels or one of the following predefined constants placed in the [Open Form Window](/4Dv20R6/4D/20-R6/Open-Form-Window.302-6958497.en.html) theme:
...
[Window Types (compatibility)](../../4D/20-R6/Window-Types-compatibility.300-6958204.en.html)  