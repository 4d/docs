...
<!--REF #_command_.New shared collection.Summary-->The **New shared collection** command creates a new empty or prefilled shared collection and returns its reference.<!-- END REF--> Adding an element to this collection must be surrounded by the [Use...End use](/4Dv20R6/4D/16-R6/UseEnd-use.300-3638490.en.html) structure, otherwise an error is generated. Reading an element without a structure is, however, possible. 

**Note:** For more information on *shared collections*, please refer to the [Shared objects and shared collections](/4Dv20R6/4D/20-R6/Shared-objects-and-shared-collections.300-6957624.en.html) page.
