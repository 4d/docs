...
The "Multi-style" option lets you use rich test areas including individual style variations. For more information, refer to [Multi-style (Rich text area)](/4Dv20R6/4D/14-R2/Multi-style-Rich-text-area.300-1477147.en.html) in the *Design Reference* manual. 

Multi-style objects can be managed by programming using the commands of the "[Styled Text](styled-text.md)" theme. 
