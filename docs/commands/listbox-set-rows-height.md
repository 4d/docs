...
By default, if you omit the *unit* parameter, the height is expressed in pixels. To modify the unit, in the *unit* parameter you can pass one of the following constants, found in the [List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html) theme:
