...
The optional *authMethod* parameter indicates the authentication method to use. You pass one of the following constants, found in the [HTTP Client](/4Dv20R6/4D/20-R6/HTTP-Client.302-6958516.en.html) theme:
