...
**Compatibility note:** If QuickTime has been enabled in the database (see the [Pictures](/4Dv20R6/4D/20-R6/Pictures.300-6957798.en.html) section), 4-character QuickTime codes can also be returned (for example “PNTG”).
