...
In *styleSheetName*, you pass the name of the style sheet as defined in the Design mode. To designate an automatic style sheet, you can use one of the following constants, found in the "[Font Styles](/4Dv20R6/4D/20-R6/Font-Styles.302-6958451.en.html)" theme: 
...
In *styles*, the command returns a value corresponding to the style(s) associated with the style sheet for the current platform. You can compare the value received with the following constants, found in the "[Font Styles](/4Dv20R6/4D/20-R6/Font-Styles.302-6958451.en.html)" theme: 
