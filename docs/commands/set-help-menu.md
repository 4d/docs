...
| action        | Text                                                                                            | [Standard Action](/4Dv20R6/4D/20-R6/Standard-Action.302-6958501.en.html) to execute when the menu item is selected. When this property is used, the "method" property is ignored if passed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
