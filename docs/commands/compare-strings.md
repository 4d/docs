...
By default, **Compare strings** functions as if the "<" (less than) operator is used. (See [String operators](https://developer.4d.com/docs/Concepts/string.html#string-operators)). This can be modified with the *options* parameter. You can pass one or a combination of the following constants from the [Strings](/4Dv20R6/4D/20-R6/Strings.302-6958511.en.html) theme: 
