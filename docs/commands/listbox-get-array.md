...
In *arrType*, pass the type of array for the property you want to get. You can use one of the following constants, available in the "[List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html)" theme: 
