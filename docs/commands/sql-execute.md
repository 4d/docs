...
**Warning:** When you pass 4D fields in the *boundObj* parameter(s) and execute the [SELECT](/4Dv20R6/4D/20-R6/SELECT.300-7184000.en.html) command, it is always the data of the remote 4D source that is modified. If you want to retrieve data from the remote source locally, you must use intermediary local arrays and call the [INSERT](/4Dv20R6/4D/20-R6/INSERT.300-7183999.en.html) command (see example 6). 
...
**Note:** For more information about referencing 4D expressions in SQL queries, refer to the [Overview of SQL Commands](/4Dv20R6/4D/20-R6/Overview-of-SQL-Commands.300-6958586.en.html) section.
