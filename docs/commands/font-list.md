...
The *listType* parameter lets you designate the type of font list you want to get. To do so, you can pass one of the following constants in the *listType* parameter, available in the "[Font Type List](/4Dv20R6/4D/20-R6/Font-Type-List.302-6958465.en.html)" theme:
