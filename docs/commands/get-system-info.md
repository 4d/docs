...
| osLanguage        | string                          | Language set by the current user of the system. Expressed in the standard defined by the RFC 3066\. See [Language codes](/4Dv20R6/4D/20-R6/Appendix-B-XLIFF-architecture.300-7003281.en.html#521672) in the Design Reference manual for a complete list. | "fr", "en", "ja", "de", etc.                                                          |             |
