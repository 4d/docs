...
* Save (locally, on disk) Preferences or Settings to be reused at the beginning of the next session in the [On Server Startup Database Method](/4Dv20R6/4D/20-R6/On-Server-Startup-Database-Method.301-7182874.en.html).
