...
You use this function to start a stored procedure. For more information about stored procedures, see the section [Stored Procedures](/4Dv20R6/4D/20-R6/Stored-Procedures.300-7182871.en.html) in the 4D Server Reference manual.
