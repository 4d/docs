...
The command generates the same XML or HTML code as the **Export >** **Structure definition to XML file... or** **Export >** **Structure definition to HTML file...**menu item (see [Exporting and importing structure definitions](/4Dv20R6/4D/20-R6/Exporting-and-importing-structure-definitions.300-7003406.en.html)).
