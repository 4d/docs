...
*breakNum* is the number of the break whose data will be set (subtotal or grand total). For a Subtotal, *breaknum* is the sort number. For the Grand total, *breaknum* equals -3 or the constant qr grand total of the [QR Operators](/4Dv20R6/4D/20-R6/QR-Operators.302-6958520.en.html) theme.

*operator* is an addition of all the operators present in the cell. You can use the constants of the [QR Operators](/4Dv20R6/4D/20-R6/QR-Operators.302-6958520.en.html) theme to set the value:
...
*operator* is an addition of all the operators present in the cell. You can use the constants of the [QR Operators](/4Dv20R6/4D/20-R6/QR-Operators.302-6958520.en.html) theme to set the value (see above). 
