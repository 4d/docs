...
By default, the command returns values as strings. You can use the optional *type* parameter to specify typing for the value returned. To do this, pass one of the following constants, found in the "[Field and Variable Types](/4Dv20R6/4D/20-R6/Field-and-Variable-Types.302-6958439.en.html)" theme:
