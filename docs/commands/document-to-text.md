...
<!--REF #_command_.Document to text.Syntax-->**Document to text** ( *fileName* {; *charSet* {; *breakMode*}} ) -> Function result<!-- END REF-->
...
In *breakMode*, you can pass a longint indicating the processing to apply to end-of-line characters in the document. You can pass one of the following constants, found in the "[System Documents](/4Dv20R6/4D/20-R6/System-Documents.302-6958484.en.html)" theme:
