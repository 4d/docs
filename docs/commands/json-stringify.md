...
**Note:** 4D dates will be converted either in "yyyy-mm-dd" or "YYYY-MM-DDThh:mm:sssZ" format according to the current database date setting (see the "Use date type instead of ISO date format in objects" option in the [Compatibility page](/4Dv20R6/4D/20-R6/Compatibility-page.300-7003469.en.html)).
