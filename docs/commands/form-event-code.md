...
4D provides predefined constants (found in the [Form Events](/4Dv20R6/4D/20-R6/Form-Events.302-6958427.en.html) theme) in order to compare the values returned by the **Form event code** command.
...
| On VP Ready              | Longint | 9     | (*4D View Pro areas only*) The loading of the 4D View Pro area is complete                                                                                                                                                                                                                                                                                                                                                       |
| On Outside Call          | Longint | 10    | The form received a [POST OUTSIDE CALL](post-outside-call.md) call[ ](http://doc.tmp.4d.fr/APPELER-PROCESS/4Dv11.4/Command/8803/page8802.fr.html "APPELER PROCESS")                                                                                                                                                                                                                                                              |
...
**WARNING:** Unlike all other events, during a On Begin Drag Over event, the method called is executed in the context of the process of the drag and drop source object, not in that of the drag and drop destination object. For more information, see the [Drag and Drop](/4Dv20R6/4D/20-R6/Drag-and-Drop.300-6957997.en.html) section.
...
(\*\*) Refer to the "[Drag and Drop](drag-and-drop.md)" chapter for more information.  
...
* On Alternative Click (new in v15): This event is generated in columns of object array type list boxes, when the user clicks on a widget ellipsis button ("alternateButton" attribute). For more information, refer to the [Using object arrays in columns](/4Dv20R6/4D/20-R6/Using-object-arrays-in-columns.300-7003338.en.html) section.
...
When the On Mouse Up event is generated, you can get the local coordinates where the mouse button was released. These coordinates are returned in the **MouseX** and **MouseY** [System Variables](/4Dv20R6/4D/20-R6/System-Variables.300-6958705.en.html). The coordinates are expressed in pixels with respect to the top left corner of the picture (0,0).  
...
For more information about these events, please refer to the [On VP Ready form event](/4Dv20R6/4D/16-R4/On-VP-Ready-form-event.300-3429193.en.html) section.
...
**Note:** For other examples showing how to handle On Drag Over and On Drop events, see the examples of the [\_o\_DRAG AND DROP PROPERTIES](/4Dv20R6/4D/20-R6/o-DRAG-AND-DROP-PROPERTIES.301-6957656.en.html) command.
