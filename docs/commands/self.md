...
**Note:** When it is used in the context of a list box, the function returns a pointer to the list box or the column of the list box depending on the context. For more information, please refer to the [Managing List Box Objects](/4Dv20R6/4D/20-R6/Managing-List-Box-Objects.300-6958138.en.html) section.
