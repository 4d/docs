...
Somewhere in your code, other than in the [On Server Startup Database Method](/4Dv20R6/4D/20-R6/On-Server-Startup-Database-Method.301-7182874.en.html), you need to check if you are running 4D Server. You can write:
