...
<!--REF #_command_.LISTBOX Get property.Syntax-->**LISTBOX Get property** ( {* ;} *object* ; *property* ) -> Function result<!-- END REF-->
...
In the *property* parameter, pass a constant indicating the property whose value you want to get. You can use one of the following constants from the “[List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html)” theme:
