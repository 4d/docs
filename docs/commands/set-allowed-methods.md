...
* The formula editor - allowed methods appear at the end of the list of default commands and can be used in formulas (see section [Description of formula editor](/4Dv20R6/4D/20-R6/Description-of-formula-editor.300-7003284.en.html)).
* The label editor - the allowed methods are listed in the **Apply** menu if they are also shared with the component (see section [Description of label editor](/4Dv20R6/4D/20-R6/Description-of-label-editor.300-7003285.en.html)).
...
* 4D View Pro documents - by default, if the [VP SET ALLOWED METHODS](/4Dv20R6/4D/19-R2/VP-SET-ALLOWED-METHODS.301-5471311.en.html) command has never been called during the session, 4D View Pro formulas only accept methods defined by **SET ALLOWED METHODS**. However, using [VP SET ALLOWED METHODS](/4Dv20R6/4D/19-R2/VP-SET-ALLOWED-METHODS.301-5471311.en.html) is recommended. See [Project method references](/4Dv20R6/4D/17-R2.1720/Project-method-references.300-3778860.en.html).
