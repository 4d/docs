...
**Note:** This command extends the functionalities offered by conventional picture transformation operators (+/, etc., see the [C\_BOOLEAN](c-boolean.md) section*)*. These operators remain entirely usable in 4D.
...
In *operator*, pass the number of the operation to be carried out and in *param*, the parameter(s) needed for this operation (the number of parameters depends on the operation). You can use one of the constants of the "[Picture Transformation](/4Dv20R6/4D/20-R6/Picture-Transformation.302-6958474.en.html)" theme in *operator*. These operators and their parameters are described in the following table:
