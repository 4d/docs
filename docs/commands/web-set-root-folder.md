...
This command does not take the default root folder that may have been set in the Database Settings into account. For more information about this folder, please refer to the [Connection Security](/4Dv20R6/4D/14-R2/Connection-Security.300-1342179.en.html) section.
