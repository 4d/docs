...
The *selectMode* parameter is used to set the possibilities for selecting records in the list using the mouse. You can pass one of the following constants of the “[Form Parameters](/4Dv20R6/4D/20-R6/Form-Parameters.302-6958477.en.html)” theme in this parameter:
