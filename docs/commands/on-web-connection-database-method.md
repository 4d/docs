...
The *$4* parameter receives the IP address requested by the 4D Web Server. 4D allows for multi-homing, which allows you to use machines with more than one IP address. For more information, please refer to the section [Web Server Settings](/4Dv20R6/4D/14-R2/Web-Server-Settings.300-1342174.en.html).
