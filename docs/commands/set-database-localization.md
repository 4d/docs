...
Pass the language to be used for the application in *languageCode*, expressed in the standard specified by RFC 3066, ISO639 and ISO3166\. Typically, you must pass "fr" for French, "es" for Spanish, "en-us" for American English, and so on. For more information about this standard, please refer to [Appendix B: XLIFF architecture](/4Dv20R6/4D/20-R6/Appendix-B-XLIFF-architecture.300-7003281.en.html) in the *Design Reference* manual.
