...
<!--REF #_command_.New collection.Syntax-->**New collection** {( *value* {; *value2* ; ... ; *valueN*} )} -> Function result<!-- END REF-->
...
<!--REF #_command_.New collection.Summary-->The **New collection** command creates a new empty or prefilled collection and returns its reference.<!-- END REF--> 

If you do not pass any parameters, **New collection** creates an empty collection and returns its reference. 

You must assign the returned reference to a 4D variable declared with [C\_COLLECTION](c-collection.md).

**Note:** Keep in mind that [C\_COLLECTION](c-collection.md) declares a variable of the [Collection](# "Array of object property values") type but does not create any collection. 
...
**Note:** For more information on object notation, please refer to the [Using object notation](/4Dv20R6/4D/20-R6/Using-object-notation.300-6957621.en.html) section. 
