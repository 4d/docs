...
In the *type* parameter, you can pass one of the constants of the [QR Output Destination](/4Dv20R6/4D/20-R6/QR-Output-Destination.302-6958458.en.html) theme. The contents of the *specifics* parameter depends on the value of *type*. The following table describes the values that can be passed in both *type* and *specifics* parameters:
