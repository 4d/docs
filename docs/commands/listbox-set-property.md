...
In the *property* and *value* parameters, you indicate, respectively, the property to set and its new value. You can use the following constants found in the “[List Box](/4Dv20R6/4D/20-R6/List-Box.302-6958504.en.html)” theme:
