...
**Reminder:** You cannot have references to local variables in compiled mode. For more information about SQL programming in 4D, refer to the section [Overview of SQL Commands](/4Dv20R6/4D/20-R6/Overview-of-SQL-Commands.300-6958586.en.html).   
