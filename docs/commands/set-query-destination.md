...
You specify the type of the destination in the parameter *destinationType*. 4D provides the following predefined constants, found in the "[Queries](/4Dv20R6/4D/20-R6/Queries.302-6958487.en.html)" theme:
