...
* Select the **Export > Structure definition to XML file...** menu item found in 4D's Design mode (see [Exporting and importing structure definitions](/4Dv20R6/4D/20-R6/Exporting-and-importing-structure-definitions.300-7003406.en.html)),
