...
In the *methodType* parameter, you pass the type of method whose path you want to get. You can use the following constants, found in the [Design Object Access](/4Dv20R6/4D/20-R6/Design-Object-Access.302-6958460.en.html) theme:
