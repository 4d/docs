...
*Classic forms* are 4D forms stored within the structure file in binary format. *Dynamic forms* are forms whose structures are defined in a 4D object (or a .json file). For more information, please refer to the [Dynamic Forms](/4Dv20R6/4D/20-R6/Dynamic-Forms.300-7003255.en.html) section.
