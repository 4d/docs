...
The *textFormat* parameter can be used to set the internal format and the character set of the text value to be written. To do this, pass one of the following constants (found in the “[BLOB](/4Dv20R6/4D/20-R6/BLOB.302-6958486.en.html)” theme) in the *textFormat* parameter:
