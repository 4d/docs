...
4D provides predefined constants so that you can designate the selection limits automatically in the *startSel* and *endSel* parameters. These constants are found in the "[Multistyle Text](/4Dv20R6/4D/20-R6/Multistyle-Text.302-6958494.en.html)" theme: 
...
This command returns a value designating the type of contents identified. You can compare this value with the following constants, found in the "[Multistyle Text](/4Dv20R6/4D/20-R6/Multistyle-Text.302-6958494.en.html)" theme: 
