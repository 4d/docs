...
In *property*, you can pass the following constants, located in the [QR Document Properties](/4Dv20R6/4D/20-R6/QR-Document-Properties.302-6958490.en.html) constant theme:
