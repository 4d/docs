...
1. Click the Arrow tool  in the toolbar.![](..assets/en/FormEditor/selection.png)
...
Click the Group button  in the toolbar of the Form editor:![](..assets/en/FormEditor/group.png)
