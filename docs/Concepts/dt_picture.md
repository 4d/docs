...
```
![](../assets/img/en/Concepts/concatHor.en.png)
![](../assets/img/en/Concepts/concatHor2.en.png)
...
```
![](../assets/img/en/Concepts/concatVer.en.png)
![](../assets/img/en/Concepts/concatVer2.en.png)

Exclusive superimposition
```4d
Pict3:=Pict1 & Pict2 // Superimposes Pict2 on top of  Pict1
```
![](../assets/img/en/Concepts/superimpoExc.fr.png)

Inclusive superimposition
```4d
Pict3:=Pict1|Pict2 // Recovers resulting mask from superimposing two pictures of the same size
```
![](../assets/img/en/Concepts/superimpoInc.fr.png)
...
```
![](../assets/img/en/Concepts/hormove.en.png)
...
```
![](../assets/img/en/Concepts/vertmove.en.png)![](../assets/img/en/Concepts/vertmove2.en.png)
...
```
![](../assets/img/en/Concepts/resize.en.png)![](../assets/img/en/Concepts/resisze2.en.png)
...
![](../assets/img/en/Concepts/Horscaling.en.png)![](../assets/img/en/Concepts/Horscaling2.en.png)
...
![](../assets/img/en/Concepts/vertscaling.en.png)![](../assets/img/en/Concepts/veticalscaling2.en.png)
