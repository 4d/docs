...
<!-- REF cs.ViewPro.TableTheme.bandRows.Desc -->
### .bandRows

<!-- REF cs.ViewPro.TableTheme.bandRows.Syntax -->**.bandRows** : Boolean<!-- END REF -->

The `.bandRows` property <!-- REF cs.ViewPro.TableTheme.bandRows.Summary -->contains True if XXX<!-- END REF -->.

<!-- END REF -->

<!-- REF cs.ViewPro.LineBorder.Desc -->
## .LineBorder


<!-- REF cs.ViewPro.LineBorder.Syntax -->**.LineBorder** : Boolean<!-- END REF -->
