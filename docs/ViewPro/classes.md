...
<!-- REF TableTheme.theme.Syntax -->**.theme** : cs.ViewPro.TableThemeOptions<!-- END REF --><br/><!-- REF TableTheme.theme.Syntax -->**.theme** : Text<!-- END REF -->
...
The `.name` property is the <!-- REF TableThemeOptions.lastHeaderCellStyle.Summary -->name name of a [native SpreadJS theme](https://www.grapecity.com/spreadjs/api/classes/GC.Spread.Sheets.Tables.TableThemes)<!-- END REF -->. 
...
<!-- REF TableThemeOptions.secondRowStripSize.Syntax -->**.secondRowStripSize** : cs.ViewPro.TableStyle<!-- END REF -->

The `.secondRowStripSize` property is the <!-- REF TableThemeOptions.secondRowStripSize.Summary -->second alternating row style<!-- END REF -->.
...
The `.forecolor` property is the <!-- REF TableStyle.backColor.Summary -->[foreground color](configuring.md/#background--foreground) of the table<!-- END REF -->. 
...
The `.borderRight` property is the <!-- REF TableStyle.borderLeft.Summary -->right border line of the table <!-- END REF -->. 
...
The `.borderHorizontal` property is the <!-- REF TableStyle.borderBottom.Summary -->horizontal border line of the table <!-- END REF -->. 
...
The `.style` property is the <!-- REF LineBorder.color.Summary -->[style](configuring.md#borders) of the border<!-- END REF -->. Default = empty. 
