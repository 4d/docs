...
- 4D ZIPfile and  folder instances are available through the `root` property ([`ZIP Folder`](zipFolderClass.md)) of the object returned by [ZIP Read archive](#zip-read-archive) command. 
