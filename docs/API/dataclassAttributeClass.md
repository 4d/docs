...
**.fieldType** : number<!-- END REF -->


#### Description
The `.fieldType` property <!-- REF #dataclassAttributeClass.fieldType.Summary -->contains the 4D database type of the attribute<!-- END REF -->.  It depends on the attribute kind (see `.kind`).
...
**.relatedDataClass** : string<!-- END REF -->
...
The conceptual value type depends on the attribute kind (see [`.kind`](#kind)).
