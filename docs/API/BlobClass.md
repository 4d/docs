...
The 4D.Blob class lets you create and manipulate blob objects (4D.Blob).
...
#### Description
`4D.Blob.new` <!-- REF #4D.Blob.new().Summary --> creates a new 4D.Blob object optionally encapsulating a copy of the data from another blob.<!-- END REF --> 
...
var $myString:= BLOB to text ($myBlob; UTF8)
