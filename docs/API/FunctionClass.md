...
The [Formula](./commands/formula) and [Formula from string](./commands/formula-from-string) commands allow you to create [`4D.Function` objects](#formula-objects) to execute any 4D expression or code expressed as text.
