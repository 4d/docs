...
|`dk status mild validation error`| 7| Non fatal error sent by the developer for a validate event. **Associated statusText**: "Mild Validation Error"|
...
|`dk status serious validation error`| 8| Fatal error sent by the developer for a validate event. **Associated statusText**: "Serious Validation Error"|
