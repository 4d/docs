...
|classID| Text | Available only if `.type = "object"` and a class has been specified in the structure. </br>Returns the name of the class used to instantiate the object. |
