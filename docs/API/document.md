...
|[getIcon()](#geticon)|<!-- INCLUDE Document.getIcon.Summary -->|
||<!--INCLUDE Document.getIcon.Syntax -->|
<!-- END REF -->
...
##### Description
The file.<!-- REF Document.getContent.Method -->getContent()<!-- END REF --> method returns <!-- REF Document.getContent.Summary -->a BLOB containing the entire content of the file. For information on BLOBs, please refer to the BLOB Commands section.<!-- END REF -->
...
<!-- REF Document.getIcon.Parameters -->
|Parameter|Type|Description|
|---------|----|-----------|
|Result|BLOB|File content|
<!-- END REF -->
...
##### Description
The file.getContent( ) method returns <!-- REF Document.getIcon.Summary -->a BLOB containing the entire content of the file. For information on BLOBs, please refer to the BLOB Commands section.<!-- END REF -->
