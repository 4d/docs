...
A project is a specific database configuration. When you [create a database project](creating.md), you select this configuration and it will not be possible to switch to the "binary" development for this database. 
