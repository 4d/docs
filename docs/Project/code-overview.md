...
This option allows you to declare the method eligible for execution in preemptive mode. It is described in the [Preemptive processes section](../Develop/processes.md#preemtive-processes).
