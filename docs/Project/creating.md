...
2. Select **New > Database Project...** from the **File** menu: ![](../assets/img/en/Project/project-create1.png) OR
	Select **Database Project...** from the **New** toolbar button: ![](../assets/img/en/Project/projectCreate2.png)   
