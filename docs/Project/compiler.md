...
- **Methods**: Groups together method parameter declarations (for instance, `C_LONGINT(mymethod;$a;$b)`). For more information, see [`Compiler` method](../Concepts/paramters.md#compiler-method)
