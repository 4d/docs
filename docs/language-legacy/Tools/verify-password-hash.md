...
This function compares *password* to a *hash* generated by the [Generate password hash](../commands/generate-password-hash) function.
...
This example verifies a password hash previously created by [Generate password hash](../commands/generate-password-hash) and stored in a \[Users\] table with a newly entered password:
