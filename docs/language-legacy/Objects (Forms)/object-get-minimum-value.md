...
You can set the "Minimum Value" property using the Property List in Design mode, or using the [OBJECT SET MINIMUM VALUE](../commands/object-set-minimum-value) command.
