...
*dataPath* designates a 4D data file (.4DD). It must correspond to the structure file defined by the *structurePath* parameter. To verify the currently open data file, use the [VERIFY CURRENT DATA FILE](../commands/verify-current-data-file) command. 
