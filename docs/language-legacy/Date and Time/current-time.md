...
The current time is always between *00:00:00* and *23:59:59*. Use [String](../commands/string) or [Time string](../commands/time-string) to obtain the string form of the time expression returned by **Current time**.
