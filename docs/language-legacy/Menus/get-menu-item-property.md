...
In the *property* parameter, pass the property for which you want to get the value. You can use one of the constants of the “*Menu Item Properties*” theme or a string corresponding to a custom property. For more information about menu properties and their values, please refer to the description of the [SET MENU ITEM PROPERTY](../commands/set-menu-item-property) command.
