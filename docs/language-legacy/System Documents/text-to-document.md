...
If you want the user to be able to indicate the name or location of the document, use the [Open document](../commands/open-document) or [Create document](../commands/create-document) commands, as well as the *Document* system variable.
