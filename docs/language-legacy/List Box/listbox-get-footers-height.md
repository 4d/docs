...
<!--REF #_command_.LISTBOX Get footers height.Syntax-->**LISTBOX Get footers height** ( * ; *object* : Text {; *unit* : Integer} ) : Integer<br/>**LISTBOX Get footers height** ( *object* : Variable {; *unit* : Integer} ) : Integer<!-- END REF-->
