...
**Note:** 4D dates will be converted either in "yyyy-mm-dd" or "YYYY-MM-DDThh:mm:sssZ" format according to the [current database date setting](../commands/set-database-parameter#dates-inside-objects-85).
