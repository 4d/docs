...
- [IMAP Transporter Class](../API/IMAPTransporterClass): [`.getBoxInfo()`]() returns *id*, [`.selectBox()`]() returns *id*, *flags* and *permanentFlags*, [`.addFlags()`]() and [`.removeFlags()`]() support custom keywords.
