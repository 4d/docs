...
- New [`onHttpGet` function keyword](../ORDA/ordaClasses.md#onhttpget-keyword) to define singleton or ORDA functions that can be called by the REST server to handle incoming [HTTP GET requests](../REST/ClassFunctions.md#function-calls). 
