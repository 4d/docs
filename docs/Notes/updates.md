...
- When a component has a declared namespace, its functions and classes are now automatically shared between all components in the host project via [`cs.<namespace>`].
