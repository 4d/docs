...
- Support of **OAuth2 token object** in [`IMAP New transporter`](../commands/imap-new-transporter.mdnsporter), [`POP3 New transporter`](../command/pop3-new-transporter.md), and [`SMTP New transporter`](../API/SMTPTransporterClass.md#smtp-new-transporter).
