...
1. Select the item you want to create and click the add ![](../assets/img/en/Menus/PlussNew.png) button below the menu bar area.
OR
...
OR
Click on the add ![](../assets/img/en/Menus/PlussNew.png) button located below the central list.
...
- Select the item to be deleted and click on the delete ![](../assets/img/en/Menus/MinussNew.png) button located beneath the list.
...
![](../assets/img/en/Menus/attach.png)
...
![](../assets/img/en/Menus/attach2.png)
