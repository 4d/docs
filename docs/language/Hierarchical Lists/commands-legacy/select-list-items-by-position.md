...
<!--REF #_command_.SELECT LIST ITEMS BY POSITION.Syntax-->**SELECT LIST ITEMS BY POSITION** ( * ; *list* : Text ; *itemPos* : Integer {; *positionsArray* : Integer array} )<br/>**SELECT LIST ITEMS BY POSITION** ( *list* : Integer ; *itemPos* : Integer {; *positionsArray* : Integer array} )<!-- END REF-->
