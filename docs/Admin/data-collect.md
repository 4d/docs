...
Collected data is written in a text file (JSON format) per database when certain events occur, such as when 4D Server starts up or shuts down.. The file is stored inside the [active 4D folder](../commands/get-4d-folder), i.e.:
