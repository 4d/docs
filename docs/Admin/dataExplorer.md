...
- On the **left area**, you can select the dataclasses and attributes to display. You can filter the list of proposed dataclass names and attribute names using the respective search areas. 
