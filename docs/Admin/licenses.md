...
|*4D Desktop*|Per-computer license, allowing to use stand-alone 4D applications|[First activation](#first-activation) dialog box on the user's machine|
|*4D Desktop Business Edition*|Embedded custom license for stand-alone 4D applications|[Licenses page](../Desktop/building.md#licenses) of the Build application dialog|
