...
This button can be used to restart the 4D Server application with the current project. When you click on this button, the 4D Server shutdown dialog box appears so that you can choose how to interrupt the operation. 
