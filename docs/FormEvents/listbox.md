...
|Form Event  |Event Code|Apply to Column Objects?|Additional Properties Returned| Comments|
|---|---|---|---|---|
...
|On After Sort|30|Yes|<li>column</li><li>columnName</li><li>row</li>|*Compound formulas cannot be sorted. <br>(e.g., This.firstName + This.lastName)*|
|On Alternative Click|38|Yes|<li>column</li><li>columnName</li><li>row</li>|*Arrays list boxes only*|
...
|On Close Detail|26|No|<li>row</li>|*Current Selection & Named Selection list boxes only*|
|On Collapse|44|No|<li>column</li><li>columnName</li><li>row</li>|*Hierarchical list box only*|
...
|On Expand|43|No|<li>column</li><li>columnName</li><li>row</li>|*Hierarchical list box only*|
|On Footer Click|57|Yes|<li>column</li><li>columnName</li><li>footerName</li>|*Arrays, Current Selection & Named Selection list boxes only*|
|On Getting Focus|15|Yes|<li>column</li><li>columnName</li><li>row</li>|*Additional properties returned only when editing a cell*|
|On Header Click|42|Yes|<li>column</li><li>columnName</li><li>headerName</li>||
|On Load|1|Yes||
|On Losing Focus|14|Yes|<li>column</li><li>columnName</li><li>row</li>|*Additional properties returned only when editing a cell has been completed*|
...
|On Open Detail|25|No|<li>row</li>|*Current Selection & Named Selection list boxes only*|
