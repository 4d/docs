...
<!--REF #_command_.WP Get frame.Syntax-->**WP Get frame** ( * ; *wpArea* : Text {; *textBoxID* : Text} ) : Integer<br/>**WP Get frame** ( *wpArea* : Variable, Field {; *textBoxID* : Text} ) : Integer<!-- END REF-->
