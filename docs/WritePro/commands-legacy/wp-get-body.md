...
<!--REF #_command_.WP Get body.Syntax-->**WP Get body** ( *wpDoc* : Object ) : Object<!-- END REF-->
...
* [WP SET ATTRIBUTES](../commands/wp-set-attributes) and [WP GET ATTRIBUTES](../commands/wp-get-attributes) commands to handle the body's attributes.
