...
<!--REF #_command_.WP Get subsection.Syntax-->**WP Get subsection** ( *targetObj* : Object ) : Object<br/>**WP Get subsection** (*wpSection* : Object ; *subSectionType* : Integer ) : Object<!-- END REF-->
