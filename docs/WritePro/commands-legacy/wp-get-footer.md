...
<!--REF #_command_.WP Get footer.Syntax-->**WP Get footer** ( *targetObj* : Object ) : Object<br/>**WP Get footer** (*wpDoc* : Object ; *sectionIndex* : Integer {; *sectionSubType* : Integer} ) : Object<!-- END REF-->
