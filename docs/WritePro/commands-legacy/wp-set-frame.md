...
<!--REF #_command_.WP SET FRAME.Syntax-->**WP SET FRAME** ( * ; *wpArea* : Text ; *frameSelector* : Integer {; *textBoxID* : Text} )<br/>**WP SET FRAME** ( *wpArea* : Variable, Field ; *frameSelector* : Integer {; *textBoxID* : Text} )<!-- END REF-->
