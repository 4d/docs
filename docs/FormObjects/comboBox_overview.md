...
- in the case of a combo box associated with an object, the `currentValue` property of the object gets the entered text,
...
Use the [`On Data Change`](Events/onDataChange.md) event to manage entries into the enterable area, as you would for any enterable area object. 
...
- [Automatic insertion](properties_DataSource.md#automatic-insertion): enables automatically adding a value to the data source when a user enters a value that is not found in the choice list associated with the combo box.
