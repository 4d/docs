...
- ![](../assets/img/en/FormObjects/property_focusable1.png)<br/>Check box shows focus when selected

- ![](../assets/img/en/FormObjects/property_focusable2.png)<br/>Check box is selected but cannot show focus|
...
![](../assets/img/en/FormObjects/multilineAuto.png)
...
![](../assets/img/en/FormObjects/multilineNo.png)
...
![](../assets/img/en/FormObjects/property_placeholder.png)
...
![](../assets/img/en/FormObjects/property_shortcut.png)
