...
|[Flat](#flat)|Standard system button with rounded corners and a minimalist appearance <p><p>![](assets/en/FormObjects/button_flat.png)|{"style":"flat"}|
|[Toolbar](#toolbar)|Button with pop-up menu for integration in a toolbar<p><p>![](assets/en/FormObjects/button_toolbar.png)|{"style":"toolbar"}|
|[Bevel](#bevel)|Combines the appearance of the [Regular button](#regular) style with the [Toolbar](#toolbar-button) tyle's functionality.<p><p>![](assets/en/FormObjects/button_bevel.png) |{"style":"bevel"}|
|[Rounded Bevel](#Rounded-bevel)|Nearly identical to the [Bevel](#bevel) style except, depending on the OS, the corners of the button may be rounded.<p><p>![](assets/en/FormObjects/button_roundedbevel.png)|{"style":"roundedBevel"}|
|[OS X Gradient](#os-x-gradient)|Nearly identical to the [Bevel](#bevel) style except, depending on the OS, it may have a two-toned appearance.<p><p>![](assets/en/FormObjects/button_osxgradient.png)|{"style":"gradientBevel"}|
|[OS X Textured](#os-x-textured)|Nearly identical to the [Bevel](#bevel) style except, depending on the OS, it may have a different appearance.<p><p>![](assets/en/FormObjects/button_osxtextured.png)|{"style":"texturedBevel"}|
|[Office XP](#office-XP)|Combines the appearance of the [Regular](#regular) style with the [Toolbar](#toolbar-button) style's functionality.<p><p>![](assets/en/FormObjects/button_officexp.png)|{"style":"office"}|
|[Help](#help)|Standard system help button<p><p>![](assets/en/FormObjects/button_help.png)|{"style":"help"}|
|[Circle](#circle)|Round system button<p><p>![](assets/en/FormObjects/button_circle.png)|{"style":"circular"}|
|[Custom](#custom)|Accepts a custom background picture and additional parameters<p><p>![](assets/en/FormObjects/button_custom.png)|{"style":"custom"}|
...
The appearance of the OS X Textured style can also be different when the cursor hovers over it depending on the OS:
