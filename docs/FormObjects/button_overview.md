...
|---|---|---|
|[Regular](#regular)|Standard system button ![oppoo](assets/en/FormObjects/button_regular.png)|{"style":"regular"}|
|[Toolbar](#toolbar)|Button with pop-up menu for integration in a toolbar<p><p>![](assets/en/button_toolbar.en.png)|{"style":"toolbar"}|
|[Bevel](#bevel)|Combines the appearance of the [Regular button](#regular) style with the [Toolbar button](#toolbar-button) button style's functionality.<p><p>![](../../assets/en/button_bevel.en.png) |{"style":"bevel"}|
...
|[Office XP](#office-XP)|Combines the appearance of the [Regular button](#regular) style with the [Toolbar button](#toolbar-button) button style's functionality.<p><p>![](../../assets/en/button_officexp.en.png)|{"style":"office"}|
|[Help](#help)|Standard system help button<p><p>![](../../assets/en/button_help.en.png)|{"style":"help"}|
...
The Bevel button style combines the appearance of the [Regular button](#regular-button) style (*i.e.*, a rectangle with a descriptive label) with the [Toolbar button](#toolbar-button) button style's pop-up menu property option. 
...
The OS X Gradient button style is nearly identical to the [Bevel](#bevel-button) style except, depending on the OS, it may have a two-toned appearance. As with the Bevel button style, the OS X Gradient button style combines the appearance of the [Regular](#regular-button) style (*i.e.*, a rectangle with a descriptive label) with the [Toolbar](#toolbar-button) style's pop-up menu property option. 
...
The OS X Textured button style is nearly identical to the [Bevel](#bevel) style except, depending on the OS, it may have a different appearance. As with the Bevel button style, the OS X Textured button style combines the appearance of the [Regular](#regular) style (*i.e.*, a rectangle with a descriptive label) with the [Toolbar](#toolbar) style's pop-up menu property option. 
...
The Office XP button style combines the appearance of the [Regular](#regular) style (*i.e.*, a rectangle with a descriptive label) with the [Toolbar](#toolbar) button style's transparency and pop-up menu property option. 
