...
| --- | --- | --- | --- |
| collection | Collection | &harr; | Collection to receive the array data |
| array | Array | &srarr; | Array to copy to the collection; if propertyName passed, array to copy to the values of propertyName in the collection |
| propertyName | Text | &srarr; | Object property name whose value to fill with array elements |
