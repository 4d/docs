...
| one | Integer | &rarr; | Status of the Many-to-One relation starting from the field or the Many-to-One relations of the table |
| many | Integer | &rarr; | Status of the One-to-Many relation starting from the field or the One-to-Many relations of the table |
