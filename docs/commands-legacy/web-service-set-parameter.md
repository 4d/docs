...
| --- | --- | --- | --- |
| name | Text | &srarr; | Name of parameter to include in SOAP request |
| value | Variable | &srarr; | 4D variable containing the value of the parameter |
| soapType | Text | &srarr; | SOAP type of the parameter |
