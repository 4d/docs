...
| itemPos | Longint | &rarr; | Position of item in expanded/collapsed list(s) |
| positionsArray | Longint array | &rarr; | Array of the positions in the expanded/collapsed list(s) |
