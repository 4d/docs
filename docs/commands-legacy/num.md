...
| --- | --- | --- | --- |
| expression | String, Boolean, Longint | &rarr; | String for which to return the numeric form, or Boolean to return 0 or 1, or Numeric expression |
| separator | String | &rarr; | Decimal separator |
