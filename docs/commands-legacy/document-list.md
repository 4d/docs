...
| --- | --- | --- | --- |
| pathname | String | &rarr; | Pathname to volume, directory or folder |
| documents | Text array | <&rarr; | Names of the documents present at this location |
| options | Longint | &rarr; | Options for building list |
