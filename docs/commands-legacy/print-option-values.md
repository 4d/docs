...
| --- | --- | --- | --- |
| option | Integer | &srarr; | Option number |
| namesArray | Text array | &harr; | Names of values |
| info1Array | Integer array | &harr; | Values (1) of the option |
| info2Array | Integer array | &harr; | Values (2) of the option |
