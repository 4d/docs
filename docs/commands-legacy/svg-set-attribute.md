...
| element_ID | Text | &srarr; | ID of element where one or more attributes are set |
| attribName | Text | &srarr; | Attribute to be specified |
| attribValue | Text, Integer | &srarr; | New value of attribute |
| * | Operator | &srarr; | If passed = modify SVG image itself |
