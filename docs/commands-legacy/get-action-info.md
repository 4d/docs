...
| --- | --- | --- | --- |
| action | String | &rarr; | Standard action name or pattern including parameter if required |
| target | Longint | &rarr; | Defines the target of the action to get information: main form or current form |
