...
| --- | --- | --- | --- |
| part | Integer | &rarr; | Part number |
| contents | Blob, Text | &larr; | Contents of part |
| name | Text | &larr; | Name of "input" variable |
| mimeType | Text | &larr; | Mime type of submitted file |
| fileName | Text | &larr; | Name of submitted file |
