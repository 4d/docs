...
| variableFrame | Boolean | &harr; | True = Variable frame printing, False = Fixed frame printing |
| fixedSubform | Integer | &harr; | Option for printing subforms in fixed size |
