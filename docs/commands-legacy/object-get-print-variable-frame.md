...
| variableFrame | Boolean | &larr; | True = Variable frame printing, False = Fixed frame printing |
| fixedSubform | Integer | &larr; | Option for printing subforms in fixed size |
