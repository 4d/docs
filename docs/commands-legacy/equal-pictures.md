...
| --- | --- | --- | --- |
| picture1 | Picture field, Picture variable | &rarr; | Original source picture |
| picture2 | Picture field, Picture variable | &rarr; | Picture to compare |
| mask | Picture field, Picture variable | <&rarr; | Resulting mask |
