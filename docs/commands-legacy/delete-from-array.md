...
| --- | --- | --- | --- |
| array | Array | &rarr; | Array from which to delete elements |
| where | Longint | &rarr; | Element at which to begin deletion |
| howMany | Longint | &rarr; | Number of elements to delete, or 1 element if omitted |
