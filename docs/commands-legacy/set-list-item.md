...
| newItemText | Text | &rarr; | New item text |
| newItemRef | Integer | &rarr; | New item reference number |
| sublist | Integer | &rarr; | New sublist attached to item, or 0 for no sublist (detaching current one, if any), or -1 for no change |
