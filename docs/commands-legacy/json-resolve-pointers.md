...
| --- | --- | --- | --- |
| object | Object | &srarr; | Object containing JSON pointers to resolve |
| &harr; | Object with JSON pointers resolved (only if result is an object) |
| options | Object | &srarr; | Options for pointer resolution |
