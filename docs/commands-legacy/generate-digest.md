...
| --- | --- | --- | --- |
| param | BLOB, Text variable | &rarr; | Blob or text for which to get digest key |
| algorithm | Longint | &rarr; | Algorithm used to return key: 0 = MD5 Digest, 1 = SHA1 Digest, 2 = 4D digest, 3 = SHA-256 digest, 4 = SHA-512 digest |
| * | Operator | &rarr; | Encode digest in Base64URL |
