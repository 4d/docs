...
| numFiles | Longint | &rarr; | Maximum number of files per folder |
| fileLimitSize | Longint | &rarr; | Maximum size of Export.sql file (in KB) |
| fieldLimitSize | Longint | &rarr; | Size limit (in bytes) below which the contents of a Text, BLOB or Picture field are embedded into the main file |
