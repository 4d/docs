...
| --- | --- | --- | --- |
| aField | Field | &rarr; | Field for which to create or delete the index |
| index | Boolean, Integer | &rarr; | True=Create index, False=Delete index, orCreate an index of the type: -1=Keywords, 0=by default, 1=B-Tree standard, 3=B-Tree cluster |
| * | Operator |  &rarr; | Asynchronous indexing if * is passed |
