...
| moveH | Longint | &rarr; | Horizontal shift of new object (>0 = to the right, <0 = to the left) |
| moveV | Longint | &rarr; | Vertical shift of new object (>0 = downwards, <0 = upwards) |
...
| * | Operator | &rarr; | If specified= absolute coordinates
