...
| variable | Variable | &larr; | Variable to write with BLOB contents |
| offset | Integer | &rarr; | Position of variable within BLOB |
| &larr; | Position of following variable within BLOB |
