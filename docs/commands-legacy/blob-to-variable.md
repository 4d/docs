...
| --- | --- | --- | --- |
| blob | Blob | &srarr; | BLOB containing 4D variables |
| variable | Variable | &harr; | Variable to write with BLOB contents |
| offset | Integer | &srarr; | Position of variable within BLOB |
| &harr; | Position of following variable within BLOB |
