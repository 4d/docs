...
| --- | --- | --- | --- |
| header&#124;fieldArray | Text, Text array | &srarr; | Field or variable containing the request HTTP header or HTTP header fields |
| valueArray | Text array | &srarr; | HTTP header field content |
