...
| minWidth | Integer | &harr; | Minimum column width (in pixels) |
| maxWidth | Integer | &harr; | Maximum column width (in pixels) |
| Function result | Longint | &larr; | Column width (in pixels) |
