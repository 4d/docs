...
| object | Form object | &rarr; | Object Name (if * is specified) or Variable or field (if * is omitted) |
| autoSpellcheck | Boolean | &rarr; | True = automatic spell-checking,False= no automatic spell-checking |
