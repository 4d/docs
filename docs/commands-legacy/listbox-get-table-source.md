...
| tableNum | Integer | &harr; | Table number of selection |
| name | Text | &harr; | Name of named selection or "" for the current selection |
| highlightName | Text | &harr; | Name of highlight set |
