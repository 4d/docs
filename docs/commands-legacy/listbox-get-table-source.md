...
| tableNum | Integer | &larr; | Table number of selection |
| name | Text | &larr; | Name of named selection or "" for the current selection |
| highlightName | Text | &larr; | Name of highlight set |
