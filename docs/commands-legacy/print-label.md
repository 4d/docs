...
| --- | --- | --- | --- |
| aTable | Table | &rarr; | Table to print, or Default table, if omitted |
| document | String | &rarr; | Name of disk label document |
| * | > | &rarr; | * to suppress the printing dialog box, or > to not reinitialize print settings |
