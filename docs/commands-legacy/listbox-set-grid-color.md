...
| color | Text, Integer | &srarr; | RGB color value |
| horizontal | Boolean | &srarr; | Use color for horizontal grid lines |
| vertical | Boolean | &srarr; | Use color for vertical grid lines |
