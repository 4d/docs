...
| offset | Real | &rarr; | File position (expressed in bytes) |
| anchor | Longint | &rarr; | 1 = In relation to the beginning of the file 2 = In relation to the end of the file 3 = In relation to current position |
