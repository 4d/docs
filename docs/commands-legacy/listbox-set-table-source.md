...
| tableNum &#124; selName | Longint, String | &srarr; | Number of table whose current selection is to be used or Named selection to be used |
| highlightName | Text | &srarr; | Name of highlight set |
