...
| tableNum &#124; selName | Longint, String | &rarr; | Number of table whose current selection is to be used or Named selection to be used |
| highlightName | Text | &rarr; | Name of highlight set |
