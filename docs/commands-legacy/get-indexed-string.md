...
| strID | Longint | &rarr; | String number or 'id' attribute of the 'trans-unit' element (XLIFF) |
| resFile | DocRef | &rarr; | Resource file reference number If omitted: all the XLIFF files or open resource files |
