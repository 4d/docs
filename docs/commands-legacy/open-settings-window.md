...
| --- | --- | --- | --- |
| selector | String | &rarr; | Key designating a theme or a page or a group of parameters in the Preferences or Settings dialog box |
| access | Boolean | &rarr; | True=Lock the other pages of the dialog box
False or omitted=Leave the other pages of the dialog box active |
| settingsType | Longint | &rarr; | 0 or omitted = Structure settings, 1 = User settings, 2 = User settings for data |
