...
| --- | --- | --- | --- |
| objectNames | Text array | &srarr; | Array of object names in their expected entry order |
| pageNumber | Integer | &srarr; | Number of the page to set the entry order (current page if omitted) |
