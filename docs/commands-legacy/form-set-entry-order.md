...
| --- | --- | --- | --- |
| objectNames | Text array | &rarr; | Array of object names in their expected entry order |
| pageNumber | Longint | &rarr; | Number of the page to set the entry order (current page if omitted) |
