...
slug: /commands-legacy/integer-to-blob
...
| --- | --- | --- | --- |
| entier | Longint | &rarr; | Integer value to write into the BLOB |
| blob | BLOB | &rarr; | BLOB to receive the Integer value |
| ordreOctet | Longint | &rarr; | 0 Native byte ordering 1 Macintosh byte ordering 2 PC byte ordering |
| offset | * | Variable, Operator | &rarr; | Offset expressed in bytes within the BLOB or * to append the value |
