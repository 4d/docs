...
| property | Text | &srarr; | Property type |
| value | Text, Number, Boolean | &srarr; | Property value |
...
| Associated standard action | String | 4D\_standard\_action             | Associate a standard action with a menu item<br/>See the constants of the *Standard Action* theme.                                                                                                                       |  
