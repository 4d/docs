...
| --- | --- | --- | --- |
| object | Form object | &rarr; | Table for which to redraw the subform, or Field for which to redraw the area, or Variable for which to redraw the area, or List box to be updated |
