...
| --- | --- | --- | --- |
| mouseX | Real | <&rarr; | Horizontal coordinate of mouse |
| mouseY | Real | <&rarr; | Vertical coordinate of mouse |
| mouseButton | Longint | <&rarr; | Mouse button state: 0 = Button up 1 = Button down 2 = Right button down 3 = Both buttons down |
