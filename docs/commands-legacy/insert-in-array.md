...
| --- | --- | --- | --- |
| array | Array | &rarr; | Name of the array |
| where | Longint | &rarr; | Where to insert the elements |
| howMany | Longint | &rarr; | Number of elements to be inserted, or 1 element if omitted |
