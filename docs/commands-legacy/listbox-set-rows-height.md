...
slug: /commands-legacy/listbox-set-rows-height
...
| height | Longint | &rarr; | Row height (in pixels) |
| unit | Longint | &rarr; | Unit of height value:0 or omitted = pixels, 1 = lines |
