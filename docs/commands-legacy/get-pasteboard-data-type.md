...
| --- | --- | --- | --- |
| 4Dsignatures | Text array | <&rarr; | 4D signatures of data types |
| nativeTypes | Text array | <&rarr; | Native data types |
| formatNames | Text array | <&rarr; | Format names (Windows only), empty strings under Mac OS |
