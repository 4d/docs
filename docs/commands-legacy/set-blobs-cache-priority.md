...
| --- | --- | --- | --- |
| aTable | Table | &rarr; | Table whose "blobs" data priority value has to be set for the session |
| priority | Longint | &rarr; | Cache priority value for BLOBs in the table |
