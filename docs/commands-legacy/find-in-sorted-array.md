...
| posFirst | Longint | <&rarr; | Position of its first occurrence if the value is found; otherwise position where the value should be inserted |
| posLast | Longint | <&rarr; | Position of its last occurrence if the value is found; otherwise same as posFirst |
