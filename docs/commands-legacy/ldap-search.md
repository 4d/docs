...
<!--REF #_command_.LDAP Search.Syntax-->**LDAP Search** ( *dnRootEntry* ; *filter* {; *scope* {; *attributes* {; *attributesAsArray*}}} ) -> Function result<!-- END REF-->
<!--REF #_command_.LDAP Search.Params-->
| Parameter | Type |  | Description |
| --- | --- | --- | --- |
| dnRootEntry | String | &rarr; | Distinguished Name of root entry where search is to start |
| filter | String | &rarr; | LDAP search filter |
| scope | String | &rarr; | Scope of search: "base" (default), "one", or "sub" |
