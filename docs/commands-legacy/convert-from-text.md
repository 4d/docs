...
| --- | --- | --- | --- |
| 4Dtext | String | &rarr; | Text expressed in current character set of 4D |
| charSet | String, Longint | &rarr; | Name or Number of character set |
| convertedBLOB | BLOB | <&rarr; | BLOB containing converted text |
