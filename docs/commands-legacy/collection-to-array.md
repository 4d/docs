...
| --- | --- | --- | --- |
| collection | Collection | &rarr; | Collection to copy in array(s) |
| array | Array | <&rarr; | Array to receive the elements of the collection; if propertyName passed, array to receive the values of propertyName in the collection |
| propertyName | Text | &rarr; | Object property name whose values to copy in array ("" for all elements) |
