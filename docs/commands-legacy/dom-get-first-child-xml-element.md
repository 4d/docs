...
| childElemName | String | <&rarr; | Name of child XML element |
| childElemValue | String | <&rarr; | Value of child XML element |
| Function result | String | &larr; | Child XML element reference |
