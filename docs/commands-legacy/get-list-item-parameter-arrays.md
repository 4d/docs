...
| list | Integer, Text | &srarr; | List reference number (if * omitted) orName of list type object (if * passed) |
...
| arrSelection | Text array | &harr; | Array of parameter names |
| arrValues | Text array | &harr; | Array of parameter values |
