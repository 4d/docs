...
| document | String | &rarr; | Quick Report document to load |
| methodName | String | &rarr; | Name of method to call |
...
| $2            | Longint  | Number of the command selected. To compare with the following constants of the *QR Commands* theme (only listed events are supported): Constant Value Comment qr cmd generate 2008 Use of command [QR RUN](qr-run.md) recommended qr cmd open 2001 qr cmd page setup 2006 qr cmd print preview 2007 qr cmd save 2002 qr cmd save as 2003 |
