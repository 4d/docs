...
| title | Text | <&rarr; | Column title |
| object | Text | <&rarr; | Object assigned for that column |
| hide | Longint | <&rarr; | 0 = displayed, 1 = hidden |
| size | Longint | <&rarr; | Column size |
| repeatedValue | Longint | <&rarr; | 0 = not repeated, 1 = repeated |
| displayFormat | Text | <&rarr; | Display format for the data |
| resultVar | Text | <&rarr; | Name of the formula variable |
