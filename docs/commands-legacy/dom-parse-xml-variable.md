...
| --- | --- | --- | --- |
| variable | Blob, Text | &srarr; | Name of the variable |
| validation | Boolean | &srarr; | True = Validation by the DTD, False = No validation |
| dtd &#124; schema | String | &srarr; | Location of the DTD or XML schema |
