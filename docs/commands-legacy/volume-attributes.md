...
| --- | --- | --- | --- |
| volume | String | &rarr; | Volume name |
| size | Real | <&rarr; | Volume size expressed in bytes |
| used | Real | <&rarr; | Used space expressed in bytes |
| free | Real | <&rarr; | Free space expressed in bytes |
