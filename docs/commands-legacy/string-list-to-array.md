...
| --- | --- | --- | --- |
| resID | Longint | &rarr; | Resource ID number or 'id' attribute of the 'group' element (XLIFF) |
| strings | String array | <&rarr; | Strings from the STR# resource or Strings from the 'group' element (XLIFF) |
| resFile | DocRef | &rarr; | Resource file reference number If omitted: all the XLIFF files or open resources files |
