...
| fileLimitSize | Longint | &rarr; | Size limit value of export files (in KB) |
| fieldLimitSize | Longint | &rarr; | Size limit (in bytes) below which the contents of a Text, BLOB or Picture field is embedded into the main file |
