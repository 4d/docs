...
| --- | --- | --- | --- |
| aField | Text, BLOB, Picture | &rarr; | Field for which to set the storage location |
| path | Text, Longint | &rarr; | Pathname and file name of external storage or0 = use structure definition 1 = use default folder |
