...
| --- | --- | --- | --- |
| aField | Text, Blob, Picture | &srarr; | Field for which to set the storage location |
| path | Text, Integer | &srarr; | Pathname and file name of external storage or0 = use structure definition 1 = use default folder |
