...
| dataPath | Text | &srarr; | Pathname of data file to be compacted |
| archiveFolder | Text | &srarr; | Pathname of folder where original data file will be put |
| option | Integer | &srarr; | Compacting options |
