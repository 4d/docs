...
| --- | --- | --- | --- |
| sourceType | Integer | &rarr; | Source type: user or system |
| sourceNamesArr | Text array | &larr; | Array of data source names |
| driversArr | Text array | &larr; | Array of drivers for sources |
