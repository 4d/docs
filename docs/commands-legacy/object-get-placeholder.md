...
<!--REF #_command_.OBJECT Get placeholder.Syntax-->**OBJECT Get placeholder** ( {* ;} *object* ) -> Function result<!-- END REF-->
...
| Function result | Text | &larr; | Placeholder text associated with object |
