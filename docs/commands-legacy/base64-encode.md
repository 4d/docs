...
| --- | --- | --- | --- |
| toEncode | Blob, Text | &srarr; | Value to encode |
| &harr; | Encoded value (if encoded parameter omitted) |
| encoded | Blob, Text | &harr; | Encoded value |
| * | Operator | &srarr; | Encode in Base64URL format |
