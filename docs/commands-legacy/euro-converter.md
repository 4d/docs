...
| fromCurrency | String | &rarr; | Code of the currency in which the value is expressed |
| toCurrency | String | &rarr; | Code of the currency into which the value must be converted |
