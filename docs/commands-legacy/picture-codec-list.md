...
| --- | --- | --- | --- |
| codecArray | Text array | &harr; | IDs of available picture Codecs |
| namesArray | Text array | &harr; | Names of picture Codecs |
| * | Operator | &srarr; | Return list of reading (decoding) Codecs |
