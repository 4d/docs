...
| --- | --- | --- | --- |
| namesArray | Text array | <&rarr; | Printer names |
| altNamesArray | Text array | <&rarr; | Windows: Printer locations, macOS: Custom printer names |
| modelsArray | Text array | <&rarr; | Printer models |
