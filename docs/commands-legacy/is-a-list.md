...
| --- | --- | --- | --- |
| list | Integer | &srarr; | ListRef value to be tested |
| Function result | Boolean | &larr; | TRUE if list is a hierarchical list FALSE if list is not a hierarchical list |
