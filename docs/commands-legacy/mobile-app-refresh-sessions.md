...
The command can return one of the following errors, that can be handled through [ON ERR CALL](on-err-call.md) and [GET LAST ERROR STACK](get-last-error-stack.md) commands:
