...
| --- | --- | --- | --- |
| folderPath | Text | &rarr; | Pathname of folder (package under OS X) containing updated application |
| silentErrors | Boolean | &rarr; | False (default) = report errors visibly, <br/>True = do not report them |
