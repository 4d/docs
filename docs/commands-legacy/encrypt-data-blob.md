...
slug: /commands-legacy/encrypt-data-blob
...
| --- | --- | --- | --- |
| blobToEncrypt | BLOB | &rarr; | BLOB to encrypt |
...
| salt | Longint | &rarr; | Additional salt for algorithm |
| encryptedBLOB | BLOB | <&rarr; | Encrypted BLOB |
