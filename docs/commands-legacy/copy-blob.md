...
| srcOffset | Longint | &rarr; | Source position for the copy |
| dstOffset | Longint | &rarr; | Destination position for the copy |
| len | Longint | &rarr; | Number of bytes to be copied |
