...
slug: /commands-legacy/dom-get-xml-element
...
| elementName | String | &rarr; | Name of element to get |
| index | Longint | &rarr; | Index number of element to get |
| elementValue | Variable | <&rarr; | Value of the element |
