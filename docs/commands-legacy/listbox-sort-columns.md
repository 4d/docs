...
<!--REF #_command_.LISTBOX SORT COLUMNS.Syntax-->**LISTBOX SORT COLUMNS** ( * ; *object* : Text ; *colNum* : Integer ; *order* : Comparator {; ...(*colNum* : Integer ; *order* : Comparator)} )<br/>**LISTBOX SORT COLUMNS** ( *object* : Variable ; *colNum* : Integer ; *order* : >, < {; ...(*colNum* : Integer ; *order* : Comparator)} )<!-- END REF-->
