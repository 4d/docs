...
| itemRef | * | Operator, Longint | &rarr; | Item reference number or 0 for the last item added to the list or * for the current item of the list |
| icon | Picture variable | <&rarr; | Icon associated with item |
