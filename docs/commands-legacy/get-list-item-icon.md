...
| itemRef &#124; * | Operator, Longint | &srarr; | Item reference number or 0 for the last item added to the list or * for the current item of the list |
| icon | Picture | &harr; | Icon associated with item |
