...
| subtotal | Longint | &rarr; | Subtotal number |
| value | Longint | <&rarr; | 0=no space, 32000=inserts a page break, >0=spacing added below the break level, <0=proportional increase |
