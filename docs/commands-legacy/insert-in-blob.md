...
| offset | Longint | &rarr; | Starting position where bytes will be inserted |
| len | Longint | &rarr; | Number of bytes to be inserted |
| filler | Longint | &rarr; | Default byte value (0x00..0xFF) 0x00 if omitted |
