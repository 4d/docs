...
<!--REF #_command_.OBJECT Is styled text.Syntax-->**OBJECT Is styled text** ( {* ;} *object* ) -> Function result<!-- END REF-->
...
| Function result | Boolean | &larr; | True if object is a multi-style text, False otherwise |
