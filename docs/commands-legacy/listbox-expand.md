...
| recursive | Boolean | &rarr; | True = expand sublevels
False = do not expand sublevels |
| selector | Longint | &rarr; | Part of list box to expand |
| line | Longint | &rarr; | Number of break row to expand or 
Number of list box level to expand |
| column | Longint | &rarr; | Number of break column to expand |
