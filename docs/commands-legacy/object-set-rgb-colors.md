...
| foregroundColor | Text, Longint | &rarr; | RGB color value for foreground |
| backgroundColor | Text, Longint | &rarr; | RGB color value for background |
| altBackgrndColor | Text, Longint | &rarr; | RGB color value for alternating background |
