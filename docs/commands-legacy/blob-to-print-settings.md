...
| --- | --- | --- | --- |
| printSettings | BLOB | &rarr; | BLOB containing print settings |
| params | Longint | &rarr; | 0=Restore saved values for number of copies and page range, 1=Reset to default values |
