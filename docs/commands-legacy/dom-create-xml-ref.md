...
| --- | --- | --- | --- |
| root | String | &rarr; | Name of root element |
| nameSpace | String | &rarr; | Value of namespace |
| nameSpaceName | String | &rarr; | Namespace name |
| nameSpaceValue | String | &rarr; | Namespace value |
