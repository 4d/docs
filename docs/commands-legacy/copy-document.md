...
| --- | --- | --- | --- |
| sourceName | Text | &rarr; | Pathname of file or folder to be copied |
| destinationName | Text | &rarr; | Name or pathname of copied file or folder |
| newName | Text | &rarr; | New name of copied file or folder |
