...
| --- | --- | --- | --- |
| pages | Text array | <&rarr; | Names of the most consulted pages |
| hits | Longint array | <&rarr; | Number of hits for each page |
| usage | Longint | <&rarr; | Percentage of the cache used |
