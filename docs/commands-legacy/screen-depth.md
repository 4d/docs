...
| --- | --- | --- | --- |
| depth | Integer | &harr; | Depth of the screen (number of colors = 2 ^ depth) |
| color | Integer | &harr; | 1 = Color screen, 0 = Black and white or Gray scale |
| screen | Integer | &srarr; | Screen number, or main screen if omitted |
