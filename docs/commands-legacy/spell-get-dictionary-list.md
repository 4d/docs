...
| --- | --- | --- | --- |
| langID | Longint array | <&rarr; | Unique ID of languages |
| langFiles | Text array | <&rarr; | Names of language files installed |
| langNames | Text array | <&rarr; | Local names of languages |
