...
| --- | --- | --- | --- |
| langID | Integer array | &harr; | Unique ID of languages |
| langFiles | Text array | &harr; | Names of language files installed |
| langNames | Text array | &harr; | Local names of languages |
