...
| startSel | Longint | &rarr; | Start of text selection |
| endSel | Longint | &rarr; | End of text selection |
| attribName | Longint | &rarr; | Attribute to get |
| attribValue | Variable | <&rarr; | Current value of attribute |
