...
| recordsArray | Longint, Boolean array | &rarr; | Array of record numbers, or Array of booleans (True = the record is in the set, False = the record is not in the set) |
| setName | String | &rarr; | Name of the set to create, or Apply the command to the Userset if omitted |
