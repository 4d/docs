...
| --- | --- | --- | --- |
| booleanArr | Boolean array | &harr; | Array to indicate if a record is in the set or not |
| set | Text | &srarr; | Name of the set or UserSet if this parameter is omitted |
