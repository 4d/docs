...
| selector | Integer | &srarr; | Height value to set: lk row min height or lk row max height |
| value | Integer | &srarr; | Minimum or maximum row height value |
| unit | Integer | &srarr; | Unit of height value: 0 = pixels, 1 = lines |
