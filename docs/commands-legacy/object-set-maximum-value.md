...
The "Maximum Value" property can be applied to number, date or time type data. For more information, refer to [Maximum and minimum values](/4Dv20R6/4D/20-R6/Data-entry-controls-and-assistance.300-7003359.en.html#421887) in the *Design Reference* manual.
