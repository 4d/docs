...
| object | any | &rarr; | Object name or "" to designate the form (if * is specified) orField or variable (if * is omitted) |
| arrEvents | Integer array | &larr; | Array of enabled events |
