...
| --- | --- | --- | --- |
| parameters | Object | &srarr; | Object containing the web area's attributes |
...
In *parameters* object, pass any of the following optional properties. These properties will be available through the [This](this.md) command within the *onEvent* method and reference the instance: 
...
| onEvent          | object (formula)    | A callback method that will be launched when the web area is ready. It can be either:<br/> an *onEvent* function of a class, or a [Formula](formula.md) object  By default, the callback method is called on the On Load, On Unload, On End URL Loading, On URL Loading Error, or On Timer events.                                |
