...
| --- | --- | --- | --- |
| triggerLevel | Longint | &rarr; | Trigger execution cycle level |
| dbEvent | Longint | <&rarr; | Database event |
| tableNum | Longint | <&rarr; | Involved table number |
| recordNum | Longint | <&rarr; | Involved record number |
