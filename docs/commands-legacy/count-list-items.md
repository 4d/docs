...
<!--REF #_command_.Count list items.Syntax-->**Count list items** ( {* ;} *list* {; *} ) -> Function result<!-- END REF-->
...
| * | Operator | &rarr; | If omitted (default): Return visible list items (expanded) If specified: Return all list items |
