...
| --- | --- | --- | --- |
| source | Text | &srarr; | String from which to get substring |
| firstChar | Integer | &srarr; | Position of first character |
| numChars | Integer | &srarr; | Number of characters to get |
